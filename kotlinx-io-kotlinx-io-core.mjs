...
function write$default(source, startIndex, endIndex, $super) {
  ...
  var tmp;
  if ($super === VOID) {
    this.x1y(source, startIndex, endIndex);
    tmp = Unit_instance;
  } else {
    tmp = $super.x1y.call(this, source, startIndex, endIndex);
  }
  return tmp;
}
class Buffer {
  ...
  p1x(byteCount) {
    ...
    if (this.l2() < byteCount) {
      throw EOFException.m1x("Buffer doesn't contain required number of bytes (size: " + this.l2().toString() + ', required: ' + byteCount.toString() + ')');
    }
  }
  q1x(byteCount) {
    // Inline function 'kotlin.require' call
  ...
  r1x() {
    ...
    var v = segment.a1y();
    this.i1x_1 = subtract(this.i1x_1, 1n);
    if (segmentSize === 1) {
      this.z1x();
    }
    return v;
  ...
  b1y() {
    ...
    if (segmentSize < 2) {
      ...
      var tmp_0 = (this.r1x() & 255) << 8;
      // Inline function 'kotlinx.io.and' call
      var tmp$ret$1 = this.r1x() & 255;
      return toShort(tmp_0 | tmp$ret$1);
    }
    var v = segment.c1y();
    this.i1x_1 = subtract(this.i1x_1, 2n);
    if (segmentSize === 2) {
      this.z1x();
    }
    return v;
  ...
  e1y(out, startIndex, endIndex) {
    checkBounds(this.l2(), startIndex, endIndex);
    if (startIndex === endIndex)
      return Unit_instance;
    var currentOffset = startIndex;
    var remainingByteCount = subtract(endIndex, startIndex);
    out.i1x_1 = add(out.i1x_1, remainingByteCount);
    var s = this.g1x_1;
    while (currentOffset >= fromInt(ensureNotNull(s).u1x_1 - s.t1x_1 | 0)) {
      currentOffset = subtract(currentOffset, fromInt(s.u1x_1 - s.t1x_1 | 0));
      s = s.x1x_1;
    }
    while (remainingByteCount > 0n) {
      var copy = ensureNotNull(s).f1y();
      copy.t1x_1 = copy.t1x_1 + convertToInt(currentOffset) | 0;
      var tmp = copy;
      var tmp0 = copy.t1x_1 + convertToInt(remainingByteCount) | 0;
      // Inline function 'kotlin.comparisons.minOf' call
      var b = copy.u1x_1;
      tmp.u1x_1 = Math.min(tmp0, b);
      // Inline function 'kotlinx.io.Buffer.pushSegment' call
      if (out.g1x_1 == null) {
        out.g1x_1 = copy;
        out.h1x_1 = copy;
      } else if (false) {
        out.h1x_1 = ensureNotNull(out.h1x_1).g1y(copy).h1y();
        if (ensureNotNull(out.h1x_1).y1x_1 == null) {
          out.g1x_1 = out.h1x_1;
        }
      } else {
        out.h1x_1 = ensureNotNull(out.h1x_1).g1y(copy);
      }
      remainingByteCount = subtract(remainingByteCount, fromInt(copy.u1x_1 - copy.t1x_1 | 0));
      currentOffset = 0n;
      s = s.x1x_1;
    }
  }
  i1y() {
    ...
    if (result === 0n)
      return 0n;
    var tail = ensureNotNull(this.h1x_1);
    if (tail.u1x_1 < 8192 && tail.w1x_1) {
      result = subtract(result, fromInt(tail.u1x_1 - tail.t1x_1 | 0));
    }
    return result;
  }
  j1y(position) {
    if (position < 0n || position >= this.l2()) {
      throw IndexOutOfBoundsException.je('position (' + position.toString() + ') is not within the range [0..size(' + this.l2().toString() + '))');
    }
    if (position === 0n) {
      return ensureNotNull(this.g1x_1).k1y(0);
    }
    $l$block_1: {
      // Inline function 'kotlinx.io.seek' call
      if (this.g1x_1 == null) {
        return ensureNotNull(null).k1y(convertToInt(subtract(position, -1n)));
      }
      if (subtract(this.l2(), position) < position) {
        var s = this.h1x_1;
        var offset = this.l2();
        $l$loop: while (!(s == null) && offset > position) {
          offset = subtract(offset, fromInt(s.u1x_1 - s.t1x_1 | 0));
          if (offset <= position)
            break $l$loop;
          s = s.y1x_1;
        }
        var tmp0 = s;
        var offset_0 = offset;
        return ensureNotNull(tmp0).k1y(convertToInt(subtract(position, offset_0)));
      } else {
        var s_0 = this.g1x_1;
        var offset_1 = 0n;
        $l$loop_0: while (!(s_0 == null)) {
          ...
          var other = s_0.u1x_1 - s_0.t1x_1 | 0;
        ...
        return ensureNotNull(tmp0_1).k1y(convertToInt(subtract(position, offset_2)));
      }
    }
  }
  i4() {
    return this.l1y(this.l2());
  }
  l1y(byteCount) {
    ...
    while (remainingByteCount > 0n) {
      ...
      var tmp;
      if (tmp0_elvis_lhs == null) {
        throw EOFException.m1x('Buffer exhausted before skipping ' + byteCount.toString() + ' bytes.');
      } else {
        tmp = tmp0_elvis_lhs;
      }
      var head = tmp;
      ...
      var b = head.u1x_1 - head.t1x_1 | 0;
      // Inline function 'kotlin.comparisons.minOf' call
      var b_0 = fromInt(b);
      var tmp$ret$3 = tmp0 <= b_0 ? tmp0 : b_0;
      var toSkip = convertToInt(tmp$ret$3);
      this.i1x_1 = subtract(this.i1x_1, fromInt(toSkip));
      remainingByteCount = subtract(remainingByteCount, fromInt(toSkip));
      head.t1x_1 = head.t1x_1 + toSkip | 0;
      if (head.t1x_1 === head.u1x_1) {
        this.z1x();
      }
    }
  }
  m1y(sink, startIndex, endIndex) {
    ...
    s.n1y(sink, startIndex, startIndex + toCopy | 0);
    this.i1x_1 = subtract(this.i1x_1, fromInt(toCopy));
    if (isEmpty(s)) {
      this.z1x();
    }
    return toCopy;
  ...
  q1y(sink, byteCount) {
    ...
    if (this.l2() < byteCount) {
      sink.p1y(this, this.l2());
      throw EOFException.m1x('Buffer exhausted before writing ' + byteCount.toString() + ' bytes. Only ' + this.l2().toString() + ' bytes were written.');
    }
    sink.p1y(this, byteCount);
  }
  r1y(sink) {
  ...
  t1y(minimumCapacity) {
    ...
    if (this.h1x_1 == null) {
      var result = SegmentPool_instance.w1y();
      this.g1x_1 = result;
      this.h1x_1 = result;
      return result;
    }
    var t = ensureNotNull(this.h1x_1);
    if ((t.u1x_1 + minimumCapacity | 0) > 8192 || !t.w1x_1) {
      var newTail = t.g1y(SegmentPool_instance.w1y());
      this.h1x_1 = newTail;
      return newTail;
    }
    return t;
  }
  x1y(source, startIndex, endIndex) {
    // Inline function 'kotlinx.io.checkBounds' call
    ...
    while (currentOffset < endIndex) {
      ...
      var b = tail.y1y();
      var toCopy = Math.min(tmp0, b);
      tail.z1y(source, currentOffset, currentOffset + toCopy | 0);
      currentOffset = currentOffset + toCopy | 0;
    }
    var tmp = this;
    var tmp0_0 = this.i1x_1;
    // Inline function 'kotlin.Long.plus' call
    var other = endIndex - startIndex | 0;
    tmp.i1x_1 = add(tmp0_0, fromInt(other));
  }
  b1z(source, byteCount) {
    // Inline function 'kotlinx.io.checkByteCount' call
    // Inline function 'kotlin.require' call
    if (!(byteCount >= 0n)) {
      var message = 'byteCount (' + byteCount.toString() + ') < 0';
    ...
    var remainingByteCount = byteCount;
    while (remainingByteCount > 0n) {
      var read = source.o1y(this, remainingByteCount);
      if (read === -1n) {
        throw EOFException.m1x('Source exhausted before reading ' + byteCount.toString() + ' bytes. ' + ('Only ' + subtract(byteCount, remainingByteCount).toString() + ' were read.'));
      }
      remainingByteCount = subtract(remainingByteCount, read);
    }
  }
  p1y(source, byteCount) {
    // Inline function 'kotlin.require' call
    if (!!(source === this)) {
      var message = 'source == this';
      throw IllegalArgumentException.h2(toString(message));
    }
    checkOffsetAndCount(source.i1x_1, 0n, byteCount);
    var remainingByteCount = byteCount;
    while (remainingByteCount > 0n) {
      if (remainingByteCount < fromInt(ensureNotNull(source.g1x_1).l2())) {
        var tail = this.h1x_1;
        var tmp;
        if (!(tail == null) && tail.w1x_1) {
          var tmp0 = remainingByteCount;
          // Inline function 'kotlin.Long.plus' call
          var other = tail.u1x_1;
          var tmp0_0 = add(tmp0, fromInt(other));
          // Inline function 'kotlin.Long.minus' call
          var other_0 = tail.c1z() ? 0 : tail.t1x_1;
          tmp = subtract(tmp0_0, fromInt(other_0)) <= 8192n;
        } else {
          tmp = false;
        }
        if (tmp) {
          ensureNotNull(source.g1x_1).e1z(tail, convertToInt(remainingByteCount));
          source.i1x_1 = subtract(source.i1x_1, remainingByteCount);
          this.i1x_1 = add(this.i1x_1, remainingByteCount);
          return Unit_instance;
        } else {
          source.g1x_1 = ensureNotNull(source.g1x_1).d1z(convertToInt(remainingByteCount));
        }
      }
      var segmentToMove = ensureNotNull(source.g1x_1);
      var movedByteCount = fromInt(segmentToMove.l2());
      source.g1x_1 = segmentToMove.f1z();
      if (source.g1x_1 == null) {
        source.h1x_1 = null;
      }
      // Inline function 'kotlinx.io.Buffer.pushSegment' call
      if (this.g1x_1 == null) {
        this.g1x_1 = segmentToMove;
        this.h1x_1 = segmentToMove;
      } else if (true) {
        this.h1x_1 = ensureNotNull(this.h1x_1).g1y(segmentToMove).h1y();
        if (ensureNotNull(this.h1x_1).y1x_1 == null) {
          this.g1x_1 = this.h1x_1;
        }
      } else {
        this.h1x_1 = ensureNotNull(this.h1x_1).g1y(segmentToMove);
      }
      source.i1x_1 = subtract(source.i1x_1, movedByteCount);
      this.i1x_1 = add(this.i1x_1, movedByteCount);
  ...
  g1z(source) {
    ...
    $l$loop: while (true) {
      var readCount = source.o1y(this, 8192n);
      if (readCount === -1n)
        break $l$loop;
  ...
  h1z(byte) {
    this.t1y(1).i1z(byte);
    this.i1x_1 = add(this.i1x_1, 1n);
  }
  j1z(short) {
    this.t1y(2).k1z(short);
    this.i1x_1 = add(this.i1x_1, 2n);
  }
  z6() {
    return Unit_instance;
  }
  toString() {
    ...
    var builder = StringBuilder.ec(imul(len, 2) + (this.l2() > fromInt(maxPrintableBytes) ? 1 : 0) | 0);
    var bytesWritten = 0;
    ...
    while (!(curr == null)) {
      ...
      while (bytesWritten < len && idx < segment.l2()) {
        ...
        var b_0 = tmp0.l1z(segment, _unary__edvuaz);
  ...
  z1x() {
    var oldHead = ensureNotNull(this.g1x_1);
    var nextHead = oldHead.x1x_1;
    this.g1x_1 = nextHead;
    if (nextHead == null) {
      this.h1x_1 = null;
    } else {
    ...
    oldHead.x1x_1 = null;
    SegmentPool_instance.m1z(oldHead);
  }
  n1z() {
    var oldTail = ensureNotNull(this.h1x_1);
    var newTail = oldTail.y1x_1;
    this.h1x_1 = newTail;
    if (newTail == null) {
      this.g1x_1 = null;
    } else {
    ...
    oldTail.y1x_1 = null;
    SegmentPool_instance.m1z(oldTail);
  }
}
class PeekSource {
  constructor(upstream) {
    this.o1z_1 = upstream;
    this.p1z_1 = this.o1z_1.n1x();
    this.q1z_1 = this.p1z_1.g1x_1;
    var tmp = this;
    var tmp0_safe_receiver = this.p1z_1.g1x_1;
    var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : tmp0_safe_receiver.t1x_1;
    tmp.r1z_1 = tmp1_elvis_lhs == null ? -1 : tmp1_elvis_lhs;
    this.s1z_1 = false;
    this.t1z_1 = 0n;
  }
  o1y(sink, byteCount) {
    ...
    // Inline function 'kotlin.check' call
    if (!(this.q1z_1 == null || (this.q1z_1 === this.p1z_1.g1x_1 && this.r1z_1 === ensureNotNull(this.p1z_1.g1x_1).t1x_1))) {
    ...
    if (byteCount === 0n)
      return 0n;
    // Inline function 'kotlin.Long.plus' call
    var this_0 = this.t1z_1;
    var tmp$ret$7 = add(this_0, fromInt(1));
    if (!this.o1z_1.q1x(tmp$ret$7))
      return -1n;
    if (this.q1z_1 == null && !(this.p1z_1.g1x_1 == null)) {
      this.q1z_1 = this.p1z_1.g1x_1;
      this.r1z_1 = ensureNotNull(this.p1z_1.g1x_1).t1x_1;
    }
    // Inline function 'kotlin.comparisons.minOf' call
    var b = subtract(this.p1z_1.l2(), this.t1z_1);
    var toCopy = byteCount <= b ? byteCount : b;
    this.p1z_1.e1y(sink, this.t1z_1, add(this.t1z_1, toCopy));
    this.t1z_1 = add(this.t1z_1, toCopy);
    return toCopy;
  }
  z6() {
    this.s1z_1 = true;
...
class RealSource {
  ...
  o1y(sink, byteCount) {
    ...
    if (this.w1z_1.l2() === 0n) {
      var read = this.u1z_1.o1y(this.w1z_1, 8192n);
      if (read === -1n)
        return -1n;
    }
    // Inline function 'kotlin.comparisons.minOf' call
    ...
    return this.w1z_1.o1y(sink, toRead);
  }
  o1x() {
    // Inline function 'kotlinx.io.RealSource.checkNotClosed' call
    // Inline function 'kotlin.check' call
    ...
    return this.w1z_1.o1x() && this.u1z_1.o1y(this.w1z_1, 8192n) === -1n;
  }
  p1x(byteCount) {
    if (!this.q1x(byteCount))
      throw EOFException.m1x("Source doesn't contain required number of bytes (" + byteCount.toString() + ').');
  }
  q1x(byteCount) {
    // Inline function 'kotlinx.io.RealSource.checkNotClosed' call
    // Inline function 'kotlin.check' call
    ...
    while (this.w1z_1.l2() < byteCount) {
      if (this.u1z_1.o1y(this.w1z_1, 8192n) === -1n)
        return false;
    }
    return true;
  }
  ...
  m1y(sink, startIndex, endIndex) {
    ...
    return this.w1z_1.m1y(sink, startIndex, startIndex + toRead | 0);
  }
  q1y(sink, byteCount) {
    try {
      this.p1x(byteCount);
      ...
      if ($p instanceof EOFException) {
        var e = $p;
        sink.p1y(this.w1z_1, this.w1z_1.l2());
        throw e;
      } else {
        throw $p;
      }
    }
    this.w1z_1.q1y(sink, byteCount);
  }
  r1y(sink) {
    var totalBytesWritten = 0n;
    while (!(this.u1z_1.o1y(this.w1z_1, 8192n) === -1n)) {
      var emitByteCount = this.w1z_1.i1y();
      if (emitByteCount > 0n) {
        totalBytesWritten = add(totalBytesWritten, emitByteCount);
        sink.p1y(this.w1z_1, emitByteCount);
      }
    }
    if (this.w1z_1.l2() > 0n) {
      totalBytesWritten = add(totalBytesWritten, this.w1z_1.l2());
      sink.p1y(this.w1z_1, this.w1z_1.l2());
    }
  ...
  toString() {
    return 'buffered(' + toString(this.u1z_1) + ')';
  }
}
class Companion {
  constructor() {
...
class Segment {
  c1z() {
    ...
    var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : tmp0_safe_receiver.b20();
    return tmp1_elvis_lhs == null ? false : tmp1_elvis_lhs;
  }
  static a20() {
    var $this = createThis(this);
    init_kotlinx_io_Segment($this);
    $this.s1x_1 = new Int8Array(8192);
    $this.w1x_1 = true;
    $this.v1x_1 = null;
    return $this;
  }
  static c20(data, pos, limit, shareToken, owner) {
    var $this = createThis(this);
    init_kotlinx_io_Segment($this);
    $this.s1x_1 = data;
    $this.t1x_1 = pos;
    $this.u1x_1 = limit;
    $this.v1x_1 = shareToken;
    $this.w1x_1 = owner;
    return $this;
  }
  f1y() {
    var tmp0_elvis_lhs = this.v1x_1;
    var tmp;
    if (tmp0_elvis_lhs == null) {
      // Inline function 'kotlin.also' call
      var this_0 = SegmentPool_instance.d20();
      this.v1x_1 = this_0;
      tmp = this_0;
    } else {
      tmp = tmp0_elvis_lhs;
    ...
    var t = tmp;
    var tmp_0 = this.t1x_1;
    var tmp_1 = this.u1x_1;
    // Inline function 'kotlin.also' call
    t.e20();
    return Segment.c20(this.s1x_1, tmp_0, tmp_1, t, false);
  }
  f1z() {
    var result = this.x1x_1;
    if (!(this.y1x_1 == null)) {
      ensureNotNull(this.y1x_1).x1x_1 = this.x1x_1;
    }
    if (!(this.x1x_1 == null)) {
      ensureNotNull(this.x1x_1).y1x_1 = this.y1x_1;
    }
    this.x1x_1 = null;
    this.y1x_1 = null;
    return result;
  ...
  g1y(segment) {
    segment.y1x_1 = this;
    segment.x1x_1 = this.x1x_1;
    if (!(this.x1x_1 == null)) {
      ensureNotNull(this.x1x_1).y1x_1 = segment;
    }
    this.x1x_1 = segment;
    return segment;
  }
  d1z(byteCount) {
    // Inline function 'kotlin.require' call
    if (!(byteCount > 0 && byteCount <= (this.u1x_1 - this.t1x_1 | 0))) {
    ...
    if (byteCount >= 1024) {
      ...
      prefix = SegmentPool_instance.w1y();
      var tmp0 = this.s1x_1;
      var tmp2 = prefix.s1x_1;
      var tmp5 = this.t1x_1;
      // Inline function 'kotlin.collections.copyInto' call
      var endIndex = this.t1x_1 + byteCount | 0;
    ...
    prefix.u1x_1 = prefix.t1x_1 + byteCount | 0;
    this.t1x_1 = this.t1x_1 + byteCount | 0;
    if (!(this.y1x_1 == null)) {
      ensureNotNull(this.y1x_1).g1y(prefix);
    } else {
      prefix.x1x_1 = this;
      this.y1x_1 = prefix;
    }
  ...
  h1y() {
    ...
    if (!ensureNotNull(this.y1x_1).w1x_1)
      return this;
    var byteCount = this.u1x_1 - this.t1x_1 | 0;
    var availableByteCount = (8192 - ensureNotNull(this.y1x_1).u1x_1 | 0) + (ensureNotNull(this.y1x_1).c1z() ? 0 : ensureNotNull(this.y1x_1).t1x_1) | 0;
    if (byteCount > availableByteCount)
      return this;
    var predecessor = this.y1x_1;
    this.e1z(ensureNotNull(predecessor), byteCount);
    var successor = this.f1z();
    // Inline function 'kotlin.check' call
    if (!(successor == null)) {
      throw IllegalStateException.o('Check failed.');
    }
    SegmentPool_instance.m1z(this);
    return predecessor;
  }
  i1z(byte) {
    var _unary__edvuaz = this.u1x_1;
    this.u1x_1 = _unary__edvuaz + 1 | 0;
    this.s1x_1[_unary__edvuaz] = byte;
  }
  k1z(short) {
    var data = this.s1x_1;
    var limit = this.u1x_1;
  ...
  a1y() {
    var _unary__edvuaz = this.t1x_1;
    this.t1x_1 = _unary__edvuaz + 1 | 0;
    return this.s1x_1[_unary__edvuaz];
  }
  c1y() {
    var data = this.s1x_1;
    var pos = this.t1x_1;
  ...
  e1z(sink, byteCount) {
    ...
    if ((sink.u1x_1 + byteCount | 0) > 8192) {
      if (sink.c1z())
        throw IllegalArgumentException.yd();
      if (((sink.u1x_1 + byteCount | 0) - sink.t1x_1 | 0) > 8192)
        throw IllegalArgumentException.yd();
      var tmp0 = sink.s1x_1;
      var tmp2 = sink.s1x_1;
      var tmp5 = sink.t1x_1;
      // Inline function 'kotlin.collections.copyInto' call
      var endIndex = sink.u1x_1;
      // Inline function 'kotlin.js.unsafeCast' call
      // Inline function 'kotlin.js.asDynamic' call
      var tmp = tmp0;
      // Inline function 'kotlin.js.unsafeCast' call
      // Inline function 'kotlin.js.asDynamic' call
      arrayCopy(tmp, tmp2, 0, tmp5, endIndex);
      sink.u1x_1 = sink.u1x_1 - sink.t1x_1 | 0;
      sink.t1x_1 = 0;
    }
    var tmp0_0 = this.s1x_1;
    var tmp2_0 = sink.s1x_1;
    var tmp4 = sink.u1x_1;
    var tmp6 = this.t1x_1;
    // Inline function 'kotlin.collections.copyInto' call
    var endIndex_0 = this.t1x_1 + byteCount | 0;
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    var tmp_0 = tmp0_0;
    // Inline function 'kotlin.js.unsafeCast' call
    ...
    sink.u1x_1 = sink.u1x_1 + byteCount | 0;
    this.t1x_1 = this.t1x_1 + byteCount | 0;
  }
  n1y(dst, dstStartOffset, dstEndOffset) {
    var len = dstEndOffset - dstStartOffset | 0;
    var tmp0 = this.s1x_1;
    var tmp6 = this.t1x_1;
    // Inline function 'kotlin.collections.copyInto' call
    var endIndex = this.t1x_1 + len | 0;
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    var tmp = tmp0;
    // Inline function 'kotlin.js.unsafeCast' call
  ...
  z1y(src, srcStartOffset, srcEndOffset) {
    var tmp2 = this.s1x_1;
    // Inline function 'kotlin.collections.copyInto' call
    var destinationOffset = this.u1x_1;
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    var tmp = src;
    // Inline function 'kotlin.js.unsafeCast' call
    ...
    this.u1x_1 = this.u1x_1 + (srcEndOffset - srcStartOffset | 0) | 0;
  }
  l2() {
    return this.u1x_1 - this.t1x_1 | 0;
  }
  y1y() {
    return this.s1x_1.length - this.u1x_1 | 0;
  }
  f20(readOnly) {
    return this.s1x_1;
  }
  k1y(index) {
    return this.s1x_1[this.t1x_1 + index | 0];
  }
  g20(index, value) {
    this.s1x_1[this.u1x_1 + index | 0] = value;
  }
  h20(index, b0, b1) {
    var d = this.s1x_1;
    var l = this.u1x_1;
...
class SegmentReadContextImpl$1 {
  l1z(segment, offset) {
    return segment.k1y(offset);
  }
}
class SegmentWriteContextImpl$1 {
  n20(segment, offset, value) {
    segment.g20(offset, value);
  }
  m20(segment, offset, b0, b1) {
    segment.h20(offset, b0, b1);
  }
  l20(segment, offset, b0, b1, b2) {
    segment.i20(offset, b0, b1, b2);
  }
  k20(segment, offset, b0, b1, b2, b3) {
    segment.j20(offset, b0, b1, b2, b3);
  }
}
class BufferIterationContextImpl$1 {
  l1z(segment, offset) {
    return get_SegmentReadContextImpl().l1z(segment, offset);
  }
}
...
function checkBounds(size, startIndex, endIndex) {
  ...
  if (startIndex < 0n || endIndex > size) {
    throw IndexOutOfBoundsException.je('startIndex (' + startIndex.toString() + ') and endIndex (' + endIndex.toString() + ') are not within the range [0..size(' + size.toString() + '))');
  }
  if (startIndex > endIndex) {
  ...
  $l$block_1: {
    ...
    if (subtract(_this__u8e3s4.l2(), startIndex) < startIndex) {
      ...
      do {
        ...
        segment_0 = segment_0.x1x_1;
      }
       while (!(segment_0 == null) && offset_1 < endOffset);
      return -1n;
    } else {
      var s_0 = _this__u8e3s4.g1x_1;
      var offset_2 = 0n;
      $l$loop_0: while (!(s_0 == null)) {
        var tmp0_4 = offset_2;
        // Inline function 'kotlin.Long.plus' call
        var other_1 = s_0.u1x_1 - s_0.t1x_1 | 0;
...
function readByteString(_this__u8e3s4, byteCount) {
  return UnsafeByteStringOperations_instance.f1x(readByteArray_0(_this__u8e3s4, byteCount));
}
...
function init_kotlinx_io_Segment(_this__u8e3s4) {
  _this__u8e3s4.t1x_1 = 0;
  _this__u8e3s4.u1x_1 = 0;
  _this__u8e3s4.v1x_1 = null;
  _this__u8e3s4.w1x_1 = false;
  _this__u8e3s4.x1x_1 = null;
  _this__u8e3s4.y1x_1 = null;
}
...
function indexOf_0(_this__u8e3s4, byte, startOffset, endOffset) {
  ...
  var p = _this__u8e3s4.t1x_1;
  var data = _this__u8e3s4.f20(true);
...
function indexOf_1(_this__u8e3s4, byte, startIndex, endIndex) {
  ...
  $l$loop: while (true) {
    ...
    if (offset < endIndex) {
      ...
      tmp_0 = _this__u8e3s4.q1x(tmp$ret$2);
    } else {
      tmp_0 = false;
    }
    if (!tmp_0) {
    ...
    var tmp_1 = _this__u8e3s4.n1x();
    var tmp_2 = offset;
    // Inline function 'kotlin.comparisons.minOf' call
    var b = _this__u8e3s4.n1x().l2();
    var tmp$ret$3 = endIndex <= b ? endIndex : b;
    var idx = indexOf(tmp_1, byte, tmp_2, tmp$ret$3);
    if (!(idx === -1n)) {
      return idx;
    }
    offset = _this__u8e3s4.n1x().l2();
  }
  return -1n;
}
function readByteArrayImpl(_this__u8e3s4, size) {
  ...
  if (size === -1) {
    ...
    while (_this__u8e3s4.n1x().l2() < 2147483647n && _this__u8e3s4.q1x(fetchSize)) {
      // Inline function 'kotlin.Long.times' call
      var this_0 = fetchSize;
      fetchSize = multiply(this_0, fromInt(2));
    }
    // Inline function 'kotlin.check' call
    if (!(_this__u8e3s4.n1x().l2() < 2147483647n)) {
      var message = "Can't create an array of size " + _this__u8e3s4.n1x().l2().toString();
      throw IllegalStateException.o(toString(message));
    }
    arraySize = convertToInt(_this__u8e3s4.n1x().l2());
  } else {
    _this__u8e3s4.p1x(fromInt(size));
  }
  var array = new Int8Array(arraySize);
  readTo(_this__u8e3s4.n1x(), array);
  return array;
}
function readTo(_this__u8e3s4, sink, startIndex, endIndex) {
  ...
  while (offset < endIndex) {
    var bytesRead = _this__u8e3s4.m1y(sink, offset, endIndex);
    if (bytesRead === -1) {
      throw EOFException.m1x('Source exhausted before reading ' + (endIndex - startIndex | 0) + ' bytes. ' + ('Only ' + bytesRead + ' bytes were read.'));
    }
    offset = offset + bytesRead | 0;
  }
}
function readString(_this__u8e3s4, byteCount) {
  _this__u8e3s4.p1x(byteCount);
  return commonReadUtf8(_this__u8e3s4.n1x(), byteCount);
}
function readString_0(_this__u8e3s4) {
  _this__u8e3s4.q1x(9223372036854775807n);
  return commonReadUtf8(_this__u8e3s4.n1x(), _this__u8e3s4.n1x().l2());
}
  ...
  while (i < endIndex) {
    ...
    if (c < 128) {
      $l$block_0: {
        ...
        ctx.n20(tail, segmentOffset + _unary__edvuaz | 0, toByte(c));
        $l$loop: while (i < runLimit) {
          ...
          ctx.n20(tail, segmentOffset + _unary__edvuaz_0 | 0, toByte(c));
        }
        var bytesWritten = i + segmentOffset | 0;
        if (bytesWritten === 1) {
          tail.u1x_1 = tail.u1x_1 + bytesWritten | 0;
          var tmp = this_0;
          // Inline function 'kotlin.Long.plus' call
          var this_3 = this_0.i1x_1;
          tmp.i1x_1 = add(this_3, fromInt(bytesWritten));
          break $l$block_0;
        }
        // Inline function 'kotlin.check' call
        if (!(0 <= bytesWritten ? bytesWritten <= tail.y1y() : false)) {
          var message = 'Invalid number of bytes written: ' + bytesWritten + '. Should be in 0..' + tail.y1y();
          throw IllegalStateException.o(toString(message));
        }
        if (!(bytesWritten === 0)) {
          tail.u1x_1 = tail.u1x_1 + bytesWritten | 0;
          var tmp_0 = this_0;
          // Inline function 'kotlin.Long.plus' call
          var this_4 = this_0.i1x_1;
          tmp_0.i1x_1 = add(this_4, fromInt(bytesWritten));
          break $l$block_0;
        }
        if (isEmpty(tail)) {
          this_0.n1z();
      ...
      $l$block_2: {
        // Inline function 'kotlinx.io.unsafe.UnsafeBufferOperations.writeToTail' call
        var tail_0 = this_0.t1y(2);
        get_SegmentWriteContextImpl().m20(tail_0, 0, toByte(c >> 6 | 192), toByte(c & 63 | 128));
        var bytesWritten_0 = 2;
        if (bytesWritten_0 === 2) {
          tail_0.u1x_1 = tail_0.u1x_1 + bytesWritten_0 | 0;
          var tmp_1 = this_0;
          // Inline function 'kotlin.Long.plus' call
          var this_5 = this_0.i1x_1;
          tmp_1.i1x_1 = add(this_5, fromInt(bytesWritten_0));
          break $l$block_2;
        }
        // Inline function 'kotlin.check' call
        if (!(0 <= bytesWritten_0 ? bytesWritten_0 <= tail_0.y1y() : false)) {
          var message_0 = 'Invalid number of bytes written: ' + bytesWritten_0 + '. Should be in 0..' + tail_0.y1y();
        ...
        if (!(bytesWritten_0 === 0)) {
          ...
          var tmp_2 = this_0;
          // Inline function 'kotlin.Long.plus' call
          var this_6 = this_0.i1x_1;
          tmp_2.i1x_1 = add(this_6, fromInt(bytesWritten_0));
          break $l$block_2;
        }
        if (isEmpty(tail_0)) {
          this_0.n1z();
      ...
      $l$block_4: {
        // Inline function 'kotlinx.io.unsafe.UnsafeBufferOperations.writeToTail' call
        var tail_1 = this_0.t1y(3);
        get_SegmentWriteContextImpl().l20(tail_1, 0, toByte(c >> 12 | 224), toByte(c >> 6 & 63 | 128), toByte(c & 63 | 128));
        var bytesWritten_1 = 3;
        if (bytesWritten_1 === 3) {
          tail_1.u1x_1 = tail_1.u1x_1 + bytesWritten_1 | 0;
          var tmp_3 = this_0;
          // Inline function 'kotlin.Long.plus' call
          var this_7 = this_0.i1x_1;
          tmp_3.i1x_1 = add(this_7, fromInt(bytesWritten_1));
          break $l$block_4;
        }
        // Inline function 'kotlin.check' call
        if (!(0 <= bytesWritten_1 ? bytesWritten_1 <= tail_1.y1y() : false)) {
          var message_1 = 'Invalid number of bytes written: ' + bytesWritten_1 + '. Should be in 0..' + tail_1.y1y();
          throw IllegalStateException.o(toString(message_1));
        }
        if (!(bytesWritten_1 === 0)) {
          tail_1.u1x_1 = tail_1.u1x_1 + bytesWritten_1 | 0;
          var tmp_4 = this_0;
          // Inline function 'kotlin.Long.plus' call
          var this_8 = this_0.i1x_1;
          tmp_4.i1x_1 = add(this_8, fromInt(bytesWritten_1));
          break $l$block_4;
        }
        if (isEmpty(tail_1)) {
          this_0.n1z();
      ...
      if (c > 56319 || !(56320 <= low ? low <= 57343 : false)) {
        ...
        this_0.h1z(toByte(tmp$ret$29));
        i = i + 1 | 0;
      } else {
        var codePoint = 65536 + ((c & 1023) << 10 | low & 1023) | 0;
        $l$block_6: {
          // Inline function 'kotlinx.io.unsafe.UnsafeBufferOperations.writeToTail' call
          var tail_2 = this_0.t1y(4);
          get_SegmentWriteContextImpl().k20(tail_2, 0, toByte(codePoint >> 18 | 240), toByte(codePoint >> 12 & 63 | 128), toByte(codePoint >> 6 & 63 | 128), toByte(codePoint & 63 | 128));
          var bytesWritten_2 = 4;
          if (bytesWritten_2 === 4) {
            tail_2.u1x_1 = tail_2.u1x_1 + bytesWritten_2 | 0;
            var tmp_6 = this_0;
            // Inline function 'kotlin.Long.plus' call
            var this_11 = this_0.i1x_1;
            tmp_6.i1x_1 = add(this_11, fromInt(bytesWritten_2));
            break $l$block_6;
          }
          // Inline function 'kotlin.check' call
          if (!(0 <= bytesWritten_2 ? bytesWritten_2 <= tail_2.y1y() : false)) {
            var message_2 = 'Invalid number of bytes written: ' + bytesWritten_2 + '. Should be in 0..' + tail_2.y1y();
          ...
          if (!(bytesWritten_2 === 0)) {
            ...
            var tmp_7 = this_0;
            // Inline function 'kotlin.Long.plus' call
            var this_12 = this_0.i1x_1;
            tmp_7.i1x_1 = add(this_12, fromInt(bytesWritten_2));
            break $l$block_6;
          }
          if (isEmpty(tail_2)) {
            this_0.n1z();
...
function commonToUtf8String(_this__u8e3s4, beginIndex, endIndex) {
  ...
  if (beginIndex < 0 || endIndex > _this__u8e3s4.length || beginIndex > endIndex) {
    throw IndexOutOfBoundsException.je('size=' + _this__u8e3s4.length + ' beginIndex=' + beginIndex + ' endIndex=' + endIndex);
  }
...
function init_kotlinx_io_IOException(_this__u8e3s4) {
  captureStack(_this__u8e3s4, _this__u8e3s4.p20_1);
}
function init_kotlinx_io_EOFException(_this__u8e3s4) {
  captureStack(_this__u8e3s4, _this__u8e3s4.l1x_1);
}
...
protoOf(Buffer).a1z = write$default;
...
initMetadataForClass(IOException, 'IOException', IOException.q20);
initMetadataForClass(EOFException, 'EOFException', EOFException.t20);
