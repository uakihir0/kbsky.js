...
function write$default(source, startIndex, endIndex, $super) {
  ...
  var tmp;
  if ($super === VOID) {
    this.d1k(source, startIndex, endIndex);
    tmp = Unit_instance;
  } else {
    tmp = $super.d1k.call(this, source, startIndex, endIndex);
  }
  return tmp;
}
class Buffer {
  ...
  v1i(byteCount) {
    ...
    if (this.k2() < byteCount) {
      throw EOFException.s1i("Buffer doesn't contain required number of bytes (size: " + this.k2().toString() + ', required: ' + byteCount.toString() + ')');
    }
  }
  w1i(byteCount) {
    // Inline function 'kotlin.require' call
  ...
  x1i() {
    ...
    var v = segment.g1j();
    this.o1i_1 = subtract(this.o1i_1, 1n);
    if (segmentSize === 1) {
      this.f1j();
    }
    return v;
  ...
  h1j() {
    ...
    if (segmentSize < 2) {
      ...
      var tmp_0 = (this.x1i() & 255) << 8;
      // Inline function 'kotlinx.io.and' call
      var tmp$ret$1 = this.x1i() & 255;
      return toShort(tmp_0 | tmp$ret$1);
    }
    var v = segment.i1j();
    this.o1i_1 = subtract(this.o1i_1, 2n);
    if (segmentSize === 2) {
      this.f1j();
    }
    return v;
  ...
  k1j(out, startIndex, endIndex) {
    checkBounds(this.k2(), startIndex, endIndex);
    if (startIndex === endIndex)
      return Unit_instance;
    var currentOffset = startIndex;
    var remainingByteCount = subtract(endIndex, startIndex);
    out.o1i_1 = add(out.o1i_1, remainingByteCount);
    var s = this.m1i_1;
    while (currentOffset >= fromInt(ensureNotNull(s).a1j_1 - s.z1i_1 | 0)) {
      currentOffset = subtract(currentOffset, fromInt(s.a1j_1 - s.z1i_1 | 0));
      s = s.d1j_1;
    }
    while (remainingByteCount > 0n) {
      var copy = ensureNotNull(s).l1j();
      copy.z1i_1 = copy.z1i_1 + convertToInt(currentOffset) | 0;
      var tmp = copy;
      var tmp0 = copy.z1i_1 + convertToInt(remainingByteCount) | 0;
      // Inline function 'kotlin.comparisons.minOf' call
      var b = copy.a1j_1;
      tmp.a1j_1 = Math.min(tmp0, b);
      // Inline function 'kotlinx.io.Buffer.pushSegment' call
      if (out.m1i_1 == null) {
        out.m1i_1 = copy;
        out.n1i_1 = copy;
      } else if (false) {
        out.n1i_1 = ensureNotNull(out.n1i_1).m1j(copy).n1j();
        if (ensureNotNull(out.n1i_1).e1j_1 == null) {
          out.m1i_1 = out.n1i_1;
        }
      } else {
        out.n1i_1 = ensureNotNull(out.n1i_1).m1j(copy);
      }
      remainingByteCount = subtract(remainingByteCount, fromInt(copy.a1j_1 - copy.z1i_1 | 0));
      currentOffset = 0n;
      s = s.d1j_1;
    }
  }
  o1j() {
    ...
    if (result === 0n)
      return 0n;
    var tail = ensureNotNull(this.n1i_1);
    if (tail.a1j_1 < 8192 && tail.c1j_1) {
      result = subtract(result, fromInt(tail.a1j_1 - tail.z1i_1 | 0));
    }
    return result;
  }
  p1j(position) {
    ...
    if (position === 0n) {
      return ensureNotNull(this.m1i_1).q1j(0);
    }
    $l$block_1: {
      // Inline function 'kotlinx.io.seek' call
      if (this.m1i_1 == null) {
        return ensureNotNull(null).q1j(convertToInt(subtract(position, -1n)));
      }
      if (subtract(this.k2(), position) < position) {
        var s = this.n1i_1;
        var offset = this.k2();
        $l$loop: while (!(s == null) && offset > position) {
          offset = subtract(offset, fromInt(s.a1j_1 - s.z1i_1 | 0));
          if (offset <= position)
            break $l$loop;
          s = s.e1j_1;
        }
        var tmp0 = s;
        var offset_0 = offset;
        return ensureNotNull(tmp0).q1j(convertToInt(subtract(position, offset_0)));
      } else {
        var s_0 = this.m1i_1;
        var offset_1 = 0n;
        $l$loop_0: while (!(s_0 == null)) {
          ...
          var other = s_0.a1j_1 - s_0.z1i_1 | 0;
        ...
        return ensureNotNull(tmp0_1).q1j(convertToInt(subtract(position, offset_2)));
      }
    }
  }
  i4() {
    return this.r1j(this.k2());
  }
  r1j(byteCount) {
    ...
    while (remainingByteCount > 0n) {
      ...
      var tmp;
      if (tmp0_elvis_lhs == null) {
        throw EOFException.s1i('Buffer exhausted before skipping ' + byteCount.toString() + ' bytes.');
      } else {
        tmp = tmp0_elvis_lhs;
      }
      var head = tmp;
      ...
      var b = head.a1j_1 - head.z1i_1 | 0;
      // Inline function 'kotlin.comparisons.minOf' call
      var b_0 = fromInt(b);
      var tmp$ret$3 = tmp0 <= b_0 ? tmp0 : b_0;
      var toSkip = convertToInt(tmp$ret$3);
      this.o1i_1 = subtract(this.o1i_1, fromInt(toSkip));
      remainingByteCount = subtract(remainingByteCount, fromInt(toSkip));
      head.z1i_1 = head.z1i_1 + toSkip | 0;
      if (head.z1i_1 === head.a1j_1) {
        this.f1j();
      }
    }
  }
  s1j(sink, startIndex, endIndex) {
    ...
    s.t1j(sink, startIndex, startIndex + toCopy | 0);
    this.o1i_1 = subtract(this.o1i_1, fromInt(toCopy));
    if (isEmpty(s)) {
      this.f1j();
    }
    return toCopy;
  ...
  w1j(sink, byteCount) {
    ...
    if (this.k2() < byteCount) {
      sink.v1j(this, this.k2());
      throw EOFException.s1i('Buffer exhausted before writing ' + byteCount.toString() + ' bytes. Only ' + this.k2().toString() + ' bytes were written.');
    }
    sink.v1j(this, byteCount);
  }
  x1j(sink) {
  ...
  z1j(minimumCapacity) {
    ...
    if (this.n1i_1 == null) {
      var result = SegmentPool_instance.c1k();
      this.m1i_1 = result;
      this.n1i_1 = result;
      return result;
    }
    var t = ensureNotNull(this.n1i_1);
    if ((t.a1j_1 + minimumCapacity | 0) > 8192 || !t.c1j_1) {
      var newTail = t.m1j(SegmentPool_instance.c1k());
      this.n1i_1 = newTail;
      return newTail;
    }
    return t;
  }
  d1k(source, startIndex, endIndex) {
    // Inline function 'kotlinx.io.checkBounds' call
    ...
    while (currentOffset < endIndex) {
      ...
      var b = tail.e1k();
      var toCopy = Math.min(tmp0, b);
      tail.f1k(source, currentOffset, currentOffset + toCopy | 0);
      currentOffset = currentOffset + toCopy | 0;
    }
    var tmp = this;
    var tmp0_0 = this.o1i_1;
    // Inline function 'kotlin.Long.plus' call
    var other = endIndex - startIndex | 0;
    tmp.o1i_1 = add(tmp0_0, fromInt(other));
  }
  h1k(source, byteCount) {
    // Inline function 'kotlinx.io.checkByteCount' call
    // Inline function 'kotlin.require' call
    if (!(byteCount >= 0n)) {
      var message = 'byteCount (' + byteCount.toString() + ') < 0';
    ...
    var remainingByteCount = byteCount;
    while (remainingByteCount > 0n) {
      var read = source.u1j(this, remainingByteCount);
      if (read === -1n) {
        throw EOFException.s1i('Source exhausted before reading ' + byteCount.toString() + ' bytes. ' + ('Only ' + subtract(byteCount, remainingByteCount).toString() + ' were read.'));
      }
      remainingByteCount = subtract(remainingByteCount, read);
    }
  }
  v1j(source, byteCount) {
    // Inline function 'kotlin.require' call
    if (!!(source === this)) {
      var message = 'source == this';
      throw IllegalArgumentException.h2(toString(message));
    }
    checkOffsetAndCount(source.o1i_1, 0n, byteCount);
    var remainingByteCount = byteCount;
    while (remainingByteCount > 0n) {
      if (remainingByteCount < fromInt(ensureNotNull(source.m1i_1).k2())) {
        var tail = this.n1i_1;
        var tmp;
        if (!(tail == null) && tail.c1j_1) {
          var tmp0 = remainingByteCount;
          // Inline function 'kotlin.Long.plus' call
          var other = tail.a1j_1;
          var tmp0_0 = add(tmp0, fromInt(other));
          // Inline function 'kotlin.Long.minus' call
          var other_0 = tail.i1k() ? 0 : tail.z1i_1;
          tmp = subtract(tmp0_0, fromInt(other_0)) <= 8192n;
        } else {
          tmp = false;
        }
        if (tmp) {
          ensureNotNull(source.m1i_1).k1k(tail, convertToInt(remainingByteCount));
          source.o1i_1 = subtract(source.o1i_1, remainingByteCount);
          this.o1i_1 = add(this.o1i_1, remainingByteCount);
          return Unit_instance;
        } else {
          source.m1i_1 = ensureNotNull(source.m1i_1).j1k(convertToInt(remainingByteCount));
        }
      }
      var segmentToMove = ensureNotNull(source.m1i_1);
      var movedByteCount = fromInt(segmentToMove.k2());
      source.m1i_1 = segmentToMove.l1k();
      if (source.m1i_1 == null) {
        source.n1i_1 = null;
      }
      // Inline function 'kotlinx.io.Buffer.pushSegment' call
      if (this.m1i_1 == null) {
        this.m1i_1 = segmentToMove;
        this.n1i_1 = segmentToMove;
      } else if (true) {
        this.n1i_1 = ensureNotNull(this.n1i_1).m1j(segmentToMove).n1j();
        if (ensureNotNull(this.n1i_1).e1j_1 == null) {
          this.m1i_1 = this.n1i_1;
        }
      } else {
        this.n1i_1 = ensureNotNull(this.n1i_1).m1j(segmentToMove);
      }
      source.o1i_1 = subtract(source.o1i_1, movedByteCount);
      this.o1i_1 = add(this.o1i_1, movedByteCount);
  ...
  m1k(source) {
    ...
    $l$loop: while (true) {
      var readCount = source.u1j(this, 8192n);
      if (readCount === -1n)
        break $l$loop;
  ...
  n1k(byte) {
    this.z1j(1).o1k(byte);
    this.o1i_1 = add(this.o1i_1, 1n);
  }
  p1k(short) {
    this.z1j(2).q1k(short);
    this.o1i_1 = add(this.o1i_1, 2n);
  }
  z6() {
    return Unit_instance;
  }
  toString() {
    ...
    while (!(curr == null)) {
      ...
      while (bytesWritten < len && idx < segment.k2()) {
        ...
        var b_0 = tmp0.r1k(segment, _unary__edvuaz);
  ...
  f1j() {
    var oldHead = ensureNotNull(this.m1i_1);
    var nextHead = oldHead.d1j_1;
    this.m1i_1 = nextHead;
    if (nextHead == null) {
      this.n1i_1 = null;
    } else {
    ...
    oldHead.d1j_1 = null;
    SegmentPool_instance.s1k(oldHead);
  }
  t1k() {
    var oldTail = ensureNotNull(this.n1i_1);
    var newTail = oldTail.e1j_1;
    this.n1i_1 = newTail;
    if (newTail == null) {
      this.m1i_1 = null;
    } else {
    ...
    oldTail.e1j_1 = null;
    SegmentPool_instance.s1k(oldTail);
  }
}
class PeekSource {
  constructor(upstream) {
    this.u1k_1 = upstream;
    this.v1k_1 = this.u1k_1.t1i();
    this.w1k_1 = this.v1k_1.m1i_1;
    var tmp = this;
    var tmp0_safe_receiver = this.v1k_1.m1i_1;
    var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : tmp0_safe_receiver.z1i_1;
    tmp.x1k_1 = tmp1_elvis_lhs == null ? -1 : tmp1_elvis_lhs;
    this.y1k_1 = false;
    this.z1k_1 = 0n;
  }
  u1j(sink, byteCount) {
    ...
    // Inline function 'kotlin.check' call
    if (!(this.w1k_1 == null || (this.w1k_1 === this.v1k_1.m1i_1 && this.x1k_1 === ensureNotNull(this.v1k_1.m1i_1).z1i_1))) {
    ...
    if (!this.u1k_1.w1i(tmp$ret$7))
      return -1n;
    if (this.w1k_1 == null && !(this.v1k_1.m1i_1 == null)) {
      this.w1k_1 = this.v1k_1.m1i_1;
      this.x1k_1 = ensureNotNull(this.v1k_1.m1i_1).z1i_1;
    }
    // Inline function 'kotlin.comparisons.minOf' call
    var b = subtract(this.v1k_1.k2(), this.z1k_1);
    var toCopy = byteCount <= b ? byteCount : b;
    this.v1k_1.k1j(sink, this.z1k_1, add(this.z1k_1, toCopy));
    this.z1k_1 = add(this.z1k_1, toCopy);
    return toCopy;
  }
  z6() {
    this.y1k_1 = true;
...
class RealSource {
  ...
  u1j(sink, byteCount) {
    ...
    if (this.c1l_1.k2() === 0n) {
      var read = this.a1l_1.u1j(this.c1l_1, 8192n);
      if (read === -1n)
        return -1n;
    }
    // Inline function 'kotlin.comparisons.minOf' call
    ...
    return this.c1l_1.u1j(sink, toRead);
  }
  u1i() {
    // Inline function 'kotlinx.io.RealSource.checkNotClosed' call
    // Inline function 'kotlin.check' call
    ...
    return this.c1l_1.u1i() && this.a1l_1.u1j(this.c1l_1, 8192n) === -1n;
  }
  v1i(byteCount) {
    if (!this.w1i(byteCount))
      throw EOFException.s1i("Source doesn't contain required number of bytes (" + byteCount.toString() + ').');
  }
  w1i(byteCount) {
    // Inline function 'kotlinx.io.RealSource.checkNotClosed' call
    // Inline function 'kotlin.check' call
    ...
    while (this.c1l_1.k2() < byteCount) {
      if (this.a1l_1.u1j(this.c1l_1, 8192n) === -1n)
        return false;
    }
    return true;
  }
  ...
  s1j(sink, startIndex, endIndex) {
    ...
    return this.c1l_1.s1j(sink, startIndex, startIndex + toRead | 0);
  }
  w1j(sink, byteCount) {
    try {
      this.v1i(byteCount);
      ...
      if ($p instanceof EOFException) {
        var e = $p;
        sink.v1j(this.c1l_1, this.c1l_1.k2());
        throw e;
      } else {
        throw $p;
      }
    }
    this.c1l_1.w1j(sink, byteCount);
  }
  x1j(sink) {
    var totalBytesWritten = 0n;
    while (!(this.a1l_1.u1j(this.c1l_1, 8192n) === -1n)) {
      var emitByteCount = this.c1l_1.o1j();
      if (emitByteCount > 0n) {
        totalBytesWritten = add(totalBytesWritten, emitByteCount);
        sink.v1j(this.c1l_1, emitByteCount);
      }
    }
    if (this.c1l_1.k2() > 0n) {
      totalBytesWritten = add(totalBytesWritten, this.c1l_1.k2());
      sink.v1j(this.c1l_1, this.c1l_1.k2());
    }
  ...
  toString() {
    return 'buffered(' + toString(this.a1l_1) + ')';
  }
}
class Companion {
  constructor() {
...
class Segment {
  i1k() {
    var tmp0_safe_receiver = this.b1j_1;
  ...
  static g1l() {
    ...
    $this.y1i_1 = new Int8Array(8192);
    $this.c1j_1 = true;
    $this.b1j_1 = null;
    return $this;
  }
  static i1l(data, pos, limit, shareToken, owner) {
    var $this = createThis(this);
    init_kotlinx_io_Segment($this);
    $this.y1i_1 = data;
    $this.z1i_1 = pos;
    $this.a1j_1 = limit;
    $this.b1j_1 = shareToken;
    $this.c1j_1 = owner;
    return $this;
  }
  l1j() {
    ...
    if (tmp0_elvis_lhs == null) {
      ...
      var this_0 = SegmentPool_instance.j1l();
      this.b1j_1 = this_0;
      tmp = this_0;
    } else {
      tmp = tmp0_elvis_lhs;
    ...
    var t = tmp;
    var tmp_0 = this.z1i_1;
    var tmp_1 = this.a1j_1;
    // Inline function 'kotlin.also' call
    t.k1l();
    return Segment.i1l(this.y1i_1, tmp_0, tmp_1, t, false);
  }
  l1k() {
    var result = this.d1j_1;
    if (!(this.e1j_1 == null)) {
      ensureNotNull(this.e1j_1).d1j_1 = this.d1j_1;
    }
    if (!(this.d1j_1 == null)) {
      ensureNotNull(this.d1j_1).e1j_1 = this.e1j_1;
    }
    this.d1j_1 = null;
    this.e1j_1 = null;
    return result;
  ...
  m1j(segment) {
    segment.e1j_1 = this;
    segment.d1j_1 = this.d1j_1;
    if (!(this.d1j_1 == null)) {
      ensureNotNull(this.d1j_1).e1j_1 = segment;
    }
    this.d1j_1 = segment;
    return segment;
  }
  j1k(byteCount) {
    // Inline function 'kotlin.require' call
    if (!(byteCount > 0 && byteCount <= (this.a1j_1 - this.z1i_1 | 0))) {
    ...
    if (byteCount >= 1024) {
      ...
      prefix = SegmentPool_instance.c1k();
      var tmp0 = this.y1i_1;
      var tmp2 = prefix.y1i_1;
      var tmp5 = this.z1i_1;
      // Inline function 'kotlin.collections.copyInto' call
      var endIndex = this.z1i_1 + byteCount | 0;
    ...
    prefix.a1j_1 = prefix.z1i_1 + byteCount | 0;
    this.z1i_1 = this.z1i_1 + byteCount | 0;
    if (!(this.e1j_1 == null)) {
      ensureNotNull(this.e1j_1).m1j(prefix);
    } else {
      prefix.d1j_1 = this;
      this.e1j_1 = prefix;
    }
  ...
  n1j() {
    ...
    if (!ensureNotNull(this.e1j_1).c1j_1)
      return this;
    var byteCount = this.a1j_1 - this.z1i_1 | 0;
    var availableByteCount = (8192 - ensureNotNull(this.e1j_1).a1j_1 | 0) + (ensureNotNull(this.e1j_1).i1k() ? 0 : ensureNotNull(this.e1j_1).z1i_1) | 0;
    if (byteCount > availableByteCount)
      return this;
    var predecessor = this.e1j_1;
    this.k1k(ensureNotNull(predecessor), byteCount);
    var successor = this.l1k();
    // Inline function 'kotlin.check' call
    if (!(successor == null)) {
      throw IllegalStateException.o('Check failed.');
    }
    SegmentPool_instance.s1k(this);
    return predecessor;
  }
  o1k(byte) {
    var _unary__edvuaz = this.a1j_1;
    this.a1j_1 = _unary__edvuaz + 1 | 0;
    this.y1i_1[_unary__edvuaz] = byte;
  }
  q1k(short) {
    var data = this.y1i_1;
    var limit = this.a1j_1;
  ...
  g1j() {
    var _unary__edvuaz = this.z1i_1;
    this.z1i_1 = _unary__edvuaz + 1 | 0;
    return this.y1i_1[_unary__edvuaz];
  }
  i1j() {
    var data = this.y1i_1;
    var pos = this.z1i_1;
  ...
  k1k(sink, byteCount) {
    ...
    if ((sink.a1j_1 + byteCount | 0) > 8192) {
      if (sink.i1k())
        throw IllegalArgumentException.xd();
      if (((sink.a1j_1 + byteCount | 0) - sink.z1i_1 | 0) > 8192)
        throw IllegalArgumentException.xd();
      var tmp0 = sink.y1i_1;
      var tmp2 = sink.y1i_1;
      var tmp5 = sink.z1i_1;
      // Inline function 'kotlin.collections.copyInto' call
      var endIndex = sink.a1j_1;
      // Inline function 'kotlin.js.unsafeCast' call
      // Inline function 'kotlin.js.asDynamic' call
      var tmp = tmp0;
      // Inline function 'kotlin.js.unsafeCast' call
      // Inline function 'kotlin.js.asDynamic' call
      arrayCopy(tmp, tmp2, 0, tmp5, endIndex);
      sink.a1j_1 = sink.a1j_1 - sink.z1i_1 | 0;
      sink.z1i_1 = 0;
    }
    var tmp0_0 = this.y1i_1;
    var tmp2_0 = sink.y1i_1;
    var tmp4 = sink.a1j_1;
    var tmp6 = this.z1i_1;
    // Inline function 'kotlin.collections.copyInto' call
    var endIndex_0 = this.z1i_1 + byteCount | 0;
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    var tmp_0 = tmp0_0;
    // Inline function 'kotlin.js.unsafeCast' call
    ...
    sink.a1j_1 = sink.a1j_1 + byteCount | 0;
    this.z1i_1 = this.z1i_1 + byteCount | 0;
  }
  t1j(dst, dstStartOffset, dstEndOffset) {
    var len = dstEndOffset - dstStartOffset | 0;
    var tmp0 = this.y1i_1;
    var tmp6 = this.z1i_1;
    // Inline function 'kotlin.collections.copyInto' call
    var endIndex = this.z1i_1 + len | 0;
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    var tmp = tmp0;
    // Inline function 'kotlin.js.unsafeCast' call
    ...
    this.z1i_1 = this.z1i_1 + len | 0;
  }
  f1k(src, srcStartOffset, srcEndOffset) {
    var tmp2 = this.y1i_1;
    // Inline function 'kotlin.collections.copyInto' call
    var destinationOffset = this.a1j_1;
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    var tmp = src;
    // Inline function 'kotlin.js.unsafeCast' call
    ...
    this.a1j_1 = this.a1j_1 + (srcEndOffset - srcStartOffset | 0) | 0;
  }
  k2() {
    return this.a1j_1 - this.z1i_1 | 0;
  }
  e1k() {
    return this.y1i_1.length - this.a1j_1 | 0;
  }
  l1l(readOnly) {
    return this.y1i_1;
  }
  q1j(index) {
    return this.y1i_1[this.z1i_1 + index | 0];
  }
  m1l(index, value) {
    this.y1i_1[this.a1j_1 + index | 0] = value;
  }
  n1l(index, b0, b1) {
    var d = this.y1i_1;
    var l = this.a1j_1;
...
class SegmentReadContextImpl$1 {
  r1k(segment, offset) {
    return segment.q1j(offset);
  }
}
class SegmentWriteContextImpl$1 {
  t1l(segment, offset, value) {
    segment.m1l(offset, value);
  }
  s1l(segment, offset, b0, b1) {
    segment.n1l(offset, b0, b1);
  }
  r1l(segment, offset, b0, b1, b2) {
    segment.o1l(offset, b0, b1, b2);
  }
  q1l(segment, offset, b0, b1, b2, b3) {
    segment.p1l(offset, b0, b1, b2, b3);
  }
}
class BufferIterationContextImpl$1 {
  r1k(segment, offset) {
    return get_SegmentReadContextImpl().r1k(segment, offset);
  }
}
  ...
  $l$block_1: {
    ...
    if (subtract(_this__u8e3s4.k2(), startIndex) < startIndex) {
      ...
      do {
        ...
        segment_0 = segment_0.d1j_1;
      }
       while (!(segment_0 == null) && offset_1 < endOffset);
      return -1n;
    } else {
      var s_0 = _this__u8e3s4.m1i_1;
      var offset_2 = 0n;
      $l$loop_0: while (!(s_0 == null)) {
        var tmp0_4 = offset_2;
        // Inline function 'kotlin.Long.plus' call
        var other_1 = s_0.a1j_1 - s_0.z1i_1 | 0;
...
function readByteString(_this__u8e3s4, byteCount) {
  return UnsafeByteStringOperations_instance.l1i(readByteArray_0(_this__u8e3s4, byteCount));
}
...
function init_kotlinx_io_Segment(_this__u8e3s4) {
  _this__u8e3s4.z1i_1 = 0;
  _this__u8e3s4.a1j_1 = 0;
  _this__u8e3s4.b1j_1 = null;
  _this__u8e3s4.c1j_1 = false;
  _this__u8e3s4.d1j_1 = null;
  _this__u8e3s4.e1j_1 = null;
}
...
function indexOf_0(_this__u8e3s4, byte, startOffset, endOffset) {
  ...
  var p = _this__u8e3s4.z1i_1;
  var data = _this__u8e3s4.l1l(true);
...
function indexOf_1(_this__u8e3s4, byte, startIndex, endIndex) {
  ...
  $l$loop: while (true) {
    ...
    if (offset < endIndex) {
      ...
      tmp_0 = _this__u8e3s4.w1i(tmp$ret$2);
    } else {
      tmp_0 = false;
    }
    if (!tmp_0) {
    ...
    var tmp_1 = _this__u8e3s4.t1i();
    var tmp_2 = offset;
    // Inline function 'kotlin.comparisons.minOf' call
    var b = _this__u8e3s4.t1i().k2();
    var tmp$ret$3 = endIndex <= b ? endIndex : b;
    var idx = indexOf(tmp_1, byte, tmp_2, tmp$ret$3);
    if (!(idx === -1n)) {
      return idx;
    }
    offset = _this__u8e3s4.t1i().k2();
  }
  return -1n;
}
function readByteArrayImpl(_this__u8e3s4, size) {
  ...
  if (size === -1) {
    ...
    while (_this__u8e3s4.t1i().k2() < 2147483647n && _this__u8e3s4.w1i(fetchSize)) {
      // Inline function 'kotlin.Long.times' call
      var this_0 = fetchSize;
      fetchSize = multiply(this_0, fromInt(2));
    }
    // Inline function 'kotlin.check' call
    if (!(_this__u8e3s4.t1i().k2() < 2147483647n)) {
      var message = "Can't create an array of size " + _this__u8e3s4.t1i().k2().toString();
      throw IllegalStateException.o(toString(message));
    }
    arraySize = convertToInt(_this__u8e3s4.t1i().k2());
  } else {
    _this__u8e3s4.v1i(fromInt(size));
  }
  var array = new Int8Array(arraySize);
  readTo(_this__u8e3s4.t1i(), array);
  return array;
}
function readTo(_this__u8e3s4, sink, startIndex, endIndex) {
  ...
  while (offset < endIndex) {
    var bytesRead = _this__u8e3s4.s1j(sink, offset, endIndex);
    if (bytesRead === -1) {
      throw EOFException.s1i('Source exhausted before reading ' + (endIndex - startIndex | 0) + ' bytes. ' + ('Only ' + bytesRead + ' bytes were read.'));
    }
    offset = offset + bytesRead | 0;
  }
}
function readString(_this__u8e3s4, byteCount) {
  _this__u8e3s4.v1i(byteCount);
  return commonReadUtf8(_this__u8e3s4.t1i(), byteCount);
}
function readString_0(_this__u8e3s4) {
  _this__u8e3s4.w1i(9223372036854775807n);
  return commonReadUtf8(_this__u8e3s4.t1i(), _this__u8e3s4.t1i().k2());
}
  ...
  while (i < endIndex) {
    ...
    if (c < 128) {
      $l$block_0: {
        ...
        ctx.t1l(tail, segmentOffset + _unary__edvuaz | 0, toByte(c));
        $l$loop: while (i < runLimit) {
          ...
          ctx.t1l(tail, segmentOffset + _unary__edvuaz_0 | 0, toByte(c));
        }
        var bytesWritten = i + segmentOffset | 0;
        if (bytesWritten === 1) {
          tail.a1j_1 = tail.a1j_1 + bytesWritten | 0;
          var tmp = this_0;
          // Inline function 'kotlin.Long.plus' call
          var this_3 = this_0.o1i_1;
          tmp.o1i_1 = add(this_3, fromInt(bytesWritten));
          break $l$block_0;
        }
        // Inline function 'kotlin.check' call
        if (!(0 <= bytesWritten ? bytesWritten <= tail.e1k() : false)) {
          var message = 'Invalid number of bytes written: ' + bytesWritten + '. Should be in 0..' + tail.e1k();
          throw IllegalStateException.o(toString(message));
        }
        if (!(bytesWritten === 0)) {
          tail.a1j_1 = tail.a1j_1 + bytesWritten | 0;
          var tmp_0 = this_0;
          // Inline function 'kotlin.Long.plus' call
          var this_4 = this_0.o1i_1;
          tmp_0.o1i_1 = add(this_4, fromInt(bytesWritten));
          break $l$block_0;
        }
        if (isEmpty(tail)) {
          this_0.t1k();
      ...
      $l$block_2: {
        // Inline function 'kotlinx.io.unsafe.UnsafeBufferOperations.writeToTail' call
        var tail_0 = this_0.z1j(2);
        get_SegmentWriteContextImpl().s1l(tail_0, 0, toByte(c >> 6 | 192), toByte(c & 63 | 128));
        var bytesWritten_0 = 2;
        if (bytesWritten_0 === 2) {
          tail_0.a1j_1 = tail_0.a1j_1 + bytesWritten_0 | 0;
          var tmp_1 = this_0;
          // Inline function 'kotlin.Long.plus' call
          var this_5 = this_0.o1i_1;
          tmp_1.o1i_1 = add(this_5, fromInt(bytesWritten_0));
          break $l$block_2;
        }
        // Inline function 'kotlin.check' call
        if (!(0 <= bytesWritten_0 ? bytesWritten_0 <= tail_0.e1k() : false)) {
          var message_0 = 'Invalid number of bytes written: ' + bytesWritten_0 + '. Should be in 0..' + tail_0.e1k();
        ...
        if (!(bytesWritten_0 === 0)) {
          ...
          var tmp_2 = this_0;
          // Inline function 'kotlin.Long.plus' call
          var this_6 = this_0.o1i_1;
          tmp_2.o1i_1 = add(this_6, fromInt(bytesWritten_0));
          break $l$block_2;
        }
        if (isEmpty(tail_0)) {
          this_0.t1k();
      ...
      $l$block_4: {
        // Inline function 'kotlinx.io.unsafe.UnsafeBufferOperations.writeToTail' call
        var tail_1 = this_0.z1j(3);
        get_SegmentWriteContextImpl().r1l(tail_1, 0, toByte(c >> 12 | 224), toByte(c >> 6 & 63 | 128), toByte(c & 63 | 128));
        var bytesWritten_1 = 3;
        if (bytesWritten_1 === 3) {
          tail_1.a1j_1 = tail_1.a1j_1 + bytesWritten_1 | 0;
          var tmp_3 = this_0;
          // Inline function 'kotlin.Long.plus' call
          var this_7 = this_0.o1i_1;
          tmp_3.o1i_1 = add(this_7, fromInt(bytesWritten_1));
          break $l$block_4;
        }
        // Inline function 'kotlin.check' call
        if (!(0 <= bytesWritten_1 ? bytesWritten_1 <= tail_1.e1k() : false)) {
          var message_1 = 'Invalid number of bytes written: ' + bytesWritten_1 + '. Should be in 0..' + tail_1.e1k();
          throw IllegalStateException.o(toString(message_1));
        }
        if (!(bytesWritten_1 === 0)) {
          tail_1.a1j_1 = tail_1.a1j_1 + bytesWritten_1 | 0;
          var tmp_4 = this_0;
          // Inline function 'kotlin.Long.plus' call
          var this_8 = this_0.o1i_1;
          tmp_4.o1i_1 = add(this_8, fromInt(bytesWritten_1));
          break $l$block_4;
        }
        if (isEmpty(tail_1)) {
          this_0.t1k();
      ...
      if (c > 56319 || !(56320 <= low ? low <= 57343 : false)) {
        ...
        this_0.n1k(toByte(tmp$ret$29));
        i = i + 1 | 0;
      } else {
        var codePoint = 65536 + ((c & 1023) << 10 | low & 1023) | 0;
        $l$block_6: {
          // Inline function 'kotlinx.io.unsafe.UnsafeBufferOperations.writeToTail' call
          var tail_2 = this_0.z1j(4);
          get_SegmentWriteContextImpl().q1l(tail_2, 0, toByte(codePoint >> 18 | 240), toByte(codePoint >> 12 & 63 | 128), toByte(codePoint >> 6 & 63 | 128), toByte(codePoint & 63 | 128));
          var bytesWritten_2 = 4;
          if (bytesWritten_2 === 4) {
            tail_2.a1j_1 = tail_2.a1j_1 + bytesWritten_2 | 0;
            var tmp_6 = this_0;
            // Inline function 'kotlin.Long.plus' call
            var this_11 = this_0.o1i_1;
            tmp_6.o1i_1 = add(this_11, fromInt(bytesWritten_2));
            break $l$block_6;
          }
          // Inline function 'kotlin.check' call
          if (!(0 <= bytesWritten_2 ? bytesWritten_2 <= tail_2.e1k() : false)) {
            var message_2 = 'Invalid number of bytes written: ' + bytesWritten_2 + '. Should be in 0..' + tail_2.e1k();
          ...
          if (!(bytesWritten_2 === 0)) {
            ...
            var tmp_7 = this_0;
            // Inline function 'kotlin.Long.plus' call
            var this_12 = this_0.o1i_1;
            tmp_7.o1i_1 = add(this_12, fromInt(bytesWritten_2));
            break $l$block_6;
          }
          if (isEmpty(tail_2)) {
            this_0.t1k();
...
function commonReadUtf8(_this__u8e3s4, byteCount) {
  if (byteCount === 0n)
    return '';
  // Inline function 'kotlinx.io.unsafe.UnsafeBufferOperations.forEachSegment' call
  var curr = _this__u8e3s4.m1i_1;
  while (!(curr == null)) {
    get_SegmentReadContextImpl();
    if (fromInt(curr.k2()) >= byteCount) {
      var result = '';
      // Inline function 'kotlinx.io.unsafe.withData' call
      var tmp0 = curr.l1l(true);
      var tmp2 = curr.z1i_1;
      var tmp0_0 = curr.a1j_1;
...
function init_kotlinx_io_IOException(_this__u8e3s4) {
  captureStack(_this__u8e3s4, _this__u8e3s4.v1l_1);
}
function init_kotlinx_io_EOFException(_this__u8e3s4) {
  captureStack(_this__u8e3s4, _this__u8e3s4.r1i_1);
}
...
protoOf(Buffer).g1k = write$default;
...
initMetadataForClass(IOException, 'IOException', IOException.w1l);
initMetadataForClass(EOFException, 'EOFException', EOFException.z1l);
