...
class Buffer {
  ...
  p1x(byteCount) {
    ...
    if (this.k2() < byteCount) {
      throw EOFException.m1x("Buffer doesn't contain required number of bytes (size: " + this.k2().toString() + ', required: ' + byteCount.toString() + ')');
    }
  }
  q1x(byteCount) {
    // Inline function 'kotlin.require' call
  ...
  j1y(position) {
    if (position < 0n || position >= this.k2()) {
      throw IndexOutOfBoundsException.je('position (' + position.toString() + ') is not within the range [0..size(' + this.k2().toString() + '))');
    }
    if (position === 0n) {
  ...
  q1y(sink, byteCount) {
    ...
    if (this.k2() < byteCount) {
      sink.p1y(this, this.k2());
      throw EOFException.m1x('Buffer exhausted before writing ' + byteCount.toString() + ' bytes. Only ' + this.k2().toString() + ' bytes were written.');
    }
  ...
  p1y(source, byteCount) {
    ...
    var remainingByteCount = byteCount;
    while (remainingByteCount > 0n) {
      if (remainingByteCount < fromInt(ensureNotNull(source.g1x_1).k2())) {
        var tail = this.h1x_1;
        var tmp;
...
class PeekSource {
  ...
  o1y(sink, byteCount) {
    ...
    // Inline function 'kotlin.comparisons.minOf' call
    var b = subtract(this.p1z_1.k2(), this.t1z_1);
...
class RealSource {
  ...
  q1y(sink, byteCount) {
    try {
      ...
      if ($p instanceof EOFException) {
        var e = $p;
        sink.p1y(this.w1z_1, this.w1z_1.k2());
        throw e;
      } else {
        throw $p;
      }
  ...
  r1y(sink) {
    ...
    if (this.w1z_1.k2() > 0n) {
      totalBytesWritten = add(totalBytesWritten, this.w1z_1.k2());
      sink.p1y(this.w1z_1, this.w1z_1.k2());
    }
...
function readByteArrayImpl(_this__u8e3s4, size) {
  ...
  if (size === -1) {
    ...
    while (_this__u8e3s4.n1x().k2() < 2147483647n && _this__u8e3s4.q1x(fetchSize)) {
      // Inline function 'kotlin.Long.times' call
      var this_0 = fetchSize;
      fetchSize = multiply(this_0, fromInt(2));
    }
    // Inline function 'kotlin.check' call
    if (!(_this__u8e3s4.n1x().k2() < 2147483647n)) {
      var message = "Can't create an array of size " + _this__u8e3s4.n1x().k2().toString();
      throw IllegalStateException.o(toString(message));
    }
    arraySize = convertToInt(_this__u8e3s4.n1x().k2());
  } else {
...
function readString_0(_this__u8e3s4) {
  ...
  return commonReadUtf8(_this__u8e3s4.n1x(), _this__u8e3s4.n1x().k2());
}
