...
import {
  ...
  readLineStrictTo1xxmy01uq4bp as readLineStrictTo,
  Companion_getInstanceu6i25dezdn6m as Companion_getInstance_0,
  LineEndingMode__plus_impl_ttpz2jpqrbpe81vmkf as LineEndingMode__plus_impl_ttpz2j,
  readUntil3qqal0dj72fys as readUntil,
  copyTo2si6ixg3c5rjz as copyTo,
  skipIfFound34xzbgurmhd09 as skipIfFound,
  ...
  readPacket1qzyfym3sry67 as readPacket,
...
class CIOMultipartDataBase {
  constructor(coroutineContext, channel, contentType, contentLength, formFieldLimit) {
    ...
    this.y2w_1 = coroutineContext;
    this.z2w_1 = null;
    this.a2x_1 = parseMultipart(this, channel, contentType, contentLength, formFieldLimit);
  }
  r1m() {
    return this.y2w_1;
  }
...
class HttpHeadersMap {
  constructor(builder) {
    ...
    this.c2x_1 = 0;
    this.d2x_1 = 0;
    this.e2x_1 = get_HeadersDataPool().n2a();
  }
  p2b(name) {
    if (this.c2x_1 === 0)
      return null;
    ...
    var hash = abs(this_0);
    var headerIndex = hash % this.d2x_1 | 0;
    while (!(this.e2x_1.j2x(imul(headerIndex, 6) + 0 | 0) === -1)) {
      if (headerHasName(this, name, imul(headerIndex, 6))) {
        return this.l2x(imul(headerIndex, 6));
      }
      headerIndex = (headerIndex + 1 | 0) % this.d2x_1 | 0;
    }
    return null;
  }
  m2x() {
    return this.e2x_1.i2x();
  }
  k2x(nameStartIndex, nameEndIndex, valueStartIndex, valueEndIndex) {
    if (thresholdReached(this)) {
      resize(this);
    }
    // Inline function 'kotlin.math.absoluteValue' call
    var this_0 = hashCodeLowerCase(this.b2x_1, nameStartIndex, nameEndIndex);
    var hash = abs(this_0);
    var name = this.b2x_1.c(nameStartIndex, nameEndIndex);
    var headerIndex = hash % this.d2x_1 | 0;
    ...
    this.e2x_1.u2x(headerOffset + 0 | 0, hash);
    this.e2x_1.u2x(headerOffset + 1 | 0, nameStartIndex);
    this.e2x_1.u2x(headerOffset + 2 | 0, nameEndIndex);
    this.e2x_1.u2x(headerOffset + 3 | 0, valueStartIndex);
    this.e2x_1.u2x(headerOffset + 4 | 0, valueEndIndex);
    this.e2x_1.u2x(headerOffset + 5 | 0, -1);
    if (!(sameNameHeaderIndex === -1)) {
      this.e2x_1.u2x(imul(sameNameHeaderIndex, 6) + 5 | 0, headerIndex);
    }
    this.c2x_1 = this.c2x_1 + 1 | 0;
  }
  v2x(headerOffset) {
    var nameStartIndex = this.e2x_1.j2x(headerOffset + 1 | 0);
    var nameEndIndex = this.e2x_1.j2x(headerOffset + 2 | 0);
    return this.b2x_1.c(nameStartIndex, nameEndIndex);
  }
  l2x(headerOffset) {
    var valueStartIndex = this.e2x_1.j2x(headerOffset + 3 | 0);
    var valueEndIndex = this.e2x_1.j2x(headerOffset + 4 | 0);
    return this.b2x_1.c(valueStartIndex, valueEndIndex);
  }
  w2x() {
    this.c2x_1 = 0;
    this.d2x_1 = 0;
    get_HeadersDataPool().o2a(this.e2x_1);
    this.e2x_1 = get_HeadersDataPool().n2a();
  }
  toString() {
...
class HeadersData$headersStarts$slambda {
  ...
  *y2x($this$sequence, $completion) {
    var joinedIndex = 0;
    var _iterator__ex2g4s = this.x2x_1.f2x_1.l1();
    while (_iterator__ex2g4s.m1()) {
      var arr = _iterator__ex2g4s.n1();
      var localIndex = 0;
      while (localIndex < arr.length) {
        if (!(this.x2x_1.j2x(joinedIndex + 0 | 0) === -1)) {
          yield* $this$sequence.el(joinedIndex, $completion);
        }
...
class HeadersData {
  constructor() {
    ...
    tmp.f2x_1 = ArrayList.n2();
  }
  g2x() {
    return this.f2x_1.k2();
  }
  h2x(subArraysCount) {
    ...
    if (inductionVariable < subArraysCount)
      do {
        ...
        this.f2x_1.z1(get_IntArrayPool().n2a());
      }
       while (inductionVariable < subArraysCount);
  }
  j2x(index) {
    return this.f2x_1.j2(index / 768 | 0)[index % 768 | 0];
  }
  u2x(index, value) {
    this.f2x_1.j2(index / 768 | 0)[index % 768 | 0] = value;
  }
  i2x() {
    return sequence(HeadersData$headersStarts$slambda_0(this));
  }
  w2x() {
    var _iterator__ex2g4s = this.f2x_1.l1();
    while (_iterator__ex2g4s.m1()) {
      var array = _iterator__ex2g4s.n1();
      get_IntArrayPool().o2a(array);
    }
    this.f2x_1.i4();
  }
}
class IntArrayPool$1 extends DefaultPool {
  ...
  c2y(instance) {
    fill(instance, -1);
    return protoOf(DefaultPool).l2a.call(this, instance);
  }
  l2a(instance) {
    return this.c2y(isIntArray(instance) ? instance : THROW_CCE());
  }
}
class HeadersDataPool$1 extends DefaultPool {
  ...
  l2a(instance) {
    return this.g2y(instance instanceof HeadersData ? instance : THROW_CCE());
  }
}
class ParserException extends IllegalStateException {
  static n2y(message) {
    var $this = this.o(message);
    captureStack($this, $this.m2y_1);
    return $this;
  }
}
...
class parseMultipart$slambda$slambda {
  constructor($firstBoundary, $countedInput) {
    this.x2y_1 = $firstBoundary;
    this.y2y_1 = $countedInput;
  }
  *z2y($this$writer, $completion) {
    yield* /*#__NOINLINE__*/parsePreambleImpl(this.x2y_1, this.y2y_1, $this$writer.u28_1, 8193n, $completion);
    yield* $this$writer.u28_1.y27($completion);
    return Unit_instance;
  }
  qd(p1, $completion) {
    return this.z2y(p1 instanceof WriterScope ? p1 : THROW_CCE(), $completion);
  }
}
class parseMultipart$slambda {
  constructor($input, $boundaryPrefixed, $maxPartSize, $totalLength) {
    this.a2z_1 = $input;
    this.b2z_1 = $boundaryPrefixed;
    this.c2z_1 = $maxPartSize;
    this.d2z_1 = $totalLength;
  }
  *e2z($this$produce, $completion) {
    var countedInput = counted(this.a2z_1);
    var readBeforeParse = countedInput.l29();
    var firstBoundary = this.b2z_1.m1i(get_PrefixString().k2());
    var preambleData = yield* readRemaining(writer($this$produce, VOID, VOID, parseMultipart$slambda$slambda_0(firstBoundary, countedInput)).s28_1, $completion);
    if (get_remaining(preambleData) > 0n) {
      yield* $this$produce.k21(new Preamble(preambleData), $completion);
    }
    $l$loop: while (!countedInput.o27() && !(yield* skipIfFound(countedInput, get_PrefixString(), $completion))) {
      ...
      yield* $this$produce.k21(part, $completion);
      var headersMap = null;
      try {
        headersMap = yield* /*#__NOINLINE__*/parsePartHeadersImpl(countedInput, $completion);
        if (!headers.d1t(headersMap)) {
          headersMap.w2x();
          throw CancellationException.n('Multipart processing has been cancelled');
        }
        yield* /*#__NOINLINE__*/parsePartBodyImpl(this.b2z_1, countedInput, body, headersMap, this.c2z_1, $completion);
        body.z6();
      } catch ($p) {
        if ($p instanceof Error) {
          var cause = $p;
          if (headers.e1t(cause)) {
            var tmp0_safe_receiver = headersMap;
            if (tmp0_safe_receiver == null)
              null;
            else {
              tmp0_safe_receiver.w2x();
            }
          }
          close(body, cause);
          throw cause;
    ...
    yield* skipIfFound(countedInput, get_CrLf(), $completion);
    if (!(this.d2z_1 == null)) {
      var consumedExceptEpilogue = subtract(countedInput.l29(), readBeforeParse);
      var size = subtract(this.d2z_1, consumedExceptEpilogue);
      if (size > 2147483647n)
        throw IOException.b1m('Failed to parse multipart: prologue is too long');
      if (size > 0n) {
        yield* $this$produce.k21(new Epilogue(yield* readPacket(countedInput, convertToInt(size), $completion)), $completion);
      }
    } else {
      var epilogueContent = yield* readRemaining(countedInput, $completion);
      if (!epilogueContent.y1i()) {
        yield* $this$produce.k21(new Epilogue(epilogueContent), $completion);
      }
    }
    return Unit_instance;
  }
  qd(p1, $completion) {
    return this.e2z((!(p1 == null) ? isInterface(p1, ProducerScope) : false) ? p1 : THROW_CCE(), $completion);
  }
}
class Node {
...
class Companion {
  o2y(from) {
    ...
    return this.j2z(from, tmp, AsciiCharTree$Companion$build$lambda_0);
  }
  j2z(from, length, charAt) {
    var tmp$ret$0;
    $l$block_0: {
    ...
    if (tmp1_elvis_lhs == null) {
      throw NoSuchElementException.d2('Unable to build char tree from an empty list');
    } else {
    ...
    if (tmp$ret$2)
      throw IllegalArgumentException.h2('There should be no empty entries');
    var root = ArrayList.n2();
...
class SubSequenceImpl {
  ...
  a() {
    return this.m2z_1 - this.l2z_1 | 0;
  }
  b(index) {
    var withOffset = index + this.l2z_1 | 0;
  ...
  c(startIndex, endIndex) {
    ...
    // Inline function 'kotlin.require' call
    if (!(endIndex <= (this.m2z_1 - this.l2z_1 | 0))) {
      var message_1 = 'end should be less than length (' + this.a() + ')';
      throw IllegalArgumentException.h2(toString(message_1));
    }
    if (startIndex === endIndex)
      return '';
    return new SubSequenceImpl(this.o2z_1, this.l2z_1 + startIndex | 0, this.l2z_1 + endIndex | 0);
  }
  toString() {
    var tmp0_elvis_lhs = this.n2z_1;
    var tmp;
    if (tmp0_elvis_lhs == null) {
      // Inline function 'kotlin.also' call
      var this_0 = toString(copy(this.o2z_1, this.l2z_1, this.m2z_1));
      this.n2z_1 = this_0;
      tmp = this_0;
    } else {
      tmp = tmp0_elvis_lhs;
  ...
  equals(other) {
    ...
    if (!(charSequenceLength(other) === this.a()))
      return false;
    return rangeEqualsImpl(this.o2z_1, this.l2z_1, other, 0, this.a());
  }
  hashCode() {
    var tmp0_safe_receiver = this.n2z_1;
    var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : getStringHashCode(tmp0_safe_receiver);
    return tmp1_elvis_lhs == null ? hashCodeImpl(this.o2z_1, this.l2z_1, this.m2z_1) : tmp1_elvis_lhs;
  }
}
class CharArrayBuilder {
  ...
  b(index) {
    ...
    // Inline function 'kotlin.require' call
    if (!(index < this.t2x_1)) {
      var message_0 = 'index ' + index + ' is not in range [0, ' + this.t2x_1 + ')';
      throw IllegalArgumentException.h2(toString(message_0));
    }
  ...
  c(startIndex, endIndex) {
    ...
    // Inline function 'kotlin.require' call
    if (!(endIndex <= this.t2x_1)) {
      var message_1 = 'endIndex (' + endIndex + ') is greater than length (' + this.t2x_1 + ')';
      throw IllegalArgumentException.h2(toString(message_1));
    }
  ...
  toString() {
    ...
    if (tmp0_elvis_lhs == null) {
      // Inline function 'kotlin.also' call
      var this_0 = toString(copy(this, 0, this.t2x_1));
      this.q2x_1 = this_0;
      tmp = this_0;
    } else {
      tmp = tmp0_elvis_lhs;
  ...
  equals(other) {
    if (!(!(other == null) ? isCharSequence(other) : false))
      return false;
    if (!(this.t2x_1 === charSequenceLength(other)))
      return false;
    return rangeEqualsImpl(this, 0, other, 0, this.t2x_1);
  }
  hashCode() {
    var tmp0_safe_receiver = this.q2x_1;
    var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : getStringHashCode(tmp0_safe_receiver);
    return tmp1_elvis_lhs == null ? hashCodeImpl(this, 0, this.t2x_1) : tmp1_elvis_lhs;
  }
  k1(value) {
    nonFullBuffer(this)[ensureNotNull(this.p2x_1).length - this.s2x_1 | 0] = value;
    this.q2x_1 = null;
    this.s2x_1 = this.s2x_1 - 1 | 0;
    this.t2x_1 = this.t2x_1 + 1 | 0;
    return this;
  }
  ug(value, startIndex, endIndex) {
    ...
    while (current < endIndex) {
      ...
      var offset = buffer.length - this.s2x_1 | 0;
      ...
      this.s2x_1 = this.s2x_1 - bytesToCopy | 0;
    }
    this.q2x_1 = null;
    this.t2x_1 = this.t2x_1 + (endIndex - startIndex | 0) | 0;
    return this;
  }
  i2(value) {
    if (value == null)
      return this;
    return this.ug(value, 0, charSequenceLength(value));
  }
  w2x() {
    var list = this.o2x_1;
    if (!(list == null)) {
      ...
      if (inductionVariable < last)
        do {
          var i = inductionVariable;
          inductionVariable = inductionVariable + 1 | 0;
          this.n2x_1.o2a(list.j2(i));
        }
         while (inductionVariable < last);
    } else {
      var tmp0_safe_receiver = this.p2x_1;
      if (tmp0_safe_receiver == null)
        null;
      else {
        // Inline function 'kotlin.let' call
        this.n2x_1.o2a(tmp0_safe_receiver);
      }
      this.p2x_1 = null;
    }
    this.r2x_1 = true;
...
class MutableRange {
  ...
  toString() {
    return 'MutableRange(start=' + this.h2y_1 + ', end=' + this.i2y_1 + ')';
  }
}
//endregion
...
function thresholdReached($this) {
  return $this.c2x_1 >= $this.d2x_1 * 0.75;
}
function resize($this) {
  var prevSize = $this.c2x_1;
  var prevData = $this.e2x_1;
  $this.c2x_1 = 0;
  $this.d2x_1 = imul($this.d2x_1, 2) | 128;
  var tmp = $this;
  // Inline function 'kotlin.apply' call
  var this_0 = get_HeadersDataPool().n2a();
  this_0.h2x(imul(prevData.g2x(), 2) | 1);
  tmp.e2x_1 = this_0;
  var _iterator__ex2g4s = prevData.i2x().l1();
  while (_iterator__ex2g4s.m1()) {
    var headerOffset = _iterator__ex2g4s.n1();
    $this.k2x(prevData.j2x(headerOffset + 1 | 0), prevData.j2x(headerOffset + 2 | 0), prevData.j2x(headerOffset + 3 | 0), prevData.j2x(headerOffset + 4 | 0));
  }
  get_HeadersDataPool().o2a(prevData);
  // Inline function 'kotlin.require' call
  // Inline function 'kotlin.require' call
  if (!(prevSize === $this.c2x_1)) {
...
function headerHasName($this, name, headerOffset) {
  var nameStartIndex = $this.e2x_1.j2x(headerOffset + 1 | 0);
  var nameEndIndex = $this.e2x_1.j2x(headerOffset + 2 | 0);
  return equalsLowerCase($this.b2x_1, nameStartIndex, nameEndIndex, name);
}
function HeadersData$headersStarts$slambda_0(this$0) {
  var i = new HeadersData$headersStarts$slambda(this$0);
  var l = ($this$sequence, $completion) => i.y2x($this$sequence, $completion);
  l.$arity = 1;
  return l;
}
function dumpTo(_this__u8e3s4, indent, out) {
  _init_properties_HttpHeadersMap_kt__hwatby();
  var _iterator__ex2g4s = _this__u8e3s4.m2x().l1();
  while (_iterator__ex2g4s.m1()) {
    var offset = _iterator__ex2g4s.n1();
    out.i2(indent);
    out.i2(_this__u8e3s4.v2x(offset));
    out.i2(' => ');
    out.i2(_this__u8e3s4.l2x(offset));
    out.i2('\n');
  }
}
...
function *parseHeaders(input, builder, range, $completion) {
  ...
  try {
    $l$loop: while (true) {
      ...
      range.i2y_1 = builder.t2x_1;
      var rangeLength = range.i2y_1 - range.h2y_1 | 0;
      if (rangeLength === 0)
        break $l$loop;
      if (rangeLength >= 8192) {
      ...
      var nameStart = range.h2y_1;
      var nameEnd = parseHeaderName(builder, range);
      var headerEnd = range.i2y_1;
      parseHeaderValue(builder, range);
      var valueStart = range.h2y_1;
      var valueEnd = range.i2y_1;
      range.h2y_1 = headerEnd;
      headers.k2x(nameStart, nameEnd, valueStart, valueEnd);
    }
    var host = headers.p2b('Host');
    if (!(host == null)) {
...
function parseHeaderName(text, range) {
  _init_properties_HttpParser_kt__gbdom1();
  var index = range.h2y_1;
  var end = range.i2y_1;
  while (index < end) {
    var ch = text.b(index);
    if (ch === _Char___init__impl__6a9atx(58) && !(index === range.h2y_1)) {
      range.h2y_1 = index + 1 | 0;
      return index;
    }
    if (isDelimiter(ch)) {
      parseHeaderNameFailed(text, index, range.h2y_1, ch);
    }
    index = index + 1 | 0;
  }
...
function parseHeaderValue(text, range) {
  ...
  range.h2y_1 = valueStart;
  range.i2y_1 = valueLastIndex + 1 | 0;
}
function validateHostHeader(host) {
  _init_properties_HttpParser_kt__gbdom1();
  if (endsWith(host, ':')) {
    throw ParserException.n2y("Host header with ':' should contains port: " + toString(host));
  }
  var tmp$ret$0;
  $l$block: {
    ...
    while (inductionVariable < charSequenceLength(host)) {
      ...
      inductionVariable = inductionVariable + 1 | 0;
      if (get_hostForbiddenSymbols().t3(new Char(element))) {
        tmp$ret$0 = true;
        break $l$block;
      }
    }
  ...
  if (tmp$ret$0) {
    throw ParserException.n2y('Host cannot contain any of the following symbols: ' + toString(get_hostForbiddenSymbols()));
  }
}
...
function parseHeaderNameFailed(text, index, start, ch) {
  ...
  if (ch === _Char___init__impl__6a9atx(58)) {
    throw ParserException.n2y('Empty header names are not allowed as per RFC7230.');
  }
  if (index === start) {
    throw ParserException.n2y('Multiline headers via line folding is not supported since it is deprecated as per RFC7230.');
  }
  characterIsNotAllowed(text, ch);
}
function noColonFound(text, range) {
  _init_properties_HttpParser_kt__gbdom1();
  var tmp2 = range.h2y_1;
  // Inline function 'kotlin.text.substring' call
  var endIndex = range.i2y_1;
  var tmp$ret$0 = toString(charSequenceSubSequence(text, tmp2, endIndex));
  throw ParserException.n2y('No colon in HTTP header in ' + tmp$ret$0 + ' in builder: \n' + toString(text));
}
function characterIsNotAllowed(text, ch) {
  _init_properties_HttpParser_kt__gbdom1();
  // Inline function 'kotlin.code' call
  var tmp$ret$0 = Char__toInt_impl_vasixd(ch);
  throw ParserException.n2y('Character with code ' + (tmp$ret$0 & 255) + ' is not allowed in header names, \n' + toString(text));
}
...
function _init_properties_HttpParser_kt__gbdom1() {
  if (!properties_initialized_HttpParser_kt_uedryv) {
    ...
    httpLineEndings = LineEndingMode__plus_impl_ttpz2j(Companion_getInstance_0().o29_1, Companion_getInstance_0().n29_1);
    versions = Companion_instance.o2y(listOf(['HTTP/1.0', 'HTTP/1.1']));
  }
}
function get_CrLf() {
...
function parseMultipart(_this__u8e3s4, input, contentType, contentLength, maxPartSize) {
  ...
  _init_properties_Multipart_kt__ato98a();
  if (!MultiPart_getInstance().a2k(contentType)) {
    throw UnsupportedMediaTypeExceptionCIO.w2y('Failed to parse multipart: Content-Type should be multipart/* but it is ' + toString(contentType));
  }
  var boundaryByteBuffer = parseBoundaryInternal(contentType);
  var boundaryBytes = ByteString.k1i(boundaryByteBuffer);
...
function parseBoundaryInternal(contentType) {
  ...
  if (boundaryParameter === -1) {
    throw IOException.b1m("Failed to parse multipart: Content-Type's boundary parameter is missing");
  }
  ...
  if (inductionVariable < last)
    loop: do {
      ...
      if ((v & 65535) > 127) {
        throw IOException.b1m('Failed to parse multipart: wrong boundary byte 0x' + toString_0(v, 16) + ' - should be 7bit character');
      }
      switch (state) {
        case 0:
     ...
     while (inductionVariable < last);
  if (position._v === 4) {
    throw IOException.b1m('Empty multipart boundary is not allowed');
  }
...
function *parsePartHeadersImpl(input, $completion) {
  ...
  try {
    ...
    var tmp;
    if (tmp0_elvis_lhs == null) {
      throw EOFException.w1i('Failed to parse multipart headers: unexpected end of stream');
    } else {
      tmp = tmp0_elvis_lhs;
    }
    return tmp;
...
function *parsePartBodyImpl(boundaryPrefixed, input, output, headers, limit, $completion) {
  var tmp0_safe_receiver = headers.p2b('Content-Length');
...
function throwLimitExceeded(actual, limit) {
  _init_properties_Multipart_kt__ato98a();
  throw IOException.b1m('Multipart content length exceeds limit ' + actual.toString() + ' > ' + limit.toString() + '; ' + "limit is defined using 'formFieldLimit' argument");
}
function parseBoundaryInternal$put(position, boundaryBytes, value) {
  if (position._v >= boundaryBytes.length) {
    throw IOException.b1m("Failed to parse multipart: boundary shouldn't be longer than 70 characters");
  }
...
function parseMultipart$slambda$slambda_0($firstBoundary, $countedInput) {
  ...
  var l = ($this$writer, $completion) => i.z2y($this$writer, $completion);
  l.$arity = 1;
  return l;
}
function parseMultipart$slambda_0($input, $boundaryPrefixed, $maxPartSize, $totalLength) {
  ...
  var l = ($this$produce, $completion) => i.e2z($this$produce, $completion);
  l.$arity = 1;
  return l;
}
...
function _init_properties_Multipart_kt__ato98a() {
  if (!properties_initialized_Multipart_kt_wu0sh0) {
    ...
    CrLf = ByteString.k1i(toByteArray_0('\r\n'));
...
function build($this, resultList, from, maxLength, idx, length, charAt) {
  ...
  while (_iterator__ex2g4s.m1()) {
    ...
    var value = destination.c4(key);
    var tmp;
    if (value == null) {
      var answer = ArrayList.n2();
      destination.f4(key, answer);
      tmp = answer;
    } else {
      tmp = value;
    }
  ...
  while (_iterator__ex2g4s_0.m1()) {
    ...
    var ch = element_0.v2().g3_1;
    // Inline function 'kotlin.collections.component2' call
    var list_0 = element_0.w2();
    var nextIdx = idx + 1 | 0;
    ...
    resultList.z1(new Node(ch, destination_1, children));
  }
}
...
function getImpl($this, index) {
  return bufferForIndex($this, index)[index % ensureNotNull($this.p2x_1).length | 0];
}
function copy($this, startIndex, endIndex) {
  if (startIndex === endIndex)
    return '';
  var builder = StringBuilder.dc(endIndex - startIndex | 0);
  var buffer;
...
function bufferForIndex($this, index) {
  ...
  return list.j2(index / ensureNotNull($this.p2x_1).length | 0);
}
function throwSingleBuffer($this, index) {
  if ($this.r2x_1)
    throw IllegalStateException.o('Buffer is already released');
  throw IndexOutOfBoundsException.ke('' + index + ' is not in range [0; ' + currentPosition($this) + ')');
}
function nonFullBuffer($this) {
  return $this.s2x_1 === 0 ? appendNewArray($this) : ensureNotNull($this.p2x_1);
}
function appendNewArray($this) {
  var newBuffer = $this.n2x_1.n2a();
  var existing = $this.p2x_1;
  $this.p2x_1 = newBuffer;
  $this.s2x_1 = newBuffer.length;
  $this.r2x_1 = false;
  if (!(existing == null)) {
...
function currentPosition($this) {
  return ensureNotNull($this.p2x_1).length - $this.s2x_1 | 0;
}
...
function numberFormatException(cs) {
  _init_properties_Chars_kt__d3i39x();
  throw NumberFormatException.ze('Invalid number ' + toString(cs) + ': too large for Long type');
}
...
function numberFormatException_0(cs, idx) {
  _init_properties_Chars_kt__d3i39x();
  throw NumberFormatException.ze('Invalid number: ' + toString(cs) + ', wrong digit: ' + toString_1(charSequenceGet(cs, idx)) + ' at position ' + idx);
}
function DefaultHttpMethods$lambda(it) {
  _init_properties_Chars_kt__d3i39x();
  return it.d2q_1.length;
}
function DefaultHttpMethods$lambda_0(m, idx) {
  _init_properties_Chars_kt__d3i39x();
  return new Char(charCodeAt(m.d2q_1, idx));
}
...
function _init_properties_Chars_kt__d3i39x() {
  if (!properties_initialized_Chars_kt_phjfhp) {
    ...
    var tmp_0 = Companion_getInstance().c2q_1;
    var tmp_1 = DefaultHttpMethods$lambda;
    DefaultHttpMethods = tmp.j2z(tmp_0, tmp_1, DefaultHttpMethods$lambda_0);
    ...
    // Inline function 'kotlin.collections.mapTo' call
    var destination_0 = ArrayList.y1(collectionSizeOrDefault(this_9, 10));
    var inductionVariable_0 = this_9.z2_1;
    var last_0 = this_9.a3_1;
