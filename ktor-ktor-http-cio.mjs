...
import {
  ...
  readUTF8LineTo3gov7wweuj55m as readUTF8LineTo,
  Companion_getInstance1jnwy1jx65t7w as Companion_getInstance_0,
  LineEndingMode__plus_impl_ttpz2j2y4ckcarwdvhq as LineEndingMode__plus_impl_ttpz2j,
  readUntil3k1nh8lpn23ao as readUntil,
  copyTo3z8um8xkg7g1 as copyTo,
  skipIfFound1m8ofwnay4fp9 as skipIfFound,
  ...
  readPacket1r77mz431qe8y as readPacket,
...
class CIOMultipartDataBase {
  constructor(coroutineContext, channel, contentType, contentLength, formFieldLimit) {
    ...
    this.p2w_1 = coroutineContext;
    this.q2w_1 = null;
    this.r2w_1 = parseMultipart(this, channel, contentType, contentLength, formFieldLimit);
  }
  u1m() {
    return this.p2w_1;
  }
...
class HttpHeadersMap {
  constructor(builder) {
    ...
    this.t2w_1 = 0;
    this.u2w_1 = 0;
    this.v2w_1 = get_HeadersDataPool().g2a();
  }
  i2b(name) {
    if (this.t2w_1 === 0)
      return null;
    ...
    var hash = abs(this_0);
    var headerIndex = hash % this.u2w_1 | 0;
    while (!(this.v2w_1.a2x(imul(headerIndex, 6) + 0 | 0) === -1)) {
      if (headerHasName(this, name, imul(headerIndex, 6))) {
        return this.c2x(imul(headerIndex, 6));
      }
      headerIndex = (headerIndex + 1 | 0) % this.u2w_1 | 0;
    }
    return null;
  }
  d2x() {
    return this.v2w_1.z2w();
  }
  b2x(nameStartIndex, nameEndIndex, valueStartIndex, valueEndIndex) {
    if (thresholdReached(this)) {
      resize(this);
    }
    // Inline function 'kotlin.math.absoluteValue' call
    var this_0 = hashCodeLowerCase(this.s2w_1, nameStartIndex, nameEndIndex);
    var hash = abs(this_0);
    var name = this.s2w_1.c(nameStartIndex, nameEndIndex);
    var headerIndex = hash % this.u2w_1 | 0;
    ...
    this.v2w_1.l2x(headerOffset + 0 | 0, hash);
    this.v2w_1.l2x(headerOffset + 1 | 0, nameStartIndex);
    this.v2w_1.l2x(headerOffset + 2 | 0, nameEndIndex);
    this.v2w_1.l2x(headerOffset + 3 | 0, valueStartIndex);
    this.v2w_1.l2x(headerOffset + 4 | 0, valueEndIndex);
    this.v2w_1.l2x(headerOffset + 5 | 0, -1);
    if (!(sameNameHeaderIndex === -1)) {
      this.v2w_1.l2x(imul(sameNameHeaderIndex, 6) + 5 | 0, headerIndex);
    }
    this.t2w_1 = this.t2w_1 + 1 | 0;
  }
  m2x(headerOffset) {
    var nameStartIndex = this.v2w_1.a2x(headerOffset + 1 | 0);
    var nameEndIndex = this.v2w_1.a2x(headerOffset + 2 | 0);
    return this.s2w_1.c(nameStartIndex, nameEndIndex);
  }
  c2x(headerOffset) {
    var valueStartIndex = this.v2w_1.a2x(headerOffset + 3 | 0);
    var valueEndIndex = this.v2w_1.a2x(headerOffset + 4 | 0);
    return this.s2w_1.c(valueStartIndex, valueEndIndex);
  }
  n2x() {
    this.t2w_1 = 0;
    this.u2w_1 = 0;
    get_HeadersDataPool().h2a(this.v2w_1);
    this.v2w_1 = get_HeadersDataPool().g2a();
  }
  toString() {
...
class HeadersData {
  constructor() {
    ...
    tmp.w2w_1 = ArrayList.s2();
  }
  x2w() {
    return this.w2w_1.q2();
  }
  y2w(subArraysCount) {
    ...
    if (inductionVariable < subArraysCount)
      do {
        ...
        this.w2w_1.c2(get_IntArrayPool().g2a());
      }
       while (inductionVariable < subArraysCount);
  }
  a2x(index) {
    return this.w2w_1.p2(index / 768 | 0)[index % 768 | 0];
  }
  l2x(index, value) {
    this.w2w_1.p2(index / 768 | 0)[index % 768 | 0] = value;
  }
  z2w() {
    return sequence(HeadersData$headersStarts$slambda_0(this));
  }
  n2x() {
    var _iterator__ex2g4s = this.w2w_1.q1();
    while (_iterator__ex2g4s.r1()) {
      var array = _iterator__ex2g4s.s1();
      get_IntArrayPool().h2a(array);
    }
    this.w2w_1.n4();
  }
}
class IntArrayPool$1 extends DefaultPool {
  ...
  t2x(instance) {
    fill(instance, -1);
    return protoOf(DefaultPool).e2a.call(this, instance);
  }
  e2a(instance) {
    return this.t2x(isIntArray(instance) ? instance : THROW_CCE());
  }
}
class HeadersDataPool$1 extends DefaultPool {
  ...
  e2a(instance) {
    return this.x2x(instance instanceof HeadersData ? instance : THROW_CCE());
  }
}
class ParserException extends IllegalStateException {
  static e2y(message) {
    var $this = this.o(message);
    captureStack($this, $this.d2y_1);
    return $this;
  }
}
...
class parseMultipart$slambda$slambda {
  constructor($firstBoundary, $countedInput) {
    this.o2y_1 = $firstBoundary;
    this.p2y_1 = $countedInput;
  }
...
class parseMultipart$slambda {
  constructor($input, $boundaryPrefixed, $maxPartSize, $totalLength) {
    this.q2y_1 = $input;
    this.r2y_1 = $boundaryPrefixed;
    this.s2y_1 = $maxPartSize;
    this.t2y_1 = $totalLength;
  }
  v2y($this$produce, $completion) {
    return suspendOrReturn(/*#__NOINLINE__*/_generator_invoke__zhh2q8_1.bind(VOID, this, $this$produce), $completion);
  }
  yd(p1, $completion) {
    return this.v2y((!(p1 == null) ? isInterface(p1, ProducerScope) : false) ? p1 : THROW_CCE(), $completion);
  }
}
class Node {
...
class Companion {
  f2y(from) {
    ...
    return this.a2z(from, tmp, AsciiCharTree$Companion$build$lambda_0);
  }
  a2z(from, length, charAt) {
    var tmp$ret$0;
    $l$block_0: {
      // Inline function 'kotlin.collections.maxByOrNull' call
      var iterator = from.q1();
      if (!iterator.r1()) {
        tmp$ret$0 = null;
        break $l$block_0;
      }
    ...
    if (tmp1_elvis_lhs == null) {
      throw NoSuchElementException.g2('Unable to build char tree from an empty list');
    } else {
    ...
    if (tmp$ret$2)
      throw IllegalArgumentException.k2('There should be no empty entries');
    var root = ArrayList.s2();
...
class SubSequenceImpl {
  ...
  a() {
    return this.d2z_1 - this.c2z_1 | 0;
  }
  b(index) {
    var withOffset = index + this.c2z_1 | 0;
  ...
  c(startIndex, endIndex) {
    ...
    // Inline function 'kotlin.require' call
    if (!(endIndex <= (this.d2z_1 - this.c2z_1 | 0))) {
      var message_1 = 'end should be less than length (' + this.a() + ')';
      throw IllegalArgumentException.k2(toString(message_1));
    }
    if (startIndex === endIndex)
      return '';
    return new SubSequenceImpl(this.f2z_1, this.c2z_1 + startIndex | 0, this.c2z_1 + endIndex | 0);
  }
  toString() {
    var tmp0_elvis_lhs = this.e2z_1;
    var tmp;
    if (tmp0_elvis_lhs == null) {
      // Inline function 'kotlin.also' call
      var this_0 = toString(copy(this.f2z_1, this.c2z_1, this.d2z_1));
      this.e2z_1 = this_0;
      tmp = this_0;
    } else {
      tmp = tmp0_elvis_lhs;
  ...
  equals(other) {
    ...
    if (!(charSequenceLength(other) === this.a()))
      return false;
    return rangeEqualsImpl(this.f2z_1, this.c2z_1, other, 0, this.a());
  }
  hashCode() {
    var tmp0_safe_receiver = this.e2z_1;
    var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : getStringHashCode(tmp0_safe_receiver);
    return tmp1_elvis_lhs == null ? hashCodeImpl(this.f2z_1, this.c2z_1, this.d2z_1) : tmp1_elvis_lhs;
  }
}
class CharArrayBuilder {
  ...
  b(index) {
    ...
    // Inline function 'kotlin.require' call
    if (!(index < this.k2x_1)) {
      var message_0 = 'index ' + index + ' is not in range [0, ' + this.k2x_1 + ')';
      throw IllegalArgumentException.k2(toString(message_0));
    }
  ...
  c(startIndex, endIndex) {
    ...
    // Inline function 'kotlin.require' call
    if (!(endIndex <= this.k2x_1)) {
      var message_1 = 'endIndex (' + endIndex + ') is greater than length (' + this.k2x_1 + ')';
      throw IllegalArgumentException.k2(toString(message_1));
    }
    return new SubSequenceImpl(this, startIndex, endIndex);
  }
  toString() {
    var tmp0_elvis_lhs = this.h2x_1;
    var tmp;
    if (tmp0_elvis_lhs == null) {
      // Inline function 'kotlin.also' call
      var this_0 = toString(copy(this, 0, this.k2x_1));
      this.h2x_1 = this_0;
      tmp = this_0;
    } else {
      tmp = tmp0_elvis_lhs;
  ...
  equals(other) {
    if (!(!(other == null) ? isCharSequence(other) : false))
      return false;
    if (!(this.k2x_1 === charSequenceLength(other)))
      return false;
    return rangeEqualsImpl(this, 0, other, 0, this.k2x_1);
  }
  hashCode() {
    var tmp0_safe_receiver = this.h2x_1;
    var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : getStringHashCode(tmp0_safe_receiver);
    return tmp1_elvis_lhs == null ? hashCodeImpl(this, 0, this.k2x_1) : tmp1_elvis_lhs;
  }
  p1(value) {
    nonFullBuffer(this)[ensureNotNull(this.g2x_1).length - this.j2x_1 | 0] = value;
    this.h2x_1 = null;
    this.j2x_1 = this.j2x_1 - 1 | 0;
    this.k2x_1 = this.k2x_1 + 1 | 0;
    return this;
  }
  bh(value, startIndex, endIndex) {
    ...
    while (current < endIndex) {
      ...
      var offset = buffer.length - this.j2x_1 | 0;
      ...
      this.j2x_1 = this.j2x_1 - bytesToCopy | 0;
    }
    this.h2x_1 = null;
    this.k2x_1 = this.k2x_1 + (endIndex - startIndex | 0) | 0;
    return this;
  }
  o2(value) {
    if (value == null)
      return this;
    return this.bh(value, 0, charSequenceLength(value));
  }
  n2x() {
    var list = this.f2x_1;
    if (!(list == null)) {
      ...
      if (tmp0_safe_receiver == null)
        ...
        // Inline function 'kotlin.let' call
        this.e2x_1.h2a(tmp0_safe_receiver);
      }
      this.g2x_1 = null;
    }
    this.i2x_1 = true;
...
class MutableRange {
  ...
  toString() {
    return 'MutableRange(start=' + this.y2x_1 + ', end=' + this.z2x_1 + ')';
  }
}
//endregion
...
function thresholdReached($this) {
  return $this.t2w_1 >= $this.u2w_1 * 0.75;
}
function resize($this) {
  var prevSize = $this.t2w_1;
  var prevData = $this.v2w_1;
  $this.t2w_1 = 0;
  $this.u2w_1 = imul($this.u2w_1, 2) | 128;
  var tmp = $this;
  // Inline function 'kotlin.apply' call
  var this_0 = get_HeadersDataPool().g2a();
  this_0.y2w(imul(prevData.x2w(), 2) | 1);
  tmp.v2w_1 = this_0;
  var _iterator__ex2g4s = prevData.z2w().q1();
  while (_iterator__ex2g4s.r1()) {
    var headerOffset = _iterator__ex2g4s.s1();
    $this.b2x(prevData.a2x(headerOffset + 1 | 0), prevData.a2x(headerOffset + 2 | 0), prevData.a2x(headerOffset + 3 | 0), prevData.a2x(headerOffset + 4 | 0));
  }
  get_HeadersDataPool().h2a(prevData);
  // Inline function 'kotlin.require' call
  // Inline function 'kotlin.require' call
  if (!(prevSize === $this.t2w_1)) {
...
function headerHasName($this, name, headerOffset) {
  var nameStartIndex = $this.v2w_1.a2x(headerOffset + 1 | 0);
  var nameEndIndex = $this.v2w_1.a2x(headerOffset + 2 | 0);
  return equalsLowerCase($this.s2w_1, nameStartIndex, nameEndIndex, name);
}
function *_generator_invoke__zhh2q8($this, $this$sequence, $completion) {
  var joinedIndex = 0;
  var _iterator__ex2g4s = $this.o2x_1.w2w_1.q1();
  while (_iterator__ex2g4s.r1()) {
    var arr = _iterator__ex2g4s.s1();
    var localIndex = 0;
    while (localIndex < arr.length) {
      if (!($this.o2x_1.a2x(joinedIndex + 0 | 0) === -1)) {
        var tmp = $this$sequence.pl(joinedIndex, $completion);
...
function HeadersData$headersStarts$slambda_0(this$0) {
  ...
  var l = ($this$sequence, $completion) => i.p2x($this$sequence, $completion);
  l.$arity = 1;
  return l;
}
function dumpTo(_this__u8e3s4, indent, out) {
  _init_properties_HttpHeadersMap_kt__hwatby();
  var _iterator__ex2g4s = _this__u8e3s4.d2x().q1();
  while (_iterator__ex2g4s.r1()) {
    var offset = _iterator__ex2g4s.s1();
    out.o2(indent);
    out.o2(_this__u8e3s4.m2x(offset));
    out.o2(' => ');
    out.o2(_this__u8e3s4.c2x(offset));
    out.o2('\n');
  }
}
...
function *_generator_parseHeaders__yk88b9(input, builder, range, $completion) {
  ...
  try {
    $l$loop: while (true) {
      ...
      range.z2x_1 = builder.k2x_1;
      var rangeLength = range.z2x_1 - range.y2x_1 | 0;
      if (rangeLength === 0)
        break $l$loop;
      if (rangeLength >= 8192) {
      ...
      var nameStart = range.y2x_1;
      var nameEnd = parseHeaderName(builder, range);
      var headerEnd = range.z2x_1;
      parseHeaderValue(builder, range);
      var valueStart = range.y2x_1;
      var valueEnd = range.z2x_1;
      range.y2x_1 = headerEnd;
      headers.b2x(nameStart, nameEnd, valueStart, valueEnd);
    }
    var host = headers.i2b(HttpHeaders_getInstance().v2l_1);
    if (!(host == null)) {
...
function parseHeaderName(text, range) {
  _init_properties_HttpParser_kt__gbdom1();
  var index = range.y2x_1;
  var end = range.z2x_1;
  while (index < end) {
    var ch = text.b(index);
    if (ch === _Char___init__impl__6a9atx(58) && !(index === range.y2x_1)) {
      range.y2x_1 = index + 1 | 0;
      return index;
    }
    if (isDelimiter(ch)) {
      parseHeaderNameFailed(text, index, range.y2x_1, ch);
    }
    index = index + 1 | 0;
  }
...
function parseHeaderValue(text, range) {
  ...
  range.y2x_1 = valueStart;
  range.z2x_1 = valueLastIndex + 1 | 0;
}
function validateHostHeader(host) {
  _init_properties_HttpParser_kt__gbdom1();
  if (endsWith(host, ':')) {
    throw ParserException.e2y("Host header with ':' should contains port: " + toString(host));
  }
  var tmp$ret$1;
  $l$block: {
    ...
    while (inductionVariable < charSequenceLength(host)) {
      ...
      inductionVariable = inductionVariable + 1 | 0;
      if (get_hostForbiddenSymbols().y3(new Char(element))) {
        tmp$ret$1 = true;
        break $l$block;
      }
    }
  ...
  if (tmp$ret$1) {
    throw ParserException.e2y('Host cannot contain any of the following symbols: ' + toString(get_hostForbiddenSymbols()));
  }
}
...
function parseHeaderNameFailed(text, index, start, ch) {
  ...
  if (ch === _Char___init__impl__6a9atx(58)) {
    throw ParserException.e2y('Empty header names are not allowed as per RFC7230.');
  }
  if (index === start) {
    throw ParserException.e2y('Multiline headers via line folding is not supported since it is deprecated as per RFC7230.');
  }
  characterIsNotAllowed(text, ch);
}
function noColonFound(text, range) {
  _init_properties_HttpParser_kt__gbdom1();
  var tmp2 = range.y2x_1;
  // Inline function 'kotlin.text.substring' call
  var endIndex = range.z2x_1;
  var tmp$ret$0 = toString(charSequenceSubSequence(text, tmp2, endIndex));
  throw ParserException.e2y('No colon in HTTP header in ' + tmp$ret$0 + ' in builder: \n' + toString(text));
}
function characterIsNotAllowed(text, ch) {
  _init_properties_HttpParser_kt__gbdom1();
  // Inline function 'kotlin.code' call
  var tmp$ret$0 = Char__toInt_impl_vasixd(ch);
  throw ParserException.e2y('Character with code ' + (tmp$ret$0 & 255) + ' is not allowed in header names, \n' + toString(text));
}
...
function _init_properties_HttpParser_kt__gbdom1() {
  if (!properties_initialized_HttpParser_kt_uedryv) {
    ...
    httpLineEndings = LineEndingMode__plus_impl_ttpz2j(Companion_getInstance_0().j28_1, Companion_getInstance_0().i28_1);
    versions = Companion_instance.f2y(listOf(['HTTP/1.0', 'HTTP/1.1']));
  }
}
function get_CrLf() {
...
function parseMultipart(_this__u8e3s4, input, contentType, contentLength, maxPartSize) {
  ...
  _init_properties_Multipart_kt__ato98a();
  if (!MultiPart_getInstance().t2j(contentType)) {
    throw UnsupportedMediaTypeExceptionCIO.n2y('Failed to parse multipart: Content-Type should be multipart/* but it is ' + toString(contentType));
  }
  var boundaryByteBuffer = parseBoundaryInternal(contentType);
  var boundaryBytes = ByteString.n1i(boundaryByteBuffer);
...
function parseBoundaryInternal(contentType) {
  ...
  if (boundaryParameter === -1) {
    throw IOException.e1m("Failed to parse multipart: Content-Type's boundary parameter is missing");
  }
  ...
  if (inductionVariable < last)
    loop: do {
      ...
      if ((v & 65535) > 127) {
        throw IOException.e1m('Failed to parse multipart: wrong boundary byte 0x' + toString_0(v, 16) + ' - should be 7bit character');
      }
      switch (state) {
        case 0:
     ...
     while (inductionVariable < last);
  if (position._v === 4) {
    throw IOException.e1m('Empty multipart boundary is not allowed');
  }
...
function *_generator_parsePartHeadersImpl__ngvtk8(input, $completion) {
  ...
  try {
    ...
    var tmp_0;
    if (tmp0_elvis_lhs == null) {
      throw EOFException.z1i('Failed to parse multipart headers: unexpected end of stream');
    } else {
...
function *_generator_parsePartBodyImpl__8tyvmc(boundaryPrefixed, input, output, headers, limit, $completion) {
  var tmp0_safe_receiver = headers.i2b('Content-Length');
  ...
  var byteCount = tmp;
  var tmp_3 = output.w26($completion);
...
function throwLimitExceeded(actual, limit) {
  _init_properties_Multipart_kt__ato98a();
  throw IOException.e1m('Multipart content length exceeds limit ' + actual.toString() + ' > ' + limit.toString() + '; ' + "limit is defined using 'formFieldLimit' argument");
}
function parseBoundaryInternal$put(position, boundaryBytes, value) {
  if (position._v >= boundaryBytes.length) {
    throw IOException.e1m("Failed to parse multipart: boundary shouldn't be longer than 70 characters");
  }
...
function *_generator_invoke__zhh2q8_0($this, $this$writer, $completion) {
  var tmp = parsePreambleImpl($this.o2y_1, $this.p2y_1, $this$writer.t28_1, 8193n, $completion);
  if (tmp === get_COROUTINE_SUSPENDED())
    tmp = yield tmp;
  var tmp_0 = $this$writer.t28_1.s27($completion);
  if (tmp_0 === get_COROUTINE_SUSPENDED())
    tmp_0 = yield tmp_0;
  return Unit_instance;
}
function *_generator_invoke__zhh2q8_1($this, $this$produce, $completion) {
  var countedInput = counted($this.q2y_1);
  var readBeforeParse = countedInput.j29();
  var firstBoundary = $this.r2y_1.p1i(get_PrefixString().q2());
  var tmp = readRemaining(writer($this$produce, VOID, VOID, parseMultipart$slambda$slambda_0(firstBoundary, countedInput)).r28_1, $completion);
  if (tmp === get_COROUTINE_SUSPENDED())
    tmp = yield tmp;
  var preambleData = tmp;
  if (get_remaining(preambleData) > 0n) {
    var tmp_0 = $this$produce.i21(new Preamble(preambleData), $completion);
    if (tmp_0 === get_COROUTINE_SUSPENDED())
      tmp_0 = yield tmp_0;
  }
  $l$loop_0: while (true) {
    ...
    var tmp_5 = $this$produce.i21(part, $completion);
    ...
    try {
      ...
      if (tmp_6 === get_COROUTINE_SUSPENDED())
        tmp_6 = yield tmp_6;
      headersMap = tmp_6;
      if (!headers.w1s(headersMap)) {
        headersMap.n2x();
        throw CancellationException.n('Multipart processing has been cancelled');
      }
      var tmp_7 = parsePartBodyImpl($this.r2y_1, countedInput, body, headersMap, $this.s2y_1, $completion);
      ...
      if ($p instanceof Error) {
        var cause = $p;
        if (headers.x1s(cause)) {
          var tmp0_safe_receiver = headersMap;
          if (tmp0_safe_receiver == null)
            null;
          else {
            tmp0_safe_receiver.n2x();
          }
        }
        close(body, cause);
        throw cause;
  ...
  if (tmp_9 === get_COROUTINE_SUSPENDED())
    tmp_9 = yield tmp_9;
  if (!($this.t2y_1 == null)) {
    var consumedExceptEpilogue = subtract(countedInput.j29(), readBeforeParse);
    var size = subtract($this.t2y_1, consumedExceptEpilogue);
    if (size > 2147483647n)
      throw IOException.e1m('Failed to parse multipart: prologue is too long');
    if (size > 0n) {
      var tmp_10 = readPacket(countedInput, convertToInt(size), $completion);
      if (tmp_10 === get_COROUTINE_SUSPENDED())
        tmp_10 = yield tmp_10;
      var tmp_11 = $this$produce.i21(new Epilogue(tmp_10), $completion);
    ...
    if (!epilogueContent.b1j()) {
      var tmp_13 = $this$produce.i21(new Epilogue(epilogueContent), $completion);
...
function parseMultipart$slambda_0($input, $boundaryPrefixed, $maxPartSize, $totalLength) {
  ...
  var l = ($this$produce, $completion) => i.v2y($this$produce, $completion);
  l.$arity = 1;
  return l;
}
...
function _init_properties_Multipart_kt__ato98a() {
  if (!properties_initialized_Multipart_kt_wu0sh0) {
    ...
    CrLf = ByteString.n1i(toByteArray_0('\r\n'));
...
function build($this, resultList, from, maxLength, idx, length, charAt) {
  ...
  var destination = LinkedHashMap.q5();
  var _iterator__ex2g4s = from.q1();
  while (_iterator__ex2g4s.r1()) {
    var element = _iterator__ex2g4s.s1();
    var key = charAt(element, idx);
    // Inline function 'kotlin.collections.getOrPut' call
    var value = destination.h4(key);
    var tmp;
    if (value == null) {
      var answer = ArrayList.s2();
      destination.k4(key, answer);
      tmp = answer;
    } else {
      tmp = value;
    }
  ...
  while (_iterator__ex2g4s_0.r1()) {
    ...
    var _iterator__ex2g4s_2 = list_0.q1();
    while (_iterator__ex2g4s_2.r1()) {
      var element_2 = _iterator__ex2g4s_2.s1();
      if (length(element_2) === nextIdx) {
        destination_1.c2(element_2);
      }
    }
    resultList.c2(new Node(ch, destination_1, children));
  }
}
...
function getImpl($this, index) {
  return bufferForIndex($this, index)[index % ensureNotNull($this.g2x_1).length | 0];
}
function copy($this, startIndex, endIndex) {
  if (startIndex === endIndex)
    return '';
  var builder = StringBuilder.ic(endIndex - startIndex | 0);
  var buffer;
...
function bufferForIndex($this, index) {
  ...
  return list.p2(index / ensureNotNull($this.g2x_1).length | 0);
}
function throwSingleBuffer($this, index) {
  if ($this.i2x_1)
    throw IllegalStateException.o('Buffer is already released');
  throw IndexOutOfBoundsException.te('' + index + ' is not in range [0; ' + currentPosition($this) + ')');
}
function nonFullBuffer($this) {
  return $this.j2x_1 === 0 ? appendNewArray($this) : ensureNotNull($this.g2x_1);
}
function appendNewArray($this) {
  var newBuffer = $this.e2x_1.g2a();
  var existing = $this.g2x_1;
  $this.g2x_1 = newBuffer;
  $this.j2x_1 = newBuffer.length;
  $this.i2x_1 = false;
  if (!(existing == null)) {
...
function currentPosition($this) {
  return ensureNotNull($this.g2x_1).length - $this.j2x_1 | 0;
}
...
function numberFormatException(cs) {
  _init_properties_Chars_kt__d3i39x();
  throw NumberFormatException.gf('Invalid number ' + toString(cs) + ': too large for Long type');
}
...
function numberFormatException_0(cs, idx) {
  _init_properties_Chars_kt__d3i39x();
  throw NumberFormatException.gf('Invalid number: ' + toString(cs) + ', wrong digit: ' + toString_1(charSequenceGet(cs, idx)) + ' at position ' + idx);
}
function DefaultHttpMethods$lambda(it) {
  _init_properties_Chars_kt__d3i39x();
  return it.u2p_1.length;
}
function DefaultHttpMethods$lambda_0(m, idx) {
  _init_properties_Chars_kt__d3i39x();
  return new Char(charCodeAt(m.u2p_1, idx));
}
...
function _init_properties_Chars_kt__d3i39x() {
  if (!properties_initialized_Chars_kt_phjfhp) {
    ...
    var tmp_0 = Companion_getInstance().t2p_1;
    var tmp_1 = DefaultHttpMethods$lambda;
    DefaultHttpMethods = tmp.a2z(tmp_0, tmp_1, DefaultHttpMethods$lambda_0);
    ...
    // Inline function 'kotlin.collections.mapTo' call
    var destination_0 = ArrayList.b2(collectionSizeOrDefault(this_9, 10));
