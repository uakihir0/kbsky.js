...
class CIOMultipartDataBase {
  constructor(coroutineContext, channel, contentType, contentLength, formFieldLimit) {
    ...
    this.b3c_1 = coroutineContext;
    this.c3c_1 = null;
    this.d3c_1 = parseMultipart(this, channel, contentType, contentLength, formFieldLimit);
  }
  h21() {
    return this.b3c_1;
  }
...
class HttpHeadersMap {
  constructor(builder) {
    ...
    this.f3c_1 = 0;
    this.g3c_1 = 0;
    this.h3c_1 = get_HeadersDataPool().p2o();
  }
  m1l(name) {
    if (this.f3c_1 === 0)
      return null;
    ...
    var hash = abs(this_0);
    var headerIndex = hash % this.g3c_1 | 0;
    while (!(this.h3c_1.m3c(imul(headerIndex, 6) + 0 | 0) === -1)) {
      if (headerHasName(this, name, imul(headerIndex, 6))) {
        return this.o3c(imul(headerIndex, 6));
      }
      headerIndex = (headerIndex + 1 | 0) % this.g3c_1 | 0;
    }
    return null;
  }
  p3c() {
    return this.h3c_1.l3c();
  }
  n3c(nameStartIndex, nameEndIndex, valueStartIndex, valueEndIndex) {
    if (thresholdReached(this)) {
      resize(this);
    }
    // Inline function 'kotlin.math.absoluteValue' call
    var this_0 = hashCodeLowerCase(this.e3c_1, nameStartIndex, nameEndIndex);
    var hash = abs(this_0);
    var name = this.e3c_1.c(nameStartIndex, nameEndIndex);
    var headerIndex = hash % this.g3c_1 | 0;
    ...
    this.h3c_1.x3c(headerOffset + 0 | 0, hash);
    this.h3c_1.x3c(headerOffset + 1 | 0, nameStartIndex);
    this.h3c_1.x3c(headerOffset + 2 | 0, nameEndIndex);
    this.h3c_1.x3c(headerOffset + 3 | 0, valueStartIndex);
    this.h3c_1.x3c(headerOffset + 4 | 0, valueEndIndex);
    this.h3c_1.x3c(headerOffset + 5 | 0, -1);
    if (!(sameNameHeaderIndex === -1)) {
      this.h3c_1.x3c(imul(sameNameHeaderIndex, 6) + 5 | 0, headerIndex);
    }
    this.f3c_1 = this.f3c_1 + 1 | 0;
  }
  y3c(headerOffset) {
    var nameStartIndex = this.h3c_1.m3c(headerOffset + 1 | 0);
    var nameEndIndex = this.h3c_1.m3c(headerOffset + 2 | 0);
    return this.e3c_1.c(nameStartIndex, nameEndIndex);
  }
  o3c(headerOffset) {
    var valueStartIndex = this.h3c_1.m3c(headerOffset + 3 | 0);
    var valueEndIndex = this.h3c_1.m3c(headerOffset + 4 | 0);
    return this.e3c_1.c(valueStartIndex, valueEndIndex);
  }
  q1i() {
    this.f3c_1 = 0;
    this.g3c_1 = 0;
    get_HeadersDataPool().q2o(this.h3c_1);
    this.h3c_1 = get_HeadersDataPool().p2o();
  }
  toString() {
...
class HeadersData {
  constructor() {
    ...
    tmp.i3c_1 = ArrayList.k2();
  }
  j3c() {
    return this.i3c_1.l2();
  }
  k3c(subArraysCount) {
    ...
    if (inductionVariable < subArraysCount)
      do {
        ...
        this.i3c_1.z1(get_IntArrayPool().p2o());
      }
       while (inductionVariable < subArraysCount);
  }
  m3c(index) {
    return this.i3c_1.j2(index / 768 | 0)[index % 768 | 0];
  }
  x3c(index, value) {
    this.i3c_1.j2(index / 768 | 0)[index % 768 | 0] = value;
  }
  l3c() {
    return sequence(HeadersData$headersStarts$slambda(this));
  }
  q1i() {
    var _iterator__ex2g4s = this.i3c_1.l1();
    while (_iterator__ex2g4s.m1()) {
      var array = _iterator__ex2g4s.n1();
      get_IntArrayPool().q2o(array);
    }
    this.i3c_1.i4();
  }
}
class IntArrayPool$1 extends DefaultPool {
  ...
  c3d(instance) {
    fill(instance, -1);
    return protoOf(DefaultPool).n2o.call(this, instance);
  }
  n2o(instance) {
    return this.c3d(isIntArray(instance) ? instance : THROW_CCE());
  }
}
class HeadersDataPool$1 extends DefaultPool {
  ...
  n2o(instance) {
    return this.g3d(instance instanceof HeadersData ? instance : THROW_CCE());
  }
}
class ParserException extends IllegalStateException {
  constructor(message) {
    return new.target.n3d(message);
  }
  static n3d(message) {
...
class Companion {
  o3d(from) {
    ...
    return this.b3e(from, tmp, AsciiCharTree$Companion$build$lambda_0);
  }
  b3e(from, length, charAt) {
    var tmp$ret$0;
    $l$block_0: {
...
class SubSequenceImpl {
  ...
  a() {
    return this.e3e_1 - this.d3e_1 | 0;
  }
  b(index) {
    var withOffset = index + this.d3e_1 | 0;
  ...
  c(startIndex, endIndex) {
    ...
    // Inline function 'kotlin.require' call
    if (!(endIndex <= (this.e3e_1 - this.d3e_1 | 0))) {
      var message_1 = 'end should be less than length (' + this.a() + ')';
      throw IllegalArgumentException.h2(toString(message_1));
    }
    if (startIndex === endIndex)
      return '';
    return new SubSequenceImpl(this.g3e_1, this.d3e_1 + startIndex | 0, this.d3e_1 + endIndex | 0);
  }
  toString() {
    ...
    if (tmp0_elvis_lhs == null) {
      ...
      var this_0 = toString(copy(this.g3e_1, this.d3e_1, this.e3e_1));
      this.f3e_1 = this_0;
      tmp = this_0;
    } else {
      tmp = tmp0_elvis_lhs;
  ...
  equals(other) {
    ...
    if (!(charSequenceLength(other) === this.a()))
      return false;
    return rangeEqualsImpl(this.g3e_1, this.d3e_1, other, 0, this.a());
  }
  hashCode() {
    var tmp0_safe_receiver = this.f3e_1;
    var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : getStringHashCode(tmp0_safe_receiver);
    return tmp1_elvis_lhs == null ? hashCodeImpl(this.g3e_1, this.d3e_1, this.e3e_1) : tmp1_elvis_lhs;
  }
}
class CharArrayBuilder {
  ...
  b(index) {
    ...
    // Inline function 'kotlin.require' call
    if (!(index < this.w3c_1)) {
      var message_0 = 'index ' + index + ' is not in range [0, ' + this.w3c_1 + ')';
      throw IllegalArgumentException.h2(toString(message_0));
    }
  ...
  c(startIndex, endIndex) {
    ...
    // Inline function 'kotlin.require' call
    if (!(endIndex <= this.w3c_1)) {
      var message_1 = 'endIndex (' + endIndex + ') is greater than length (' + this.w3c_1 + ')';
      throw IllegalArgumentException.h2(toString(message_1));
    }
  ...
  toString() {
    ...
    if (tmp0_elvis_lhs == null) {
      // Inline function 'kotlin.also' call
      var this_0 = toString(copy(this, 0, this.w3c_1));
      this.t3c_1 = this_0;
      tmp = this_0;
    } else {
      tmp = tmp0_elvis_lhs;
  ...
  equals(other) {
    if (!(!(other == null) ? isCharSequence(other) : false))
      return false;
    if (!(this.w3c_1 === charSequenceLength(other)))
      return false;
    return rangeEqualsImpl(this, 0, other, 0, this.w3c_1);
  }
  hashCode() {
    var tmp0_safe_receiver = this.t3c_1;
    var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : getStringHashCode(tmp0_safe_receiver);
    return tmp1_elvis_lhs == null ? hashCodeImpl(this, 0, this.w3c_1) : tmp1_elvis_lhs;
  }
  k1(value) {
    nonFullBuffer(this)[ensureNotNull(this.s3c_1).length - this.v3c_1 | 0] = value;
    this.t3c_1 = null;
    this.v3c_1 = this.v3c_1 - 1 | 0;
    this.w3c_1 = this.w3c_1 + 1 | 0;
    return this;
  }
  ug(value, startIndex, endIndex) {
    ...
    while (current < endIndex) {
      ...
      var offset = buffer.length - this.v3c_1 | 0;
      ...
      this.v3c_1 = this.v3c_1 - bytesToCopy | 0;
    }
    this.t3c_1 = null;
    this.w3c_1 = this.w3c_1 + (endIndex - startIndex | 0) | 0;
    return this;
  }
  i2(value) {
    if (value == null)
    ...
    if (!(list == null)) {
      ...
      if (inductionVariable < last)
        do {
          var i = inductionVariable;
          inductionVariable = inductionVariable + 1 | 0;
          this.q3c_1.q2o(list.j2(i));
        }
         while (inductionVariable < last);
    } else {
      var tmp0_safe_receiver = this.s3c_1;
      if (tmp0_safe_receiver == null)
        null;
      else {
        // Inline function 'kotlin.let' call
        this.q3c_1.q2o(tmp0_safe_receiver);
      }
      this.s3c_1 = null;
    }
    this.u3c_1 = true;
...
class UnsupportedMediaTypeExceptionCIO extends IOException {
  constructor(message) {
    return new.target.w3d(message);
  }
  static w3d(message) {
    var $this = this.r20(message);
    captureStack($this, $this.v3d_1);
    return $this;
  }
}
class MutableRange {
  ...
  toString() {
    return 'MutableRange(start=' + this.h3d_1 + ', end=' + this.i3d_1 + ')';
  }
}
//endregion
...
function thresholdReached($this) {
  return $this.f3c_1 >= $this.g3c_1 * 0.75;
}
function resize($this) {
  var prevSize = $this.f3c_1;
  var prevData = $this.h3c_1;
  $this.f3c_1 = 0;
  $this.g3c_1 = imul($this.g3c_1, 2) | 128;
  var tmp = $this;
  // Inline function 'kotlin.apply' call
  var this_0 = get_HeadersDataPool().p2o();
  this_0.k3c(imul(prevData.j3c(), 2) | 1);
  tmp.h3c_1 = this_0;
  var _iterator__ex2g4s = prevData.l3c().l1();
  while (_iterator__ex2g4s.m1()) {
    var headerOffset = _iterator__ex2g4s.n1();
    $this.n3c(prevData.m3c(headerOffset + 1 | 0), prevData.m3c(headerOffset + 2 | 0), prevData.m3c(headerOffset + 3 | 0), prevData.m3c(headerOffset + 4 | 0));
  }
  get_HeadersDataPool().q2o(prevData);
  // Inline function 'kotlin.require' call
  // Inline function 'kotlin.require' call
  if (!(prevSize === $this.f3c_1)) {
...
function headerHasName($this, name, headerOffset) {
  var nameStartIndex = $this.h3c_1.m3c(headerOffset + 1 | 0);
  var nameEndIndex = $this.h3c_1.m3c(headerOffset + 2 | 0);
  return equalsLowerCase($this.e3c_1, nameStartIndex, nameEndIndex, name);
}
function HeadersData$headersStarts$slambda(this$0) {
  return constructCallableReference(function *($this$sequence, $completion) {
    var joinedIndex = 0;
    var _iterator__ex2g4s = this$0.i3c_1.l1();
    while (_iterator__ex2g4s.m1()) {
      var arr = _iterator__ex2g4s.n1();
      var localIndex = 0;
      while (localIndex < arr.length) {
        if (!(this$0.m3c(joinedIndex + 0 | 0) === -1)) {
          yield* $this$sequence.pl(joinedIndex, $completion);
        }
...
function dumpTo(_this__u8e3s4, indent, out) {
  _init_properties_HttpHeadersMap_kt__hwatby();
  var _iterator__ex2g4s = _this__u8e3s4.p3c().l1();
  while (_iterator__ex2g4s.m1()) {
    var offset = _iterator__ex2g4s.n1();
    out.i2(indent);
    out.i2(_this__u8e3s4.y3c(offset));
    out.i2(' => ');
    out.i2(_this__u8e3s4.o3c(offset));
    out.i2('\n');
  }
}
...
function *parseHeaders(input, builder, range, $completion) {
  ...
  try {
    $l$loop: while (true) {
      ...
      range.i3d_1 = builder.w3c_1;
      var rangeLength = range.i3d_1 - range.h3d_1 | 0;
      if (rangeLength === 0)
        break $l$loop;
      if (rangeLength >= 8192) {
      ...
      var nameStart = range.h3d_1;
      var nameEnd = parseHeaderName(builder, range);
      var headerEnd = range.i3d_1;
      parseHeaderValue(builder, range);
      var valueStart = range.h3d_1;
      var valueEnd = range.i3d_1;
      range.h3d_1 = headerEnd;
      headers.n3c(nameStart, nameEnd, valueStart, valueEnd);
    }
    var host = headers.m1l('Host');
    if (!(host == null)) {
...
function parseHeaderName(text, range) {
  _init_properties_HttpParser_kt__gbdom1();
  var index = range.h3d_1;
  var end = range.i3d_1;
  while (index < end) {
    var ch = text.b(index);
    if (ch === _Char___init__impl__6a9atx(58) && !(index === range.h3d_1)) {
      range.h3d_1 = index + 1 | 0;
      return index;
    }
    if (isDelimiter(ch)) {
      parseHeaderNameFailed(text, index, range.h3d_1, ch);
    }
    index = index + 1 | 0;
  }
...
function parseHeaderValue(text, range) {
  ...
  range.h3d_1 = valueStart;
  range.i3d_1 = valueLastIndex + 1 | 0;
}
function validateHostHeader(host) {
  _init_properties_HttpParser_kt__gbdom1();
  if (endsWith(host, ':')) {
    throw ParserException.n3d("Host header with ':' should contains port: " + toString(host));
  }
  var tmp$ret$0;
  $l$block: {
  ...
  if (tmp$ret$0) {
    throw ParserException.n3d('Host cannot contain any of the following symbols: ' + toString(get_hostForbiddenSymbols()));
  }
}
...
function parseHeaderNameFailed(text, index, start, ch) {
  ...
  if (ch === _Char___init__impl__6a9atx(58)) {
    throw ParserException.n3d('Empty header names are not allowed as per RFC7230.');
  }
  if (index === start) {
    throw ParserException.n3d('Multiline headers via line folding is not supported since it is deprecated as per RFC7230.');
  }
  characterIsNotAllowed(text, ch);
}
function noColonFound(text, range) {
  _init_properties_HttpParser_kt__gbdom1();
  var tmp2 = range.h3d_1;
  // Inline function 'kotlin.text.substring' call
  var endIndex = range.i3d_1;
  var tmp$ret$0 = toString(charSequenceSubSequence(text, tmp2, endIndex));
  throw ParserException.n3d('No colon in HTTP header in ' + tmp$ret$0 + ' in builder: \n' + toString(text));
}
function characterIsNotAllowed(text, ch) {
  _init_properties_HttpParser_kt__gbdom1();
  // Inline function 'kotlin.code' call
  var tmp$ret$0 = Char__toInt_impl_vasixd(ch);
  throw ParserException.n3d('Character with code ' + (tmp$ret$0 & 255) + ' is not allowed in header names, \n' + toString(text));
}
...
function _init_properties_HttpParser_kt__gbdom1() {
  if (!properties_initialized_HttpParser_kt_uedryv) {
    ...
    httpLineEndings = LineEndingMode__plus_impl_ttpz2j(Companion_getInstance_0().q2n_1, Companion_getInstance_0().p2n_1);
    versions = Companion_instance.o3d(listOf(['HTTP/1.0', 'HTTP/1.1']));
  }
}
function get_CrLf() {
...
function parseMultipart(_this__u8e3s4, input, contentType, contentLength, maxPartSize) {
  ...
  _init_properties_Multipart_kt__ato98a();
  if (!MultiPart_getInstance().x2y(contentType)) {
    throw UnsupportedMediaTypeExceptionCIO.w3d('Failed to parse multipart: Content-Type should be multipart/* but it is ' + toString(contentType));
  }
  var boundaryByteBuffer = parseBoundaryInternal(contentType);
  var boundaryBytes = ByteString.b1x(boundaryByteBuffer);
...
function parseBoundaryInternal(contentType) {
  ...
  if (boundaryParameter === -1) {
    throw IOException.r20("Failed to parse multipart: Content-Type's boundary parameter is missing");
  }
  ...
  if (inductionVariable < last)
    loop: do {
      ...
      if ((v & 65535) > 127) {
        throw IOException.r20('Failed to parse multipart: wrong boundary byte 0x' + toString_0(v, 16) + ' - should be 7bit character');
      }
      switch (state) {
        case 0:
     ...
     while (inductionVariable < last);
  if (position._v === 4) {
    throw IOException.r20('Empty multipart boundary is not allowed');
  }
...
function *parsePartHeadersImpl(input, $completion) {
  ...
  try {
    ...
    var tmp;
    if (tmp0_elvis_lhs == null) {
      throw EOFException.m1x('Failed to parse multipart headers: unexpected end of stream');
    } else {
      tmp = tmp0_elvis_lhs;
    }
    return tmp;
...
function *parsePartBodyImpl(boundaryPrefixed, input, output, headers, limit, $completion) {
  var tmp0_safe_receiver = headers.m1l('Content-Length');
...
function throwLimitExceeded(actual, limit) {
  _init_properties_Multipart_kt__ato98a();
  throw IOException.r20('Multipart content length exceeds limit ' + actual.toString() + ' > ' + limit.toString() + '; ' + "limit is defined using 'formFieldLimit' argument");
}
function parseBoundaryInternal$put(position, boundaryBytes, value) {
  if (position._v >= boundaryBytes.length) {
    throw IOException.r20("Failed to parse multipart: boundary shouldn't be longer than 70 characters");
  }
...
function parseMultipart$slambda$slambda($firstBoundary, $countedInput) {
  return constructCallableReference(function *($this$writer, $completion) {
    yield* /*#__NOINLINE__*/parsePreambleImpl($firstBoundary, $countedInput, $this$writer.f2n_1, 8193n, $completion);
    yield* $this$writer.f2n_1.i2m($completion);
    return Unit_instance;
  }, 1);
}
function parseMultipart$slambda($input, $boundaryPrefixed, $maxPartSize, $totalLength) {
  return constructCallableReference(function *($this$produce, $completion) {
    ...
    var readBeforeParse = countedInput.n2n();
    var firstBoundary = $boundaryPrefixed.c1x(get_PrefixString().l2());
    var preambleData = yield* readRemaining(writer($this$produce, VOID, VOID, parseMultipart$slambda$slambda(firstBoundary, countedInput)).v2m_1, $completion);
    var tmp;
    if (get_remaining(preambleData) > 0n) {
      tmp = yield* $this$produce.v2f(new Preamble(preambleData), $completion);
    }
    $l$loop: while (!countedInput.y2l() && !(yield* skipIfFound(countedInput, get_PrefixString(), $completion))) {
      ...
      try {
        ...
        if ($p instanceof Error) {
          var cause = $p;
          if (headers.k27(cause)) {
            var tmp0_safe_receiver = headersMap;
            if (tmp0_safe_receiver == null)
              null;
            else {
              tmp0_safe_receiver.q1i();
            }
          }
          close(body, cause);
          throw cause;
    ...
    var tmp_0;
    if (!($totalLength == null)) {
      var consumedExceptEpilogue = subtract(countedInput.n2n(), readBeforeParse);
      var size = subtract($totalLength, consumedExceptEpilogue);
      if (size > 2147483647n)
        throw IOException.r20('Failed to parse multipart: prologue is too long');
      var tmp_1;
      if (size > 0n) {
        tmp_1 = yield* $this$produce.v2f(new Epilogue(yield* readPacket(countedInput, convertToInt(size), $completion)), $completion);
      }
      tmp_0 = tmp_1;
    } else {
      var epilogueContent = yield* readRemaining(countedInput, $completion);
      var tmp_2;
      if (!epilogueContent.o1x()) {
        tmp_2 = yield* $this$produce.v2f(new Epilogue(epilogueContent), $completion);
      }
      tmp_0 = tmp_2;
    }
    return Unit_instance;
...
function _init_properties_Multipart_kt__ato98a() {
  if (!properties_initialized_Multipart_kt_wu0sh0) {
    ...
    CrLf = ByteString.b1x(toByteArray_0('\r\n'));
...
function getImpl($this, index) {
  return bufferForIndex($this, index)[index % ensureNotNull($this.s3c_1).length | 0];
}
...
function bufferForIndex($this, index) {
  ...
  return list.j2(index / ensureNotNull($this.s3c_1).length | 0);
}
function throwSingleBuffer($this, index) {
  if ($this.u3c_1)
    throw IllegalStateException.o('Buffer is already released');
  throw IndexOutOfBoundsException.je('' + index + ' is not in range [0; ' + currentPosition($this) + ')');
}
function nonFullBuffer($this) {
  return $this.v3c_1 === 0 ? appendNewArray($this) : ensureNotNull($this.s3c_1);
}
function appendNewArray($this) {
  var newBuffer = $this.q3c_1.p2o();
  var existing = $this.s3c_1;
  $this.s3c_1 = newBuffer;
  $this.v3c_1 = newBuffer.length;
  $this.u3c_1 = false;
  if (!(existing == null)) {
    var tmp0_elvis_lhs = $this.r3c_1;
    var tmp;
    if (tmp0_elvis_lhs == null) {
      // Inline function 'kotlin.also' call
      var this_0 = ArrayList.k2();
      $this.r3c_1 = this_0;
      this_0.z1(existing);
      tmp = this_0;
    } else {
...
function currentPosition($this) {
  return ensureNotNull($this.s3c_1).length - $this.v3c_1 | 0;
}
...
function numberFormatException(cs) {
  _init_properties_Chars_kt__d3i39x();
  throw NumberFormatException.ye('Invalid number ' + toString(cs) + ': too large for Long type');
}
...
function numberFormatException_0(cs, idx) {
  _init_properties_Chars_kt__d3i39x();
  throw NumberFormatException.ye('Invalid number: ' + toString(cs) + ', wrong digit: ' + toString_1(charSequenceGet(cs, idx)) + ' at position ' + idx);
}
function DefaultHttpMethods$lambda(it) {
  _init_properties_Chars_kt__d3i39x();
  return it.c35_1.length;
}
function DefaultHttpMethods$lambda_0(m, idx) {
  _init_properties_Chars_kt__d3i39x();
  return new Char(charCodeAt(m.c35_1, idx));
}
...
function _init_properties_Chars_kt__d3i39x() {
  if (!properties_initialized_Chars_kt_phjfhp) {
    ...
    var tmp_0 = Companion_getInstance().b35_1;
    var tmp_1 = DefaultHttpMethods$lambda;
    DefaultHttpMethods = tmp.b3e(tmp_0, tmp_1, DefaultHttpMethods$lambda_0);
