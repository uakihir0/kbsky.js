...
class ATProtocolStreamConfig extends ATProtocolConfig {
  ...
  copy(firehoseUri, $super) {
    ...
    return $super === VOID ? this.a61(firehoseUri) : $super.a61.call(this, firehoseUri);
  }
  toString() {
...
class ATProtocolStreamFactory {
  ...
  instanceFromConfig(config, $super) {
    ...
    return $super === VOID ? this.w7p(config) : $super.w7p.call(this, config);
  }
}
class SyncResource {}
class SyncSubscribeReposRequest {
  ...
  copy(cursor, filter, $super) {
    ...
    return $super === VOID ? this.y7p(cursor, filter) : $super.y7p.call(this, cursor, filter);
  }
  toString() {
...
class SyncStreamClient {
  ...
  *q7q($completion) {
  ...
  open() {
    return promisify(($completion) => this.q7q($completion));
  }
  *r7q($completion) {
    if (this.open === protoOf(SyncStreamClient).open)
      yield* this.q7q($completion);
    else
...
class $serializer {
  ...
  t7q(encoder, value) {
    ...
    if (tmp1_output.u11(tmp0_desc, 0) ? true : !(value.d7q_1 == null)) {
      tmp1_output.q11(tmp0_desc, 0, StringSerializer_getInstance(), value.d7q_1);
    }
    if (tmp1_output.u11(tmp0_desc, 1) ? true : !(value.e7q_1 == null)) {
      tmp1_output.q11(tmp0_desc, 1, StringSerializer_getInstance(), value.e7q_1);
    }
    tmp1_output.xz(tmp0_desc);
  }
  nv(encoder, value) {
    return this.t7q(encoder, value instanceof StreamOp ? value : THROW_CCE());
  }
  ov(decoder) {
    var tmp0_desc = this.s7q_1;
    var tmp1_flag = true;
    ...
    return StreamOp.u7q(tmp3_bitMask0, tmp4_local0, tmp5_local1, null);
  }
  mv() {
    return this.s7q_1;
  }
...
class StreamOp {
  ...
  toString() {
    return 'StreamOp(action=' + this.d7q_1 + ', path=' + this.e7q_1 + ')';
  }
  hashCode() {
    var result = this.d7q_1 == null ? 0 : getStringHashCode(this.d7q_1);
    result = imul(result, 31) + (this.e7q_1 == null ? 0 : getStringHashCode(this.e7q_1)) | 0;
    return result;
  }
  equals(other) {
    if (this === other)
  ...
  static u7q(seen0, action, path, serializationConstructorMarker) {
    if (!(0 === (0 & seen0))) {
      throwMissingFieldException(seen0, 0, $serializer_getInstance().s7q_1);
    }
...
class Companion_0 {
  constructor() {
    ...
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    tmp.v7q_1 = [null, null, lazy(tmp_0, StreamRoot$Companion$$childSerializers$_anonymous__gnm36w), null];
  }
}
class $serializer_0 {
  constructor() {
    ...
    this.w7q_1 = tmp0_serialDesc;
  }
  x7q(encoder, value) {
    var tmp0_desc = this.w7q_1;
    var tmp1_output = encoder.wz(tmp0_desc);
    var tmp2_cached = Companion_getInstance_0().v7q_1;
    if (tmp1_output.u11(tmp0_desc, 0) ? true : !(value.z7p_1 == null)) {
      tmp1_output.q11(tmp0_desc, 0, IntSerializer_getInstance(), value.z7p_1);
    }
    if (tmp1_output.u11(tmp0_desc, 1) ? true : !(value.a7q_1 == null)) {
      tmp1_output.q11(tmp0_desc, 1, StringSerializer_getInstance(), value.a7q_1);
    }
    if (tmp1_output.u11(tmp0_desc, 2) ? true : !(value.b7q_1 == null)) {
      tmp1_output.q11(tmp0_desc, 2, tmp2_cached[2].w2(), value.b7q_1);
    }
    if (tmp1_output.u11(tmp0_desc, 3) ? true : !(value.c7q_1 == null)) {
      tmp1_output.q11(tmp0_desc, 3, StringSerializer_getInstance(), value.c7q_1);
    }
    tmp1_output.xz(tmp0_desc);
  }
  nv(encoder, value) {
    return this.x7q(encoder, value instanceof StreamRoot ? value : THROW_CCE());
  }
  ov(decoder) {
    var tmp0_desc = this.w7q_1;
    var tmp1_flag = true;
    ...
    var tmp9_cached = Companion_getInstance_0().v7q_1;
    if (tmp8_input.m10()) {
    ...
    return StreamRoot.y7q(tmp3_bitMask0, tmp4_local0, tmp5_local1, tmp6_local2, tmp7_local3, null);
  }
  mv() {
    return this.w7q_1;
  }
  c18() {
    var tmp0_cached = Companion_getInstance_0().v7q_1;
    // Inline function 'kotlin.arrayOf' call
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
...
class StreamRoot {
  ...
  toString() {
    return 'StreamRoot(op=' + this.z7p_1 + ', repo=' + this.a7q_1 + ', ops=' + toString_0(this.b7q_1) + ', t=' + this.c7q_1 + ')';
  }
  hashCode() {
    var result = this.z7p_1 == null ? 0 : this.z7p_1;
    result = imul(result, 31) + (this.a7q_1 == null ? 0 : getStringHashCode(this.a7q_1)) | 0;
    result = imul(result, 31) + (this.b7q_1 == null ? 0 : hashCode(this.b7q_1)) | 0;
    result = imul(result, 31) + (this.c7q_1 == null ? 0 : getStringHashCode(this.c7q_1)) | 0;
    return result;
  }
  equals(other) {
    if (this === other)
    ...
    if (!(this.z7p_1 == other.z7p_1))
      return false;
    if (!(this.a7q_1 == other.a7q_1))
      return false;
    if (!equals(this.b7q_1, other.b7q_1))
      return false;
    if (!(this.c7q_1 == other.c7q_1))
      return false;
    return true;
  }
  static y7q(seen0, op, repo, ops, t, serializationConstructorMarker) {
    Companion_getInstance_0();
    if (!(0 === (0 & seen0))) {
      throwMissingFieldException(seen0, 0, $serializer_getInstance_0().w7q_1);
    }
    var $this = createThis(this);
    if (0 === (seen0 & 1))
      $this.z7p_1 = null;
...
class ATProtocolStreamImpl {
  constructor(config) {
    this.z7q_1 = new ATProtocolImpl(config);
    this.a7r_1 = new SyncResourceImpl(this.z7q_1, config);
  }
  sync() {
    return this.a7r_1;
  }
...
class SyncResourceImpl {
  ...
  subscribeRepos(request) {
    var url = 'wss://' + Url(this.c7r_1.firehoseUri).i38_1 + '/xrpc/' + 'com.atproto.sync.subscribeRepos';
    return new SyncStreamClient(this.b7r_1, url, request.filter);
  }
}
//endregion
...
function onMessage($this, data) {
  ...
  $l$loop_1: while (_iterator__ex2g4s_1.m1()) {
    ...
    try {
      ...
      if (item_1.b7q_1 == null) {
        continue $l$loop_1;
      }
      // Inline function 'kotlin.checkNotNull' call
      var tmp0 = item_1.b7q_1;
      var tmp$ret$13;
      $l$block: {
        // Inline function 'kotlin.checkNotNull' call
        if (tmp0 == null) {
      ...
      $l$loop_0: while (_iterator__ex2g4s_2.m1()) {
        ...
        try {
          ...
          var response = $this.atproto.repo().t53(new RepoGetRecordRequest(ensureNotNull(repo), elements[0], elements[1]));
          var tmp0_safe_receiver = $this.f7q_1;
          if (tmp0_safe_receiver == null)
            null;
          else {
            tmp0_safe_receiver.j7q(response.data.cid, response.data.uri, response.data.value);
          }
        } catch ($p) {
...
function SyncStreamClient$lambda(this$0) {
  return (it) => {
    this$0.isOpen = true;
    var tmp0_safe_receiver = this$0.g7q_1;
    if (tmp0_safe_receiver == null)
      null;
    else {
      tmp0_safe_receiver.k7q();
    }
    return Unit_instance;
  };
}
function SyncStreamClient$lambda_0(this$0) {
  return (it) => {
    this$0.isOpen = false;
    var tmp0_safe_receiver = this$0.h7q_1;
    if (tmp0_safe_receiver == null)
      null;
    else {
      tmp0_safe_receiver.l7q();
    }
    return Unit_instance;
  };
}
function SyncStreamClient$onMessage$lambda($this$Cbor) {
  $this$Cbor.l7m_1 = true;
  return Unit_instance;
}
