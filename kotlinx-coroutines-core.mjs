...
function invokeOnCompletion$default(onCancelling, invokeImmediately, handler, $super) {
  ...
  return $super === VOID ? this.k22(onCancelling, invokeImmediately, handler) : $super.k22.call(this, onCancelling, invokeImmediately, handler);
}
class ParentJob {}
class JobSupport {
  constructor(active) {
    this.b21_1 = atomic$ref$1(active ? get_EMPTY_ACTIVE() : get_EMPTY_NEW());
    this.c21_1 = atomic$ref$1(null);
  }
  v2() {
    return Key_instance_3;
  }
  z21(value) {
    this.c21_1.kotlinx$atomicfu$value = value;
  }
  a22() {
    return this.c21_1.kotlinx$atomicfu$value;
  }
  d21(parent) {
    // Inline function 'kotlinx.coroutines.assert' call
    if (parent == null) {
      this.z21(NonDisposableHandle_instance);
      return Unit_instance;
    }
    parent.e22();
    var handle = parent.z22(this);
    this.z21(handle);
    if (this.c22()) {
      handle.j24();
      this.z21(NonDisposableHandle_instance);
  ...
  b22() {
    return this.b21_1.kotlinx$atomicfu$value;
  }
  i21() {
    var state = this.b22();
    var tmp;
  ...
  g22() {
    ...
    var tmp;
    if (state instanceof Finishing) {
      var tmp0_safe_receiver = state.s29();
      var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : this.h22(tmp0_safe_receiver, get_classSimpleName(this) + ' is cancelling');
      var tmp_0;
      ...
      if (!(state == null) ? isInterface(state, Incomplete) : false) {
        ...
        if (state instanceof CompletedExceptionally) {
          tmp = this.i22(state.n21_1);
        } else {
          tmp = JobCancellationException.l29(get_classSimpleName(this) + ' has completed normally', null, this);
        }
      }
    }
    return tmp;
  }
  h22(_this__u8e3s4, message) {
    var tmp0_elvis_lhs = _this__u8e3s4 instanceof CancellationException ? _this__u8e3s4 : null;
    var tmp;
    if (tmp0_elvis_lhs == null) {
      // Inline function 'kotlinx.coroutines.JobSupport.defaultCancellationException' call
      tmp = JobCancellationException.l29(message == null ? this.l21() : message, _this__u8e3s4, this);
    } else {
      tmp = tmp0_elvis_lhs;
    }
    return tmp;
  }
  i22(_this__u8e3s4, message, $super) {
    message = message === VOID ? null : message;
    return $super === VOID ? this.h22(_this__u8e3s4, message) : $super.h22.call(this, _this__u8e3s4, message);
  }
  j22(handler) {
    return this.m22(true, new InvokeOnCompletion(handler));
  }
  k22(onCancelling, invokeImmediately, handler) {
    var tmp;
    if (onCancelling) {
    ...
    return this.m22(invokeImmediately, tmp);
  }
  m22(invokeImmediately, node) {
    node.y26_1 = this;
    var tmp$ret$0;
    $l$block_1: {
      ...
      while (true) {
        ...
        if (state instanceof Empty) {
          if (state.o29_1) {
            if (this.b21_1.atomicfu$compareAndSet(state, node)) {
              tmp$ret$0 = true;
              break $l$block_1;
            }
          } else {
          ...
          if (!(state == null) ? isInterface(state, Incomplete) : false) {
            ...
            if (list == null) {
              ...
              if (node.u26()) {
                ...
                var rootCause = tmp0_safe_receiver == null ? null : tmp0_safe_receiver.s29();
                var tmp_0;
                if (rootCause == null) {
                  tmp_0 = list.e27(node, 5);
                } else {
    ...
    if (added)
      ...
      node.i24(tmp0_safe_receiver_0 == null ? null : tmp0_safe_receiver_0.n21_1);
    }
    return NonDisposableHandle_instance;
  }
  *n22($completion) {
  ...
  o22(node) {
    ...
    while (true) {
      ...
      if (state instanceof JobNode) {
        if (!(state === node))
          return Unit_instance;
        if (this.b21_1.atomicfu$compareAndSet(state, get_EMPTY_ACTIVE()))
          return Unit_instance;
      } else {
        if (!(state == null) ? isInterface(state, Incomplete) : false) {
          if (!(state.a27() == null)) {
  ...
  q22(cause) {
    ...
    if (cause == null) {
      // Inline function 'kotlinx.coroutines.JobSupport.defaultCancellationException' call
      tmp = JobCancellationException.l29(null == null ? this.l21() : null, null, this);
    } else {
      tmp = cause;
    }
    this.s22(tmp);
  ...
  u22(cause) {
    if (cause instanceof CancellationException)
      return true;
    return this.w22(cause) && this.c23();
  }
  v22(cause) {
    return this.w22(cause);
  }
  w22(cause) {
  ...
  x22() {
    ...
    return tmp1_elvis_lhs == null ? JobCancellationException.l29('Parent job is ' + stateString(this, state), rootCause, this) : tmp1_elvis_lhs;
  }
  y22(proposedUpdate) {
    // Inline function 'kotlinx.coroutines.JobSupport.loopOnState' call
    while (true) {
        ...
        if (state instanceof Empty) {
          ...
          if (!(state == null) ? isInterface(state, Incomplete) : false) {
            ...
            if (list == null) {
              ...
              var addedBeforeCancellation = list.e27(node, 7);
              var tmp;
              if (addedBeforeCancellation) {
                tmp = true;
              } else {
                var addedBeforeCompletion = list.e27(node, 3);
                var latestState = this.b22();
                var tmp_0;
                if (latestState instanceof Finishing) {
                  tmp_0 = latestState.s29();
                } else {
                  // Inline function 'kotlinx.coroutines.assert' call
                  var tmp0_safe_receiver = latestState instanceof CompletedExceptionally ? latestState : null;
                  tmp_0 = tmp0_safe_receiver == null ? null : tmp0_safe_receiver.n21_1;
                }
                var rootCause = tmp_0;
                node.i24(rootCause);
                var tmp_1;
  ...
  toString() {
    return this.e23() + '@' + get_hexAddress(this);
  }
  e23() {
    return this.u21() + '{' + stateString(this, this.b22()) + '}';
  }
  u21() {
...
class AbstractCoroutine extends JobSupport {
  constructor(parentContext, initParentJob, active) {
    super(active);
    if (initParentJob) {
      this.d21(parentContext.ed(Key_instance_3));
    }
    this.g21_1 = parentContext.qm(this);
  }
  sc() {
    return this.g21_1;
  }
  ...
  m21(state) {
    if (state instanceof CompletedExceptionally) {
      this.k21(state.n21_1, state.p21());
    } else {
      this.j21(state);
    }
  }
  uc(result) {
    var state = this.q21(toState_0(result));
    if (state === get_COMPLETING_WAITING_CHILDREN())
      return Unit_instance;
    this.r21(state);
  }
  r21(state) {
    return this.s21(state);
  }
  t21(exception) {
    handleCoroutineException(this.g21_1, exception);
  }
  u21() {
    var tmp0_elvis_lhs = get_coroutineName(this.g21_1);
    var tmp;
    if (tmp0_elvis_lhs == null) {
      return super.u21();
    } else {
    ...
    return '"' + coroutineName + '":' + super.u21();
  }
  v21(start, receiver, block) {
    start.y21(block, receiver, this);
  }
}
...
class LazyStandaloneCoroutine extends StandaloneCoroutine {
  constructor(parentContext, block) {
    ...
    this.n23_1 = createCoroutineUninterceptedGeneratorVersion(block, this, this);
  }
  f22() {
    startCoroutineCancellable_1(this.n23_1, this);
  }
}
class DeferredCoroutine extends AbstractCoroutine {
  ...
  *r23($completion) {
    return yield* this.f23($completion);
  }
}
class LazyDeferredCoroutine extends DeferredCoroutine {
  constructor(parentContext, block) {
    super(parentContext, false);
    this.v23_1 = createCoroutineUninterceptedGeneratorVersion(block, this, this);
  }
  f22() {
    startCoroutineCancellable_1(this.v23_1, this);
  }
}
...
class DisposeOnCancel {
  ...
  i24(cause) {
    return this.h24_1.j24();
  }
  toString() {
    return 'DisposeOnCancel[' + toString(this.h24_1) + ']';
  }
}
class UserSupplied {
  constructor(handler) {
  ...
  toString() {
    return 'CancelHandler.UserSupplied[' + get_classSimpleName(this.s24_1) + '@' + get_hexAddress(this) + ']';
  }
}
class Runnable {}
class SchedulerTask {}
class DispatchedTask extends SchedulerTask {
  constructor(resumeMode) {
    super();
    this.u24_1 = resumeMode;
  }
  s25(takenState, cause) {
  }
  a26(state) {
    return state;
  }
  k26(state) {
    ...
    return tmp0_safe_receiver == null ? null : tmp0_safe_receiver.n21_1;
  }
  m26() {
    // Inline function 'kotlinx.coroutines.assert' call
    try {
      ...
      var continuation = delegate.m24_1;
      // Inline function 'kotlinx.coroutines.withContinuationContext' call
      delegate.o24_1;
      var context = continuation.sc();
      var state = this.r25();
      var exception = this.k26(state);
      var job = exception == null && get_isCancellableMode(this.u24_1) ? context.ed(Key_instance_3) : null;
      if (!(job == null) && !job.i21()) {
        var cause = job.g22();
        this.s25(state, cause);
        // Inline function 'kotlinx.coroutines.resumeWithStackTrace' call
        // Inline function 'kotlin.Companion.failure' call
        var exception_0 = recoverStackTrace(cause, continuation);
        var tmp$ret$4 = _Result___init__impl__xyqfz8(createFailure(exception_0));
        continuation.uc(tmp$ret$4);
      } else {
        if (!(exception == null)) {
          // Inline function 'kotlin.coroutines.resumeWithException' call
          // Inline function 'kotlin.Companion.failure' call
          var tmp$ret$6 = _Result___init__impl__xyqfz8(createFailure(exception));
          continuation.uc(tmp$ret$6);
        } else {
          // Inline function 'kotlin.coroutines.resume' call
          // Inline function 'kotlin.Companion.success' call
          var value = this.a26(state);
          var tmp$ret$8 = _Result___init__impl__xyqfz8(value);
          continuation.uc(tmp$ret$8);
        }
      }
    } catch ($p) {
      if ($p instanceof DispatchException) {
        var e = $p;
        handleCoroutineException(this.p25().sc(), e.r27_1);
      } else {
  ...
  n26(exception) {
    var reason = CoroutinesInternalError.s28('Fatal exception in coroutines machinery for ' + toString(this) + '. ' + "Please read KDoc to 'handleFatalException' method and report this incident to maintainers", exception);
    handleCoroutineException(this.p25().sc(), reason);
  }
}
class Waiter {}
class CancellableContinuationImpl extends DispatchedTask {
  constructor(delegate, resumeMode) {
    ...
    this.b24_1 = delegate;
    // Inline function 'kotlinx.coroutines.assert' call
    this.c24_1 = this.b24_1.sc();
    var tmp = this;
    // Inline function 'kotlinx.coroutines.decisionAndIndex' call
    var tmp$ret$1 = (0 << 29) + 536870911 | 0;
    tmp.d24_1 = atomic$int$1(tmp$ret$1);
    this.e24_1 = atomic$ref$1(Active_instance);
    this.f24_1 = atomic$ref$1(null);
  }
  p25() {
    return this.b24_1;
  }
  ...
  b22() {
    return this.e24_1.kotlinx$atomicfu$value;
  }
  c22() {
    var tmp = this.b22();
  ...
  q25() {
    ...
    if (this.c22()) {
      handle.j24();
      this.f24_1.kotlinx$atomicfu$value = NonDisposableHandle_instance;
    }
  }
  r24() {
    // Inline function 'kotlinx.coroutines.assert' call
    // Inline function 'kotlinx.coroutines.assert' call
    var state = this.e24_1.kotlinx$atomicfu$value;
    // Inline function 'kotlinx.coroutines.assert' call
    var tmp;
    if (state instanceof CompletedContinuation) {
      tmp = !(state.i25_1 == null);
    } else {
      tmp = false;
    }
    if (tmp) {
    ...
    var tmp_0 = this.d24_1;
    // Inline function 'kotlinx.coroutines.decisionAndIndex' call
    tmp_0.kotlinx$atomicfu$value = (0 << 29) + 536870911 | 0;
    this.e24_1.kotlinx$atomicfu$value = Active_instance;
    return true;
  }
  r25() {
    return this.b22();
      ...
      if (!(state == null) ? isInterface(state, NotCompleted) : false) {
        ...
        if (state instanceof CompletedExceptionally)
          ...
          if (state instanceof CompletedContinuation) {
            ...
            var update = state.m25(VOID, VOID, VOID, VOID, cause);
            if (this.e24_1.atomicfu$compareAndSet(state, update)) {
              state.t25(this, cause);
              return Unit_instance;
            }
          } else {
            if (this.e24_1.atomicfu$compareAndSet(state, new CompletedContinuation(state, VOID, VOID, VOID, cause))) {
              return Unit_instance;
            }
          }
        }
  ...
  u25(cause) {
    ...
    while (true) {
      ...
      $l$block: {
        ...
        if (!this.e24_1.atomicfu$compareAndSet(tmp0, update)) {
          break $l$block;
        }
        if (isInterface(tmp0, CancelHandler)) {
          this.k25(tmp0, cause);
        ...
        dispatchResume(this, this.u24_1);
        return true;
      }
    }
  }
  ...
  k25(handler, cause) {
    ...
    try {
      ...
      if ($p instanceof Error) {
        var ex = $p;
        handleCoroutineException(this.sc(), CompletionHandlerException.e25('Exception in invokeOnCancellation handler for ' + this.toString(), ex));
      } else {
        throw $p;
      }
    }
  ...
  w25(onCancellation, cause, value) {
    try {
      onCancellation(cause, value, this.sc());
    } catch ($p) {
      if ($p instanceof Error) {
        var ex = $p;
        handleCoroutineException(this.sc(), CompletionHandlerException.e25('Exception in resume onCancellation handler for ' + this.toString(), ex));
      } else {
        throw $p;
      }
    }
  ...
  y25() {
    ...
    var state = this.b22();
    if (state instanceof CompletedExceptionally)
      throw recoverStackTrace(state.n21_1, this);
    if (get_isCancellableMode(this.u24_1)) {
      var job = this.sc().ed(Key_instance_3);
      if (!(job == null) && !job.i21()) {
        var cause = job.g22();
        this.s25(state, cause);
    ...
    return this.a26(state);
  }
  z25() {
    var tmp = this.b24_1;
    var tmp0_safe_receiver = tmp instanceof DispatchedContinuation ? tmp : null;
    var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : tmp0_safe_receiver.b26(this);
    var tmp_0;
    if (tmp1_elvis_lhs == null) {
      return Unit_instance;
    } else {
    ...
    this.o25();
    this.u25(cancellationCause);
  }
  uc(result) {
    return this.c26(toState(result, this), this.u24_1);
  }
  d26(value, onCancellation) {
    return this.e26(value, this.u24_1, onCancellation);
  }
  f26(segment, index) {
    var tmp0 = this.d24_1;
    $l$block: {
  ...
  e26(proposedUpdate, resumeMode, onCancellation) {
    // Inline function 'kotlinx.atomicfu.loop' call
    var this_0 = this.e24_1;
    while (true) {
      var tmp0 = this_0.kotlinx$atomicfu$value;
          ...
          if (tmp0 instanceof CancelledContinuation) {
            if (tmp0.j26()) {
              if (onCancellation == null)
                ...
                this.w25(onCancellation, tmp0.n21_1, proposedUpdate);
              }
              return Unit_instance;
            }
          }
  ...
  c26(proposedUpdate, resumeMode, onCancellation, $super) {
    onCancellation = onCancellation === VOID ? null : onCancellation;
    var tmp;
    if ($super === VOID) {
      this.e26(proposedUpdate, resumeMode, onCancellation);
      tmp = Unit_instance;
    } else {
      tmp = $super.e26.call(this, proposedUpdate, resumeMode, onCancellation);
    }
    return tmp;
  }
  o25() {
  ...
  w23(value, idempotent, onCancellation) {
  ...
  z23(_this__u8e3s4, value) {
    var tmp = this.b24_1;
    var dc = tmp instanceof DispatchedContinuation ? tmp : null;
    var tmp_0;
    if ((dc == null ? null : dc.l24_1) === _this__u8e3s4) {
      tmp_0 = 4;
    } else {
      tmp_0 = this.u24_1;
    }
    this.c26(value, tmp_0);
  }
  a26(state) {
    var tmp;
    if (state instanceof CompletedContinuation) {
  ...
  k26(state) {
    var tmp0_safe_receiver = super.k26(state);
    var tmp;
    if (tmp0_safe_receiver == null) {
      tmp = null;
    } else {
      // Inline function 'kotlin.let' call
      tmp = recoverStackTrace(tmp0_safe_receiver, this.b24_1);
    }
    return tmp;
  }
  toString() {
    return this.l26() + '(' + toDebugString(this.b24_1) + '){' + _get_stateDebugRepresentation__bf18u4(this) + '}@' + get_hexAddress(this);
  }
  l26() {
...
class CompletedContinuation {
  constructor(result, cancelHandler, onCancellation, idempotentResume, cancelCause) {
    ...
    this.f25_1 = result;
    this.g25_1 = cancelHandler;
    this.h25_1 = onCancellation;
    this.i25_1 = idempotentResume;
    this.j25_1 = cancelCause;
  }
  l25() {
    return !(this.j25_1 == null);
  }
  t25(cont, cause) {
    ...
    if (tmp0_safe_receiver == null)
      ...
      // Inline function 'kotlin.let' call
      cont.k25(tmp0_safe_receiver, cause);
    }
    var tmp1_safe_receiver = this.h25_1;
    if (tmp1_safe_receiver == null)
      null;
    else {
      // Inline function 'kotlin.let' call
      cont.w25(tmp1_safe_receiver, cause, this.f25_1);
    }
  }
  o26(result, cancelHandler, onCancellation, idempotentResume, cancelCause) {
    return new CompletedContinuation(result, cancelHandler, onCancellation, idempotentResume, cancelCause);
  }
  m25(result, cancelHandler, onCancellation, idempotentResume, cancelCause, $super) {
    result = result === VOID ? this.f25_1 : result;
    cancelHandler = cancelHandler === VOID ? this.g25_1 : cancelHandler;
    onCancellation = onCancellation === VOID ? this.h25_1 : onCancellation;
    idempotentResume = idempotentResume === VOID ? this.i25_1 : idempotentResume;
    cancelCause = cancelCause === VOID ? this.j25_1 : cancelCause;
    return $super === VOID ? this.o26(result, cancelHandler, onCancellation, idempotentResume, cancelCause) : $super.o26.call(this, result, cancelHandler, onCancellation, idempotentResume, cancelCause);
  }
  toString() {
    return 'CompletedContinuation(result=' + toString_0(this.f25_1) + ', cancelHandler=' + toString_0(this.g25_1) + ', onCancellation=' + toString_0(this.h25_1) + ', idempotentResume=' + toString_0(this.i25_1) + ', cancelCause=' + toString_0(this.j25_1) + ')';
  }
  hashCode() {
    var result = this.f25_1 == null ? 0 : hashCode(this.f25_1);
    ...
    result = imul(result, 31) + (this.i25_1 == null ? 0 : hashCode(this.i25_1)) | 0;
    result = imul(result, 31) + (this.j25_1 == null ? 0 : hashCode(this.j25_1)) | 0;
    return result;
  }
  equals(other) {
    if (this === other)
    ...
    if (!(other instanceof CompletedContinuation))
      return false;
    if (!equals(this.f25_1, other.f25_1))
      return false;
    if (!equals(this.g25_1, other.g25_1))
      return false;
...
class LockFreeLinkedListNode {
  ...
  e27(node, permissionsBitmask) {
    var prev = this.c27_1;
    var tmp;
    if (prev instanceof ListClosed) {
      tmp = ((prev.v2j_1 & permissionsBitmask) === 0 && prev.e27(node, permissionsBitmask));
    } else {
      node.b27_1 = this;
      node.c27_1 = prev;
      prev.b27_1 = node;
  ...
  m29(forbiddenElementsBit) {
    this.e27(new ListClosed(forbiddenElementsBit), forbiddenElementsBit);
  }
  f27() {
    if (this.d27_1)
      return false;
...
class JobNode extends LockFreeLinkedListNode {
  ...
  j24() {
    return this.z26().o22(this);
  }
  toString() {
    return get_classSimpleName(this) + '@' + get_hexAddress(this) + '[job@' + get_hexAddress(this.z26()) + ']';
  }
}
class ChildContinuation extends JobNode {
  ...
  i24(cause) {
    this.t26_1.v25(this.t26_1.x25(this.z26()));
  }
}
class CompletableDeferredImpl extends JobSupport {
  ...
  *r23($completion) {
  ...
  j27(value) {
    return this.y22(value);
  }
  k27(exception) {
    return this.y22(new CompletedExceptionally(exception));
  }
}
...
class CompletedExceptionally {
  constructor(cause, handled) {
    ...
    this.n21_1 = cause;
    this.o21_1 = atomic$boolean$1(handled);
  }
  p21() {
    return this.o21_1.kotlinx$atomicfu$value;
  }
  n25() {
    return this.o21_1.atomicfu$compareAndSet(false, true);
  }
  toString() {
    return get_classSimpleName(this) + '[' + this.n21_1.toString() + ']';
  }
}
class CancelledContinuation extends CompletedExceptionally {
  constructor(continuation, cause, handled) {
    ...
    this.i26_1 = atomic$boolean$1(false);
  }
  j26() {
    return this.i26_1.atomicfu$compareAndSet(false, true);
  }
}
...
class CoroutineName extends AbstractCoroutineContextElement {
  ...
  toString() {
    return 'CoroutineName(' + this.v27_1 + ')';
  }
  hashCode() {
...
function invokeOnTimeout(timeMillis, block, context) {
  return get_DefaultDelay().y27(timeMillis, block, context);
}
...
class EventLoop extends CoroutineDispatcher {
  ...
  g28() {
    return this.b28_1 >= delta(this, true);
  }
  h28() {
    var tmp0_safe_receiver = this.d28_1;
    var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : tmp0_safe_receiver.j1();
    return tmp1_elvis_lhs == null ? true : tmp1_elvis_lhs;
  }
  i28(unconfined) {
    this.b28_1 = add(this.b28_1, delta(this, unconfined));
    if (!unconfined)
      this.c28_1 = true;
  }
  j28(unconfined) {
    this.b28_1 = subtract(this.b28_1, delta(this, unconfined));
    if (this.b28_1 > 0n)
      return Unit_instance;
    // Inline function 'kotlinx.coroutines.assert' call
    if (this.c28_1) {
...
class ThreadLocalEventLoop {
  constructor() {
    ...
    this.l28_1 = commonThreadLocal(new Symbol('ThreadLocalEventLoop'));
  }
  m28() {
    var tmp0_elvis_lhs = this.l28_1.o28();
    var tmp;
    if (tmp0_elvis_lhs == null) {
      // Inline function 'kotlin.also' call
      var this_0 = createEventLoop();
      ThreadLocalEventLoop_getInstance().l28_1.p28(this_0);
      tmp = this_0;
    } else {
      tmp = tmp0_elvis_lhs;
    }
...
class CompletionHandlerException extends RuntimeException {
  constructor(message, cause) {
    return new.target.e25(message, cause);
  }
  static e25(message, cause) {
    var $this = this.xd(message, cause);
    captureStack($this, $this.d25_1);
    return $this;
  }
}
class CoroutinesInternalError extends Error_0 {
  constructor(message, cause) {
    return new.target.s28(message, cause);
  }
  static s28(message, cause) {
    var $this = this.ne(message, cause);
    captureStack($this, $this.r28_1);
    return $this;
  }
}
class Key_2 {}
...
class Finishing extends SynchronizedObject {
  constructor(list, isCompleting, rootCause) {
    super();
    this.z28_1 = list;
    this.a29_1 = atomic$boolean$1(isCompleting);
    this.b29_1 = atomic$ref$1(rootCause);
    this.c29_1 = atomic$ref$1(null);
  }
  a27() {
    return this.z28_1;
  }
  t29(value) {
    this.a29_1.kotlinx$atomicfu$value = value;
  }
  p29() {
    return this.a29_1.kotlinx$atomicfu$value;
  }
  z29(value) {
    this.b29_1.kotlinx$atomicfu$value = value;
  }
  s29() {
    return this.b29_1.kotlinx$atomicfu$value;
  }
  q29() {
    return _get_exceptionsHolder__nhszp(this) === get_SEALED();
  }
  d29() {
    return !(this.s29() == null);
  }
  i21() {
    return this.s29() == null;
  }
  e29(proposedException) {
  ...
  r29(exception) {
    ...
    if (eh == null) {
      ...
      if (eh instanceof Error) {
        ...
        if (eh instanceof ArrayList) {
          (eh instanceof ArrayList ? eh : THROW_CCE()).z1(exception);
        } else {
          // Inline function 'kotlin.error' call
          var message = 'State is ' + toString(eh);
          throw IllegalStateException.o(toString(message));
  ...
  toString() {
    return 'Finishing[cancelling=' + this.d29() + ', completing=' + this.p29() + ', rootCause=' + toString_0(this.s29()) + ', exceptions=' + toString_0(_get_exceptionsHolder__nhszp(this)) + ', list=' + this.z28_1.toString() + ']';
  }
}
class ChildCompletion extends JobNode {
  constructor(parent, state, child, proposedUpdate) {
    ...
    this.f2a_1 = state;
    this.g2a_1 = child;
    this.h2a_1 = proposedUpdate;
  }
  u26() {
    return false;
  }
  i24(cause) {
    continueCompleting(this.e2a_1, this.f2a_1, this.g2a_1, this.h2a_1);
  }
}
...
class JobImpl extends JobSupport {
  constructor(parent) {
    super(true);
    this.d21(parent);
    this.r2a_1 = handlesExceptionF(this);
  }
  p22() {
    return true;
  }
...
class Empty {
  ...
  toString() {
    return 'Empty{' + (this.o29_1 ? 'Active' : 'New') + '}';
  }
}
...
class NodeList extends LockFreeLinkedListHead {
  ...
  toString() {
    return get_DEBUG() ? this.v2a('Active') : super.toString();
  }
}
...
class InactiveNodeList {
  ...
  toString() {
    return get_DEBUG() ? this.n29_1.v2a('New') : anyToString(this);
  }
}
...
class InvokeOnCancelling extends JobNode {
  constructor(handler) {
    super();
    this.f2b_1 = handler;
    this.g2b_1 = atomic$boolean$1(false);
  }
  u26() {
    return true;
  }
  i24(cause) {
    if (this.g2b_1.atomicfu$compareAndSet(false, true))
      this.f2b_1(cause);
  }
}
...
class ChildHandleNode extends JobNode {
  ...
  i24(cause) {
    return this.y29_1.t22(this.z26());
  }
  u22(cause) {
    return this.z26().u22(cause);
  }
}
class ResumeAwaitOnCompletion extends JobNode {
  constructor(continuation) {
    super();
    this.q2b_1 = continuation;
  }
  u26() {
    return false;
  }
  i24(cause) {
    var state = this.z26().b22();
    // Inline function 'kotlinx.coroutines.assert' call
    if (state instanceof CompletedExceptionally) {
      var tmp0 = this.q2b_1;
      // Inline function 'kotlin.coroutines.resumeWithException' call
      // Inline function 'kotlin.Companion.failure' call
      var exception = state.n21_1;
      var tmp$ret$2 = _Result___init__impl__xyqfz8(createFailure(exception));
      tmp0.uc(tmp$ret$2);
    } else {
      var tmp0_0 = this.q2b_1;
      // Inline function 'kotlin.coroutines.resume' call
      // Inline function 'kotlin.Companion.success' call
...
class MainCoroutineDispatcher extends CoroutineDispatcher {
  toString() {
    var tmp0_elvis_lhs = this.t2b();
    return tmp0_elvis_lhs == null ? get_classSimpleName(this) + '@' + get_hexAddress(this) : tmp0_elvis_lhs;
  }
  t2b() {
    var main = Dispatchers_getInstance().y2b();
    if (this === main)
...
class TimeoutCancellationException extends CancellationException {
  constructor(message, coroutine) {
    return new.target.i2c(message, coroutine);
  }
  static i2c(message, coroutine) {
    var $this = this.n(message);
    captureStack($this, $this.h2c_1);
    $this.g2c_1 = coroutine;
    return $this;
  }
  w27() {
    var tmp0_elvis_lhs = this.message;
    // Inline function 'kotlin.also' call
    var this_0 = TimeoutCancellationException.i2c(tmp0_elvis_lhs == null ? '' : tmp0_elvis_lhs, this.g2c_1);
...
class ScopeCoroutine extends AbstractCoroutine {
  ...
  s21(state) {
    resumeCancellableWithInternal(intercepted(this.r2c_1), recoverResult(state, this.r2c_1));
  }
  s2c() {
  }
  r21(state) {
    this.r2c_1.uc(recoverResult(state, this.r2c_1));
  }
}
class TimeoutCoroutine extends ScopeCoroutine {
  constructor(time, uCont) {
    super(uCont.sc(), uCont);
    this.n2c_1 = time;
  }
  m26() {
    var delay = get_delay(this.g21_1);
    var tmp0_safe_receiver = this.g21_1.ed(Key_instance_2);
    var name = tmp0_safe_receiver == null ? null : tmp0_safe_receiver.v27_1;
    this.v22(TimeoutCancellationException_0(this.n2c_1, delay, this, name));
  }
  u21() {
    return super.u21() + '(timeMillis=' + this.n2c_1.toString() + ')';
  }
}
class Unconfined extends CoroutineDispatcher {
  ...
  o27(context, block) {
    var yieldContext = context.ed(Key_instance_4);
    if (!(yieldContext == null)) {
      yieldContext.v2c_1 = true;
      return Unit_instance;
    }
    throw UnsupportedOperationException.la('Dispatchers.Unconfined.dispatch function can only be used by the yield function. If you wrap Unconfined dispatcher in your code, make sure you properly delegate isDispatchNeeded and dispatch calls.');
  }
  toString() {
...
class ConcurrentLinkedListNode {
  constructor(prev) {
    this.e2e_1 = atomic$ref$1(null);
    this.f2e_1 = atomic$ref$1(prev);
  }
  g2e() {
  ...
  h2e(value) {
    return this.e2e_1.atomicfu$compareAndSet(null, value);
  }
  i2e() {
    return this.g2e() == null;
  }
  j2e() {
    return this.f2e_1.kotlinx$atomicfu$value;
  }
  k2e() {
    // Inline function 'kotlinx.atomicfu.AtomicRef.lazySet' call
    this.f2e_1.kotlinx$atomicfu$value = null;
  }
  l2e() {
    return this.e2e_1.atomicfu$compareAndSet(null, get_CLOSED());
  }
  d7() {
    // Inline function 'kotlinx.coroutines.assert' call
    if (this.i2e())
    ...
    $l$loop_0: while (true) {
      ...
      if (!(prev === null))
        prev.e2e_1.kotlinx$atomicfu$value = next;
      if (next.b2e() && !next.i2e())
        continue $l$loop_0;
      if (!(prev === null) && prev.b2e())
        continue $l$loop_0;
      return Unit_instance;
    }
  }
...
class Segment extends ConcurrentLinkedListNode {
  constructor(id, prev, pointers) {
    super(prev);
    this.y24_1 = id;
    this.z24_1 = atomic$int$1(pointers << 16);
  }
  b2e() {
    return this.z24_1.kotlinx$atomicfu$value === this.d2d() && !this.i2e();
  }
  c2e() {
    var tmp0 = this.z24_1;
    var tmp$ret$0;
  ...
  d2e() {
    return this.z24_1.atomicfu$addAndGet(-65536) === this.d2d() && !this.i2e();
  }
  a2e() {
    if (this.z24_1.atomicfu$incrementAndGet() === this.d2d()) {
      this.d7();
    }
  }
}
class ChannelSegment extends Segment {
  constructor(id, prev, channel, pointers) {
    ...
    this.a2d_1 = channel;
    this.b2d_1 = atomicfu$AtomicRefArray$ofNulls(imul(get_SEGMENT_SIZE(), 2));
  }
  c2d() {
    return ensureNotNull(this.a2d_1);
  }
  d2d() {
  ...
  f2d(index) {
    return this.b2d_1.atomicfu$get(imul(index, 2)).kotlinx$atomicfu$value;
  }
  g2d(index) {
    // Inline function 'kotlin.also' call
    var this_0 = this.f2d(index);
    this.h2d(index);
    return this_0;
  }
  h2d(index) {
  ...
  i2d(index) {
    return this.b2d_1.atomicfu$get(imul(index, 2) + 1 | 0).kotlinx$atomicfu$value;
  }
  j2d(index, value) {
    this.b2d_1.atomicfu$get(imul(index, 2) + 1 | 0).kotlinx$atomicfu$value = value;
  }
  k2d(index, from, to) {
    return this.b2d_1.atomicfu$get(imul(index, 2) + 1 | 0).atomicfu$compareAndSet(from, to);
  }
  l2d(index, update) {
    return this.b2d_1.atomicfu$get(imul(index, 2) + 1 | 0).atomicfu$getAndSet(update);
  }
  a25(index, cause, context) {
    var isSender = index >= get_SEGMENT_SIZE();
    var index_0 = isSender ? index - get_SEGMENT_SIZE() | 0 : index;
    var element = this.f2d(index_0);
    $l$loop: while (true) {
      var cur = this.i2d(index_0);
      var tmp;
      ...
      if (tmp) {
        ...
        if (this.k2d(index_0, cur, update)) {
          this.h2d(index_0);
          this.y2d(index_0, !isSender);
          if (isSender) {
            var tmp0_safe_receiver = this.c2d().n2d_1;
            if (tmp0_safe_receiver == null)
              null;
            else {
        ...
        if (cur === get_INTERRUPTED_SEND() || cur === get_INTERRUPTED_RCV()) {
          this.h2d(index_0);
          if (isSender) {
            var tmp1_safe_receiver = this.c2d().n2d_1;
            if (tmp1_safe_receiver == null)
              null;
            else {
...
class BufferedChannelIterator {
  constructor($outer) {
    this.o2e_1 = $outer;
    this.m2e_1 = get_NO_RECEIVE_RESULT();
    this.n2e_1 = null;
  }
  *h2f($completion) {
    var tmp;
    if (!(this.m2e_1 === get_NO_RECEIVE_RESULT()) && !(this.m2e_1 === get_CHANNEL_CLOSED())) {
      tmp = true;
    } else {
      var tmp0 = this.o2e_1;
      var tmp$ret$0;
      $l$block_0: {
        ...
        var segment = tmp0.t2d_1.kotlinx$atomicfu$value;
        $l$loop_0: while (true) {
          if (tmp0.r2e()) {
            tmp$ret$0 = onClosedHasNext(this);
            break $l$block_0;
          }
          var r = tmp0.p2d_1.atomicfu$getAndIncrement$long();
  ...
  f26(segment, index) {
    ...
    if (tmp0_safe_receiver == null)
      ...
      tmp0_safe_receiver.f26(segment, index);
    }
  }
  n1() {
    var result = this.m2e_1;
    // Inline function 'kotlin.check' call
    ...
    if (result === get_CHANNEL_CLOSED())
      throw recoverStackTrace_0(_get_receiveException__foorc1(this.o2e_1));
    return result;
  }
  w2e(element) {
    var cont = ensureNotNull(this.n2e_1);
    this.n2e_1 = null;
    this.m2e_1 = element;
    var tmp0_safe_receiver = this.o2e_1.n2d_1;
    return tryResume0(cont, true, tmp0_safe_receiver == null ? null : bindCancellationFun(this.o2e_1, tmp0_safe_receiver, element));
  }
  i2f() {
    var cont = ensureNotNull(this.n2e_1);
    this.n2e_1 = null;
    this.m2e_1 = get_CHANNEL_CLOSED();
    var cause = this.o2e_1.p2e();
    if (cause == null) {
      // Inline function 'kotlin.coroutines.resume' call
      // Inline function 'kotlin.Companion.success' call
...
function close$default(cause, $super) {
  cause = cause === VOID ? null : cause;
  return $super === VOID ? this.f2g(cause) : $super.f2g.call(this, cause);
}
...
class BufferedChannel {
  constructor(capacity, onUndeliveredElement) {
    ...
    this.m2d_1 = capacity;
    this.n2d_1 = onUndeliveredElement;
    // Inline function 'kotlin.require' call
    if (!(this.m2d_1 >= 0)) {
      var message = 'Invalid channel capacity: ' + this.m2d_1 + ', should be >=0';
      throw IllegalArgumentException.h2(toString(message));
    }
    this.o2d_1 = atomic$long$1(0n);
    this.p2d_1 = atomic$long$1(0n);
    this.q2d_1 = atomic$long$1(initialBufferEnd(this.m2d_1));
    this.r2d_1 = atomic$long$1(_get_bufferEndCounter__2d4hee(this));
    var firstSegment = new ChannelSegment(0n, null, this, 3);
    this.s2d_1 = atomic$ref$1(firstSegment);
    this.t2d_1 = atomic$ref$1(firstSegment);
    var tmp = this;
    var tmp_0;
    ...
    tmp_2.v2d_1 = tmp_3;
    this.w2d_1 = atomic$ref$1(get_NO_CLOSE_CAUSE());
    this.x2d_1 = atomic$ref$1(null);
  }
  q2e() {
    // Inline function 'kotlinx.coroutines.channels.sendersCounter' call
    return this.o2d_1.kotlinx$atomicfu$value & 1152921504606846975n;
  }
  t2e() {
    return this.p2d_1.kotlinx$atomicfu$value;
  }
  *v2f(element, $completion) {
    $l$block_5: {
  ...
  w2f(element) {
    if (shouldSendSuspend0(this, this.o2d_1.kotlinx$atomicfu$value))
      return Companion_getInstance_0().x2f();
      ...
      $l$loop_0: while (true) {
        ...
        if (!(segment.y24_1 === id)) {
          ...
          if (tmp0_elvis_lhs == null) {
            var tmp_0;
            if (closed) {
              tmp$ret$0 = Companion_getInstance_0().r2f(this.s2e());
              break $l$block_5;
            } else {
              continue $l$loop_0;
            }
        ...
        switch (access$updateCellSend(this, segment, i, element, s, tmp4, closed)) {
          case 0:
            segment.k2e();
            tmp$ret$0 = Companion_getInstance_0().y2e(Unit_instance);
            break $l$block_5;
          case 1:
            tmp$ret$0 = Companion_getInstance_0().y2e(Unit_instance);
            break $l$block_5;
          case 2:
            ...
            segment.a2e();
            tmp$ret$0 = Companion_getInstance_0().x2f();
            break $l$block_5;
          case 4:
            if (s < this.t2e()) {
              segment.k2e();
  ...
  *y2f($completion) {
    ...
    $l$block_0: {
      // Inline function 'kotlinx.coroutines.channels.BufferedChannel.receiveImpl' call
      var segment = this.t2d_1.kotlinx$atomicfu$value;
      $l$loop_0: while (true) {
        if (this.r2e()) {
          throw recoverStackTrace_0(_get_receiveException__foorc1(this));
        }
        var r = this.p2d_1.atomicfu$getAndIncrement$long();
        // Inline function 'kotlin.Long.div' call
        var other = get_SEGMENT_SIZE();
        var id = divide(r, fromInt(other));
        // Inline function 'kotlin.Long.rem' call
  ...
  p2f(globalCellIndex) {
    ...
    var segment = this.t2d_1.kotlinx$atomicfu$value;
    $l$loop_0: while (true) {
      var r = this.p2d_1.kotlinx$atomicfu$value;
      // Inline function 'kotlin.Long.plus' call
      var other = this.m2d_1;
      ...
      if (!this.p2d_1.atomicfu$compareAndSet(r, tmp$ret$3))
        continue $l$loop_0;
      // Inline function 'kotlin.Long.div' call
      var other_0 = get_SEGMENT_SIZE();
      ...
      if (updCellResult === get_FAILED()) {
        ...
        segment.k2e();
        var tmp1_safe_receiver = this.n2d_1;
  ...
  z2d(globalIndex) {
    ...
    if (inductionVariable < times)
      do {
        ...
        var ebCompleted = this.r2d_1.kotlinx$atomicfu$value & 4611686018427387903n;
    ...
    while (true) {
      ...
      var ebCompletedAndBit = this.r2d_1.kotlinx$atomicfu$value;
      // Inline function 'kotlinx.coroutines.channels.ebCompletedCounter' call
      ...
      if (!pauseExpandBuffers) {
        this.r2d_1.atomicfu$compareAndSet(ebCompletedAndBit, constructEBCompletedAndPauseFlag(ebCompleted_0, true));
      }
    }
  }
  l1() {
  ...
  p2e() {
    var tmp = this.w2d_1.kotlinx$atomicfu$value;
    return (tmp == null ? true : tmp instanceof Error) ? tmp : THROW_CCE();
  }
  s2e() {
    var tmp0_elvis_lhs = this.p2e();
    return tmp0_elvis_lhs == null ? ClosedSendChannelException.d2g('Channel was closed') : tmp0_elvis_lhs;
  }
  e2g() {
  }
  f2g(cause) {
    return this.g2g(cause, false);
  }
  q22(cause) {
    this.i2g(cause);
  }
  i2g(cause) {
    return this.g2g(cause == null ? CancellationException.n('Channel was cancelled') : cause, true);
  }
  g2g(cause, cancel) {
    if (cancel) {
      markCancellationStarted(this);
    }
    var closedByThisOperation = this.w2d_1.atomicfu$compareAndSet(get_NO_CLOSE_CAUSE(), cause);
    if (cancel) {
      markCancelled(this);
    } else {
      markClosed(this);
  ...
  o2f() {
    return _get_isClosedForSend0__kxgf9m(this, this.o2d_1.kotlinx$atomicfu$value);
  }
  r2e() {
    return _get_isClosedForReceive0__f7qknl(this, this.o2d_1.kotlinx$atomicfu$value);
  }
  s2f() {
    $l$loop: while (true) {
      var segment = this.t2d_1.kotlinx$atomicfu$value;
      ...
      if (!(segment.y24_1 === id)) {
        ...
        if (tmp0_elvis_lhs == null) {
          var tmp_0;
          if (this.t2d_1.kotlinx$atomicfu$value.y24_1 < id) {
            return false;
          } else {
            continue $l$loop;
          }
      ...
      this.p2d_1.atomicfu$compareAndSet(r, tmp$ret$2);
    }
  }
  toString() {
    var sb = StringBuilder.h1();
    // Inline function 'kotlinx.coroutines.channels.sendersCloseStatus' call
    var this_0 = this.o2d_1.kotlinx$atomicfu$value;
    ...
    sb.i1('capacity=' + this.m2d_1 + ',');
    sb.i1('data=[');
    // Inline function 'kotlin.collections.filter' call
    var tmp0 = listOf([this.t2d_1.kotlinx$atomicfu$value, this.s2d_1.kotlinx$atomicfu$value, this.u2d_1.kotlinx$atomicfu$value]);
    ...
    append_elements: while (true) {
      ...
      if (inductionVariable < last_0)
        process_cell: do {
          ...
          var cellState = segment.i2d(i);
          var element_0 = segment.f2d(i);
          var tmp;
      ...
      var tmp4_elvis_lhs = segment.g2e();
      var tmp_0;
...
class WaiterEB {
  ...
  toString() {
    return 'WaiterEB(' + toString(this.v2e_1) + ')';
  }
}
...
class Factory {
  constructor() {
    ...
    this.k2g_1 = 2147483647;
    this.l2g_1 = 0;
    this.m2g_1 = -1;
    this.n2g_1 = -2;
    this.o2g_1 = -3;
    this.p2g_1 = 'kotlinx.coroutines.channels.defaultBuffer';
    this.q2g_1 = systemProp('kotlinx.coroutines.channels.defaultBuffer', 64, 1, 2147483646);
  }
}
class Failed {
  toString() {
...
class Closed extends Failed {
  ...
  equals(other) {
    ...
    if (other instanceof Closed) {
      tmp = equals(this.r2g_1, other.r2g_1);
    } else {
      tmp = false;
    }
    return tmp;
  ...
  hashCode() {
    ...
    var tmp0_safe_receiver = this.r2g_1;
    var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : hashCode(tmp0_safe_receiver);
    return tmp1_elvis_lhs == null ? 0 : tmp1_elvis_lhs;
  }
  toString() {
    return 'Closed(' + toString_0(this.r2g_1) + ')';
  }
}
class Companion {
  constructor() {
    Companion_instance_0 = this;
    this.x2e_1 = new Failed();
  }
  y2e(value) {
    return _ChannelResult___init__impl__siwsuf(value);
  }
  x2f() {
    return _ChannelResult___init__impl__siwsuf(this.x2e_1);
  }
  r2f(cause) {
...
class ChannelResult {
  ...
  toString() {
    return ChannelResult__toString_impl_rrcqu7(this.u2f_1);
  }
  hashCode() {
    return ChannelResult__hashCode_impl_lilec2(this.u2f_1);
  }
  equals(other) {
    return ChannelResult__equals_impl_f471ri(this.u2f_1, other);
  }
}
class ClosedReceiveChannelException extends NoSuchElementException {
  constructor(message) {
    return new.target.n2f(message);
  }
  static n2f(message) {
    var $this = this.d2(message);
    captureStack($this, $this.m2f_1);
    return $this;
  }
}
class ClosedSendChannelException extends IllegalStateException {
  constructor(message) {
    return new.target.d2g(message);
  }
  static d2g(message) {
...
class ChannelCoroutine extends AbstractCoroutine {
  ...
  j2g(cause, $super) {
    return this.r22(cause, ($super == null ? true : $super instanceof ChannelCoroutine) ? $super : THROW_CCE());
  }
  s22(cause) {
    var exception = this.i22(cause);
    this.v2g_1.q22(exception);
    this.v22(exception);
  }
  o2f() {
    return this.v2g_1.o2f();
  }
  *v2f(element, $completion) {
    yield* this.v2g_1.v2f(element, $completion);
    return Unit_instance;
  }
  w2f(element) {
    return this.v2g_1.w2f(element);
  }
  f2g(cause) {
    return this.v2g_1.f2g(cause);
  }
  *y2f($completion) {
    return yield* this.v2g_1.y2f($completion);
  }
  l1() {
    return this.v2g_1.l1();
  }
}
class ConflatedBufferedChannel extends BufferedChannel {
  constructor(capacity, onBufferOverflow, onUndeliveredElement) {
    ...
    this.i2h_1 = capacity;
    this.j2h_1 = onBufferOverflow;
    // Inline function 'kotlin.require' call
    if (!!(this.j2h_1 === BufferOverflow_SUSPEND_getInstance())) {
      var message = 'This implementation does not support suspension for senders, use ' + getKClass(BufferedChannel).f1() + ' instead';
      throw IllegalArgumentException.h2(toString(message));
    }
    // Inline function 'kotlin.require' call
    if (!(this.i2h_1 >= 1)) {
      var message_0 = 'Buffered channel capacity must be at least 1, but ' + this.i2h_1 + ' was specified';
      throw IllegalArgumentException.h2(toString(message_0));
    }
  }
  q2f() {
    return this.j2h_1.equals(BufferOverflow_DROP_OLDEST_getInstance());
  }
  *v2f(element, $completion) {
    ...
    if (tmp instanceof Closed) {
      ...
      var tmp0_safe_receiver = this.n2d_1;
      var tmp1_safe_receiver = tmp0_safe_receiver == null ? null : callUndeliveredElementCatchingException(tmp0_safe_receiver, element);
      if (tmp1_safe_receiver == null)
        null;
      else {
        // Inline function 'kotlin.let' call
        addSuppressed(tmp1_safe_receiver, this.s2e());
...
class ProducerCoroutine extends ChannelCoroutine {
  ...
  j21(value) {
    return this.o2h(value instanceof Unit ? value : THROW_CCE());
  }
  k21(cause, handled) {
    var processed = this.v2g_1.f2g(cause);
    if (!processed && !handled) {
      handleCoroutineException(this.g21_1, cause);
    }
  }
  j2g(cause, $super) {
    return this.r22(cause, ($super == null ? true : $super instanceof ProducerCoroutine) ? $super : THROW_CCE());
  }
}
class SegmentOrClosed {
  ...
  toString() {
    return SegmentOrClosed__toString_impl_pzb2an(this.t2f_1);
  }
  hashCode() {
    return SegmentOrClosed__hashCode_impl_4855hs(this.t2f_1);
  }
  equals(other) {
    return SegmentOrClosed__equals_impl_6erq1g(this.t2f_1, other);
  }
}
...
class DispatchedContinuation extends DispatchedTask {
  constructor(dispatcher, continuation) {
    super(-1);
    this.l24_1 = dispatcher;
    this.m24_1 = continuation;
    this.n24_1 = get_UNDEFINED();
    this.o24_1 = threadContextElements(this.sc());
    this.p24_1 = atomic$ref$1(null);
  }
  t24() {
    return !(this.p24_1.kotlinx$atomicfu$value == null);
  }
  t2h() {
    // Inline function 'kotlinx.atomicfu.loop' call
  ...
  q24() {
    ...
    while (true) {
      var state = this_0.kotlinx$atomicfu$value;
      if (state === null) {
        this.p24_1.kotlinx$atomicfu$value = get_REUSABLE_CLAIMED();
        return null;
      } else {
        if (state instanceof CancellableContinuationImpl) {
          if (this.p24_1.atomicfu$compareAndSet(state, get_REUSABLE_CLAIMED())) {
  ...
  b26(continuation) {
    ...
    while (true) {
      var state = this_0.kotlinx$atomicfu$value;
      if (state === get_REUSABLE_CLAIMED()) {
        if (this.p24_1.atomicfu$compareAndSet(get_REUSABLE_CLAIMED(), continuation))
          return null;
      } else {
        if (state instanceof Error) {
          // Inline function 'kotlin.require' call
          // Inline function 'kotlin.require' call
          if (!this.p24_1.atomicfu$compareAndSet(state, null)) {
  ...
  v24(cause) {
    ...
    while (true) {
      ...
      if (equals(state, get_REUSABLE_CLAIMED())) {
        if (this.p24_1.atomicfu$compareAndSet(get_REUSABLE_CLAIMED(), cause))
          return true;
      } else {
        if (state instanceof Error)
          return true;
  ...
  uc(result) {
    ...
    if (safeIsDispatchNeeded(this.l24_1, this.sc())) {
      this.n24_1 = state;
      this.u24_1 = 0;
      safeDispatch(this.l24_1, this.sc(), this);
    } else {
      $l$block: {
        // Inline function 'kotlinx.coroutines.internal.executeUnconfined' call
        // Inline function 'kotlinx.coroutines.assert' call
        var eventLoop = ThreadLocalEventLoop_getInstance().m28();
        if (false && eventLoop.h28()) {
          break $l$block;
        }
        var tmp;
        if (eventLoop.g28()) {
          ...
          try {
            ...
            this.o24_1;
            this.m24_1.uc(result);
            $l$loop: while (eventLoop.e28()) {
            }
          } catch ($p) {
            if ($p instanceof Error) {
              var e = $p;
  ...
  toString() {
    return 'DispatchedContinuation[' + this.l24_1.toString() + ', ' + toDebugString(this.m24_1) + ']';
  }
  sc() {
    return this.m24_1.sc();
  }
}
class DispatchException extends Exception {
  constructor(cause, dispatcher, context) {
    return new.target.u2h(cause, dispatcher, context);
  }
  static u2h(cause, dispatcher, context) {
    var $this = this.de('Coroutine dispatcher ' + dispatcher.toString() + ' threw an exception, context = ' + toString(context), cause);
    captureStack($this, $this.s27_1);
    $this.r27_1 = cause;
    delete $this.cause;
    return $this;
  }
...
class UndeliveredElementException extends RuntimeException {
  constructor(message, cause) {
    return new.target.y2h(message, cause);
  }
  static y2h(message, cause) {
    var $this = this.xd(message, cause);
    captureStack($this, $this.x2h_1);
    return $this;
  }
}
class ContextScope {
  ...
  toString() {
    return 'CoroutineScope(coroutineContext=' + toString(this.z2h_1) + ')';
  }
}
class Symbol {
  constructor(symbol) {
...
class ClauseData {
  e2i(select, internalResult) {
    var tmp0_safe_receiver = this.d2i_1;
    return tmp0_safe_receiver == null ? null : tmp0_safe_receiver(select, this.c2i_1, internalResult);
  }
}
class SelectImplementation {
  g2f(clauseObject, result) {
...
class SetTimeoutBasedDispatcher extends CoroutineDispatcher {
  constructor() {
    super();
    this.o2i_1 = new ScheduledMessageQueue(this);
  }
  o27(context, block) {
    this.o2i_1.w2i(block);
  }
  y27(timeMillis, block, context) {
...
class NodeDispatcher extends SetTimeoutBasedDispatcher {
  ...
  h2i() {
    process.nextTick(this.o2i_1.m2i_1);
  }
}
class MessageQueue {
  constructor() {
    this.p2i_1 = ArrayDeque.bk();
    this.q2i_1 = 16;
    this.r2i_1 = false;
  }
  w2i(element) {
  ...
  x2i(element) {
    return this.p2i_1.z1(element);
  }
  z1(element) {
    return this.x2i((!(element == null) ? isInterface(element, Runnable) : false) ? element : THROW_CCE());
  }
  y2i(index, element) {
    this.p2i_1.o4(index, element);
  }
  o4(index, element) {
    return this.y2i(index, (!(element == null) ? isInterface(element, Runnable) : false) ? element : THROW_CCE());
  }
  z2i(element) {
    return this.p2i_1.j4(element);
  }
  j4(element) {
    if (!(!(element == null) ? isInterface(element, Runnable) : false))
      return false;
    return this.z2i((!(element == null) ? isInterface(element, Runnable) : false) ? element : THROW_CCE());
  }
  a2j(elements) {
    return this.p2i_1.n2(elements);
  }
  n2(elements) {
    return this.a2j(elements);
  }
  b2j(index, elements) {
    return this.p2i_1.k4(index, elements);
  }
  k4(index, elements) {
    return this.b2j(index, elements);
  }
  c2j(elements) {
    return this.p2i_1.l4(elements);
  }
  l4(elements) {
    return this.c2j(elements);
  }
  d2j(elements) {
    return this.p2i_1.m4(elements);
  }
  m4(elements) {
    return this.d2j(elements);
  }
  i4() {
    this.p2i_1.i4();
  }
  e2j(index, element) {
    return this.p2i_1.n4(index, element);
  }
  n4(index, element) {
    return this.e2j(index, (!(element == null) ? isInterface(element, Runnable) : false) ? element : THROW_CCE());
  }
  p4(index) {
    return this.p2i_1.p4(index);
  }
  x3() {
    return this.p2i_1.x3();
  }
  p2(index) {
    return this.p2i_1.p2(index);
  }
  y3(fromIndex, toIndex) {
    return this.p2i_1.y3(fromIndex, toIndex);
  }
  asJsArrayView() {
    return this.p2i_1.asJsArrayView();
  }
  j1() {
    return this.p2i_1.j1();
  }
  f2j(element) {
    return this.p2i_1.t3(element);
  }
  t3(element) {
    if (!(!(element == null) ? isInterface(element, Runnable) : false))
      return false;
  ...
  l1() {
    return this.p2i_1.l1();
  }
  g2j(elements) {
    return this.p2i_1.u3(elements);
  }
  u3(elements) {
    return this.g2j(elements);
  }
  j2(index) {
    return this.p2i_1.j2(index);
  }
  h2j(element) {
    return this.p2i_1.v3(element);
  }
  v3(element) {
    if (!(!(element == null) ? isInterface(element, Runnable) : false))
      return -1;
    return this.h2j((!(element == null) ? isInterface(element, Runnable) : false) ? element : THROW_CCE());
  }
  i2j(element) {
    return this.p2i_1.w3(element);
  }
  w3(element) {
    if (!(!(element == null) ? isInterface(element, Runnable) : false))
      return -1;
  ...
  asJsReadonlyArrayView() {
    return this.p2i_1.asJsReadonlyArrayView();
  }
  l2() {
    return this.p2i_1.yj_1;
  }
}
class ScheduledMessageQueue extends MessageQueue {
  constructor(dispatcher) {
    super();
    this.l2i_1 = dispatcher;
    var tmp = this;
    tmp.m2i_1 = ScheduledMessageQueue$processQueue$lambda(this);
  }
  t2i() {
    this.l2i_1.h2i();
  }
  u2i() {
    setTimeout(this.m2i_1, 0);
  }
  v2i(timeout) {
    setTimeout(this.m2i_1, timeout);
  }
}
class WindowMessageQueue extends MessageQueue {
  constructor(window_0) {
    super();
    this.m2j_1 = window_0;
    this.n2j_1 = 'dispatchCoroutine';
    this.m2j_1.addEventListener('message', WindowMessageQueue$lambda(this), true);
  }
  t2i() {
  ...
  u2i() {
    this.m2j_1.postMessage(this.n2j_1, '*');
  }
}
class Dispatchers {
  constructor() {
    Dispatchers_instance = this;
    this.u2b_1 = createDefaultDispatcher();
    this.v2b_1 = Unconfined_getInstance();
    this.w2b_1 = new JsMainDispatcher(this.u2b_1, false);
    this.x2b_1 = null;
  }
  y2b() {
    var tmp0_elvis_lhs = this.x2b_1;
    return tmp0_elvis_lhs == null ? this.w2b_1 : tmp0_elvis_lhs;
  }
}
class JsMainDispatcher extends MainCoroutineDispatcher {
  constructor(delegate, invokeImmediately) {
    super();
    this.p2j_1 = delegate;
    this.q2j_1 = invokeImmediately;
    this.r2j_1 = this.q2j_1 ? this : new JsMainDispatcher(this.p2j_1, true);
  }
  s2b() {
    return this.r2j_1;
  }
  ...
  o27(context, block) {
    return this.p2j_1.o27(context, block);
  }
  toString() {
    var tmp0_elvis_lhs = this.t2b();
    return tmp0_elvis_lhs == null ? this.p2j_1.toString() : tmp0_elvis_lhs;
  }
}
class JobCancellationException extends CancellationException {
  constructor(message, cause, job) {
    return new.target.l29(message, cause, job);
  }
  static l29(message, cause, job) {
    var $this = this.p(message, cause);
    captureStack($this, $this.k29_1);
    $this.j29_1 = job;
    return $this;
  }
  toString() {
    return super.toString() + '; job=' + toString(this.j29_1);
  }
  equals(other) {
    var tmp;
    if (other === this) {
      ...
      if (tmp_2) {
        tmp_1 = equals(other.j29_1, this.j29_1);
      } else {
        tmp_1 = false;
      }
      if (tmp_1) {
  ...
  hashCode() {
    var tmp = imul(imul(getStringHashCode(ensureNotNull(this.message)), 31) + hashCode(this.j29_1) | 0, 31);
...
class DiagnosticCoroutineContextException extends RuntimeException {
  constructor(context) {
    return new.target.s2h(context);
  }
  static s2h(context) {
    var $this = this.bb(toString(context));
    captureStack($this, $this.r2h_1);
    return $this;
  }
}
class ListClosed extends LockFreeLinkedListNode {
  constructor(forbiddenElementsBitmask) {
    super();
    this.v2j_1 = forbiddenElementsBitmask;
  }
}
...
class ClearTimeout {
  ...
  j24() {
    w3cClearTimeout_0(this.h2k_1);
  }
  i24(cause) {
    this.j24();
  }
  toString() {
    return 'ClearTimeout[' + this.h2k_1 + ']';
  }
}
class WindowClearTimeout extends ClearTimeout {
  ...
  j24() {
    w3cClearTimeout(this.d2k_1.f2k_1, this.h2k_1);
  }
}
class WindowDispatcher extends CoroutineDispatcher {
  constructor(window_0) {
    super();
    this.f2k_1 = window_0;
    this.g2k_1 = new WindowMessageQueue(this.f2k_1);
  }
  o27(context, block) {
    return this.g2k_1.w2i(block);
  }
  x27(timeMillis, continuation) {
    var handle = w3cSetTimeout_0(this.f2k_1, WindowDispatcher$scheduleResumeAfterDelay$lambda(continuation, this), delayToInt(timeMillis));
    invokeOnCancellation(continuation, new WindowClearTimeout(this, handle));
  }
  y27(timeMillis, block, context) {
    var handle = w3cSetTimeout_0(this.f2k_1, Runnable$run$ref(block), delayToInt(timeMillis));
...
function launch(_this__u8e3s4, context, start, block) {
  ...
  var coroutine = start.g23() ? new LazyStandaloneCoroutine(newContext, block) : new StandaloneCoroutine(newContext, true);
  coroutine.v21(start, coroutine, block);
  return coroutine;
}
function async(_this__u8e3s4, context, start, block) {
  ...
  start = start === VOID ? CoroutineStart_DEFAULT_getInstance() : start;
  var newContext = newCoroutineContext(_this__u8e3s4, context);
  var coroutine = start.g23() ? new LazyDeferredCoroutine(newContext, block) : new DeferredCoroutine(newContext, true);
  coroutine.v21(start, coroutine, block);
  return coroutine;
}
function invokeOnCancellation(_this__u8e3s4, handler) {
  ...
  if (_this__u8e3s4 instanceof CancellableContinuationImpl) {
    _this__u8e3s4.g24(handler);
    tmp = Unit_instance;
  } else {
    throw UnsupportedOperationException.la('third-party implementation of CancellableContinuation is not supported');
  }
  return tmp;
}
...
function getOrCreateCancellableContinuation(delegate) {
  ...
  var tmp0_safe_receiver = delegate.q24();
  var tmp;
  if (tmp0_safe_receiver == null) {
    tmp = null;
  } else {
...
function _get_parentHandle__f8dcex($this) {
  return $this.f24_1.kotlinx$atomicfu$value;
}
function _get_stateDebugRepresentation__bf18u4($this) {
  var tmp0_subject = $this.b22();
  var tmp;
...
function isReusable($this) {
  var tmp;
  if (get_isReusableMode($this.u24_1)) {
    var tmp_0 = $this.b24_1;
    tmp = (tmp_0 instanceof DispatchedContinuation ? tmp_0 : THROW_CCE()).t24();
  } else {
    tmp = false;
  }
  return tmp;
...
function cancelLater($this, cause) {
  ...
  return dispatched.v24(cause);
}
function callSegmentOnCancellation($this, segment, cause) {
  // Inline function 'kotlinx.coroutines.index' call
  var index = $this.d24_1.kotlinx$atomicfu$value & 536870911;
  // Inline function 'kotlin.check' call
  if (!!(index === 536870911)) {
  ...
  // Inline function 'kotlinx.coroutines.CancellableContinuationImpl.callCancelHandlerSafely' call
  try {
    segment.a25(index, cause, $this.sc());
  } catch ($p) {
    if ($p instanceof Error) {
      var ex = $p;
      handleCoroutineException($this.sc(), CompletionHandlerException.e25('Exception in invokeOnCancellation handler for ' + $this.toString(), ex));
  ...
  while (true) {
    ...
    switch (cur >> 29) {
      case 0:
        ...
        if ($this.d24_1.atomicfu$compareAndSet(cur, tmp$ret$4))
          return true;
        break;
      case 2:
        return false;
...
function installParentHandle($this) {
  var tmp0_elvis_lhs = $this.sc().ed(Key_instance_3);
  var tmp;
  if (tmp0_elvis_lhs == null) {
    return null;
  } else {
  ...
  $this.f24_1.atomicfu$compareAndSet(null, handle);
  return handle;
}
function invokeOnCancellationImpl($this, handler) {
  ...
  while (true) {
    ...
    if (state instanceof Active) {
      if ($this.e24_1.atomicfu$compareAndSet(state, handler))
        return Unit_instance;
    } else {
      var tmp;
      ...
      if (tmp) {
        ...
        if (state instanceof CompletedExceptionally) {
          ...
          if (state instanceof CancelledContinuation) {
            ...
            var cause = tmp1_safe_receiver == null ? null : tmp1_safe_receiver.n21_1;
            if (isInterface(handler, CancelHandler)) {
              $this.k25(handler, cause);
            } else {
          ...
          if (state instanceof CompletedContinuation) {
            ...
            if (!isInterface(handler, CancelHandler))
              THROW_CCE();
            if (state.l25()) {
              $this.k25(handler, state.j25_1);
              return Unit_instance;
            }
            var update = state.m25(VOID, handler);
            if ($this.e24_1.atomicfu$compareAndSet(state, update))
              return Unit_instance;
          } else {
            if (handler instanceof Segment)
            ...
            if ($this.e24_1.atomicfu$compareAndSet(state, update_0))
              return Unit_instance;
          }
        }
      }
...
function tryResumeImpl($this, proposedUpdate, idempotent, onCancellation) {
  ...
  while (true) {
    ...
    $l$block: {
      if (!(tmp0 == null) ? isInterface(tmp0, NotCompleted) : false) {
        var update = resumedState($this, tmp0, proposedUpdate, $this.u24_1, onCancellation, idempotent);
        if (!$this.e24_1.atomicfu$compareAndSet(tmp0, update)) {
          break $l$block;
        }
        detachChildIfNonReusable($this);
        ...
        if (tmp0 instanceof CompletedContinuation) {
          var tmp;
          if (!(idempotent == null) && tmp0.i25_1 === idempotent) {
            // Inline function 'kotlinx.coroutines.assert' call
...
function recoverResult(state, uCont) {
  ...
  if (state instanceof CompletedExceptionally) {
    // Inline function 'kotlin.Companion.failure' call
    var exception = recoverStackTrace(state.n21_1, uCont);
...
function handleCoroutineException(context, exception) {
  ...
  try {
    var tmp0_safe_receiver = context.ed(Key_instance_1);
    if (tmp0_safe_receiver == null)
      null;
    else {
      // Inline function 'kotlin.let' call
      tmp0_safe_receiver.t27(context, reportException);
      return Unit_instance;
    }
  } catch ($p) {
    if ($p instanceof Error) {
...
function handlerException(originalException, thrownException) {
  ...
  // Inline function 'kotlin.apply' call
  var this_0 = RuntimeException.xd('Exception while trying to handle coroutine exception', thrownException);
...
function CoroutineScope(context) {
  return new ContextScope(!(context.ed(Key_instance_3) == null) ? context : context.qm(Job_0()));
}
function cancel(_this__u8e3s4, cause) {
  cause = cause === VOID ? null : cause;
  var tmp0_elvis_lhs = _this__u8e3s4.h21().ed(Key_instance_3);
  var tmp;
  if (tmp0_elvis_lhs == null) {
    // Inline function 'kotlin.error' call
...
function *delay(timeMillis, $completion) {
  ...
  (yield () => {
    ...
    if (timeMillis < 9223372036854775807n) {
      get_delay(cancellable.sc()).x27(timeMillis, cancellable);
    }
...
function get_delay(_this__u8e3s4) {
  var tmp = _this__u8e3s4.ed(Key_instance);
...
function get_job(_this__u8e3s4) {
  var tmp0_elvis_lhs = _this__u8e3s4.ed(Key_instance_3);
  var tmp;
  if (tmp0_elvis_lhs == null) {
    // Inline function 'kotlin.error' call
...
function cancel_1(_this__u8e3s4, message, cause) {
  cause = cause === VOID ? null : cause;
  return _this__u8e3s4.q22(CancellationException_0(message, cause));
}
function cancel_2(_this__u8e3s4, cause) {
  cause = cause === VOID ? null : cause;
  var tmp0_safe_receiver = _this__u8e3s4.ed(Key_instance_3);
  if (tmp0_safe_receiver == null)
    null;
  else {
    tmp0_safe_receiver.q22(cause);
  }
}
function invokeOnCompletion(_this__u8e3s4, invokeImmediately, handler) {
  ...
  if (_this__u8e3s4 instanceof JobSupport) {
    tmp = _this__u8e3s4.m22(invokeImmediately, handler);
  } else {
    var tmp_0 = handler.u26();
    tmp = _this__u8e3s4.k22(tmp_0, invokeImmediately, JobNode$invoke$ref(handler));
  }
  return tmp;
}
...
function ensureActive_0(_this__u8e3s4) {
  if (!_this__u8e3s4.i21())
    throw _this__u8e3s4.g22();
}
...
function unboxState(_this__u8e3s4) {
  ...
  var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : tmp0_safe_receiver.y28_1;
  return tmp1_elvis_lhs == null ? _this__u8e3s4 : tmp1_elvis_lhs;
}
function _set_exceptionsHolder__tqm22h($this, value) {
  $this.c29_1.kotlinx$atomicfu$value = value;
}
function _get_exceptionsHolder__nhszp($this) {
  return $this.c29_1.kotlinx$atomicfu$value;
}
function allocateList($this) {
  return ArrayList.y1(4);
}
function finalizeFinishingState($this, state, proposedUpdate) {
  ...
  var proposedException = tmp0_safe_receiver == null ? null : tmp0_safe_receiver.n21_1;
  var wasCancelling;
  // Inline function 'kotlinx.coroutines.internal.synchronized' call
  // Inline function 'kotlinx.coroutines.internal.synchronizedImpl' call
  wasCancelling = state.d29();
  var exceptions = state.e29(proposedException);
  ...
  if (!(finalException == null)) {
    var handled = cancelParent($this, finalException) || $this.d23(finalException);
    if (handled) {
      (finalState instanceof CompletedExceptionally ? finalState : THROW_CCE()).n25();
    }
  }
  if (!wasCancelling) {
    $this.a23(finalException);
  }
  $this.m21(finalState);
  var casSuccess = $this.b21_1.atomicfu$compareAndSet(state, boxIncomplete(finalState));
  // Inline function 'kotlinx.coroutines.assert' call
...
function getFinalRootCause($this, state, exceptions) {
  if (exceptions.j1()) {
    if (state.d29()) {
      // Inline function 'kotlinx.coroutines.JobSupport.defaultCancellationException' call
      return JobCancellationException.l29(null == null ? $this.l21() : null, null, $this);
    }
    return null;
  }
  var tmp$ret$1;
  $l$block: {
    ...
    var _iterator__ex2g4s = exceptions.l1();
    while (_iterator__ex2g4s.m1()) {
      var element = _iterator__ex2g4s.n1();
  ...
  var first = exceptions.j2(0);
  if (first instanceof TimeoutCancellationException) {
    var tmp$ret$3;
    $l$block_0: {
      // Inline function 'kotlin.collections.firstOrNull' call
      var _iterator__ex2g4s_0 = exceptions.l1();
...
function addSuppressedExceptions($this, rootCause, exceptions) {
  if (exceptions.l2() <= 1)
    return Unit_instance;
  var seenExceptions = identitySet(exceptions.l2());
  var unwrappedCause = unwrap(rootCause);
  var _iterator__ex2g4s = exceptions.l1();
  while (_iterator__ex2g4s.m1()) {
    var exception = _iterator__ex2g4s.n1();
    ...
    if (tmp_0) {
      tmp = seenExceptions.z1(unwrapped);
    } else {
      tmp = false;
    }
    if (tmp) {
...
function tryFinalizeSimpleState($this, state, update) {
  // Inline function 'kotlinx.coroutines.assert' call
  // Inline function 'kotlinx.coroutines.assert' call
  if (!$this.b21_1.atomicfu$compareAndSet(state, boxIncomplete(update)))
    return false;
  $this.a23(null);
  $this.m21(update);
...
function completeStateFinalization($this, state, update) {
  ...
  if (state instanceof JobNode) {
    try {
      ...
      if ($p instanceof Error) {
        var ex = $p;
        $this.t21(CompletionHandlerException.e25('Exception in completion handler ' + state.toString() + ' for ' + $this.toString(), ex));
      } else {
        throw $p;
      }
    }
  } else {
    var tmp2_safe_receiver = state.a27();
    if (tmp2_safe_receiver == null)
      null;
    else {
      ...
      try {
        ...
        if ($p instanceof Error) {
          ...
          if (tmp_0 == null) {
            ...
            exception = CompletionHandlerException.e25('Exception in completion handler ' + node.toString() + ' for ' + $this.toString(), ex);
          }
        } else {
          throw $p;
        }
...
function cancelParent($this, cause) {
  ...
  return parent.u22(cause) || isCancellation;
}
...
function startInternal($this, state) {
  if (state instanceof Empty) {
    ...
    if (state instanceof InactiveNodeList) {
      if (!$this.b21_1.atomicfu$compareAndSet(state, state.n29_1))
        return -1;
      $this.f22();
      return 1;
    } else {
...
function promoteEmptyToNodeList($this, state) {
  ...
  var update = state.o29_1 ? list : new InactiveNodeList(list);
  $this.b21_1.atomicfu$compareAndSet(state, update);
}
function promoteSingleToNodeList($this, state) {
  state.g27(new NodeList());
  // Inline function 'kotlinx.coroutines.internal.LockFreeLinkedListNode.nextNode' call
  var list = state.b27_1;
  $this.b21_1.atomicfu$compareAndSet(state, list);
}
...
function createCauseException($this, cause) {
  ...
  if (cause == null ? true : cause instanceof Error) {
    ...
    if (cause == null) {
      // Inline function 'kotlinx.coroutines.JobSupport.defaultCancellationException' call
      tmp_0 = JobCancellationException.l29(null == null ? $this.l21() : null, null, $this);
    } else {
      tmp_0 = cause;
    }
    tmp = tmp_0;
  } else {
    tmp = (isInterface(cause, ParentJob) ? cause : THROW_CCE()).x22();
  }
  return tmp;
}
    ...
    $l$block: {
      if (tmp0 instanceof Finishing) {
        ...
        if (notifyRootCause == null)
          ...
          // Inline function 'kotlin.let' call
          notifyCancelling($this, tmp0.z28_1, notifyRootCause);
        }
        return get_COMPLETING_ALREADY();
      } else {
...
function tryMakeCancelling($this, state, rootCause) {
  ...
  if (!$this.b21_1.atomicfu$compareAndSet(state, cancelling))
    return false;
...
function tryMakeCompletingSlowPath($this, state, proposedUpdate) {
  ...
  finishing.t29(true);
  if (!(finishing === state)) {
    if (!$this.b21_1.atomicfu$compareAndSet(state, finishing))
      return get_COMPLETING_RETRY();
  }
  // Inline function 'kotlinx.coroutines.assert' call
  var wasCancelling = finishing.d29();
  var tmp0_safe_receiver = proposedUpdate instanceof CompletedExceptionally ? proposedUpdate : null;
  if (tmp0_safe_receiver == null)
    null;
  else {
    // Inline function 'kotlin.let' call
    finishing.r29(tmp0_safe_receiver.n21_1);
  }
  // Inline function 'kotlin.takeIf' call
  var this_0 = finishing.s29();
  var tmp_0;
  if (!wasCancelling) {
    tmp_0 = this_0;
  } else {
...
function tryWaitForChild($this, state, child, proposedUpdate) {
  ...
  $l$1: do {
    $l$0: do {
      var handle = invokeOnCompletion(child_0.y29_1, false, new ChildCompletion($this_0, state_0, child_0, proposedUpdate_0));
...
function stateString($this, state) {
  var tmp;
  if (state instanceof Finishing) {
    tmp = state.d29() ? 'Cancelling' : state.p29() ? 'Completing' : 'Active';
  } else {
    if (!(state == null) ? isInterface(state, Incomplete) : false) {
      tmp = state.i21() ? 'Active' : 'New';
    } else {
      if (state instanceof CompletedExceptionally) {
        tmp = 'Cancelled';
      } else {
...
function handlesExceptionF($this) {
  ...
  var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : tmp0_safe_receiver.z26();
  var tmp_0;
  if (tmp1_elvis_lhs == null) {
    return false;
  } else {
  ...
  while (true) {
    if (parentJob.c23())
      return true;
    var tmp_1 = parentJob.a22();
    var tmp2_safe_receiver = tmp_1 instanceof ChildHandleNode ? tmp_1 : null;
    var tmp3_elvis_lhs = tmp2_safe_receiver == null ? null : tmp2_safe_receiver.z26();
    var tmp_2;
...
function *withTimeoutOrNull(timeMillis, block, $completion) {
  ...
  try {
    ...
    return yield () => {
      var uCont = $completion;
      var timeoutCoroutine = new TimeoutCoroutine(timeMillis, uCont);
      coroutine._v = timeoutCoroutine;
      return setupTimeout(timeoutCoroutine, block);
    };
  } catch ($p) {
    if ($p instanceof TimeoutCancellationException) {
      var e = $p;
      if (e.g2c_1 === coroutine._v) {
        return null;
      }
      throw e;
    } else {
...
function setupTimeout(coroutine, block) {
  var cont = coroutine.r2c_1;
  var context = cont.sc();
  disposeOnCompletion(coroutine, get_delay(context).y27(coroutine.n2c_1, coroutine, coroutine.g21_1));
...
function TimeoutCancellationException_0(time, delay, coroutine, coroutineName) {
  ...
  if (tmp0_safe_receiver == null) {
    ...
    tmp = tmp0_safe_receiver.z27(tmp$ret$0);
  }
  var tmp1_elvis_lhs = tmp;
  ...
  var message = tmp_0;
  return TimeoutCancellationException.i2c(message, coroutine);
}
...
function setElementLazy($this, index, value) {
  // Inline function 'kotlinx.atomicfu.AtomicRef.lazySet' call
  $this.b2d_1.atomicfu$get(imul(index, 2)).kotlinx$atomicfu$value = value;
}
function onClosedHasNext($this) {
  $this.m2e_1 = get_CHANNEL_CLOSED();
  var tmp0_elvis_lhs = $this.o2e_1.p2e();
  var tmp;
  if (tmp0_elvis_lhs == null) {
    return false;
  } else {
  ...
  return yield () => {
    ...
    try {
      ...
      if (updCellResult === get_SUSPEND()) {
        ...
        $l$block_0: {
          // Inline function 'kotlinx.coroutines.channels.BufferedChannel.receiveImpl' call
          var segment_0 = tmp0.t2d_1.kotlinx$atomicfu$value;
          $l$loop_0: while (true) {
            if (tmp0.r2e()) {
              onClosedHasNextNoWaiterSuspend($this);
              break $l$block_0;
            }
            var r_0 = tmp0.p2d_1.atomicfu$getAndIncrement$long();
            // Inline function 'kotlin.Long.div' call
            var other = get_SEGMENT_SIZE();
            ...
            if (updCellResult_0 === get_SUSPEND()) {
              ...
              segment_0.k2e();
              $this.m2e_1 = updCellResult_0;
              $this.n2e_1 = null;
              var tmp0_safe_receiver = $this.o2e_1.n2d_1;
              cancellable.d26(true, tmp0_safe_receiver == null ? null : bindCancellationFun($this.o2e_1, tmp0_safe_receiver, updCellResult_0));
            }
            break $l$block_0;
          }
        }
        ...
        $this.m2e_1 = updCellResult;
        $this.n2e_1 = null;
        var tmp0_safe_receiver_0 = $this.o2e_1.n2d_1;
        cancellable.d26(true, tmp0_safe_receiver_0 == null ? null : bindCancellationFun($this.o2e_1, tmp0_safe_receiver_0, updCellResult));
      }
    } catch ($p) {
      if ($p instanceof Error) {
        var e = $p;
...
function _get_bufferEndCounter__2d4hee($this) {
  return $this.q2d_1.kotlinx$atomicfu$value;
}
  ...
  (yield () => {
    ...
    $l$block: {
      ...
      if (tmp1_safe_receiver == null)
        ...
        cancellable.uc(tmp$ret$7);
        break $l$block;
      }
      // Inline function 'kotlinx.coroutines.resumeWithStackTrace' call
      var exception_0 = $this.s2e();
      // Inline function 'kotlin.Companion.failure' call
      ...
      switch (updateCellSend(tmp0, tmp2, tmp4, tmp6, s_0, cancellable, false)) {
        ...
        case 5:
          ...
          $l$block_5: {
            ...
            $l$loop_0: while (true) {
              var sendersAndCloseStatusCur = access$_get_sendersAndCloseStatus__tvw29s(tmp0).atomicfu$getAndIncrement$long();
              // Inline function 'kotlinx.coroutines.channels.sendersCounter' call
              var s_1 = sendersAndCloseStatusCur & 1152921504606846975n;
              var closed = access$_get_isClosedForSend0__sm8f7a(tmp0, sendersAndCloseStatusCur);
              // Inline function 'kotlin.Long.div' call
              var other = get_SEGMENT_SIZE();
              ...
              switch (access$updateCellSend(tmp0, segment_0, i, tmp6, s_1, cancellable, closed)) {
                ...
                case 2:
                  ...
                  if (tmp2_safe_receiver == null)
                    ...
                    access$prepareSenderForSuspension(tmp0, tmp2_safe_receiver, segment_0, i);
                  }
...
function prepareSenderForSuspension($this, $receiver, segment, index) {
  $receiver.f26(segment, index + get_SEGMENT_SIZE() | 0);
}
function onClosedSendOnNoWaiterSuspend($this, element, cont) {
  ...
  if (tmp0_safe_receiver == null)
    ...
    callUndeliveredElement(tmp0_safe_receiver, element, cont.sc());
  }
  // Inline function 'kotlin.coroutines.resumeWithException' call
  // Inline function 'kotlin.Companion.failure' call
  var exception = recoverStackTrace($this.s2e(), cont);
  var tmp$ret$1 = _Result___init__impl__xyqfz8(createFailure(exception));
  cont.uc(tmp$ret$1);
}
function updateCellSend($this, segment, index, element, s, waiter, closed) {
  segment.e2d(index, element);
  if (closed)
    return updateCellSendSlow($this, segment, index, element, s, waiter, closed);
  var state = segment.i2d(index);
  if (state === null) {
    if (bufferOrRendezvousSend($this, s)) {
      if (segment.k2d(index, null, get_BUFFERED())) {
        return 1;
      }
    } else {
      if (waiter == null) {
        ...
        if (segment.k2d(index, null, waiter))
          return 2;
      }
    }
  } else {
    if (isInterface(state, Waiter)) {
      ...
      if (tryResumeReceiver($this, state, element)) {
        segment.j2d(index, get_DONE_RCV());
        $this.u2e();
        tmp = 0;
      } else {
        if (!(segment.l2d(index, get_INTERRUPTED_RCV()) === get_INTERRUPTED_RCV())) {
          segment.y2d(index, true);
        }
        tmp = 5;
      }
      return tmp;
  ...
  while (true) {
    ...
    if (state === null) {
      if (bufferOrRendezvousSend($this, s) && !closed) {
        ...
        if (closed) {
          if (segment.k2d(index, null, get_INTERRUPTED_SEND())) {
            segment.y2d(index, false);
            return 4;
          }
        } else if (waiter == null)
          return 3;
        else if (segment.k2d(index, null, waiter))
          return 2;
      }
    } else if (state === get_IN_BUFFER()) {
      if (segment.k2d(index, state, get_BUFFERED())) {
        return 1;
      }
...
function tryResumeReceiver($this, $receiver, element) {
  ...
  if (isInterface($receiver, SelectInstance)) {
    tmp = $receiver.a2f($this, element);
  } else {
    if ($receiver instanceof ReceiveCatching) {
      if (!($receiver instanceof ReceiveCatching))
        THROW_CCE();
      var tmp_0 = Companion_getInstance_0().y2e(element);
      var tmp1_safe_receiver = $this.n2d_1;
      tmp = tryResume0($receiver.z2e_1, new ChannelResult(tmp_0), tmp1_safe_receiver == null ? null : bindCancellationFunResult($this, tmp1_safe_receiver));
    } else {
      if ($receiver instanceof BufferedChannelIterator) {
        if (!($receiver instanceof BufferedChannelIterator))
          THROW_CCE();
        tmp = $receiver.w2e(element);
      } else {
        if (isInterface($receiver, CancellableContinuation)) {
          if (!isInterface($receiver, CancellableContinuation))
            THROW_CCE();
          var tmp2_safe_receiver = $this.n2d_1;
      ...
      if (updCellResult === get_SUSPEND()) {
        ...
        $l$block_0: {
          ...
          $l$loop_0: while (true) {
            ...
            var r_1 = tmp0.p2d_1.atomicfu$getAndIncrement$long();
            // Inline function 'kotlin.Long.div' call
            var other = get_SEGMENT_SIZE();
            ...
            if (updCellResult_0 === get_SUSPEND()) {
              ...
              cancellable.d26(updCellResult_0, onCancellation);
            }
            break $l$block_0;
          }
        }
...
function updateCellReceive($this, segment, index, r, waiter) {
  ...
  if (state === null) {
    // Inline function 'kotlinx.coroutines.channels.sendersCounter' call
    var senders = $this.o2d_1.kotlinx$atomicfu$value & 1152921504606846975n;
    if (r >= senders) {
      if (waiter === null) {
        return get_SUSPEND_NO_WAITER();
      }
      if (segment.k2d(index, state, waiter)) {
        expandBuffer($this);
        return get_SUSPEND();
      }
    }
  } else if (state === get_BUFFERED())
    if (segment.k2d(index, state, get_DONE_RCV())) {
      expandBuffer($this);
      return segment.g2d(index);
    }
...
function updateCellReceiveSlow($this, segment, index, r, waiter) {
  $l$loop: while (true) {
    ...
    if (state === null || state === get_IN_BUFFER()) {
      ...
      var senders = $this.o2d_1.kotlinx$atomicfu$value & 1152921504606846975n;
      if (r < senders) {
        if (segment.k2d(index, state, get_POISONED())) {
          expandBuffer($this);
          return get_FAILED();
        }
      } else {
      ...
      if (segment.k2d(index, state, get_RESUMING_BY_RCV())) {
        ...
        if (tryResumeSender($this, sender, segment, index)) {
          segment.j2d(index, get_DONE_RCV());
          expandBuffer($this);
          tmp_0 = segment.g2d(index);
        } else {
          segment.j2d(index, get_INTERRUPTED_SEND());
          segment.y2d(index, false);
          if (helpExpandBuffer) {
            expandBuffer($this);
          }
  ...
  if (isInterface($receiver, CancellableContinuation)) {
    ...
    if (isInterface($receiver, SelectInstance)) {
      if (!($receiver instanceof SelectImplementation))
        THROW_CCE();
      var trySelectResult = $receiver.g2f($this, Unit_instance);
      ...
      if ($receiver instanceof SendBroadcast) {
        tmp = tryResume0($receiver.c2f_1, true);
      } else {
        // Inline function 'kotlin.error' call
...
function expandBuffer($this) {
  if (_get_isRendezvousOrUnlimited__3mdufi($this))
    return Unit_instance;
  var segment = $this.u2d_1.kotlinx$atomicfu$value;
  try_again: while (true) {
    var b = $this.q2d_1.atomicfu$getAndIncrement$long();
    // Inline function 'kotlin.Long.div' call
    var other = get_SEGMENT_SIZE();
    var id = divide(b, fromInt(other));
    var s = $this.q2e();
    if (s <= b) {
      if (segment.y24_1 < id && !(segment.g2e() == null)) {
...
function updateCellExpandBuffer($this, segment, index, b) {
  ...
  if (!(state == null) ? isInterface(state, Waiter) : false) {
    if (b >= $this.p2d_1.kotlinx$atomicfu$value) {
      if (segment.k2d(index, state, get_RESUMING_BY_EB())) {
        var tmp;
        if (tryResumeSender($this, state, segment, index)) {
          segment.j2d(index, get_BUFFERED());
          tmp = true;
        } else {
          segment.j2d(index, get_INTERRUPTED_SEND());
          segment.y2d(index, false);
...
function updateCellExpandBufferSlow($this, segment, index, b) {
  $l$loop: while (true) {
    ...
    if (!(state == null) ? isInterface(state, Waiter) : false) {
      if (b < $this.p2d_1.kotlinx$atomicfu$value) {
        if (segment.k2d(index, state, new WaiterEB(state)))
          return true;
      } else {
        if (segment.k2d(index, state, get_RESUMING_BY_EB())) {
          var tmp;
      ...
      if (state === get_INTERRUPTED_SEND())
        ...
        if (state === null) {
          if (segment.k2d(index, state, get_IN_BUFFER()))
            return true;
        } else {
...
function incCompletedExpandBufferAttempts($this, nAttempts) {
  ...
  // Inline function 'kotlin.also' call
  // Inline function 'kotlinx.coroutines.channels.ebPauseExpandBuffers' call
  if (!(($this.r2d_1.atomicfu$addAndGet$long(nAttempts) & 4611686018427387904n) === 0n)) {
    $l$loop: while (true) {
      // Inline function 'kotlinx.coroutines.channels.ebPauseExpandBuffers' call
      if (!!(($this.r2d_1.kotlinx$atomicfu$value & 4611686018427387904n) === 0n)) {
        break $l$loop;
      }
    }
  }
...
function _get_receiveException__foorc1($this) {
  var tmp0_elvis_lhs = $this.p2e();
  return tmp0_elvis_lhs == null ? ClosedReceiveChannelException.n2f('Channel was closed') : tmp0_elvis_lhs;
}
...
function completeClose($this, sendersCur) {
  ...
  if ($this.q2f()) {
    ...
    if (!(lastBufferedCellGlobalIndex === -1n)) {
      $this.p2f(lastBufferedCellGlobalIndex);
    }
  }
...
function closeLinkedList($this) {
  var lastSegment = $this.u2d_1.kotlinx$atomicfu$value;
  // Inline function 'kotlin.let' call
  var it = $this.s2d_1.kotlinx$atomicfu$value;
  if (it.y24_1 > lastSegment.y24_1)
    lastSegment = it;
  // Inline function 'kotlin.let' call
  var it_0 = $this.t2d_1.kotlinx$atomicfu$value;
  if (it_0.y24_1 > lastSegment.y24_1)
    lastSegment = it_0;
  ...
  while (true) {
    ...
    if (0 <= inductionVariable)
      do {
        var index = inductionVariable;
        inductionVariable = inductionVariable + -1 | 0;
        var tmp0 = segment.y24_1;
        // Inline function 'kotlin.Long.times' call
        var other = get_SEGMENT_SIZE();
        // Inline function 'kotlin.Long.plus' call
        var this_0 = multiply(tmp0, fromInt(other));
        var globalIndex = add(this_0, fromInt(index));
        if (globalIndex < $this.t2e())
          return -1n;
        cell_update: while (true) {
          var state = segment.i2d(index);
          if (state === null || state === get_IN_BUFFER()) {
            if (segment.k2d(index, state, get_CHANNEL_CLOSED())) {
              segment.a2e();
              break cell_update;
            }
          } else if (state === get_BUFFERED())
    ...
    var tmp0_elvis_lhs = segment.j2e();
    var tmp;
    if (tmp0_elvis_lhs == null) {
      return -1n;
    } else {
...
function removeUnprocessedElements($this, lastSegment) {
  var onUndeliveredElement = $this.n2d_1;
            ...
            if (state === get_BUFFERED()) {
              ...
              if (state === get_IN_BUFFER() || state === null) {
                ...
                if (tmp) {
                  ...
                  if (segment.k2d(index, state, get_CHANNEL_CLOSED())) {
                    if (!(onUndeliveredElement == null)) {
                      var element_0 = segment.f2d(index);
  ...
  $l$block: {
    ...
    if (tmp0_subject == null) {
      ...
      if (!(tmp0_subject instanceof ArrayList)) {
        ...
        var inductionVariable_0 = list.l2() - 1 | 0;
      ...
      do {
        ...
        cell_update: while (true) {
          ...
          if (state === null || state === get_IN_BUFFER()) {
            ...
            if (state instanceof WaiterEB) {
              if (segment.k2d(index, state, get_CHANNEL_CLOSED())) {
                suspendedReceivers = InlineList__plus_impl_nuetvo(suspendedReceivers, state.v2e_1);
                segment.y2d(index, true);
                break cell_update;
              }
            } else {
...
function resumeWaiterOnClosedChannel($this, $receiver, receiver) {
  if ($receiver instanceof SendBroadcast) {
    ...
    if (isInterface($receiver, CancellableContinuation)) {
      // Inline function 'kotlin.coroutines.resumeWithException' call
      // Inline function 'kotlin.Companion.failure' call
      var exception = receiver ? _get_receiveException__foorc1($this) : $this.s2e();
      var tmp$ret$3 = _Result___init__impl__xyqfz8(createFailure(exception));
      $receiver.uc(tmp$ret$3);
    } else {
      if ($receiver instanceof ReceiveCatching) {
        var tmp0 = $receiver.z2e_1;
        // Inline function 'kotlin.coroutines.resume' call
        // Inline function 'kotlin.Companion.success' call
        var value = new ChannelResult(Companion_getInstance_0().r2f($this.p2e()));
        ...
        if ($receiver instanceof BufferedChannelIterator) {
          ...
          if (isInterface($receiver, SelectInstance))
            $receiver.a2f($this, get_CHANNEL_CLOSED());
          else {
            // Inline function 'kotlin.error' call
            var message = 'Unexpected waiter: ' + toString($receiver);
            throw IllegalStateException.o(toString(message));
...
function isClosed($this, sendersAndCloseStatusCur, isClosedForReceive) {
  ...
  switch (convertToInt(shiftRight(sendersAndCloseStatusCur, 60))) {
    ...
    case 2:
      ...
      tmp = isClosedForReceive ? !$this.s2f() : true;
      break;
    case 3:
      // Inline function 'kotlinx.coroutines.channels.sendersCounter' call
...
function findSegmentSend($this, id, startFrom) {
  ...
  if (_SegmentOrClosed___get_isClosed__impl__qmxmlo(it)) {
    completeCloseOrCancel($this);
    var tmp0_0 = startFrom.y24_1;
    // Inline function 'kotlin.Long.times' call
    var other = get_SEGMENT_SIZE();
    if (multiply(tmp0_0, fromInt(other)) < $this.t2e()) {
      startFrom.k2e();
    }
    tmp_0 = null;
  } else {
    ...
    var tmp_1;
    if (segment.y24_1 > id) {
      var tmp0_1 = segment.y24_1;
      // Inline function 'kotlin.Long.times' call
      var other_0 = get_SEGMENT_SIZE();
      var tmp$ret$7 = multiply(tmp0_1, fromInt(other_0));
      updateSendersCounterIfLower($this, tmp$ret$7);
      var tmp0_2 = segment.y24_1;
      // Inline function 'kotlin.Long.times' call
      var other_1 = get_SEGMENT_SIZE();
      if (multiply(tmp0_2, fromInt(other_1)) < $this.t2e()) {
        segment.k2e();
      }
      tmp_1 = null;
    } else {
...
function findSegmentReceive($this, id, startFrom) {
  ...
  if (_SegmentOrClosed___get_isClosed__impl__qmxmlo(it)) {
    ...
    // Inline function 'kotlin.Long.times' call
    var other = get_SEGMENT_SIZE();
    if (multiply(tmp0_0, fromInt(other)) < $this.q2e()) {
      startFrom.k2e();
    }
    tmp_0 = null;
  } else {
    ...
    if (tmp_1) {
      var tmp0_2 = $this.u2d_1;
      $l$block_5: {
        // Inline function 'kotlinx.coroutines.internal.moveForward' call
        // Inline function 'kotlinx.atomicfu.loop' call
        while (true) {
          var cur_0 = tmp0_2.kotlinx$atomicfu$value;
          if (cur_0.y24_1 >= segment.y24_1) {
            break $l$block_5;
          }
          if (!segment.c2e()) {
            break $l$block_5;
...
function findSegmentBufferEnd($this, id, startFrom, currentBufferEndCounter) {
  ...
  if (_SegmentOrClosed___get_isClosed__impl__qmxmlo(it)) {
    ...
    if (segment.y24_1 > id) {
      ...
      if ($this.q2d_1.atomicfu$compareAndSet(tmp_2, tmp$ret$7)) {
        var tmp0_1 = segment.y24_1;
        // Inline function 'kotlin.Long.times' call
        var other_0 = get_SEGMENT_SIZE();
...
function moveSegmentBufferEndToSpecifiedOrLast($this, id, startFrom) {
  ...
  $l$loop: while (segment.y24_1 < id) {
    var tmp0_elvis_lhs = segment.g2e();
    var tmp;
    if (tmp0_elvis_lhs == null) {
      break $l$loop;
    } else {
  ...
  while (true) {
    $l$loop_0: while (segment.b2e()) {
      var tmp1_elvis_lhs = segment.g2e();
      var tmp_0;
      if (tmp1_elvis_lhs == null) {
        break $l$loop_0;
      } else {
...
function updateSendersCounterIfLower($this, value) {
  ...
  while (true) {
    ...
    if ($this.o2d_1.atomicfu$compareAndSet(cur, update))
      return Unit_instance;
  }
  return tmp$ret$0;
}
function updateReceiversCounterIfLower($this, value) {
  ...
  while (true) {
    ...
    if (cur >= value)
      return Unit_instance;
    if ($this.p2d_1.atomicfu$compareAndSet(cur, value))
      return Unit_instance;
  }
  return tmp$ret$0;
}
...
function onCancellationChannelResultImplDoNotCall($this, cause, element, context) {
  callUndeliveredElement(ensureNotNull($this.n2d_1), ensureNotNull(ChannelResult__getOrNull_impl_f5e07h(element)), context);
}
...
function onCancellationImplDoNotCall($this, cause, element, context) {
  callUndeliveredElement(ensureNotNull($this.n2d_1), element, context);
}
...
function BufferedChannel$onUndeliveredElementReceiveCancellationConstructor$lambda$lambda($element, this$0, $select) {
  return (_unused_var__etf5q3, _unused_var__etf5q3_0, _unused_var__etf5q3_1) => {
    ...
    if (!($element === get_CHANNEL_CLOSED())) {
      callUndeliveredElement(this$0.n2d_1, $element, $select.sc());
      tmp = Unit_instance;
    }
    return Unit_instance;
  };
...
function BufferedChannel$onCancellationChannelResultImplDoNotCall$ref(p0) {
  return constructCallableReference((p0_0, p1, p2) => {
    var tmp0 = p0;
    onCancellationChannelResultImplDoNotCall(tmp0, p0_0, p1.u2f_1, p2);
    return Unit_instance;
  }, 3, 0, 13, 'onCancellationChannelResultImplDoNotCall', [p0]);
}
...
function BufferedChannel$onCancellationImplDoNotCall$ref(p0) {
  return constructCallableReference((p0_0, p1, p2) => {
    ...
    return Unit_instance;
  }, 3, 0, 14, 'onCancellationImplDoNotCall', [p0]);
}
...
function tryResume0(_this__u8e3s4, value, onCancellation) {
  ...
  _init_properties_BufferedChannel_kt__d6uc4y();
  // Inline function 'kotlin.let' call
  var token = _this__u8e3s4.w23(value, null, onCancellation);
  var tmp;
  if (!(token == null)) {
    _this__u8e3s4.x23(token);
    tmp = true;
  } else {
    tmp = false;
  }
...
function createSegment(id, prev) {
  _init_properties_BufferedChannel_kt__d6uc4y();
  return new ChannelSegment(id, prev, prev.c2d(), 0);
}
function createSegment$ref() {
  return constructCallableReference((p0, p1) => createSegment(p0, p1), 2, 0, 15, 'createSegment');
}
...
function ChannelResult__exceptionOrNull_impl_16ei30($this) {
  ...
  return tmp0_safe_receiver == null ? null : tmp0_safe_receiver.r2g_1;
}
...
function ChannelResult__equals_impl_f471ri($this, other) {
  if (!(other instanceof ChannelResult))
    return false;
  var tmp0_other_with_cast = other.u2f_1;
...
function Channel(capacity, onBufferOverflow, onUndeliveredElement) {
  ...
  switch (capacity) {
    ...
    case 2147483647:
      ...
      break;
    case -2:
      tmp = onBufferOverflow.equals(BufferOverflow_SUSPEND_getInstance()) ? new BufferedChannel(Factory_getInstance().q2g_1, onUndeliveredElement) : new ConflatedBufferedChannel(1, onBufferOverflow, onUndeliveredElement);
      break;
    default:
...
function cancelConsumed(_this__u8e3s4, cause) {
  ...
  _this__u8e3s4.q22(tmp);
}
function trySendImpl($this, element, isSendOp) {
  return $this.j2h_1 === BufferOverflow_DROP_LATEST_getInstance() ? trySendDropLatest($this, element, isSendOp) : trySendDropOldest($this, element);
}
function trySendDropLatest($this, element, isSendOp) {
  var result = protoOf(BufferedChannel).w2f.call($this, element);
  ...
  return Companion_getInstance_0().y2e(Unit_instance);
}
    ...
    $l$loop_0: while (true) {
      ...
      if (!(segment.y24_1 === id)) {
        ...
        if (tmp0_elvis_lhs == null) {
          var tmp_0;
          if (closed) {
            return Companion_getInstance_0().r2f($this.s2e());
          } else {
            continue $l$loop_0;
          }
        } else {
...
function SegmentOrClosed__equals_impl_6erq1g($this, other) {
  if (!(other instanceof SegmentOrClosed))
    return false;
  var tmp0_other_with_cast = other.t2f_1;
  if (!equals($this, tmp0_other_with_cast))
    return false;
  return true;
}
function _get_nextOrClosed__w0gmuv($this) {
  return $this.e2e_1.kotlinx$atomicfu$value;
}
function _get_aliveSegmentLeft__mr4ndu($this) {
  var cur = $this.j2e();
  while (!(cur === null) && cur.b2e())
    cur = cur.f2e_1.kotlinx$atomicfu$value;
  return cur;
}
function _get_aliveSegmentRight__7ulr0b($this) {
  // Inline function 'kotlinx.coroutines.assert' call
  var cur = ensureNotNull($this.g2e());
  while (cur.b2e()) {
    var tmp0_elvis_lhs = cur.g2e();
    var tmp;
    if (tmp0_elvis_lhs == null) {
      return cur;
    } else {
...
function findSegmentInternal(_this__u8e3s4, id, createNewSegment) {
  _init_properties_ConcurrentLinkedList_kt__5gcgzy();
  var cur = _this__u8e3s4;
  $l$loop: while (cur.y24_1 < id || cur.b2e()) {
    // Inline function 'kotlinx.coroutines.internal.ConcurrentLinkedListNode.nextOrIfClosed' call
    var this_0 = cur;
    // Inline function 'kotlin.let' call
    var it = access$_get_nextOrClosed__ywzond(this_0);
...
function handleUncaughtCoroutineException(context, exception) {
  var _iterator__ex2g4s = get_platformExceptionHandlers().l1();
  while (_iterator__ex2g4s.m1()) {
    var handler = _iterator__ex2g4s.n1();
    try {
      handler.t27(context, exception);
    } catch ($p) {
  ...
  try {
    addSuppressed(exception, DiagnosticCoroutineContextException.s2h(context));
  } catch ($p_0) {
...
function resumeCancellableWithInternal(_this__u8e3s4, result) {
  ...
  if (_this__u8e3s4 instanceof DispatchedContinuation) {
    ...
    var state = toState_0(result);
    if (safeIsDispatchNeeded(_this__u8e3s4.l24_1, _this__u8e3s4.sc())) {
      _this__u8e3s4.n24_1 = state;
      _this__u8e3s4.u24_1 = 1;
      safeDispatch(_this__u8e3s4.l24_1, _this__u8e3s4.sc(), _this__u8e3s4);
    } else {
      $l$block: {
        // Inline function 'kotlinx.coroutines.internal.executeUnconfined' call
        // Inline function 'kotlinx.coroutines.assert' call
        ...
        if (eventLoop.g28()) {
          ...
          try {
            ...
            $l$block_0: {
              ...
              var job = _this__u8e3s4.sc().ed(Key_instance_3);
              if (!(job == null) && !job.i21()) {
                var cause = job.g22();
                _this__u8e3s4.s25(state, cause);
                // Inline function 'kotlin.coroutines.resumeWithException' call
                // Inline function 'kotlin.Companion.failure' call
                var tmp$ret$7 = _Result___init__impl__xyqfz8(createFailure(cause));
                _this__u8e3s4.uc(tmp$ret$7);
                tmp$ret$5 = true;
                break $l$block_0;
              }
              tmp$ret$5 = false;
    ...
    _this__u8e3s4.uc(result);
    tmp = Unit_instance;
  }
  return tmp;
}
function _get_reusableCancellableContinuation__9qex09($this) {
  var tmp = $this.p24_1.kotlinx$atomicfu$value;
  return tmp instanceof CancellableContinuationImpl ? tmp : null;
}
function safeDispatch(_this__u8e3s4, context, runnable) {
  _init_properties_DispatchedContinuation_kt__tnmqc0();
  try {
    _this__u8e3s4.o27(context, runnable);
  } catch ($p) {
    if ($p instanceof Error) {
      var e = $p;
      throw DispatchException.u2h(e, _this__u8e3s4, context);
    } else {
      throw $p;
    }
  }
...
function safeIsDispatchNeeded(_this__u8e3s4, context) {
  _init_properties_DispatchedContinuation_kt__tnmqc0();
  try {
    return _this__u8e3s4.n27(context);
  } catch ($p) {
    if ($p instanceof Error) {
      var e = $p;
      throw DispatchException.u2h(e, _this__u8e3s4, context);
...
function dispatch(_this__u8e3s4, mode) {
  // Inline function 'kotlinx.coroutines.assert' call
  var delegate = _this__u8e3s4.p25();
  ...
  if (tmp_0) {
    tmp = get_isCancellableMode(mode) === get_isCancellableMode(_this__u8e3s4.u24_1);
  } else {
    tmp = false;
  }
  if (tmp) {
    var dispatcher = delegate.l24_1;
    var context = delegate.sc();
...
function resumeUnconfined(_this__u8e3s4) {
  ...
  if (eventLoop.g28()) {
    ...
    eventLoop.i28(true);
    try {
      resume(_this__u8e3s4, _this__u8e3s4.p25(), true);
      $l$loop: while (eventLoop.e28()) {
      }
    } catch ($p) {
      if ($p instanceof Error) {
...
function resume(_this__u8e3s4, delegate, undispatched) {
  var state = _this__u8e3s4.r25();
  var exception = _this__u8e3s4.k26(state);
  var tmp;
  if (!(exception == null)) {
    // Inline function 'kotlin.Companion.failure' call
    tmp = _Result___init__impl__xyqfz8(createFailure(exception));
    ...
    // Inline function 'kotlin.Companion.success' call
    var value = _this__u8e3s4.a26(state);
...
function InlineList__plus_impl_nuetvo($this, element) {
  ...
  if (tmp0_subject == null) {
    ...
    if (tmp0_subject instanceof ArrayList) {
      ...
      (tmp_0 instanceof ArrayList ? tmp_0 : THROW_CCE()).z1(element);
      tmp = _InlineList___init__impl__z8n56(_get_holder__f6h5pd($this));
    } else {
      var list = ArrayList.y1(4);
      list.z1(_get_holder__f6h5pd($this));
      list.z1(element);
  ...
  try {
    ...
    if ($p instanceof Error) {
      ...
      if (!(undeliveredElementException == null) && !(undeliveredElementException.cause === ex)) {
        ...
        return UndeliveredElementException.y2h('Exception in undelivered element handler for ' + toString_0(element), ex);
      }
    } else {
      throw $p;
    }
...
function startUndispatched(_this__u8e3s4, alwaysRethrow, receiver, block) {
  ...
  if (result === get_COROUTINE_SUSPENDED())
    return get_COROUTINE_SUSPENDED();
  var state = _this__u8e3s4.q21(result);
  if (state === get_COMPLETING_WAITING_CHILDREN())
    return get_COROUTINE_SUSPENDED();
  _this__u8e3s4.s2c();
  var tmp_1;
  if (state instanceof CompletedExceptionally) {
    var tmp_2;
    if (alwaysRethrow || notOwnTimeout(_this__u8e3s4, state.n21_1)) {
      throw recoverStackTrace(state.n21_1, _this__u8e3s4.r2c_1);
    } else {
      if (result instanceof CompletedExceptionally) {
        throw recoverStackTrace(result.n21_1, _this__u8e3s4.r2c_1);
      } else {
        tmp_2 = result;
      }
    }
...
function dispatchExceptionAndMakeCompleting(_this__u8e3s4, e) {
  _this__u8e3s4.y22(new CompletedExceptionally(e.r27_1));
  throw recoverStackTrace(e.r27_1, _this__u8e3s4.r2c_1);
}
...
function trySelectInternal($this, clauseObject, internalResult) {
  $l$loop: while (true) {
    var curState = $this.d2f_1.kotlinx$atomicfu$value;
    if (isInterface(curState, CancellableContinuation)) {
      ...
      var clause = tmp;
      var onCancellation = clause.e2i($this, internalResult);
      if ($this.d2f_1.atomicfu$compareAndSet(curState, clause)) {
        var cont = isInterface(curState, CancellableContinuation) ? curState : THROW_CCE();
        $this.f2f_1 = internalResult;
        if (tryResume_0(cont, onCancellation))
          return 0;
        $this.f2f_1 = get_NO_RESULT();
        return 2;
      }
    } else {
      var tmp_0;
      ...
      if (tmp_0)
        ...
        if (equals(curState, get_STATE_CANCELLED()))
          ...
          if (equals(curState, get_STATE_REG())) {
            if ($this.d2f_1.atomicfu$compareAndSet(curState, listOf_0(clauseObject)))
              return 1;
          } else {
            if (isInterface(curState, KtList)) {
              if ($this.d2f_1.atomicfu$compareAndSet(curState, plus_0(curState, clauseObject)))
                return 1;
            } else {
              // Inline function 'kotlin.error' call
...
function tryResume_0(_this__u8e3s4, onCancellation) {
  _init_properties_Select_kt__zhm2jg();
  var tmp0_elvis_lhs = _this__u8e3s4.w23(Unit_instance, null, onCancellation);
  var tmp;
  if (tmp0_elvis_lhs == null) {
    return false;
  } else {
...
function get_classSimpleName(_this__u8e3s4) {
  var tmp0_elvis_lhs = getKClassFromExpression(_this__u8e3s4).f1();
...
function WindowMessageQueue$lambda(this$0) {
  return (event) => {
    var tmp;
    if (event.source == this$0.m2j_1 && event.data == this$0.n2j_1) {
...
function toThrowable(_this__u8e3s4) {
  ...
  return tmp0_elvis_lhs == null ? Exception.ce("Promise resolved with a non-Throwable exception '" + _this__u8e3s4.toString() + "' (type " + toString(getKClassFromExpression(_this__u8e3s4)) + ')') : tmp0_elvis_lhs;
}
...
function newCoroutineContext(_this__u8e3s4, context) {
  var combined = _this__u8e3s4.h21().qm(context);
  return !(combined === Dispatchers_getInstance().u2b_1) && combined.ed(Key_instance) == null ? combined.qm(Dispatchers_getInstance().u2b_1) : combined;
}
function toDebugString(_this__u8e3s4) {
  return toString(_this__u8e3s4);
}
function get_DefaultDelay() {
  var tmp = Dispatchers_getInstance().u2b_1;
...
function _init_properties_CoroutineExceptionHandlerImpl_kt__37d7wf() {
  if (!properties_initialized_CoroutineExceptionHandlerImpl_kt_qhrgvx) {
    ...
    platformExceptionHandlers_ = LinkedHashSet.o2();
  }
}
...
function unsupported() {
  throw UnsupportedOperationException.la('runBlocking event loop is not supported');
}
...
function propagateExceptionFinalResort(exception) {
  ...
  throwAsyncJsError(exception.message, getKClassFromExpression(exception).f1(), stackTraceToString(exception));
  return Unit_instance;
}
...
function SetTimeoutBasedDispatcher$scheduleResumeAfterDelay$lambda($continuation, this$0) {
  return () => {
    // Inline function 'kotlin.with' call
    $continuation.z23(this$0, Unit_instance);
    return Unit_instance;
  };
}
...
protoOf(JobSupport).l22 = invokeOnCompletion$default;
protoOf(JobSupport).r22 = cancel$default;
protoOf(JobSupport).qm = plus;
protoOf(JobSupport).ed = get_0;
...
initMetadataForClass(AbstractCoroutine, 'AbstractCoroutine', VOID, VOID, [Job, Continuation], [0]);
...
initMetadataForClass(DeferredCoroutine, 'DeferredCoroutine', VOID, VOID, [Job], [0]);
...
initMetadataForClass(CancellableContinuationImpl, 'CancellableContinuationImpl', VOID, VOID, [CancellableContinuation, Waiter]);
...
initMetadataForClass(CompletableDeferredImpl, 'CompletableDeferredImpl', VOID, VOID, [Job], [0]);
...
protoOf(CoroutineDispatcher).ed = get;
...
initMetadataForObject(GlobalScope, 'GlobalScope');
...
initMetadataForClass(JobImpl, 'JobImpl', VOID, VOID, [CompletableJob], [0]);
...
initMetadataForClass(ChildHandleNode, 'ChildHandleNode', VOID, VOID, [DisposableHandle]);
...
initMetadataForClass(TimeoutCoroutine, 'TimeoutCoroutine', VOID, VOID, [Runnable], [0]);
...
protoOf(BufferedChannel).h2g = close$default;
protoOf(BufferedChannel).j2g = cancel$default_0;
...
protoOf(ChannelCoroutine).h2g = close$default;
initMetadataForClass(ChannelCoroutine, 'ChannelCoroutine', VOID, VOID, [SendChannel, ReceiveChannel], [1, 0]);
initMetadataForClass(ConflatedBufferedChannel, 'ConflatedBufferedChannel', VOID, VOID, VOID, [1, 0]);
initMetadataForClass(ProducerCoroutine, 'ProducerCoroutine', VOID, VOID, [SendChannel], [1, 0]);
...
initMetadataForClass(DispatchedContinuation, 'DispatchedContinuation', VOID, VOID, [Continuation]);
...
export {
  _ChannelResult___get_isClosed__impl__mg7kuu as _ChannelResult___get_isClosed__impl__mg7kuu3a26on4apn4j4,
  _ChannelResult___get_isSuccess__impl__odq1z9 as _ChannelResult___get_isSuccess__impl__odq1z9t6ktwy0g0q0f,
  Factory_getInstance as Factory_getInstance32nnliw9sj63p,
  Key_instance_1 as Key_instancex2w5ku7ehbar,
  Dispatchers_getInstance as Dispatchers_getInstance20p7pyqnrepag,
  GlobalScope_instance as GlobalScope_instance3w3xrcgjszz2p,
  Key_instance_3 as Key_instancebefxze3q9f64,
  BufferOverflow_DROP_OLDEST_getInstance as BufferOverflow_DROP_OLDEST_getInstanceckq6sjfawt4w,
  BufferOverflow_SUSPEND_getInstance as BufferOverflow_SUSPEND_getInstanceob833ibjouyy,
  CoroutineStart_UNDISPATCHED_getInstance as CoroutineStart_UNDISPATCHED_getInstance2pq896dvru5v1,
  await_0 as await3gx2tubo6ckuc,
  delay as delay3e2ei0hoxjoud,
  withTimeoutOrNull as withTimeoutOrNull3qi35nuwr2k8a,
  cancel$default_0 as cancel$default2imfx8rp1ubvu,
  close$default as close$defaultlxi0kykibhye,
  ...
  CoroutineScope as CoroutineScopelux7s7zphw7e,
  DisposableHandle as DisposableHandle1uzxt8frdchxn,
