...
class Companion {
  constructor() {
    ...
    this.a1i_1 = ByteString.e1i(new Int8Array(0), null);
    this.b1i_1 = toCharArray('0123456789abcdef');
  }
  f1i(byteArray) {
    return ByteString.e1i(byteArray, null);
  }
}
class ByteString {
  static e1i(data, dummy) {
  ...
  static g1i(data, startIndex, endIndex) {
    Companion_getInstance();
    startIndex = startIndex === VOID ? 0 : startIndex;
    endIndex = endIndex === VOID ? data.length : endIndex;
    return this.e1i(copyOfRange(data, startIndex, endIndex), null);
  }
  k2() {
    return this.c1i_1.length;
  }
  equals(other) {
    if (this === other)
      return true;
    ...
    if (!(other instanceof ByteString))
      THROW_CCE();
    if (!(other.c1i_1.length === this.c1i_1.length))
      return false;
    if (!(other.d1i_1 === 0) && !(this.d1i_1 === 0) && !(other.d1i_1 === this.d1i_1))
      return false;
    return contentEquals(this.c1i_1, other.c1i_1);
  }
  hashCode() {
    var hc = this.d1i_1;
    if (hc === 0) {
      hc = contentHashCode(this.c1i_1);
      this.d1i_1 = hc;
    }
    return hc;
  }
  j2(index) {
    ...
    return this.c1i_1[index];
  }
  h1i(startIndex, endIndex) {
    var tmp;
    if (startIndex === endIndex) {
      tmp = Companion_getInstance().a1i_1;
    } else {
      tmp = ByteString.g1i(this.c1i_1, startIndex, endIndex);
    }
    return tmp;
  }
  i1i(startIndex, endIndex, $super) {
    endIndex = endIndex === VOID ? this.k2() : endIndex;
    return $super === VOID ? this.h1i(startIndex, endIndex) : $super.h1i.call(this, startIndex, endIndex);
  }
  j1i(other) {
    if (other === this)
      return 0;
    var localData = this.c1i_1;
    var otherData = other.c1i_1;
  ...
  d(other) {
    return this.j1i(other instanceof ByteString ? other : THROW_CCE());
  }
  toString() {
    if (isEmpty(this)) {
    ...
    if (inductionVariable < last)
      do {
        ...
        inductionVariable = inductionVariable + 1 | 0;
        var b = localData[i];
        $this$with.k1(Companion_getInstance().b1i_1[(b >>> 4 | 0) & 15]);
        $this$with.k1(Companion_getInstance().b1i_1[b & 15]);
      }
       while (inductionVariable < last);
...
class UnsafeByteStringOperations {
  l1i(array) {
    return Companion_getInstance().f1i(array);
  }
}
//endregion
...
function ByteString_0(bytes) {
  ...
  if (bytes.length === 0) {
    ...
    tmp = Companion_getInstance().f1i(bytes);
  }
  return tmp;
}
function decodeToString_0(_this__u8e3s4) {
  return decodeToString(_this__u8e3s4.k1i());
}
