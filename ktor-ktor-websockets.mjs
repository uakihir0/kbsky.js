...
class Companion {
  constructor() {
    ...
    while (_iterator__ex2g4s.m1()) {
      ...
      var tmp$ret$2 = element.n30_1;
      destination.f4(tmp$ret$2, element);
    }
    tmp.o30_1 = destination;
    this.p30_1 = Codes_INTERNAL_ERROR_getInstance();
  }
  q30(code) {
    return this.o30_1.c4(code);
  }
}
...
class CloseReason {
  static t30(code, message) {
    var $this = createThis(this);
    $this.r30_1 = code;
    $this.s30_1 = message;
    return $this;
  }
  static u30(code, message) {
    return this.t30(code.n30_1, message);
  }
  v30() {
    return Companion_getInstance().q30(this.r30_1);
  }
  toString() {
    var tmp0_elvis_lhs = this.v30();
    return 'CloseReason(reason=' + toString(tmp0_elvis_lhs == null ? this.r30_1 : tmp0_elvis_lhs) + ', message=' + this.s30_1 + ')';
  }
  hashCode() {
    var result = this.r30_1;
    result = imul(result, 31) + getStringHashCode(this.s30_1) | 0;
    return result;
  }
  equals(other) {
    if (this === other)
...
function *send(frame, $completion) {
  yield* this.a31().g21(frame, $completion);
...
class Companion_0 {
  constructor() {
    ...
    this.a32_1 = Pong.w32(new Int8Array(0), NonDisposableHandle_instance);
  }
}
class DefaultWebSocketSessionImpl$start$slambda {
  constructor($incomingJob, $outgoingJob, this$0) {
    this.x32_1 = $incomingJob;
    this.y32_1 = $outgoingJob;
    this.z32_1 = this$0;
  }
  *x28($this$launch, $completion) {
    yield* this.x32_1.t1n($completion);
    yield* this.y32_1.t1n($completion);
    this.z32_1.i31_1.x1n();
    return Unit_instance;
  }
  qd(p1, $completion) {
...
class DefaultWebSocketSessionImpl$runIncomingProcessor$slambda {
  ...
  *x28($this$launch, $completion) {
    ...
    try {
          ...
          while (yield* _iterator__ex2g4s.s20($completion)) {
            ...
            $l$block_0: {
              ...
              if (get_isTraceEnabled(this_0)) {
                ...
                this_0.s2h(tmp$ret$5);
              }
              if (e instanceof Close) {
                if (!this.a33_1.a31().z20()) {
                  var tmp = this.a33_1.a31();
                  var tmp1_elvis_lhs = readReason(e);
                  yield* tmp.g21(Close.z31(tmp1_elvis_lhs == null ? get_NORMAL_CLOSE() : tmp1_elvis_lhs), $completion);
                }
                closeFramePresented = true;
                return Unit_instance;
              } else {
                if (e instanceof Pong) {
                  var tmp2_safe_receiver = this.a33_1.g31_1.kotlinx$atomicfu$value;
                  if (tmp2_safe_receiver == null)
                    null;
                  else
                    yield* tmp2_safe_receiver.g21(e, $completion);
                } else {
                  if (e instanceof Ping)
                    yield* this.b33_1.g21(e, $completion);
                  else {
                    yield* /*#__NOINLINE__*/checkMaxFrameSize(this.a33_1, frameBody, e, $completion);
                    if (!e.b32_1) {
                      if (firstFrame == null) {
                        firstFrame = e;
                      }
                      ...
                      writeFully(frameBody, e.d32_1);
                      break $l$block_0;
                    }
                    if (firstFrame == null) {
                      yield* this.a33_1.k31_1.g21(processIncomingExtensions(this.a33_1, e), $completion);
                      break $l$block_0;
                    }
                    writeFully(ensureNotNull(frameBody), e.d32_1);
                    var defragmented = Companion_getInstance_5().d33(true, firstFrame.c32_1, readByteArray(build(frameBody)), firstFrame.f32_1, firstFrame.g32_1, firstFrame.h32_1);
                    firstFrame = null;
                    yield* this.a33_1.k31_1.g21(processIncomingExtensions(this.a33_1, defragmented), $completion);
                  }
                }
              }
            }
      ...
      this.a33_1.k31_1.t21();
      if (!closeFramePresented) {
        yield* close(this.a33_1, CloseReason.u30(Codes_CLOSED_ABNORMALLY_getInstance(), 'Connection was closed without close frame'), $completion);
      }
    }
    return Unit_instance;
  }
...
class DefaultWebSocketSessionImpl$runOutgoingProcessor$slambda {
  ...
  *x28($this$launch, $completion) {
    try {
      yield* /*#__NOINLINE__*/outgoingProcessorLoop(this.e33_1, $completion);
    } catch ($p) {
      if ($p instanceof ClosedSendChannelException) {
        var _unused_var__etf5q3 = $p;
      } else {
        if ($p instanceof ClosedReceiveChannelException) {
          ...
          if ($p instanceof CancellationException) {
            ...
            yield* /*#__NOINLINE__*/sendCloseSequence(this.e33_1, CloseReason.u30(Codes_NORMAL_getInstance(), ''), VOID, $completion);
          } else {
            if ($p instanceof ChannelIOException) {
              ...
              if ($p instanceof Error) {
                var cause = $p;
                this.e33_1.l31_1.w1n(CancellationException.p('Failed to send frame', cause));
                yield* closeExceptionally(this.e33_1.f31_1, cause, $completion);
                return Unit_instance;
              } else {
                throw $p;
              }
      ...
      this.e33_1.l31_1.v21();
      yield* close(this.e33_1.f31_1, VOID, $completion);
    }
    return Unit_instance;
  }
  qd(p1, $completion) {
...
class DefaultWebSocketSessionImpl$runOrCancelPinger$slambda {
  ...
  *g33(it, $completion) {
    yield* /*#__NOINLINE__*/sendCloseSequence(this.f33_1, it, IOException.x1l('Ping timeout'), $completion);
    return Unit_instance;
  }
  qd(p1, $completion) {
    return this.g33(p1 instanceof CloseReason ? p1 : THROW_CCE(), $completion);
  }
}
class DefaultWebSocketSessionImpl {
  constructor(raw, pingIntervalMillis, timeoutMillis, incomingFramesConfig, outgoingFramesConfig) {
    ...
    this.i31_1 = Job();
    this.j31_1 = this.f31_1.n1m().dm(Key_instance).fm(this.i31_1).fm(new CoroutineName('ws-default'));
  ...
  x30(value) {
    this.f31_1.x30(value);
  }
  y30() {
    return this.f31_1.y30();
  }
  w30(negotiatedExtensions) {
    ...
    if (get_isTraceEnabled(this_0)) {
      ...
      this_0.s2h(tmp$ret$2);
    }
    this.n31_1.m2(negotiatedExtensions);
    runOrCancelPinger(this);
    var incomingJob = runIncomingProcessor(this, ponger(this, this.a31()));
  ...
  *s27($completion) {
    yield* this.f31_1.s27($completion);
    return Unit_instance;
  }
}
...
class Companion_1 {
  constructor() {
    ...
    tmp.l33_1 = ensureNotNull(tmp$ret$0).k33_1;
    var tmp_0 = this;
    var tmp_1 = 0;
    var tmp_2 = this.l33_1 + 1 | 0;
    ...
    try {
      ...
      $l$block: {
        ...
        try {
          ...
          while (yield* _iterator__ex2g4s.s20($completion)) {
            var e = _iterator__ex2g4s.n1();
            get_LOGGER().s2h('Received ping message, sending pong message');
            yield* this.o33_1.g21(Pong.w32(e.d32_1), $completion);
          }
          break $l$block;
        } catch ($p) {
          if ($p instanceof Error) {
...
class pinger$slambda$slambda {
  ...
  *x28($this$withTimeoutOrNull, $completion) {
    while (true) {
      yield* this.p33_1.k21($completion);
    }
    return Unit_instance;
  }
  qd(p1, $completion) {
...
class pinger$slambda$slambda_0 {
  constructor($outgoing, $pingMessage, $channel) {
    this.q33_1 = $outgoing;
    this.r33_1 = $pingMessage;
    this.s33_1 = $channel;
  }
  *x28($this$withTimeoutOrNull, $completion) {
    get_LOGGER().s2h('WebSocket Pinger: sending ping frame');
    yield* this.q33_1.g21(Ping.a34(toByteArray(this.r33_1, Charsets_getInstance().v29_1)), $completion);
    $l$loop: while (true) {
      var msg = yield* this.s33_1.k21($completion);
      if (decodeToString(msg.d32_1, 0, 0 + msg.d32_1.length | 0) === this.r33_1) {
        get_LOGGER().s2h('WebSocket Pinger: received valid pong frame ' + msg.toString());
        break $l$loop;
      }
      get_LOGGER().s2h('WebSocket Pinger: received invalid pong frame ' + msg.toString() + ', continue waiting');
    }
    return Unit_instance;
  }
  qd(p1, $completion) {
...
class pinger$slambda {
  constructor($periodMillis, $timeoutMillis, $onTimeout, $channel, $outgoing) {
    this.b34_1 = $periodMillis;
    this.c34_1 = $timeoutMillis;
    this.d34_1 = $onTimeout;
    this.e34_1 = $channel;
    this.f34_1 = $outgoing;
  }
  *x28($this$launch, $completion) {
    get_LOGGER().s2h('Starting WebSocket pinger coroutine with period ' + this.b34_1.toString() + ' ms and timeout ' + this.c34_1.toString() + ' ms');
    var random = Random(getTimeMillis());
    var pingIdBytes = new Int8Array(32);
    try {
      $l$loop: while (true) {
        yield* withTimeoutOrNull(this.b34_1, pinger$slambda$slambda_1(this.e34_1), $completion);
        random.fo(pingIdBytes);
        var pingMessage = '[ping ' + hex(pingIdBytes) + ' ping]';
        var rc = yield* withTimeoutOrNull(this.c34_1, pinger$slambda$slambda_2(this.f34_1, pingMessage, this.e34_1), $completion);
        if (rc == null) {
          get_LOGGER().s2h('WebSocket pinger has timed out');
          yield* this.d34_1(CloseReason.u30(Codes_INTERNAL_ERROR_getInstance(), 'Ping timeout'), $completion);
          break $l$loop;
        }
      }
    } catch ($p) {
...
class Companion_2 {
  constructor() {
    ...
    this_0.d31_1 = this_0.g34();
    this_0.e31_1 = this_0.g34();
    tmp.c31_1 = this_0;
  }
}
class WebSocketChannelsConfig {
  constructor() {
    ...
    this.d31_1 = Companion_getInstance_3().h34_1;
    this.e31_1 = Companion_getInstance_3().h34_1;
  }
  g34() {
    return Companion_getInstance_3().h34_1;
  }
}
class Companion_3 {
  constructor() {
    Companion_instance_3 = this;
    this.h34_1 = new ChannelConfig(2147483647, ChannelOverflow_SUSPEND_getInstance());
  }
}
class ChannelConfig {
  constructor(capacity, onOverflow) {
    ...
    this.i34_1 = capacity;
    this.j34_1 = onOverflow;
  }
  k34() {
    return this.j34_1.equals(ChannelOverflow_SUSPEND_getInstance()) && !(this.i34_1 === 2147483647);
  }
}
...
class BoundedChannel {
  constructor(capacity, delegate) {
    delegate = delegate === VOID ? Companion_instance_4.p34(capacity) : delegate;
    this.q34_1 = delegate;
  }
  r34(element) {
    var result = this.q34_1.h21(element);
    if (!_ChannelResult___get_isSuccess__impl__odq1z9(result) && !_ChannelResult___get_isClosed__impl__mg7kuu(result)) {
      this.r21(ChannelOverflowException.o34('Channel overflowed'));
    }
    return result;
  }
  h21(element) {
    return this.r34(element);
  }
  *s34(element, $completion) {
    yield* this.q34_1.g21(element, $completion);
    return Unit_instance;
  }
  g21(element, $completion) {
    return this.s34(element, $completion);
  }
  r21(cause) {
    return this.q34_1.r21(cause);
  }
  z20() {
    return this.q34_1.z20();
  }
  *t34($completion) {
    return yield* this.q34_1.k21($completion);
  }
  k21($completion) {
    return this.t34($completion);
  }
  l1() {
    return this.q34_1.l1();
  }
  w1n(cause) {
    this.q34_1.w1n(cause);
  }
}
class ChannelOverflowException extends RuntimeException {
  static o34(message) {
    var $this = this.ab(message);
    captureStack($this, $this.n34_1);
    return $this;
  }
}
...
class WebSocketExtensionsConfig {
  constructor() {
    var tmp = this;
    // Inline function 'kotlin.collections.mutableListOf' call
    tmp.w34_1 = ArrayList.n2();
    var tmp_0 = this;
    // Inline function 'kotlin.arrayOf' call
    // Inline function 'kotlin.js.unsafeCast' call
    // Inline function 'kotlin.js.asDynamic' call
    tmp_0.x34_1 = [false, false, false];
  }
  q2l() {
    // Inline function 'kotlin.collections.map' call
    var this_0 = this.w34_1;
...
class WebSocketExtensionHeader {
  constructor(name, parameters) {
    this.y34_1 = name;
    this.z34_1 = parameters;
  }
  toString() {
    return this.y34_1 + ' ' + parametersToString(this);
  }
}
class Frame {
  static i35(fin, frameType, data, disposableHandle, rsv1, rsv2, rsv3) {
    ...
    var $this = createThis(this);
    $this.b32_1 = fin;
    $this.c32_1 = frameType;
    $this.d32_1 = data;
    $this.e32_1 = disposableHandle;
    $this.f32_1 = rsv1;
    $this.g32_1 = rsv2;
    $this.h32_1 = rsv3;
    return $this;
  ...
  toString() {
    return 'Frame ' + this.c32_1.toString() + ' (fin=' + this.b32_1 + ', buffer len = ' + this.d32_1.length + ')';
  }
}
class Binary extends Frame {
  static h35(fin, data, rsv1, rsv2, rsv3) {
    ...
    rsv2 = rsv2 === VOID ? false : rsv2;
    rsv3 = rsv3 === VOID ? false : rsv3;
    return this.i35(fin, FrameType_BINARY_getInstance(), data, NonDisposableHandle_instance, rsv1, rsv2, rsv3);
  }
  static j35(fin, data) {
...
class Text extends Frame {
  static r35(fin, data, rsv1, rsv2, rsv3) {
    rsv1 = rsv1 === VOID ? false : rsv1;
    rsv2 = rsv2 === VOID ? false : rsv2;
    rsv3 = rsv3 === VOID ? false : rsv3;
    return this.i35(fin, FrameType_TEXT_getInstance(), data, NonDisposableHandle_instance, rsv1, rsv2, rsv3);
  }
  static s35(fin, data) {
    return this.r35(fin, data, false, false, false);
  }
  static t35(text) {
    return this.s35(true, toByteArray(text));
  }
}
class Close extends Frame {
  static u35(data) {
    return this.i35(true, FrameType_CLOSE_getInstance(), data, NonDisposableHandle_instance, false, false, false);
  }
  static z31(reason) {
    // Inline function 'io.ktor.utils.io.core.buildPacket' call
    var builder = new Buffer();
    builder.p1k(reason.r30_1);
    writeText(builder, reason.s30_1);
    return this.v35(builder);
  }
  static v35(packet) {
    return this.u35(readByteArray(packet));
  }
  static w35() {
    return this.u35(Companion_getInstance_5().c33_1);
  }
}
class Ping extends Frame {
  static a34(data) {
    return this.i35(true, FrameType_PING_getInstance(), data, NonDisposableHandle_instance, false, false, false);
  }
}
class Pong extends Frame {
  static w32(data, disposableHandle) {
    disposableHandle = disposableHandle === VOID ? NonDisposableHandle_instance : disposableHandle;
    return this.i35(true, FrameType_PONG_getInstance(), data, disposableHandle, false, false, false);
  }
}
class Companion_5 {
  constructor() {
    Companion_instance_5 = this;
    this.c33_1 = new Int8Array(0);
  }
  d33(fin, frameType, data, rsv1, rsv2, rsv3) {
    var tmp;
    switch (frameType.s1_1) {
      case 1:
        tmp = Binary.h35(fin, data, rsv1, rsv2, rsv3);
        break;
      case 0:
        tmp = Text.r35(fin, data, rsv1, rsv2, rsv3);
        break;
      case 2:
        tmp = Close.u35(data);
        break;
...
function DefaultWebSocketSession_0(session, pingIntervalMillis, timeoutMillis, channelsConfig) {
  ...
  channelsConfig = channelsConfig === VOID ? Companion_getInstance_2().c31_1 : channelsConfig;
  _init_properties_DefaultWebSocketSession_kt__469s0y();
  ...
  return new DefaultWebSocketSessionImpl(session, pingIntervalMillis, timeoutMillis, channelsConfig.d31_1, channelsConfig.e31_1);
}
function runIncomingProcessor($this, ponger) {
  var tmp = get_IncomingProcessorCoroutineName().fm(Dispatchers_getInstance().l1x_1);
...
function runOutgoingProcessor($this) {
  var tmp = get_OutgoingProcessorCoroutineName().fm(Dispatchers_getInstance().l1x_1);
...
function *outgoingProcessorLoop($this, $completion) {
  var _iterator__ex2g4s = $this.l31_1.l1();
  $l$loop: while (yield* _iterator__ex2g4s.s20($completion)) {
    var frame = _iterator__ex2g4s.n1();
    // Inline function 'io.ktor.util.logging.trace' call
    var this_0 = get_LOGGER();
    if (get_isTraceEnabled(this_0)) {
      var tmp$ret$1 = 'Sending ' + frame.toString() + ' from session ' + toString($this);
      this_0.s2h(tmp$ret$1);
    }
    var tmp;
    ...
    yield* $this.f31_1.a31().g21(processedFrame, $completion);
  }
  return Unit_instance;
}
function *sendCloseSequence($this, reason, exception, $completion) {
  ...
  $this.i31_1.b1t();
  var reasonToSend = reason == null ? CloseReason.u30(Codes_NORMAL_getInstance(), '') : reason;
  try {
    runOrCancelPinger($this);
    if (!(reasonToSend.r30_1 === Codes_CLOSED_ABNORMALLY_getInstance().n30_1)) {
      yield* $this.f31_1.a31().g21(Close.z31(reasonToSend), $completion);
    }
  }finally {
    $this.h31_1.z1s(reasonToSend);
    if (!(exception == null)) {
      $this.l31_1.r21(exception);
      $this.k31_1.r21(exception);
    }
  }
  return Unit_instance;
}
...
function runOrCancelPinger($this) {
  ...
  if (tmp0_safe_receiver == null)
    ...
    tmp0_safe_receiver.t21();
  var tmp2_safe_receiver = newPinger == null ? null : new ChannelResult(newPinger.h21(Companion_getInstance_0().a32_1));
  if (tmp2_safe_receiver == null)
    null;
  else
    _ChannelResult___get_isSuccess__impl__odq1z9(tmp2_safe_receiver.f21_1);
  if ($this.m31_1.kotlinx$atomicfu$value && !(newPinger == null)) {
    runOrCancelPinger($this);
  }
}
function *checkMaxFrameSize($this, packet, frame, $completion) {
  var tmp = frame.d32_1.length;
  var tmp1_elvis_lhs = packet == null ? null : get_size(packet);
  var size = tmp + (tmp1_elvis_lhs == null ? 0 : tmp1_elvis_lhs) | 0;
  if (fromInt(size) > $this.y30()) {
    if (packet == null)
      null;
    else {
      packet.z6();
    }
    yield* close($this, CloseReason.u30(Codes_TOO_BIG_getInstance(), 'Frame is too big: ' + size + '. Max size is ' + $this.y30().toString()), $completion);
...
function processIncomingExtensions($this, frame) {
  ...
  var _iterator__ex2g4s = $this.m32().l1();
  while (_iterator__ex2g4s.m1()) {
    var element = _iterator__ex2g4s.n1();
...
function DefaultWebSocketSessionImpl$runOrCancelPinger$slambda_0(this$0) {
  ...
  var l = (it, $completion) => i.g33(it, $completion);
  l.$arity = 1;
  return l;
}
...
function _init_properties_DefaultWebSocketSession_kt__469s0y() {
  if (!properties_initialized_DefaultWebSocketSession_kt_6cjlhc) {
    ...
    NORMAL_CLOSE = CloseReason.u30(Codes_NORMAL_getInstance(), 'OK');
...
function readReason(_this__u8e3s4) {
  ...
  return CloseReason.t30(code, message);
}
...
function pinger(_this__u8e3s4, outgoing, periodMillis, timeoutMillis, onTimeout) {
  ...
  var tmp_0 = ensureNotNull(_this__u8e3s4.n1m().dd(Key_instance));
  tmp_0.p1n(pinger$lambda(actorJob));
  return channel;
}
...
function pinger$slambda$slambda_1($channel) {
  ...
  var l = ($this$withTimeoutOrNull, $completion) => i.x28($this$withTimeoutOrNull, $completion);
  l.$arity = 1;
  return l;
}
...
function from(_this__u8e3s4, config) {
  ...
  var tmp;
  if (config.i34_1 === 2147483647) {
    tmp = Channel(2147483647);
  } else if (config.j34_1.equals(ChannelOverflow_SUSPEND_getInstance())) {
    tmp = Channel(config.i34_1, BufferOverflow_SUSPEND_getInstance());
  } else if (config.j34_1.equals(ChannelOverflow_CLOSE_getInstance())) {
    tmp = new BoundedChannel(config.i34_1);
  } else {
    // Inline function 'kotlin.error' call
...
function BoundedChannel$Companion$createDelegate$lambda($channel) {
  return (it) => {
    ...
    if (!tmp_0.z20()) {
      ...
      tmp_1.r21(ChannelOverflowException.o34('Channel overflowed'));
      tmp = Unit_instance;
    }
    return Unit_instance;
  };
...
function parametersToString($this) {
  return $this.z34_1.j1() ? '' : '; ' + joinToString($this.z34_1, ';');
}
...
function *close(_this__u8e3s4, reason, $completion) {
  reason = reason === VOID ? CloseReason.u30(Codes_NORMAL_getInstance(), '') : reason;
  try {
    yield* _this__u8e3s4.b31(Close.z31(reason), $completion);
...
function *closeExceptionally(_this__u8e3s4, cause, $completion) {
  ...
  if (cause instanceof CancellationException) {
    tmp = CloseReason.u30(Codes_NORMAL_getInstance(), '');
  } else {
    tmp = CloseReason.u30(Codes_INTERNAL_ERROR_getInstance(), cause.toString());
  }
  var reason = tmp;
...
protoOf(DefaultWebSocketSessionImpl).b31 = send;
...
protoOf(BoundedChannel).t21 = close$default;
protoOf(BoundedChannel).v21 = cancel$default;
...
initMetadataForClass(Close, 'Close', Close.w35);
