...
class ByteChannel {
  ...
  *z2l(min, $completion) {
    ...
    if (this.z2k_1.k2() >= fromInt(min))
      return true;
    // Inline function 'io.ktor.utils.io.ByteChannel.sleepWhile' call
    var this_0 = this;
    $l$loop: while (add(numberToLong(this.w2k_1), this.z2k_1.k2()) < fromInt(min) && this.b2l_1.kotlinx$atomicfu$value == null) {
      ...
      (yield () => {
        ...
        $l$block_0: {
          ...
          if (!(add(numberToLong(this.w2k_1), this.z2k_1.k2()) < fromInt(min) && this.b2l_1.kotlinx$atomicfu$value == null)) {
    ...
    if (this.z2k_1.k2() < 1048576n) {
      moveFlushToReadBuffer(this);
    }
    return this.z2k_1.k2() >= fromInt(min);
  }
  *g2m($completion) {
    rethrowCloseCauseIfNeeded_0(this);
    this.h2m();
  ...
  h2m() {
    ...
    this.x2k_1;
    var count = convertToInt(this.a2l_1.k2());
...
function buildPartialMatchTable($this) {
  var table = new Int32Array($this.m2m_1.k2());
  var j = 0;
  var inductionVariable = 1;
  var last = $this.m2m_1.k2();
  if (inductionVariable < last)
    do {
      var i = inductionVariable;
      inductionVariable = inductionVariable + 1 | 0;
...
function *readPacket(_this__u8e3s4, packet, $completion) {
  ...
  $l$loop: while (result.k2() < fromInt(packet)) {
    ...
    if (_this__u8e3s4.y2l())
      break $l$loop;
    if (get_remaining(_this__u8e3s4.g2l()) > subtract(numberToLong(packet), result.k2())) {
      _this__u8e3s4.g2l().q1y(result, subtract(numberToLong(packet), result.k2()));
    } else {
      _this__u8e3s4.g2l().r1y(result);
    }
  }
  if (result.k2() < fromInt(packet)) {
    throw EOFException.m1x('Not enough data available, required ' + packet + ' bytes but only ' + result.k2().toString() + ' available');
  }
  return result;
}
...
function get_availableForRead(_this__u8e3s4) {
  return convertToInt(_this__u8e3s4.g2l().n1x().k2());
}
...
function updateConsumed($this) {
  $this.m2n_1 = add($this.m2n_1, subtract($this.l2n_1, $this.k2n_1.k2()));
  $this.l2n_1 = $this.k2n_1.k2();
}
...
function get_size(_this__u8e3s4) {
  return convertToInt(_this__u8e3s4.n1x().k2());
}
