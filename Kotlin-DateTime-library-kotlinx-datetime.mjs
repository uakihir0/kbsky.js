...
class TimeBased extends DateTimeUnit {
  constructor(nanoseconds) {
    super();
    this.k47_1 = nanoseconds;
    // Inline function 'kotlin.require' call
    if (!(this.k47_1 > 0n)) {
      var message = 'Unit duration must be positive, but was ' + this.k47_1.toString() + ' ns.';
      throw IllegalArgumentException.h2(toString(message));
    }
    if (modulo(this.k47_1, 3600000000000n) === 0n) {
      this.l47_1 = 'HOUR';
      this.m47_1 = divide(this.k47_1, 3600000000000n);
    } else {
      if (modulo(this.k47_1, 60000000000n) === 0n) {
        this.l47_1 = 'MINUTE';
        this.m47_1 = divide(this.k47_1, 60000000000n);
      } else {
        var tmp0 = this.k47_1;
        ...
        if (modulo(tmp0, fromInt(other)) === 0n) {
          ...
          tmp.m47_1 = divide(tmp0_0, fromInt(other_0));
        } else {
          // Inline function 'kotlin.Long.rem' call
          var this_0 = this.k47_1;
          if (modulo(this_0, fromInt(1000000)) === 0n) {
            this.l47_1 = 'MILLISECOND';
            var tmp_0 = this;
            // Inline function 'kotlin.Long.div' call
            var this_1 = this.k47_1;
            tmp_0.m47_1 = divide(this_1, fromInt(1000000));
          } else {
            // Inline function 'kotlin.Long.rem' call
            var this_2 = this.k47_1;
            if (modulo(this_2, fromInt(1000)) === 0n) {
              this.l47_1 = 'MICROSECOND';
              var tmp_1 = this;
              // Inline function 'kotlin.Long.div' call
              var this_3 = this.k47_1;
              tmp_1.m47_1 = divide(this_3, fromInt(1000));
            } else {
              this.l47_1 = 'NANOSECOND';
              this.m47_1 = this.k47_1;
            }
          }
        }
      }
  ...
  n47(scalar) {
    return new TimeBased(safeMultiply(this.k47_1, fromInt(scalar)));
  }
  equals(other) {
    var tmp;
    if (this === other) {
  ...
  hashCode() {
    return convertToInt(this.k47_1) ^ convertToInt(shiftRight(this.k47_1, 32));
  }
  toString() {
    return this.o47(this.m47_1, this.l47_1);
  }
}
...
class DayBased extends DateBased {
  constructor(days) {
    ...
    // Inline function 'kotlin.require' call
    if (!(this.q47_1 > 0)) {
      var message = 'Unit duration must be positive, but was ' + this.q47_1 + ' days.';
      throw IllegalArgumentException.h2(toString(message));
    }
  }
  n47(scalar) {
    return new DayBased(safeMultiply_0(this.q47_1, scalar));
  }
  equals(other) {
    var tmp;
    if (this === other) {
  ...
  hashCode() {
    return this.q47_1 ^ 65536;
  }
  toString() {
    return (this.q47_1 % 7 | 0) === 0 ? this.p47(this.q47_1 / 7 | 0, 'WEEK') : this.p47(this.q47_1, 'DAY');
  }
}
class MonthBased extends DateBased {
  constructor(months) {
    ...
    // Inline function 'kotlin.require' call
    if (!(this.r47_1 > 0)) {
      var message = 'Unit duration must be positive, but was ' + this.r47_1 + ' months.';
      throw IllegalArgumentException.h2(toString(message));
    }
  }
  n47(scalar) {
    return new MonthBased(safeMultiply_0(this.r47_1, scalar));
  }
  equals(other) {
    var tmp;
    if (this === other) {
  ...
  hashCode() {
    return this.r47_1 ^ 131072;
  }
  toString() {
    return (this.r47_1 % 1200 | 0) === 0 ? this.p47(this.r47_1 / 1200 | 0, 'CENTURY') : (this.r47_1 % 12 | 0) === 0 ? this.p47(this.r47_1 / 12 | 0, 'YEAR') : (this.r47_1 % 3 | 0) === 0 ? this.p47(this.r47_1 / 3 | 0, 'QUARTER') : this.p47(this.r47_1, 'MONTH');
  }
}
class Companion_3 {
  constructor() {
    Companion_instance_4 = this;
    this.s47_1 = new TimeBased(1n);
    this.t47_1 = this.s47_1.n47(1000);
    this.u47_1 = this.t47_1.n47(1000);
    this.v47_1 = this.u47_1.n47(1000);
    this.w47_1 = this.v47_1.n47(60);
    this.x47_1 = this.w47_1.n47(60);
    this.y47_1 = new DayBased(1);
    this.z47_1 = this.y47_1.n47(7);
    this.a48_1 = new MonthBased(1);
    this.b48_1 = this.a48_1.n47(3);
    this.c48_1 = this.a48_1.n47(12);
    this.d48_1 = this.c48_1.n47(100);
  }
}
...
class IllegalTimeZoneException extends IllegalArgumentException {
  ...
  static s48(cause) {
    var $this = this.zd(cause);
    init_kotlinx_datetime_IllegalTimeZoneException($this);
    return $this;
  }
  static t48(message, cause) {
    var $this = this.yd(message, cause);
    init_kotlinx_datetime_IllegalTimeZoneException($this);
    return $this;
  }
...
class AbstractDateTimeFormat {
  b49(value) {
    ...
    this.g49().n49().o49(this.h49(value), this_0);
    return this_0.toString();
  }
  vr(input) {
    var tmp;
    try {
      tmp = Parser__match$default_impl_x2xlti(_Parser___init__impl__gdyfby(this.g49().p49()), input, this.j49());
    } catch ($p) {
      var tmp_0;
      if ($p instanceof ParseException) {
        var e = $p;
        throw DateTimeFormatException.l48("Failed to parse value from '" + toString(input) + "'", e);
      } else {
        throw $p;
      }
    }
    var matched = tmp;
    try {
      return this.i49(matched);
    } catch ($p) {
      if ($p instanceof IllegalArgumentException) {
        var e_0 = $p;
        var message = e_0.message;
        throw DateTimeFormatException.l48(message == null ? "The value parsed from '" + toString(input) + "' is invalid" : '' + message + " (when parsing '" + toString(input) + "')", e_0);
      } else {
        throw $p;
      }
    }
...
function year$default(padding, $super) {
  ...
  if ($super === VOID) {
    ...
    tmp = $super.q49.call(this, padding);
  }
  return tmp;
}
function monthNumber$default(padding, $super) {
  ...
  if ($super === VOID) {
    ...
    tmp = $super.s49.call(this, padding);
  }
  return tmp;
}
class WithDate {}
function day$default(padding, $super) {
  ...
  if ($super === VOID) {
    ...
    tmp = $super.v49.call(this, padding);
  }
  return tmp;
}
class WithTime {}
...
function minute$default(padding, $super) {
  ...
  if ($super === VOID) {
    ...
    tmp = $super.a4a.call(this, padding);
  }
  return tmp;
}
function second$default(padding, $super) {
  ...
  if ($super === VOID) {
    ...
    tmp = $super.c4a.call(this, padding);
  }
  return tmp;
}
class WithUtcOffset {}
...
function offsetSecondsOfMinute$default(padding, $super) {
  ...
  if ($super === VOID) {
    ...
    tmp = $super.k4a.call(this, padding);
  }
  return tmp;
}
...
function appendAlternativeParsingImpl(otherFormats, mainFormat) {
  ...
  var destination = ArrayList.y1(otherFormats.length);
  ...
  var this_1 = this.p4a();
  mainFormat(this_1);
  var main = this_1.o4a().x2k();
  this.o4a().r4a(new AlternativesParsingFormatStructure(main, others));
}
function appendOptionalImpl(onZero, format) {
  ...
  var this_0 = this.p4a();
  format(this_0);
  tmp.r4a(new OptionalFormatStructure(onZero, this_0.o4a().x2k()));
}
function chars(value) {
  return this.o4a().r4a(new ConstantFormatStructure(value));
}
function build() {
  return new CachedFormatStructure(this.o4a().x2k().s4a_1);
}
class IncompleteLocalDate {
  constructor(yearMonth, day, dayOfWeek, dayOfYear) {
    ...
    this.u4a_1 = yearMonth;
    this.v4a_1 = day;
    this.w4a_1 = dayOfWeek;
    this.x4a_1 = dayOfYear;
  }
  y4a(_set____db54di) {
    this.v4a_1 = _set____db54di;
  }
  z4a() {
    return this.v4a_1;
  }
  ...
  c4b(_set____db54di) {
    this.x4a_1 = _set____db54di;
  }
  d4b() {
    return this.x4a_1;
  }
  e4b() {
    var year = requireParsedField(this.f4b(), 'year');
    var dayOfYear = this.x4a_1;
    var tmp;
    if (dayOfYear == null) {
      tmp = new LocalDate(year, requireParsedField(this.k4b(), 'monthNumber'), requireParsedField(this.v4a_1, 'day'));
    } else {
      // Inline function 'kotlin.also' call
      var this_0 = plus_0(new LocalDate(year, 1, 1), dayOfYear - 1 | 0, Companion_getInstance_4().y47_1);
      if (!(this_0.g4b_1 === year)) {
        throw DateTimeFormatException.k48('Can not create a LocalDate from the given input: ' + ('the day of year is ' + dayOfYear + ', which is not a valid day of year for the year ' + year));
      }
      if (!(this.k4b() == null) && !(get_number(this_0.j4b()) === this.k4b())) {
        throw DateTimeFormatException.k48('Can not create a LocalDate from the given input: ' + ('the day of year is ' + dayOfYear + ', which is ' + this_0.j4b().toString() + ', ') + ('but ' + this.k4b() + ' was specified as the month number'));
      }
      if (!(this.v4a_1 == null) && !(this_0.h4b_1 === this.v4a_1)) {
        throw DateTimeFormatException.k48('Can not create a LocalDate from the given input: ' + ('the day of year is ' + dayOfYear + ', which is the day ' + this_0.h4b_1 + ' of ' + this_0.j4b().toString() + ', ') + ('but ' + this.v4a_1 + ' was specified as the day of month'));
      }
      tmp = this_0;
    }
    var date = tmp;
    var tmp0_safe_receiver = this.w4a_1;
    if (tmp0_safe_receiver == null)
      null;
    else {
      // Inline function 'kotlin.let' call
      if (!(tmp0_safe_receiver === get_isoDayNumber(date.b4b()))) {
        throw DateTimeFormatException.k48('Can not create a LocalDate from the given input: ' + ('the day of week is ' + DayOfWeek_0(tmp0_safe_receiver).toString() + ' but the date is ' + date.toString() + ', which is a ' + date.b4b().toString()));
      }
    }
    return date;
  }
  l4b(date) {
    this.m4b(date.g4b_1);
    this.n4b(get_number(date.j4b()));
    this.v4a_1 = date.h4b_1;
    this.w4a_1 = get_isoDayNumber(date.b4b());
    this.x4a_1 = date.d4b();
  }
  o4b() {
    return new IncompleteLocalDate(this.u4a_1.o4b(), this.v4a_1, this.w4a_1, this.x4a_1);
  }
  equals(other) {
    var tmp;
    var tmp_0;
    ...
    if (other instanceof IncompleteLocalDate) {
      tmp_2 = this.u4a_1.equals(other.u4a_1);
    } else {
      tmp_2 = false;
    }
    if (tmp_2) {
      tmp_1 = this.v4a_1 == other.v4a_1;
    } else {
      tmp_1 = false;
    }
    if (tmp_1) {
      tmp_0 = this.w4a_1 == other.w4a_1;
    } else {
      tmp_0 = false;
    }
    if (tmp_0) {
      tmp = this.x4a_1 == other.x4a_1;
    } else {
      tmp = false;
    }
    return tmp;
  ...
  toString() {
    var tmp;
    if (this.x4a_1 == null) {
      var tmp_0 = this.u4a_1.toString();
      var tmp0_elvis_lhs = this.v4a_1;
      var tmp_1 = toString(tmp0_elvis_lhs == null ? '??' : tmp0_elvis_lhs);
      var tmp1_elvis_lhs = this.w4a_1;
      tmp = tmp_0 + '-' + tmp_1 + ' (day of week is ' + toString(tmp1_elvis_lhs == null ? '??' : tmp1_elvis_lhs) + ')';
    } else if (this.v4a_1 == null && this.k4b() == null) {
      var tmp2_elvis_lhs = this.u4a_1.p4b_1;
      var tmp_2 = toString(tmp2_elvis_lhs == null ? '??' : tmp2_elvis_lhs);
      var tmp_3 = this.x4a_1;
      var tmp3_elvis_lhs = this.w4a_1;
      tmp = '(' + tmp_2 + ')-' + tmp_3 + ' (day of week is ' + toString(tmp3_elvis_lhs == null ? '??' : tmp3_elvis_lhs) + ')';
    } else {
      var tmp_4 = this.u4a_1.toString();
      var tmp4_elvis_lhs = this.v4a_1;
      var tmp_5 = toString(tmp4_elvis_lhs == null ? '??' : tmp4_elvis_lhs);
      var tmp5_elvis_lhs = this.w4a_1;
      tmp = tmp_4 + '-' + tmp_5 + ' (day of week is ' + toString(tmp5_elvis_lhs == null ? '??' : tmp5_elvis_lhs) + ', day of year is ' + this.x4a_1 + ')';
    }
    return tmp;
  }
  m4b(_set____db54di) {
    this.u4a_1.p4b_1 = _set____db54di;
  }
  f4b() {
    return this.u4a_1.p4b_1;
  }
  n4b(_set____db54di) {
    this.u4a_1.q4b_1 = _set____db54di;
  }
  k4b() {
    return this.u4a_1.q4b_1;
  }
}
class Companion_5 {
  r4b(block) {
    ...
    block(builder);
    return new LocalDateFormat(builder.x2k());
  }
}
class AbstractWithYearMonthBuilder {}
function year(padding) {
  return this.u4b(new BasicFormatStructure(new YearDirective(padding)));
}
function monthNumber(padding) {
  return this.u4b(new BasicFormatStructure(new MonthDirective(padding)));
}
...
function day(padding) {
  return this.t4b(new BasicFormatStructure(new DayDirective(padding)));
}
function date(format) {
  var tmp;
  if (format instanceof LocalDateFormat) {
    this.t4b(format.v4b_1);
    tmp = Unit_instance;
  }
  return tmp;
}
class Builder {
  constructor(actualBuilder) {
    this.s4b_1 = actualBuilder;
  }
  o4a() {
    return this.s4b_1;
  }
  t4b(structure) {
    return this.s4b_1.r4a(structure);
  }
  p4a() {
...
class LocalDateFormat extends AbstractDateTimeFormat {
  ...
  h49(value) {
    return this.w4b(value instanceof LocalDate ? value : THROW_CCE());
  }
  x4b(intermediate) {
    return intermediate.e4b();
  }
  i49(intermediate) {
    return this.x4b(intermediate instanceof IncompleteLocalDate ? intermediate : THROW_CCE());
  }
  j49() {
...
class UnsignedIntFieldFormatDirective {
  constructor(field, minDigits, spacePadding) {
    this.g4c_1 = field;
    this.h4c_1 = minDigits;
    this.i4c_1 = spacePadding;
    this.j4c_1 = this.g4c_1.n4i_1;
    // Inline function 'kotlin.require' call
    if (!(this.h4c_1 >= 0)) {
      var message = 'The minimum number of digits (' + this.h4c_1 + ') is negative';
      throw IllegalArgumentException.h2(toString(message));
    }
    // Inline function 'kotlin.require' call
    if (!(this.j4c_1 >= this.h4c_1)) {
      var message_0 = 'The maximum number of digits (' + this.j4c_1 + ') is less than the minimum number of digits (' + this.h4c_1 + ')';
      throw IllegalArgumentException.h2(toString(message_0));
    }
    if (!(this.i4c_1 == null)) {
      // Inline function 'kotlin.require' call
      if (!(this.i4c_1 > this.h4c_1)) {
        var message_1 = 'The space padding (' + this.i4c_1 + ') should be more than the minimum number of digits (' + this.h4c_1 + ')';
  ...
  n49() {
    var formatter = new UnsignedIntFormatterStructure(Accessor$getterNotNull$ref(this.g4c_1.h4i_1), this.h4c_1);
    return !(this.i4c_1 == null) ? new SpacePaddedFormatter(formatter, this.i4c_1) : formatter;
  }
  p49() {
    return spaceAndZeroPaddedUnsignedInt(this.h4c_1, this.j4c_1, this.i4c_1, this.g4c_1.h4i_1, this.g4c_1.k4i_1);
  }
}
class DayDirective extends UnsignedIntFieldFormatDirective {
  constructor(padding) {
    var tmp = DateFields_getInstance().y4b_1;
  ...
  equals(other) {
    ...
    if (other instanceof DayDirective) {
      tmp = this.f4c_1.equals(other.f4c_1);
    } else {
      tmp = false;
    }
    return tmp;
...
class DateFields {
  constructor() {
    ...
    tmp.y4b_1 = new UnsignedFieldSpec(new PropertyAccessor(getPropertyCallableRef('day', 1, tmp_0, tmp_1, DateFieldContainer$_set_day_$ref_s0jsax())), 1, 31);
    var tmp_2 = this;
    var tmp_3 = KMutableProperty1;
    var tmp_4 = DateFieldContainer$_get_dayOfWeek_$ref_thwqom();
    tmp_2.z4b_1 = new UnsignedFieldSpec(new PropertyAccessor(getPropertyCallableRef('dayOfWeek', 1, tmp_3, tmp_4, DateFieldContainer$_set_dayOfWeek_$ref_ea586a())), 1, 7);
    var tmp_5 = this;
    var tmp_6 = KMutableProperty1;
    var tmp_7 = DateFieldContainer$_get_dayOfYear_$ref_2m6gfz();
    tmp_5.a4c_1 = new UnsignedFieldSpec(new PropertyAccessor(getPropertyCallableRef('dayOfYear', 1, tmp_6, tmp_7, DateFieldContainer$_set_dayOfYear_$ref_cll22d())), 1, 366);
  }
}
class Companion_6 {
  l4c(block) {
    ...
    block(builder);
    return new LocalDateTimeFormat(builder.x2k());
  }
}
class AbstractWithTimeBuilder {}
function hour(padding) {
  return this.t4a(new BasicFormatStructure(new HourDirective(padding)));
}
function minute(padding) {
  return this.t4a(new BasicFormatStructure(new MinuteDirective(padding)));
}
function second(padding) {
  return this.t4a(new BasicFormatStructure(new SecondDirective(padding)));
}
function secondFraction(minLength, maxLength) {
  return this.t4a(new BasicFormatStructure(new FractionalSecondDirective(minLength, maxLength)));
}
function time(format) {
  var tmp;
  if (format instanceof LocalTimeFormat) {
    this.t4a(format.c4e_1);
    tmp = Unit_instance;
  }
  return tmp;
}
...
class Builder_0 {
  constructor(actualBuilder) {
    this.m4c_1 = actualBuilder;
  }
  o4a() {
    return this.m4c_1;
  }
  n4c(structure) {
    this.m4c_1.r4a(structure);
  }
  p4a() {
...
class LocalDateTimeFormat extends AbstractDateTimeFormat {
  ...
  h49(value) {
    return this.p4c(value instanceof LocalDateTime ? value : THROW_CCE());
  }
  t4c(intermediate) {
    return intermediate.u4c();
  }
  i49(intermediate) {
    return this.t4c(intermediate instanceof IncompleteLocalDateTime ? intermediate : THROW_CCE());
  }
  j49() {
...
function set_fractionOfSecond(value) {
  this.j4d(value == null ? null : value.v4d(9));
}
function get_fractionOfSecond() {
  var tmp0_safe_receiver = this.k4d();
  var tmp;
  if (tmp0_safe_receiver == null) {
    tmp = null;
  } else {
...
class IncompleteLocalDateTime {
  ...
  u4c() {
    return new LocalDateTime(this.q4c_1.e4b(), this.r4c_1.b4d());
  }
  s4c(dateTime) {
    this.q4c_1.l4b(dateTime.c4d_1);
    this.r4c_1.e4d(dateTime.d4d_1);
  }
  o4b() {
    return new IncompleteLocalDateTime(this.q4c_1.o4b(), this.r4c_1.o4b());
  }
  y4a(_set____db54di) {
    this.q4c_1.v4a_1 = _set____db54di;
  }
  z4a() {
    return this.q4c_1.v4a_1;
  }
  a4b(_set____db54di) {
    this.q4c_1.w4a_1 = _set____db54di;
  }
  b4b() {
    return this.q4c_1.w4a_1;
  }
  c4b(_set____db54di) {
    this.q4c_1.x4a_1 = _set____db54di;
  }
  d4b() {
    return this.q4c_1.x4a_1;
  }
  m4b(_set____db54di) {
    this.q4c_1.m4b(_set____db54di);
  }
  f4b() {
    return this.q4c_1.f4b();
  }
  n4b(_set____db54di) {
    this.q4c_1.n4b(_set____db54di);
  }
  k4b() {
    return this.q4c_1.k4b();
  }
  f4d(_set____db54di) {
    this.r4c_1.y4c_1 = _set____db54di;
  }
  g4d() {
    return this.r4c_1.y4c_1;
  }
  h4d(_set____db54di) {
    this.r4c_1.z4c_1 = _set____db54di;
  }
  i4d() {
    return this.r4c_1.z4c_1;
  }
  j4d(_set____db54di) {
    this.r4c_1.a4d_1 = _set____db54di;
  }
  k4d() {
    return this.r4c_1.a4d_1;
  }
  l4d(_set____db54di) {
    this.r4c_1.v4c_1 = _set____db54di;
  }
  m4d() {
    return this.r4c_1.v4c_1;
  }
  n4d(_set____db54di) {
    this.r4c_1.w4c_1 = _set____db54di;
  }
  o4d() {
    return this.r4c_1.w4c_1;
  }
  p4d(_set____db54di) {
    this.r4c_1.x4c_1 = _set____db54di;
  }
  q4d() {
    return this.r4c_1.x4c_1;
  }
  r4d(value) {
    this.r4c_1.r4d(value);
  }
  s4d() {
    return this.r4c_1.s4d();
  }
}
class IncompleteLocalTime {
  constructor(hour, hourOfAmPm, amPm, minute, second, nanosecond) {
    ...
    this.v4c_1 = hour;
    this.w4c_1 = hourOfAmPm;
    this.x4c_1 = amPm;
    this.y4c_1 = minute;
    this.z4c_1 = second;
    this.a4d_1 = nanosecond;
  }
  l4d(_set____db54di) {
    this.v4c_1 = _set____db54di;
  }
  m4d() {
    return this.v4c_1;
  }
  n4d(_set____db54di) {
    this.w4c_1 = _set____db54di;
  }
  o4d() {
    return this.w4c_1;
  }
  p4d(_set____db54di) {
    this.x4c_1 = _set____db54di;
  }
  q4d() {
    return this.x4c_1;
  }
  f4d(_set____db54di) {
    this.y4c_1 = _set____db54di;
  }
  g4d() {
    return this.y4c_1;
  }
  h4d(_set____db54di) {
    this.z4c_1 = _set____db54di;
  }
  i4d() {
    return this.z4c_1;
  }
  j4d(_set____db54di) {
    this.a4d_1 = _set____db54di;
  }
  k4d() {
    return this.a4d_1;
  }
  b4d() {
    ...
    if (tmp0_safe_receiver == null) {
      ...
      // Inline function 'kotlin.let' call
      var tmp0_safe_receiver_0 = this.w4c_1;
      ...
      var tmp1_safe_receiver = this.x4c_1;
    ...
    if (tmp1_elvis_lhs == null) {
      var tmp2_safe_receiver = this.w4c_1;
      var tmp_1;
      if (tmp2_safe_receiver == null) {
        tmp_1 = null;
      } else {
        // Inline function 'kotlin.let' call
        var tmp0_safe_receiver_1 = this.x4c_1;
        var tmp_2;
    ...
    if (tmp3_elvis_lhs == null) {
      throw DateTimeFormatException.k48('Incomplete time: missing hour');
    } else {
      tmp_3 = tmp3_elvis_lhs;
    }
    var hour = tmp_3;
    var tmp_4 = requireParsedField(this.y4c_1, 'minute');
    var tmp4_elvis_lhs = this.z4c_1;
    var tmp_5 = tmp4_elvis_lhs == null ? 0 : tmp4_elvis_lhs;
    var tmp5_elvis_lhs = this.a4d_1;
    return new LocalTime(hour, tmp_4, tmp_5, tmp5_elvis_lhs == null ? 0 : tmp5_elvis_lhs);
  }
  e4d(localTime) {
    this.v4c_1 = localTime.w4d_1;
    this.w4c_1 = ((localTime.w4d_1 + 11 | 0) % 12 | 0) + 1 | 0;
    this.x4c_1 = localTime.w4d_1 >= 12 ? AmPmMarker_PM_getInstance() : AmPmMarker_AM_getInstance();
    this.y4c_1 = localTime.x4d_1;
    this.z4c_1 = localTime.y4d_1;
    this.a4d_1 = localTime.z4d_1;
  }
  o4b() {
    return new IncompleteLocalTime(this.v4c_1, this.w4c_1, this.x4c_1, this.y4c_1, this.z4c_1, this.a4d_1);
  }
  equals(other) {
    var tmp;
    var tmp_0;
    ...
    if (other instanceof IncompleteLocalTime) {
      tmp_4 = this.v4c_1 == other.v4c_1;
    } else {
      tmp_4 = false;
    }
    if (tmp_4) {
      tmp_3 = this.w4c_1 == other.w4c_1;
    } else {
      tmp_3 = false;
    }
    if (tmp_3) {
      tmp_2 = equals(this.x4c_1, other.x4c_1);
    } else {
      tmp_2 = false;
    }
    if (tmp_2) {
      tmp_1 = this.y4c_1 == other.y4c_1;
    } else {
      tmp_1 = false;
    }
    if (tmp_1) {
      tmp_0 = this.z4c_1 == other.z4c_1;
    } else {
      tmp_0 = false;
    }
    if (tmp_0) {
      tmp = this.a4d_1 == other.a4d_1;
    } else {
      tmp = false;
    }
    return tmp;
...
class Companion_7 {
  a4e(block) {
    ...
    block(builder);
    return new LocalTimeFormat(builder.x2k());
  }
}
class Builder_1 {
  constructor(actualBuilder) {
    this.b4e_1 = actualBuilder;
  }
  o4a() {
    return this.b4e_1;
  }
  t4a(structure) {
    this.b4e_1.r4a(structure);
  }
  p4a() {
...
class LocalTimeFormat extends AbstractDateTimeFormat {
  ...
  h49(value) {
    return this.d4e(value instanceof LocalTime ? value : THROW_CCE());
  }
  e4e(intermediate) {
    return intermediate.b4d();
  }
  i49(intermediate) {
    return this.e4e(intermediate instanceof IncompleteLocalTime ? intermediate : THROW_CCE());
  }
  j49() {
...
class HourDirective extends UnsignedIntFieldFormatDirective {
  constructor(padding) {
    var tmp = TimeFields_getInstance().f4e_1;
    // Inline function 'kotlinx.datetime.format.minDigits' call
    var tmp_0 = padding.equals(Padding_ZERO_getInstance()) ? 2 : 1;
    // Inline function 'kotlinx.datetime.format.spaces' call
    super(tmp, tmp_0, padding.equals(Padding_SPACE_getInstance()) ? 2 : null);
  ...
  equals(other) {
    ...
    if (other instanceof HourDirective) {
      tmp = this.p4e_1.equals(other.p4e_1);
    } else {
      tmp = false;
    }
    return tmp;
  ...
  hashCode() {
    return this.p4e_1.hashCode();
  }
}
class MinuteDirective extends UnsignedIntFieldFormatDirective {
  constructor(padding) {
    var tmp = TimeFields_getInstance().g4e_1;
    // Inline function 'kotlinx.datetime.format.minDigits' call
    var tmp_0 = padding.equals(Padding_ZERO_getInstance()) ? 2 : 1;
    // Inline function 'kotlinx.datetime.format.spaces' call
    super(tmp, tmp_0, padding.equals(Padding_SPACE_getInstance()) ? 2 : null);
  ...
  equals(other) {
    ...
    if (other instanceof MinuteDirective) {
      tmp = this.u4e_1.equals(other.u4e_1);
    } else {
      tmp = false;
    }
    return tmp;
  ...
  hashCode() {
    return this.u4e_1.hashCode();
  }
}
class SecondDirective extends UnsignedIntFieldFormatDirective {
  constructor(padding) {
    var tmp = TimeFields_getInstance().h4e_1;
    // Inline function 'kotlinx.datetime.format.minDigits' call
    var tmp_0 = padding.equals(Padding_ZERO_getInstance()) ? 2 : 1;
    // Inline function 'kotlinx.datetime.format.spaces' call
    super(tmp, tmp_0, padding.equals(Padding_SPACE_getInstance()) ? 2 : null);
  ...
  equals(other) {
    ...
    if (other instanceof SecondDirective) {
      tmp = this.z4e_1.equals(other.z4e_1);
    } else {
      tmp = false;
    }
    return tmp;
  ...
  hashCode() {
    return this.z4e_1.hashCode();
  }
}
class Companion_8 {
  constructor() {
    Companion_instance_9 = this;
    this.a4f_1 = listOf([0, 0, 0, 0, 0, 0, 0, 0, 0]);
    this.b4f_1 = listOf([2, 1, 0, 2, 1, 0, 2, 1, 0]);
  }
}
class DecimalFractionFieldFormatDirective {
  constructor(field, minDigits, maxDigits, zerosToAdd) {
    ...
    this.k4f_1 = maxDigits;
    this.l4f_1 = zerosToAdd;
  }
  k4c() {
    return this.i4f_1;
  }
  n49() {
    return new DecimalFractionFormatterStructure(Accessor$getterNotNull$ref_0(this.i4f_1.o4i()), this.j4f_1, this.k4f_1, this.l4f_1);
  }
  p49() {
    return new ParserStructure(listOf_0(new NumberSpanParserOperation(listOf_0(new FractionPartConsumer(this.j4f_1, this.k4f_1, this.i4f_1.o4i(), this.i4f_1.d1())))), emptyList());
  }
}
class FractionalSecondDirective extends DecimalFractionFieldFormatDirective {
  constructor(minDigits, maxDigits, zerosToAdd) {
    ...
    zerosToAdd = zerosToAdd === VOID ? Companion_getInstance_9().a4f_1 : zerosToAdd;
    super(TimeFields_getInstance().i4e_1, minDigits, maxDigits, zerosToAdd);
    this.g4f_1 = minDigits;
    this.h4f_1 = maxDigits;
  }
  equals(other) {
    var tmp;
    var tmp_0;
    if (other instanceof FractionalSecondDirective) {
      tmp_0 = this.g4f_1 === other.g4f_1;
    } else {
      tmp_0 = false;
    }
    if (tmp_0) {
      tmp = this.h4f_1 === other.h4f_1;
    } else {
      tmp = false;
    }
    return tmp;
  ...
  hashCode() {
    return imul(31, this.g4f_1) + this.h4f_1 | 0;
  }
}
class TimeFields {
  constructor() {
    ...
    tmp.f4e_1 = new UnsignedFieldSpec(new PropertyAccessor(getPropertyCallableRef('hour', 1, tmp_0, tmp_1, TimeFieldContainer$_set_hour_$ref_l7vnde())), 0, 23);
    var tmp_2 = this;
    var tmp_3 = KMutableProperty1;
    var tmp_4 = TimeFieldContainer$_get_minute_$ref_evb2i2();
    tmp_2.g4e_1 = new UnsignedFieldSpec(new PropertyAccessor(getPropertyCallableRef('minute', 1, tmp_3, tmp_4, TimeFieldContainer$_set_minute_$ref_6xin6())), 0, 59);
    var tmp_5 = this;
    var tmp_6 = KMutableProperty1;
    var tmp_7 = TimeFieldContainer$_get_second_$ref_t7tjxy();
    tmp_5.h4e_1 = new UnsignedFieldSpec(new PropertyAccessor(getPropertyCallableRef('second', 1, tmp_6, tmp_7, TimeFieldContainer$_set_second_$ref_qr1wvy())), 0, 59, VOID, 0);
    var tmp_8 = this;
    var tmp_9 = KMutableProperty1;
    var tmp_10 = TimeFieldContainer$_get_fractionOfSecond_$ref_u85by5();
    tmp_8.i4e_1 = new GenericFieldSpec(new PropertyAccessor(getPropertyCallableRef('fractionOfSecond', 1, tmp_9, tmp_10, TimeFieldContainer$_set_fractionOfSecond_$ref_quw20n()), 'nanosecond'), VOID, new DecimalFraction(0, 9));
    var tmp_11 = this;
    var tmp_12 = KMutableProperty1;
    var tmp_13 = TimeFieldContainer$_get_amPm_$ref_u9tt1b();
    tmp_11.j4e_1 = new GenericFieldSpec(new PropertyAccessor(getPropertyCallableRef('amPm', 1, tmp_12, tmp_13, TimeFieldContainer$_set_amPm_$ref_hgxhkj())));
    var tmp_14 = this;
    var tmp_15 = KMutableProperty1;
    var tmp_16 = TimeFieldContainer$_get_hourOfAmPm_$ref_okyxye();
    tmp_14.k4e_1 = new UnsignedFieldSpec(new PropertyAccessor(getPropertyCallableRef('hourOfAmPm', 1, tmp_15, tmp_16, TimeFieldContainer$_set_hourOfAmPm_$ref_y4i32())), 1, 12);
  }
}
...
class IncompleteUtcOffset {
  constructor(offsetIsNegative, offsetHours, offsetMinutesOfHour, offsetSecondsOfMinute) {
    ...
    this.u4f_1 = offsetIsNegative;
    this.v4f_1 = offsetHours;
    this.w4f_1 = offsetMinutesOfHour;
    this.x4f_1 = offsetSecondsOfMinute;
  }
  m4f(_set____db54di) {
    this.u4f_1 = _set____db54di;
  }
  n4f() {
    return this.u4f_1;
  }
  ...
  y4f() {
    ...
    var tmp_0 = tmp;
    var tmp1_safe_receiver = this.w4f_1;
    var tmp_1;
    if (tmp1_safe_receiver == null) {
      tmp_1 = null;
    } else {
    ...
    var tmp_2 = tmp_1;
    var tmp2_safe_receiver = this.x4f_1;
    var tmp_3;
    if (tmp2_safe_receiver == null) {
      tmp_3 = null;
    } else {
  ...
  z4f(offset) {
    this.u4f_1 = offset.a4g_1 < 0;
    // Inline function 'kotlin.math.absoluteValue' call
    var this_0 = offset.a4g_1;
    var totalSecondsAbs = abs(this_0);
    this.v4f_1 = totalSecondsAbs / 3600 | 0;
    this.w4f_1 = (totalSecondsAbs / 60 | 0) % 60 | 0;
    this.x4f_1 = totalSecondsAbs % 60 | 0;
  }
  equals(other) {
    var tmp;
    var tmp_0;
    ...
    if (other instanceof IncompleteUtcOffset) {
      tmp_2 = this.u4f_1 == other.u4f_1;
    } else {
      tmp_2 = false;
    }
    if (tmp_2) {
      tmp_1 = this.v4f_1 == other.v4f_1;
    } else {
      tmp_1 = false;
    }
    if (tmp_1) {
      tmp_0 = this.w4f_1 == other.w4f_1;
    } else {
      tmp_0 = false;
    }
    if (tmp_0) {
      tmp = this.x4f_1 == other.x4f_1;
    } else {
      tmp = false;
    }
    return tmp;
  ...
  hashCode() {
    // Inline function 'kotlin.hashCode' call
    var tmp0_safe_receiver = this.u4f_1;
    var tmp1_elvis_lhs = tmp0_safe_receiver == null ? null : hashCode(tmp0_safe_receiver);
    var tmp = tmp1_elvis_lhs == null ? 0 : tmp1_elvis_lhs;
    // Inline function 'kotlin.hashCode' call
    var tmp0_safe_receiver_0 = this.v4f_1;
    var tmp1_elvis_lhs_0 = tmp0_safe_receiver_0 == null ? null : hashCode(tmp0_safe_receiver_0);
    var tmp_0 = tmp + (tmp1_elvis_lhs_0 == null ? 0 : tmp1_elvis_lhs_0) | 0;
    // Inline function 'kotlin.hashCode' call
    var tmp0_safe_receiver_1 = this.w4f_1;
    var tmp1_elvis_lhs_1 = tmp0_safe_receiver_1 == null ? null : hashCode(tmp0_safe_receiver_1);
    var tmp_1 = tmp_0 + (tmp1_elvis_lhs_1 == null ? 0 : tmp1_elvis_lhs_1) | 0;
    // Inline function 'kotlin.hashCode' call
    var tmp0_safe_receiver_2 = this.x4f_1;
    var tmp1_elvis_lhs_2 = tmp0_safe_receiver_2 == null ? null : hashCode(tmp0_safe_receiver_2);
    return tmp_1 + (tmp1_elvis_lhs_2 == null ? 0 : tmp1_elvis_lhs_2) | 0;
  }
  o4b() {
    return new IncompleteUtcOffset(this.u4f_1, this.v4f_1, this.w4f_1, this.x4f_1);
  }
  toString() {
    var tmp0_safe_receiver = this.u4f_1;
    var tmp;
    ...
    var tmp2_elvis_lhs = this.v4f_1;
    var tmp_1 = toString(tmp2_elvis_lhs == null ? '??' : tmp2_elvis_lhs);
    var tmp3_elvis_lhs = this.w4f_1;
    var tmp_2 = toString(tmp3_elvis_lhs == null ? '??' : tmp3_elvis_lhs);
    var tmp4_elvis_lhs = this.x4f_1;
...
class UtcOffsetWholeHoursDirective extends UnsignedIntFieldFormatDirective {
  constructor(padding) {
    var tmp = OffsetFields_getInstance().c4g_1;
    // Inline function 'kotlinx.datetime.format.minDigits' call
    var tmp_0 = padding.equals(Padding_ZERO_getInstance()) ? 2 : 1;
    // Inline function 'kotlinx.datetime.format.spaces' call
    super(tmp, tmp_0, padding.equals(Padding_SPACE_getInstance()) ? 2 : null);
  ...
  equals(other) {
    ...
    if (other instanceof UtcOffsetWholeHoursDirective) {
      tmp = this.j4g_1.equals(other.j4g_1);
    } else {
      tmp = false;
    }
    return tmp;
...
class Companion_9 {
  k4g(block) {
    ...
    block(builder);
    return new UtcOffsetFormat(builder.x2k());
  }
}
class AbstractWithOffsetBuilder {}
function offsetHours(padding) {
  return this.m4g(new SignedFormatStructure(new BasicFormatStructure(new UtcOffsetWholeHoursDirective(padding)), true));
}
function offsetMinutesOfHour(padding) {
  return this.m4g(new BasicFormatStructure(new UtcOffsetMinuteOfHourDirective(padding)));
}
function offsetSecondsOfMinute(padding) {
  return this.m4g(new BasicFormatStructure(new UtcOffsetSecondOfMinuteDirective(padding)));
}
class Builder_2 {
  constructor(actualBuilder) {
    this.l4g_1 = actualBuilder;
  }
  o4a() {
    return this.l4g_1;
  }
  m4g(structure) {
    this.l4g_1.r4a(structure);
  }
  p4a() {
...
class UtcOffsetFormat extends AbstractDateTimeFormat {
  ...
  h49(value) {
    return this.o4g(value instanceof UtcOffset ? value : THROW_CCE());
  }
  p4g(intermediate) {
    return intermediate.y4f();
  }
  i49(intermediate) {
    return this.p4g(intermediate instanceof IncompleteUtcOffset ? intermediate : THROW_CCE());
  }
  j49() {
...
class OffsetFields$sign$1 {
  constructor() {
    ...
    tmp.q4g_1 = new PropertyAccessor(getPropertyCallableRef('offsetIsNegative', 1, tmp_0, tmp_1, UtcOffsetFieldContainer$_set_offsetIsNegative_$ref_h7e0jq()));
  }
  r4g() {
    return this.q4g_1;
  }
  ...
  t4g(obj) {
    return this.s4g((!(obj == null) ? isInterface(obj, UtcOffsetFieldContainer) : false) ? obj : THROW_CCE());
  }
}
class OffsetFields {
  constructor() {
    ...
    var tmp = this;
    tmp.b4g_1 = new OffsetFields$sign$1();
    var tmp_0 = this;
    ...
    var tmp1_sign = this.b4g_1;
    tmp_0.c4g_1 = new UnsignedFieldSpec(tmp0_accessor, 0, 18, VOID, 0, tmp1_sign);
    var tmp_3 = this;
    ...
    var tmp1_sign_0 = this.b4g_1;
    tmp_3.d4g_1 = new UnsignedFieldSpec(tmp0_accessor_0, 0, 59, VOID, 0, tmp1_sign_0);
    var tmp_6 = this;
    ...
    var tmp1_sign_1 = this.b4g_1;
    tmp_6.e4g_1 = new UnsignedFieldSpec(tmp0_accessor_1, 0, 59, VOID, 0, tmp1_sign_1);
  }
}
class UtcOffsetMinuteOfHourDirective extends UnsignedIntFieldFormatDirective {
  constructor(padding) {
    var tmp = OffsetFields_getInstance().d4g_1;
    // Inline function 'kotlinx.datetime.format.minDigits' call
    var tmp_0 = padding.equals(Padding_ZERO_getInstance()) ? 2 : 1;
    // Inline function 'kotlinx.datetime.format.spaces' call
    super(tmp, tmp_0, padding.equals(Padding_SPACE_getInstance()) ? 2 : null);
...
class UtcOffsetSecondOfMinuteDirective extends UnsignedIntFieldFormatDirective {
  constructor(padding) {
    var tmp = OffsetFields_getInstance().e4g_1;
    // Inline function 'kotlinx.datetime.format.minDigits' call
    var tmp_0 = padding.equals(Padding_ZERO_getInstance()) ? 2 : 1;
    // Inline function 'kotlinx.datetime.format.spaces' call
    super(tmp, tmp_0, padding.equals(Padding_SPACE_getInstance()) ? 2 : null);
  ...
  equals(other) {
    ...
    if (other instanceof UtcOffsetSecondOfMinuteDirective) {
      tmp = this.d4h_1.equals(other.d4h_1);
    } else {
      tmp = false;
    }
    return tmp;
...
class IncompleteYearMonth {
  constructor(year, monthNumber) {
    ...
    this.p4b_1 = year;
    this.q4b_1 = monthNumber;
  }
  m4b(_set____db54di) {
    this.p4b_1 = _set____db54di;
  }
  f4b() {
    return this.p4b_1;
  }
  n4b(_set____db54di) {
    this.q4b_1 = _set____db54di;
  }
  k4b() {
    return this.q4b_1;
  }
  e4h() {
    var year = requireParsedField(this.p4b_1, 'year');
    var month = requireParsedField(this.q4b_1, 'monthNumber');
    return new YearMonth(year, month);
  }
  f4h(yearMonth) {
    this.p4b_1 = yearMonth.g4h_1;
    this.q4b_1 = get_number(yearMonth.j4b());
  }
  o4b() {
    return new IncompleteYearMonth(this.p4b_1, this.q4b_1);
  }
  equals(other) {
    var tmp;
    var tmp_0;
    if (other instanceof IncompleteYearMonth) {
      tmp_0 = this.p4b_1 == other.p4b_1;
    } else {
      tmp_0 = false;
    }
    if (tmp_0) {
      tmp = this.q4b_1 == other.q4b_1;
    } else {
      tmp = false;
    }
    return tmp;
  ...
  hashCode() {
    ...
    // Inline function 'kotlin.hashCode' call
    var tmp0_safe_receiver_0 = this.q4b_1;
    var tmp1_elvis_lhs_0 = tmp0_safe_receiver_0 == null ? null : hashCode(tmp0_safe_receiver_0);
    return tmp + (tmp1_elvis_lhs_0 == null ? 0 : tmp1_elvis_lhs_0) | 0;
  }
  toString() {
    var tmp0_elvis_lhs = this.p4b_1;
    var tmp = toString(tmp0_elvis_lhs == null ? '??' : tmp0_elvis_lhs);
    var tmp1_elvis_lhs = this.q4b_1;
...
class Companion_10 {
  i4h(block) {
    ...
    block(builder);
    return new YearMonthFormat(builder.x2k());
  }
}
class Builder_3 {
  constructor(actualBuilder) {
    this.j4h_1 = actualBuilder;
  }
  o4a() {
    return this.j4h_1;
  }
  u4b(structure) {
    return this.j4h_1.r4a(structure);
  }
  p4a() {
...
class YearMonthFormat extends AbstractDateTimeFormat {
  ...
  h49(value) {
    return this.l4h(value instanceof YearMonth ? value : THROW_CCE());
  }
  m4h(intermediate) {
    return intermediate.e4h();
  }
  i49(intermediate) {
    return this.m4h(intermediate instanceof IncompleteYearMonth ? intermediate : THROW_CCE());
  }
  j49() {
...
class SignedIntFieldFormatDirective {
  constructor(field, minDigits, maxDigits, spacePadding, outputPlusOnExceededWidth) {
    this.w4h_1 = field;
    this.x4h_1 = minDigits;
    this.y4h_1 = maxDigits;
    this.z4h_1 = spacePadding;
    this.a4i_1 = outputPlusOnExceededWidth;
    // Inline function 'kotlin.require' call
    if (!(this.x4h_1 == null || this.x4h_1 >= 0)) {
      var message = 'The minimum number of digits (' + this.x4h_1 + ') is negative';
      throw IllegalArgumentException.h2(toString(message));
    }
    // Inline function 'kotlin.require' call
    if (!(this.y4h_1 == null || this.x4h_1 == null || this.y4h_1 >= this.x4h_1)) {
      var message_0 = 'The maximum number of digits (' + this.y4h_1 + ') is less than the minimum number of digits (' + this.x4h_1 + ')';
      throw IllegalArgumentException.h2(toString(message_0));
    }
  }
  k4c() {
  ...
  n49() {
    var tmp = Accessor$getterNotNull$ref_1(this.w4h_1.o4i());
    var tmp0_elvis_lhs = this.x4h_1;
    var formatter = new SignedIntFormatterStructure(tmp, tmp0_elvis_lhs == null ? 0 : tmp0_elvis_lhs, this.a4i_1);
    return !(this.z4h_1 == null) ? new SpacePaddedFormatter(formatter, this.z4h_1) : formatter;
  }
  p49() {
    return SignedIntParser(this.x4h_1, this.y4h_1, this.z4h_1, this.w4h_1.o4i(), this.w4h_1.d1(), this.a4i_1);
  }
}
class YearDirective extends SignedIntFieldFormatDirective {
  constructor(padding, isYearOfEra) {
    ...
    var tmp = YearMonthFields_getInstance().n4h_1;
    // Inline function 'kotlinx.datetime.format.minDigits' call
    ...
    this.u4h_1 = padding;
    this.v4h_1 = isYearOfEra;
  }
  equals(other) {
    var tmp;
    var tmp_0;
    if (other instanceof YearDirective) {
      tmp_0 = this.u4h_1.equals(other.u4h_1);
    } else {
      tmp_0 = false;
    }
    if (tmp_0) {
      tmp = this.v4h_1 === other.v4h_1;
    } else {
      tmp = false;
    }
    return tmp;
  ...
  hashCode() {
    return imul(this.u4h_1.hashCode(), 31) + getBooleanHashCode(this.v4h_1) | 0;
  }
}
class MonthDirective extends UnsignedIntFieldFormatDirective {
  constructor(padding) {
    var tmp = YearMonthFields_getInstance().o4h_1;
    // Inline function 'kotlinx.datetime.format.minDigits' call
    var tmp_0 = padding.equals(Padding_ZERO_getInstance()) ? 2 : 1;
    // Inline function 'kotlinx.datetime.format.spaces' call
    super(tmp, tmp_0, padding.equals(Padding_SPACE_getInstance()) ? 2 : null);
...
class YearMonthFields {
  constructor() {
    ...
    tmp.n4h_1 = new GenericFieldSpec(new PropertyAccessor(getPropertyCallableRef('year', 1, tmp_0, tmp_1, YearMonthFieldContainer$_set_year_$ref_kc0aub())));
    var tmp_2 = this;
    var tmp_3 = KMutableProperty1;
    var tmp_4 = YearMonthFieldContainer$_get_monthNumber_$ref_pn0wu5();
    tmp_2.o4h_1 = new UnsignedFieldSpec(new PropertyAccessor(getPropertyCallableRef('monthNumber', 1, tmp_3, tmp_4, YearMonthFieldContainer$_set_monthNumber_$ref_fjapbl())), 1, 12);
  }
}
class AppendableFormatStructure {
  constructor() {
    ...
    tmp.q4a_1 = ArrayList.n2();
  }
  x2k() {
    return new ConcatenatedFormatStructure(this.q4a_1);
  }
  r4a(format) {
    if (isInterface(format, NonConcatenatedFormatStructure))
      this.q4a_1.z1(format);
    else {
      if (format instanceof ConcatenatedFormatStructure) {
        // Inline function 'kotlin.collections.forEach' call
        var _iterator__ex2g4s = format.s4a_1.l1();
        while (_iterator__ex2g4s.m1()) {
          var element = _iterator__ex2g4s.n1();
          this.q4a_1.z1(element);
        }
      } else {
...
class AbstractFieldSpec {
  toString() {
    return 'The field ' + this.d1() + ' (default value is ' + toString_1(this.t4i()) + ')';
  }
}
class GenericFieldSpec extends AbstractFieldSpec {
  constructor(accessor, name, defaultValue, sign) {
    name = name === VOID ? accessor.d1() : name;
...
function getterNotNull(container) {
  var tmp0_elvis_lhs = this.z4i(container);
  var tmp;
  if (tmp0_elvis_lhs == null) {
    throw IllegalStateException.o('Field ' + this.d1() + ' is not set');
  } else {
    tmp = tmp0_elvis_lhs;
  }
  return tmp;
...
class PropertyAccessor {
  ...
  x4i(container, newValue) {
    var oldValue = this.v4i_1.get(container);
    var tmp;
    if (oldValue === null) {
      this.v4i_1.set(container, newValue);
      tmp = null;
  ...
  y4i(container, newValue) {
    return this.x4i(container, newValue);
  }
  z4i(container) {
    return this.v4i_1.get(container);
  }
}
class UnsignedFieldSpec extends AbstractFieldSpec {
  constructor(accessor, minValue, maxValue, name, defaultValue, sign) {
    ...
    this.j4i_1 = maxValue;
    this.k4i_1 = name;
    this.l4i_1 = defaultValue;
    this.m4i_1 = sign;
    var tmp = this;
    var tmp_0;
    if (this.j4i_1 < 10) {
      tmp_0 = 1;
    } else if (this.j4i_1 < 100) {
      tmp_0 = 2;
    } else if (this.j4i_1 < 1000) {
      tmp_0 = 3;
    } else {
      throw IllegalArgumentException.h2('Max value ' + this.j4i_1 + ' is too large');
    }
    tmp.n4i_1 = tmp_0;
  }
  o4i() {
...
class ConcatenatedFormatStructure {
  ...
  toString() {
    return 'ConcatenatedFormatStructure(' + joinToString(this.s4a_1, ', ') + ')';
  }
  equals(other) {
    var tmp;
    if (other instanceof ConcatenatedFormatStructure) {
      tmp = equals(this.s4a_1, other.s4a_1);
    } else {
      tmp = false;
    }
    return tmp;
  ...
  hashCode() {
    return hashCode(this.s4a_1);
  }
  p49() {
    // Inline function 'kotlin.collections.map' call
    var this_0 = this.s4a_1;
    // Inline function 'kotlin.collections.mapTo' call
...
class CachedFormatStructure extends ConcatenatedFormatStructure {
  constructor(formats) {
    super(formats);
    this.l49_1 = super.n49();
    this.m49_1 = super.p49();
  }
  n49() {
    return this.l49_1;
  }
...
class BasicFormatStructure {
  constructor(directive) {
    this.a4j_1 = directive;
  }
  toString() {
    return 'BasicFormatStructure(' + toString(this.a4j_1) + ')';
  }
  equals(other) {
    var tmp;
  ...
  p49() {
    return this.a4j_1.p49();
  }
  n49() {
    return this.a4j_1.n49();
  }
}
class ConstantFormatStructure {
  ...
  toString() {
    return 'ConstantFormatStructure(' + this.b4j_1 + ')';
  }
  equals(other) {
    var tmp;
    if (other instanceof ConstantFormatStructure) {
      tmp = this.b4j_1 === other.b4j_1;
    } else {
      tmp = false;
    }
    return tmp;
  ...
  hashCode() {
    return getStringHashCode(this.b4j_1);
  }
  p49() {
    var tmp;
    // Inline function 'kotlin.text.isEmpty' call
    var this_0 = this.b4j_1;
    if (charSequenceLength(this_0) === 0) {
      ...
      var tmp_0;
      if (isAsciiDigit(charCodeAt(this.b4j_1, 0))) {
        var tmp0 = this.b4j_1;
        var tmp$ret$5;
        $l$block: {
        ...
        this_1.z1(new NumberSpanParserOperation(listOf_0(new ConstantNumberConsumer(tmp$ret$5))));
        var tmp0_0 = this.b4j_1;
        var tmp$ret$7;
        $l$block_0: {
      ...
      if (charSequenceLength(suffix) > 0) {
        if (isAsciiDigit(charCodeAt(suffix, suffix.length - 1 | 0))) {
          ...
          this_1.z1(new PlainStringParserOperation(tmp$ret$10));
          var tmp$ret$12;
          $l$block_2: {
          ...
          this_1.z1(new NumberSpanParserOperation(listOf_0(new ConstantNumberConsumer(tmp$ret$12))));
        } else {
          this_1.z1(new PlainStringParserOperation(suffix));
        }
      }
      tmp = this_1.e5();
    }
  ...
  n49() {
    return new ConstantStringFormatterStructure(this.b4j_1);
  }
}
class SignedFormatStructure {
  constructor(format, withPlusSign) {
    this.c4j_1 = format;
    this.d4j_1 = withPlusSign;
    var tmp = this;
    // Inline function 'kotlin.collections.mapNotNull' call
    var tmp0 = basicFormats(this.c4j_1);
    ...
    while (_iterator__ex2g4s.m1()) {
      var element = _iterator__ex2g4s.n1();
      var tmp0_safe_receiver = element.k4c().u4i();
      if (tmp0_safe_receiver == null)
        null;
      else {
        // Inline function 'kotlin.let' call
  ...
  toString() {
    return 'SignedFormatStructure(' + toString(this.c4j_1) + ')';
  }
  equals(other) {
    var tmp;
    var tmp_0;
    if (other instanceof SignedFormatStructure) {
      tmp_0 = equals(this.c4j_1, other.c4j_1);
    } else {
      tmp_0 = false;
    }
    if (tmp_0) {
      tmp = this.d4j_1 === other.d4j_1;
    } else {
      tmp = false;
    }
    return tmp;
  ...
  hashCode() {
    return imul(31, hashCode(this.c4j_1)) + getBooleanHashCode(this.d4j_1) | 0;
  }
  p49() {
    return concat(listOf([new ParserStructure(listOf_0(new SignParser(SignedFormatStructure$parser$lambda(this), this.d4j_1, 'sign for ' + toString(this.e4j_1))), emptyList()), this.c4j_1.p49()]));
  }
  n49() {
    var innerFormat = this.c4j_1.n49();
    return new SignedFormatter(innerFormat, SignedFormatStructure$formatter$checkIfAllNegative$ref(this), this.d4j_1);
  }
}
class Companion_11 {
  f4j(field) {
    var default_0 = field.t4i();
    // Inline function 'kotlin.require' call
    if (!!(default_0 == null)) {
      var message = "The field '" + field.d1() + "' does not define a default value";
      throw IllegalArgumentException.h2(toString(message));
    }
    return new PropertyWithDefault(field.o4i(), default_0);
  }
}
class PropertyWithDefault {
  constructor(accessor, defaultValue) {
    this.g4j_1 = accessor;
    this.h4j_1 = defaultValue;
  }
}
class OptionalFormatStructure {
  constructor(onZero, format) {
    ...
    var tmp = this;
    // Inline function 'kotlin.collections.map' call
    var this_0 = basicFormats(this.j4j_1);
    // Inline function 'kotlin.collections.mapTo' call
    var destination = ArrayList.y1(collectionSizeOrDefault(this_0, 10));
    var _iterator__ex2g4s = this_0.l1();
    while (_iterator__ex2g4s.m1()) {
      var item = _iterator__ex2g4s.n1();
      var tmp$ret$2 = item.k4c();
      destination.z1(tmp$ret$2);
    }
    // Inline function 'kotlin.collections.map' call
    ...
    while (_iterator__ex2g4s_0.m1()) {
      ...
      var tmp$ret$5 = Companion_instance_12.f4j(item_0);
      destination_0.z1(tmp$ret$5);
    }
    tmp.k4j_1 = destination_0;
  }
  toString() {
    return 'Optional(' + this.i4j_1 + ', ' + toString(this.j4j_1) + ')';
  }
  equals(other) {
    var tmp;
    var tmp_0;
    if (other instanceof OptionalFormatStructure) {
      tmp_0 = this.i4j_1 === other.i4j_1;
    } else {
      tmp_0 = false;
    }
    if (tmp_0) {
      tmp = equals(this.j4j_1, other.j4j_1);
    } else {
      tmp = false;
    }
    return tmp;
  ...
  hashCode() {
    return imul(31, getStringHashCode(this.i4j_1)) + hashCode(this.j4j_1) | 0;
  }
  p49() {
    var tmp = emptyList();
    var tmp_0 = this.j4j_1.p49();
    var tmp_1 = (new ConstantFormatStructure(this.i4j_1)).p49();
    var tmp_2;
    if (this.k4j_1.j1()) {
      tmp_2 = emptyList();
    } else {
  ...
  n49() {
    ...
    while (_iterator__ex2g4s.m1()) {
      ...
      var tmp$ret$2 = new ComparisonPredicate(item.h4j_1, Accessor$getter$ref(item.g4j_1));
      destination.z1(tmp$ret$2);
    }
    var predicate = conjunctionPredicate(destination);
    var tmp;
    if (predicate instanceof Truth) {
      tmp = new ConstantStringFormatterStructure(this.i4j_1);
    } else {
      var tmp_0 = to(Predicate$test$ref(predicate), new ConstantStringFormatterStructure(this.i4j_1));
...
class AlternativesParsingFormatStructure {
  constructor(mainFormat, formats) {
    this.n4j_1 = mainFormat;
    this.o4j_1 = formats;
  }
  toString() {
    return 'AlternativesParsing(' + toString(this.o4j_1) + ')';
  }
  equals(other) {
    var tmp;
    var tmp_0;
    if (other instanceof AlternativesParsingFormatStructure) {
      tmp_0 = equals(this.n4j_1, other.n4j_1);
    } else {
      tmp_0 = false;
    }
    if (tmp_0) {
  ...
  hashCode() {
    return imul(31, hashCode(this.n4j_1)) + hashCode(this.o4j_1) | 0;
  }
  p49() {
    var tmp = emptyList();
    // Inline function 'kotlin.collections.buildList' call
    ...
    this_0.z1(this.n4j_1.p49());
    var _iterator__ex2g4s = this.o4j_1.l1();
    while (_iterator__ex2g4s.m1()) {
      var format = _iterator__ex2g4s.n1();
      this_0.z1(format.p49());
    }
    var tmp$ret$0 = this_0.e5();
    return new ParserStructure(tmp, tmp$ret$0);
  }
  n49() {
    return this.n4j_1.n49();
  }
}
class ComparisonPredicate {
  constructor(expectedValue, getter) {
    this.p4j_1 = expectedValue;
    this.q4j_1 = getter;
  }
  l4j(value) {
    return equals(this.q4j_1(value), this.p4j_1);
  }
}
class Truth {
  m4j(value) {
  ...
  l4j(value) {
    return this.m4j(value);
  }
}
class ConjunctionPredicate {
  constructor(predicates) {
    this.r4j_1 = predicates;
  }
  l4j(value) {
    var tmp0 = this.r4j_1;
    var tmp$ret$0;
...
function format$default(obj, builder, minusNotRequired, $super) {
  ...
  var tmp;
  if ($super === VOID) {
    this.s4j(obj, builder, minusNotRequired);
    tmp = Unit_instance;
  } else {
    tmp = $super.s4j.call(this, obj, builder, minusNotRequired);
  }
  return tmp;
}
class SpacePaddedFormatter {
  constructor(formatter, padding) {
    this.t4j_1 = formatter;
    this.u4j_1 = padding;
  }
  s4j(obj, builder, minusNotRequired) {
    // Inline function 'kotlin.let' call
    var it = StringBuilder.h1();
    this.t4j_1.s4j(obj, it, minusNotRequired);
    var string = it.toString();
    // Inline function 'kotlin.repeat' call
    var times = this.u4j_1 - string.length | 0;
    var inductionVariable = 0;
    if (inductionVariable < times)
      do {
        var index = inductionVariable;
        inductionVariable = inductionVariable + 1 | 0;
        builder.k1(_Char___init__impl__6a9atx(32));
      }
...
class SignedFormatter {
  constructor(formatter, allSubFormatsNegative, alwaysOutputSign) {
    this.v4j_1 = formatter;
    this.w4j_1 = allSubFormatsNegative;
    this.x4j_1 = alwaysOutputSign;
  }
  s4j(obj, builder, minusNotRequired) {
    var tmp;
    if (!minusNotRequired && this.w4j_1(obj)) {
    ...
    if ((tmp_0 == null ? null : new Char(tmp_0)) == null)
      ...
      var tmp_1 = sign;
      // Inline function 'kotlin.let' call
      var it = (tmp_1 == null ? null : new Char(tmp_1)).g3_1;
      builder.k1(it);
    }
    var tmp_2;
    if (minusNotRequired) {
    ...
    this.v4j_1.s4j(obj, builder, tmp_2);
  }
}
class ConditionalFormatter {
  constructor(formatters) {
    this.y4j_1 = formatters;
  }
  s4j(obj, builder, minusNotRequired) {
    var _iterator__ex2g4s = this.y4j_1.l1();
    while (_iterator__ex2g4s.m1()) {
      var _destruct__k2r9zo = _iterator__ex2g4s.n1();
      var condition = _destruct__k2r9zo.zk();
      var formatter = _destruct__k2r9zo.al();
      if (condition(obj)) {
        formatter.s4j(obj, builder, minusNotRequired);
...
class ConcatenatedFormatter {
  constructor(formatters) {
    this.z4j_1 = formatters;
  }
  s4j(obj, builder, minusNotRequired) {
    var _iterator__ex2g4s = this.z4j_1.l1();
    while (_iterator__ex2g4s.m1()) {
      var formatter = _iterator__ex2g4s.n1();
      formatter.s4j(obj, builder, minusNotRequired);
    }
  }
}
class UnsignedIntFormatterStructure {
  constructor(number, zeroPadding) {
    this.a4k_1 = number;
    this.b4k_1 = zeroPadding;
    // Inline function 'kotlin.require' call
    if (!(this.b4k_1 >= 0)) {
      var message = 'The minimum number of digits (' + this.b4k_1 + ') is negative';
      throw IllegalArgumentException.h2(toString(message));
    }
    // Inline function 'kotlin.require' call
    if (!(this.b4k_1 <= 9)) {
      var message_0 = 'The minimum number of digits (' + this.b4k_1 + ') exceeds the length of an Int';
      throw IllegalArgumentException.h2(toString(message_0));
    }
  }
  s4j(obj, builder, minusNotRequired) {
    var num = this.a4k_1(obj);
    var numberStr = num.toString();
    // Inline function 'kotlin.repeat' call
    var times = this.b4k_1 - numberStr.length | 0;
    var inductionVariable = 0;
    if (inductionVariable < times)
      do {
        var index = inductionVariable;
        inductionVariable = inductionVariable + 1 | 0;
        builder.k1(_Char___init__impl__6a9atx(48));
      }
       while (inductionVariable < times);
    builder.i2(numberStr);
  }
}
class DecimalFractionFormatterStructure {
  constructor(number, minDigits, maxDigits, zerosToAdd) {
    this.c4k_1 = number;
    this.d4k_1 = minDigits;
    this.e4k_1 = maxDigits;
    this.f4k_1 = zerosToAdd;
    var containsArg = this.d4k_1;
    // Inline function 'kotlin.require' call
    if (!(1 <= containsArg ? containsArg <= 9 : false)) {
      var message = 'The minimum number of digits (' + this.d4k_1 + ') is not in range 1..9';
      throw IllegalArgumentException.h2(toString(message));
    }
    var containsLower = this.d4k_1;
    var containsArg_0 = this.e4k_1;
    // Inline function 'kotlin.require' call
    if (!(containsLower <= containsArg_0 ? containsArg_0 <= 9 : false)) {
      var message_0 = 'The maximum number of digits (' + this.e4k_1 + ') is not in range ' + this.d4k_1 + '..9';
      throw IllegalArgumentException.h2(toString(message_0));
    }
  }
  s4j(obj, builder, minusNotRequired) {
    var number = this.c4k_1(obj);
    var numberWithRequiredPrecision = number.v4d(this.e4k_1);
    var zerosToStrip = 0;
    while (this.e4k_1 > (this.d4k_1 + zerosToStrip | 0) && (numberWithRequiredPrecision % get_POWERS_OF_TEN()[zerosToStrip + 1 | 0] | 0) === 0) {
      zerosToStrip = zerosToStrip + 1 | 0;
    }
    var zerosToAddBack = this.f4k_1.j2((this.e4k_1 - zerosToStrip | 0) - 1 | 0);
    if (zerosToStrip >= zerosToAddBack)
      zerosToStrip = zerosToStrip - zerosToAddBack | 0;
    var digitsToOutput = this.e4k_1 - zerosToStrip | 0;
    var numberToOutput = numberWithRequiredPrecision / get_POWERS_OF_TEN()[zerosToStrip] | 0;
    builder.i2(substring_0((numberToOutput + get_POWERS_OF_TEN()[digitsToOutput] | 0).toString(), 1));
  }
}
class SignedIntFormatterStructure {
  ...
  s4j(obj, builder, minusNotRequired) {
    ...
    // Inline function 'kotlin.let' call
    var it = this.g4k_1(obj);
    var number = minusNotRequired && it < 0 ? -it | 0 : it;
    if (!(this.i4k_1 == null) && number >= get_POWERS_OF_TEN()[this.i4k_1]) {
      innerBuilder.k1(_Char___init__impl__6a9atx(43));
    }
    // Inline function 'kotlin.math.absoluteValue' call
    if (abs(number) < get_POWERS_OF_TEN()[this.h4k_1 - 1 | 0]) {
      if (number >= 0) {
        innerBuilder.xg(number + get_POWERS_OF_TEN()[this.h4k_1] | 0).ch(0);
      } else {
        innerBuilder.xg(number - get_POWERS_OF_TEN()[this.h4k_1] | 0).ch(1);
      }
    } else {
      innerBuilder.xg(number);
    }
    builder.i2(innerBuilder);
  }
}
...
class FractionPartConsumer extends NumberConsumer {
  constructor(minLength, maxLength, setter, name) {
    ...
    this.m4k_1 = minLength;
    this.n4k_1 = maxLength;
    this.o4k_1 = setter;
    var containsArg = this.m4k_1;
    // Inline function 'kotlin.require' call
    if (!(1 <= containsArg ? containsArg <= 9 : false)) {
      var message = 'Invalid minimum length ' + this.m4k_1 + ' for field ' + this.q4k_1 + ': expected 1..9';
      throw IllegalArgumentException.h2(toString(message));
    }
    var containsLower = this.m4k_1;
    var containsArg_0 = this.n4k_1;
    // Inline function 'kotlin.require' call
    if (!(containsLower <= containsArg_0 ? containsArg_0 <= 9 : false)) {
      var message_0 = 'Invalid maximum length ' + this.n4k_1 + ' for field ' + this.q4k_1 + ': expected ' + this.m4k_1 + '..9';
      throw IllegalArgumentException.h2(toString(message_0));
    }
  }
  r4k(storage, input, start, end) {
    return (end - start | 0) < this.m4k_1 ? new TooFewDigits(this.m4k_1) : (end - start | 0) > this.n4k_1 ? new TooManyDigits(this.n4k_1) : setWithoutReassigning(this.o4k_1, storage, new DecimalFraction(parseAsciiInt(input, start, end), end - start | 0));
  }
}
class ConstantNumberConsumer extends NumberConsumer {
  ...
  r4k(storage, input, start, end) {
    ...
    if (toString(charSequenceSubSequence(input, start, end)) === this.u4k_1) {
      tmp = null;
    } else {
      tmp = new WrongConstant(this.u4k_1);
    }
    return tmp;
  }
}
...
class TooManyDigits {
  constructor(maxDigits) {
    this.w4k_1 = maxDigits;
  }
  v4k() {
    return 'expected at most ' + this.w4k_1 + ' digits';
  }
}
class TooFewDigits {
  constructor(minDigits) {
    this.x4k_1 = minDigits;
  }
  v4k() {
    return 'expected at least ' + this.x4k_1 + ' digits';
  }
}
class WrongConstant {
  constructor(expected) {
  ...
  v4k() {
    return "expected '" + this.y4k_1 + "'";
  }
}
class Conflicting {
  constructor(conflicting) {
    this.z4k_1 = conflicting;
  }
  v4k() {
    return "attempted to overwrite the existing value '" + toString(this.z4k_1) + "'";
  }
}
class UnsignedIntConsumer extends NumberConsumer {
  constructor(minLength, maxLength, setter, name, multiplyByMinus1) {
    ...
    super(minLength == maxLength ? minLength : null, name);
    this.c4l_1 = minLength;
    this.d4l_1 = maxLength;
    this.e4l_1 = setter;
    this.f4l_1 = multiplyByMinus1;
    // Inline function 'kotlin.require' call
    if (!(this.a() == null || numberRangeToNumber(1, 9).qo(this.a()))) {
      var message = 'Invalid length for field ' + this.q4k_1 + ': ' + this.a();
      throw IllegalArgumentException.h2(toString(message));
    }
  }
  r4k(storage, input, start, end) {
    var tmp;
    if (!(this.d4l_1 == null) && (end - start | 0) > this.d4l_1) {
      tmp = new TooManyDigits(this.d4l_1);
    } else if (!(this.c4l_1 == null) && (end - start | 0) < this.c4l_1) {
      tmp = new TooFewDigits(this.c4l_1);
    } else {
      var result = parseAsciiIntOrNull(input, start, end);
      tmp = result == null ? ExpectedInt_instance : setWithoutReassigning(this.e4l_1, storage, this.f4l_1 ? -result | 0 : result);
    }
    return tmp;
  }
}
...
class ParserState {
  constructor(output, parserStructure, inputPosition) {
    this.k4l_1 = output;
    this.l4l_1 = parserStructure;
    this.m4l_1 = inputPosition;
  }
}
class sam$kotlin_Comparator$0 {
  constructor(function_0) {
    this.v4l_1 = function_0;
  }
  pi(a, b) {
    return this.v4l_1(a, b);
  }
  compare(a, b) {
    return this.pi(a, b);
  }
...
class Parser {
  ...
  toString() {
    return Parser__toString_impl_x33iea(this.n4l_1);
  }
  hashCode() {
    return Parser__hashCode_impl_bbxllf(this.n4l_1);
  }
  equals(other) {
    return Parser__equals_impl_djxokv(this.n4l_1, other);
  }
}
class ParserStructure {
  constructor(operations, followedBy) {
    this.o4l_1 = operations;
    this.p4l_1 = followedBy;
  }
  toString() {
    return joinToString(this.o4l_1, ', ') + '(' + joinToString(this.p4l_1, ';') + ')';
  }
}
class ParseException extends Exception {
  static t4l(errors) {
    var $this = this.de(formatError(errors));
    captureStack($this, $this.s4l_1);
    return $this;
  }
}
class NumberSpanParserOperation {
  constructor(consumers) {
    this.w4l_1 = consumers;
    var tmp = this;
    // Inline function 'kotlin.collections.sumOf' call
    var sum = 0;
    var _iterator__ex2g4s = this.w4l_1.l1();
    while (_iterator__ex2g4s.m1()) {
      var element = _iterator__ex2g4s.n1();
      var tmp_0 = sum;
    ...
    tmp_1.y4l_1 = tmp$ret$2;
    var tmp0_0 = this.w4l_1;
    var tmp$ret$4;
    $l$block_2: {
      // Inline function 'kotlin.collections.all' call
      var tmp_3;
      ...
      var _iterator__ex2g4s_1 = tmp0_0.l1();
    ...
    $l$block_3: {
      ...
      var count = 0;
      var _iterator__ex2g4s_2 = tmp0_1.l1();
    ...
    if (!(tmp$ret$9 <= 1)) {
      ...
      var tmp0_2 = this.w4l_1;
      // Inline function 'kotlin.collections.filterTo' call
      var destination = ArrayList.n2();
      var _iterator__ex2g4s_3 = tmp0_2.l1();
      while (_iterator__ex2g4s_3.m1()) {
        var element_3 = _iterator__ex2g4s_3.n1();
        if (element_3.a() == null) {
          destination.z1(element_3);
        }
      }
      // Inline function 'kotlin.collections.map' call
      // Inline function 'kotlin.collections.mapTo' call
      var destination_0 = ArrayList.y1(collectionSizeOrDefault(destination, 10));
      var _iterator__ex2g4s_4 = destination.l1();
      while (_iterator__ex2g4s_4.m1()) {
        var item = _iterator__ex2g4s_4.n1();
        var tmp$ret$18 = item.q4k_1;
        destination_0.z1(tmp$ret$18);
      }
  ...
  q4l(storage, input, startIndex) {
    if ((startIndex + this.x4l_1 | 0) > charSequenceLength(input)) {
      var tmp = Companion_instance_13;
      return tmp.j4l(startIndex, NumberSpanParserOperation$consume$lambda(this));
    }
    ...
    if (digitsInRow._v < this.x4l_1) {
      var tmp_0 = Companion_instance_13;
      return tmp_0.j4l(startIndex, NumberSpanParserOperation$consume$lambda_0(digitsInRow, this));
    }
    var index = startIndex;
    var inductionVariable = 0;
    var last = this.w4l_1.k2() - 1 | 0;
    if (inductionVariable <= last)
      do {
        var i = inductionVariable;
        inductionVariable = inductionVariable + 1 | 0;
        var tmp0_elvis_lhs = this.w4l_1.j2(i).a();
        var length = tmp0_elvis_lhs == null ? (digitsInRow._v - this.x4l_1 | 0) + 1 | 0 : tmp0_elvis_lhs;
        var error = this.w4l_1.j2(i).r4k(storage, input, index, index + length | 0);
        if (!(error == null)) {
          var tmp2 = index;
          // Inline function 'kotlin.text.substring' call
          ...
          var tmp_2 = index;
          return tmp_1.j4l(tmp_2, NumberSpanParserOperation$consume$lambda_1(numberString, this, i, error));
        }
        index = index + length | 0;
      }
       while (inductionVariable <= last);
    return Companion_instance_13.i4l(index);
  }
  toString() {
...
class PlainStringParserOperation {
  constructor(string) {
    ...
    // Inline function 'kotlin.require' call
    if (!!isAsciiDigit(charCodeAt(this.z4l_1, 0))) {
      var message_0 = "String '" + this.z4l_1 + "' starts with a digit";
      throw IllegalArgumentException.h2(toString(message_0));
    }
    // Inline function 'kotlin.require' call
    if (!!isAsciiDigit(charCodeAt(this.z4l_1, this.z4l_1.length - 1 | 0))) {
      var message_1 = "String '" + this.z4l_1 + "' ends with a digit";
      throw IllegalArgumentException.h2(toString(message_1));
    }
  }
  q4l(storage, input, startIndex) {
    if ((startIndex + this.z4l_1.length | 0) > charSequenceLength(input)) {
      var tmp = Companion_instance_13;
      return tmp.j4l(startIndex, PlainStringParserOperation$consume$lambda(this));
    }
    var inductionVariable = 0;
    var last = charSequenceLength(this.z4l_1) - 1 | 0;
    if (inductionVariable <= last)
      do {
        var i = inductionVariable;
        inductionVariable = inductionVariable + 1 | 0;
        if (!(charSequenceGet(input, startIndex + i | 0) === charCodeAt(this.z4l_1, i))) {
          var tmp_0 = Companion_instance_13;
          return tmp_0.j4l(startIndex, PlainStringParserOperation$consume$lambda_0(this, input, startIndex, i));
        }
      }
       while (inductionVariable <= last);
    return Companion_instance_13.i4l(startIndex + this.z4l_1.length | 0);
  }
  toString() {
    return "'" + this.z4l_1 + "'";
  }
...
class SignParser {
  constructor(isNegativeSetter, withPlusSign, whatThisExpects) {
    this.a4m_1 = isNegativeSetter;
    this.b4m_1 = withPlusSign;
    this.c4m_1 = whatThisExpects;
  }
  q4l(storage, input, startIndex) {
    if (startIndex >= charSequenceLength(input))
      return Companion_instance_13.i4l(startIndex);
    var char = charSequenceGet(input, startIndex);
    if (char === _Char___init__impl__6a9atx(45)) {
      this.a4m_1(storage, true);
      return Companion_instance_13.i4l(startIndex + 1 | 0);
    }
    if (char === _Char___init__impl__6a9atx(43) && this.b4m_1) {
      this.a4m_1(storage, false);
      return Companion_instance_13.i4l(startIndex + 1 | 0);
    }
    var tmp = Companion_instance_13;
    return tmp.j4l(startIndex, SignParser$consume$lambda(this, char));
  }
  toString() {
    return this.c4m_1;
  }
...
class DecimalFraction {
  constructor(fractionalPart, digits) {
    this.t4d_1 = fractionalPart;
    this.u4d_1 = digits;
    // Inline function 'kotlin.require' call
    if (!(this.u4d_1 >= 0)) {
      var message = 'Digits must be non-negative, but was ' + this.u4d_1;
      throw IllegalArgumentException.h2(toString(message));
    }
  }
  v4d(newDigits) {
    return newDigits === this.u4d_1 ? this.t4d_1 : newDigits > this.u4d_1 ? imul(this.t4d_1, get_POWERS_OF_TEN()[newDigits - this.u4d_1 | 0]) : this.t4d_1 / get_POWERS_OF_TEN()[this.u4d_1 - newDigits | 0] | 0;
  }
  e4m(other) {
    var tmp0 = this.u4d_1;
    ...
    return compareTo(this.v4d(maxPrecision), other.v4d(maxPrecision));
  }
  d(other) {
    return this.e4m(other instanceof DecimalFraction ? other : THROW_CCE());
  }
  equals(other) {
    var tmp;
    if (other instanceof DecimalFraction) {
      tmp = this.e4m(other) === 0;
    } else {
      tmp = false;
    }
    return tmp;
  ...
  toString() {
    ...
    // Inline function 'kotlin.apply' call
    var this_0 = StringBuilder.h1();
    var denominator = get_POWERS_OF_TEN()[this.u4d_1];
    this_0.xg(this.t4d_1 / denominator | 0);
    this_0.k1(_Char___init__impl__6a9atx(46));
    this_0.i1(removePrefix((denominator + (this.t4d_1 % denominator | 0) | 0).toString(), '1'));
    return this_0.toString();
  }
  hashCode() {
    throw UnsupportedOperationException.ka('DecimalFraction is not supposed to be used as a hash key');
  }
}
class TimeBasedDateTimeUnitSerializer {
  constructor() {
    ...
    tmp.f4m_1 = lazy_0(tmp_0, TimeBasedDateTimeUnitSerializer$descriptor$delegate$lambda);
  }
  hv() {
    var tmp0 = this.f4m_1;
    var tmp = KProperty1;
  ...
  g4m(encoder, value) {
    ...
    var descriptor = this.hv();
    var composite = encoder.rz(descriptor);
    composite.d11(TimeBasedDateTimeUnitSerializer_getInstance().hv(), 0, value.k47_1);
    composite.sz(descriptor);
  }
  iv(encoder, value) {
    return this.g4m(encoder, value instanceof TimeBased ? value : THROW_CCE());
  }
  jv(decoder) {
    var seen = {_v: false};
    ...
    var descriptor = this.hv();
    var composite = decoder.rz(descriptor);
    if (composite.h10()) {
      nanoseconds._v = composite.xz(TimeBasedDateTimeUnitSerializer_getInstance().hv(), 0);
      seen._v = true;
    } else {
      loop: while (true) {
        var elementIndex = composite.i10(TimeBasedDateTimeUnitSerializer_getInstance().hv());
        switch (elementIndex) {
          case 0:
            nanoseconds._v = composite.xz(TimeBasedDateTimeUnitSerializer_getInstance().hv(), 0);
            seen._v = true;
    ...
    composite.sz(descriptor);
    if (!seen._v)
      throw MissingFieldException.kx('nanoseconds', this.hv().iw());
...
class DateBasedDateTimeUnitSerializer extends AbstractPolymorphicSerializer {
  constructor() {
    ...
    var tmp = this;
    var tmp_0 = LazyThreadSafetyMode_PUBLICATION_getInstance();
    tmp.h4m_1 = lazy_0(tmp_0, DateBasedDateTimeUnitSerializer$impl$delegate$lambda);
  }
  kv(decoder, klassName) {
    return _get_impl__d88w17(this).kv(decoder, klassName);
  }
  i4m(encoder, value) {
    return _get_impl__d88w17(this).mv(encoder, value);
  }
  mv(encoder, value) {
    return this.i4m(encoder, value instanceof DateBased ? value : THROW_CCE());
  }
  lv() {
    return getKClass(DateBased);
  }
  hv() {
    return _get_impl__d88w17(this).hv();
  }
}
class DayBasedDateTimeUnitSerializer {
  constructor() {
    ...
    var tmp = this;
    var tmp_0 = LazyThreadSafetyMode_PUBLICATION_getInstance();
    tmp.j4m_1 = lazy_0(tmp_0, DayBasedDateTimeUnitSerializer$descriptor$delegate$lambda);
  }
  hv() {
    var tmp0 = this.j4m_1;
    var tmp = KProperty1;
  ...
  k4m(encoder, value) {
    ...
    var descriptor = this.hv();
    var composite = encoder.rz(descriptor);
    composite.c11(DayBasedDateTimeUnitSerializer_getInstance().hv(), 0, value.q47_1);
    composite.sz(descriptor);
  }
  iv(encoder, value) {
    return this.k4m(encoder, value instanceof DayBased ? value : THROW_CCE());
  }
  jv(decoder) {
    var seen = {_v: false};
    var days = {_v: 0};
    ...
    var composite = decoder.rz(descriptor);
    if (composite.h10()) {
      days._v = composite.wz(DayBasedDateTimeUnitSerializer_getInstance().hv(), 0);
      seen._v = true;
    } else {
      loop: while (true) {
        var elementIndex = composite.i10(DayBasedDateTimeUnitSerializer_getInstance().hv());
        switch (elementIndex) {
          case 0:
            days._v = composite.wz(DayBasedDateTimeUnitSerializer_getInstance().hv(), 0);
            seen._v = true;
    ...
    composite.sz(descriptor);
    if (!seen._v)
      throw MissingFieldException.kx('days', this.hv().iw());
...
class MonthBasedDateTimeUnitSerializer {
  constructor() {
    ...
    var tmp = this;
    var tmp_0 = LazyThreadSafetyMode_PUBLICATION_getInstance();
    tmp.l4m_1 = lazy_0(tmp_0, MonthBasedDateTimeUnitSerializer$descriptor$delegate$lambda);
  }
  hv() {
    var tmp0 = this.l4m_1;
    var tmp = KProperty1;
  ...
  m4m(encoder, value) {
    ...
    var descriptor = this.hv();
    var composite = encoder.rz(descriptor);
    composite.c11(MonthBasedDateTimeUnitSerializer_getInstance().hv(), 0, value.r47_1);
    composite.sz(descriptor);
  }
  iv(encoder, value) {
    return this.m4m(encoder, value instanceof MonthBased ? value : THROW_CCE());
  }
  jv(decoder) {
    var seen = {_v: false};
    var months = {_v: 0};
    ...
    var composite = decoder.rz(descriptor);
    if (composite.h10()) {
      months._v = composite.wz(MonthBasedDateTimeUnitSerializer_getInstance().hv(), 0);
      seen._v = true;
    } else {
      loop: while (true) {
        var elementIndex = composite.i10(MonthBasedDateTimeUnitSerializer_getInstance().hv());
        switch (elementIndex) {
          case 0:
            months._v = composite.wz(MonthBasedDateTimeUnitSerializer_getInstance().hv(), 0);
            seen._v = true;
    ...
    composite.sz(descriptor);
    if (!seen._v)
      throw MissingFieldException.kx('months', this.hv().iw());
...
class DateTimeUnitSerializer extends AbstractPolymorphicSerializer {
  constructor() {
    ...
    var tmp = this;
    var tmp_0 = LazyThreadSafetyMode_PUBLICATION_getInstance();
    tmp.n4m_1 = lazy_0(tmp_0, DateTimeUnitSerializer$impl$delegate$lambda);
  }
  kv(decoder, klassName) {
    return _get_impl__d88w17_0(this).kv(decoder, klassName);
  }
  o4m(encoder, value) {
    return _get_impl__d88w17_0(this).mv(encoder, value);
  }
  mv(encoder, value) {
    return this.o4m(encoder, value instanceof DateTimeUnit ? value : THROW_CCE());
  }
  lv() {
    return getKClass(DateTimeUnit);
  }
  hv() {
    return _get_impl__d88w17_0(this).hv();
  }
}
class LocalDateSerializer {
  constructor() {
    LocalDateSerializer_instance = this;
    this.p4m_1 = PrimitiveSerialDescriptor('kotlinx.datetime.LocalDate', STRING_getInstance());
  }
  hv() {
    return this.p4m_1;
  }
  jv(decoder) {
    return Companion_getInstance_14().u4m(decoder.mz());
  }
  v4m(encoder, value) {
    encoder.w10(value.toString());
  }
  iv(encoder, value) {
    return this.v4m(encoder, value instanceof LocalDate ? value : THROW_CCE());
  }
}
class LocalDateTimeSerializer {
  constructor() {
    LocalDateTimeSerializer_instance = this;
    this.w4m_1 = PrimitiveSerialDescriptor('kotlinx.datetime.LocalDateTime', STRING_getInstance());
  }
  hv() {
    return this.w4m_1;
  }
  jv(decoder) {
    return Companion_getInstance_15().z4m(decoder.mz());
  }
  a4n(encoder, value) {
    encoder.w10(value.toString());
  }
  iv(encoder, value) {
    return this.a4n(encoder, value instanceof LocalDateTime ? value : THROW_CCE());
  }
}
class LocalTimeSerializer {
  constructor() {
    LocalTimeSerializer_instance = this;
    this.b4n_1 = PrimitiveSerialDescriptor('kotlinx.datetime.LocalTime', STRING_getInstance());
  }
  hv() {
    return this.b4n_1;
  }
  jv(decoder) {
    return Companion_getInstance_16().e4n(decoder.mz());
  }
  f4n(encoder, value) {
    encoder.w10(value.toString());
  }
  iv(encoder, value) {
    return this.f4n(encoder, value instanceof LocalTime ? value : THROW_CCE());
  }
}
class FixedOffsetTimeZoneSerializer {
  constructor() {
    FixedOffsetTimeZoneSerializer_instance = this;
    this.g4n_1 = PrimitiveSerialDescriptor('kotlinx.datetime.FixedOffsetTimeZone', STRING_getInstance());
  }
  hv() {
    return this.g4n_1;
  }
  jv(decoder) {
    var zone = Companion_getInstance_18().i4n(decoder.mz());
    if (zone instanceof FixedOffsetTimeZone) {
      return zone;
    } else {
      throw SerializationException.xw("Timezone identifier '" + zone.toString() + "' does not correspond to a fixed-offset timezone");
    }
  }
  j4n(encoder, value) {
    encoder.w10(value.e49_1);
  }
  iv(encoder, value) {
    return this.j4n(encoder, value instanceof FixedOffsetTimeZone ? value : THROW_CCE());
  }
}
class TimeZoneSerializer {
  constructor() {
    TimeZoneSerializer_instance = this;
    this.k4n_1 = PrimitiveSerialDescriptor('kotlinx.datetime.TimeZone', STRING_getInstance());
  }
  hv() {
    return this.k4n_1;
  }
  jv(decoder) {
    return Companion_getInstance_18().i4n(decoder.mz());
  }
  l4n(encoder, value) {
    encoder.w10(value.m4n());
  }
  iv(encoder, value) {
    return this.l4n(encoder, value instanceof TimeZone ? value : THROW_CCE());
  }
}
class UtcOffsetSerializer {
  constructor() {
    UtcOffsetSerializer_instance = this;
    this.n4n_1 = PrimitiveSerialDescriptor('kotlinx.datetime.UtcOffset', STRING_getInstance());
  }
  hv() {
    return this.n4n_1;
  }
  jv(decoder) {
    return Companion_getInstance_19().p4n(decoder.mz());
  }
  q4n(encoder, value) {
    encoder.w10(value.toString());
  }
  iv(encoder, value) {
    return this.q4n(encoder, value instanceof UtcOffset ? value : THROW_CCE());
  }
}
class YearMonthSerializer {
  constructor() {
    YearMonthSerializer_instance = this;
    this.r4n_1 = PrimitiveSerialDescriptor('kotlinx.datetime.YearMonth', STRING_getInstance());
  }
  hv() {
    return this.r4n_1;
  }
  jv(decoder) {
    return Companion_instance_20.s4n(decoder.mz());
  }
  t4n(encoder, value) {
    encoder.w10(value.toString());
  }
  iv(encoder, value) {
    return this.t4n(encoder, value instanceof YearMonth ? value : THROW_CCE());
  }
}
class TimeZone {
  static y4n() {
  ...
  a4o(instant) {
    var tmp;
    try {
      tmp = toLocalDateTimeImpl(instant, this.z4n(instant));
    } catch ($p) {
      var tmp_0;
      if ($p instanceof IllegalArgumentException) {
        var e = $p;
        throw DateTimeArithmeticException.y48('Instant ' + instant.toString() + ' is not representable as LocalDateTime.', e);
      } else {
        throw $p;
      }
    }
  ...
  hashCode() {
    return getStringHashCode(this.m4n());
  }
  toString() {
    return this.m4n();
  }
...
class SystemTimeZone extends TimeZone {
  ...
  z4n(instant) {
    return UtcOffset_0(VOID, -numberToInt((new Date(toNumber(instant.zr()))).getTimezoneOffset()) | 0);
  }
  equals(other) {
    return other === this;
  }
...
class tzdb$1 {
  ...
  b4o(id) {
    var tmp0_elvis_lhs = this.c4o_1.c4(id);
    var tmp;
    if (tmp0_elvis_lhs == null) {
      throw IllegalTimeZoneException.r48('Unknown time zone: ' + id);
    } else {
      tmp = tmp0_elvis_lhs;
    }
    return tmp;
...
class Companion_13 {
  constructor() {
    ...
    this.q4m_1 = new LocalDate(-999999999, 1, 1);
    this.r4m_1 = new LocalDate(999999999, 12, 31);
    this.s4m_1 = -365243219162n;
    this.t4m_1 = 365241780471n;
  }
  d4o(input, format) {
    return format.vr(input);
  }
  u4m(input, format, $super) {
    format = format === VOID ? getIsoDateFormat() : format;
    return $super === VOID ? this.d4o(input, format) : $super.d4o.call(this, input, format);
  }
  e4o(epochDays) {
    // Inline function 'kotlin.require' call
...
class LocalDate {
  constructor(year, month, day) {
    ...
    this.i4b_1 = month;
    // Inline function 'kotlin.require' call
    if (!isValidYear(this.g4b_1)) {
      var message = 'Invalid date: the year is out of range';
      throw IllegalArgumentException.h2(toString(message));
    }
    var containsArg = this.i4b_1;
    // Inline function 'kotlin.require' call
    if (!(1 <= containsArg ? containsArg <= 12 : false)) {
      var message_0 = 'Invalid date: month must be a number between 1 and 12, got ' + this.i4b_1;
      throw IllegalArgumentException.h2(toString(message_0));
    }
    var containsArg_0 = this.h4b_1;
    // Inline function 'kotlin.require' call
    if (!(1 <= containsArg_0 ? containsArg_0 <= 31 : false)) {
      var message_1 = 'Invalid date: day of month must be a number between 1 and 31, got ' + this.h4b_1;
      throw IllegalArgumentException.h2(toString(message_1));
    }
    if (this.h4b_1 > 28 && this.h4b_1 > monthLength(this.i4b_1, isLeapYear(this.g4b_1))) {
      if (this.h4b_1 === 29) {
        throw IllegalArgumentException.h2("Invalid date 'February 29' as '" + this.g4b_1 + "' is not a leap year");
      } else {
        throw IllegalArgumentException.h2("Invalid date '" + Month_0(month).toString() + ' ' + this.h4b_1 + "'");
      }
    }
  }
  f4o() {
    var y = fromInt(this.g4b_1);
    var m = fromInt(this.i4b_1);
    var total = 0n;
  ...
  b4b() {
    ...
    var tmp$ret$2 = add(r, other & shiftRight((r ^ other) & (r | negate(r)), 63));
    var dow0 = convertToInt(tmp$ret$2);
    return DayOfWeek_0(dow0 + 1 | 0);
  }
  d4b() {
    return (firstDayOfYear(this.j4b(), isLeapYear(this.g4b_1)) + this.h4b_1 | 0) - 1 | 0;
  }
  g4o(other) {
    var y = compareTo(this.g4b_1, other.g4b_1);
    if (!(y === 0)) {
      return y;
    }
    var m = compareTo(this.i4b_1, other.i4b_1);
    if (!(m === 0)) {
      return m;
    }
    return compareTo(this.h4b_1, other.h4b_1);
  }
  d(other) {
    return this.g4o(other instanceof LocalDate ? other : THROW_CCE());
  }
  h4o(monthsToAdd) {
    if (monthsToAdd === 0n) {
      return this;
    }
    var tmp0 = multiply(numberToLong(this.g4b_1), 12n);
    // Inline function 'kotlin.Long.plus' call
    var other = this.i4b_1 - 1 | 0;
    ...
    if (!contains(isInterface(this_0, ClosedRange) ? this_0 : THROW_CCE(), newYear)) {
      throw IllegalArgumentException.h2('The result of adding ' + monthsToAdd.toString() + ' months to ' + this.toString() + ' is out of LocalDate range.');
    }
    // Inline function 'kotlin.mod' call
    // Inline function 'kotlin.mod' call
    ...
    return resolvePreviousValid(this, convertToInt(newYear), newMonth, this.h4b_1);
  }
  i4o(daysToAdd) {
    return daysToAdd === 0n ? this : Companion_getInstance_14().e4o(safeAdd(this.f4o(), daysToAdd));
  }
  equals(other) {
    var tmp;
    if (this === other) {
  ...
  hashCode() {
    var yearValue = this.g4b_1;
    var monthValue = this.i4b_1;
    var dayValue = this.h4b_1;
    return yearValue & -2048 ^ (((yearValue << 11) + (monthValue << 6) | 0) + dayValue | 0);
  }
  toString() {
    return format(this, Formats_getInstance().a49());
  }
}
class Companion_14 {
  constructor() {
    Companion_instance_15 = this;
    this.x4m_1 = new LocalDateTime(Companion_getInstance_14().q4m_1, Companion_getInstance_16().c4n_1);
    this.y4m_1 = new LocalDateTime(Companion_getInstance_14().r4m_1, Companion_getInstance_16().d4n_1);
  }
  j4o(input, format) {
    return format.vr(input);
  }
  z4m(input, format, $super) {
...
class LocalDateTime {
  ...
  f4b() {
    return this.c4d_1.g4b_1;
  }
  m4d() {
    return this.d4d_1.w4d_1;
  }
  g4d() {
    return this.d4d_1.x4d_1;
  }
  i4d() {
    return this.d4d_1.y4d_1;
  }
  k4d() {
    return this.d4d_1.z4d_1;
  }
  k4o(other) {
    var d = this.c4d_1.g4o(other.c4d_1);
    if (!(d === 0)) {
      return d;
    }
    return this.d4d_1.l4o(other.d4d_1);
  }
  d(other) {
    return this.k4o(other instanceof LocalDateTime ? other : THROW_CCE());
  }
  equals(other) {
    var tmp;
    if (this === other) {
...
class Companion_15 {
  constructor() {
    ...
    this.c4n_1 = new LocalTime(0, 0, 0, 0);
    this.d4n_1 = new LocalTime(23, 59, 59, 999999999);
  }
  q4o(input, format) {
    return format.vr(input);
  }
  e4n(input, format, $super) {
    format = format === VOID ? getIsoTimeFormat() : format;
    return $super === VOID ? this.q4o(input, format) : $super.q4o.call(this, input, format);
  }
  r4o(secondOfDay, nanoOfSecond) {
    // Inline function 'kotlin.require' call
    // Inline function 'kotlin.require' call
...
class LocalTime {
  constructor(hour, minute, second, nanosecond) {
    ...
    this.x4d_1 = minute;
    this.y4d_1 = second;
    this.z4d_1 = nanosecond;
    _init_$check(this.w4d_1, 0, 23, 'hour');
    _init_$check(this.x4d_1, 0, 59, 'minute');
    _init_$check(this.y4d_1, 0, 59, 'second');
    _init_$check(this.z4d_1, 0, 999999999, 'nanosecond');
  }
  l4o(other) {
    var h = compareTo(this.w4d_1, other.w4d_1);
    if (!(h === 0)) {
      return h;
    }
    var m = compareTo(this.x4d_1, other.x4d_1);
    if (!(m === 0)) {
      return m;
    }
    var s = compareTo(this.y4d_1, other.y4d_1);
    if (!(s === 0)) {
      return s;
    }
    return compareTo(this.z4d_1, other.z4d_1);
  }
  d(other) {
    return this.l4o(other instanceof LocalTime ? other : THROW_CCE());
  }
  hashCode() {
    var nod = this.o4o();
  ...
  n4o() {
    var total = imul(this.w4d_1, 3600);
    total = total + imul(this.x4d_1, 60) | 0;
    total = total + this.y4d_1 | 0;
    return total;
  }
  o4o() {
    var tmp0 = fromInt(this.w4d_1);
    // Inline function 'kotlin.Long.times' call
    var other = 1000000000;
    // Inline function 'kotlin.Long.times' call
...
class FixedOffsetTimeZone extends TimeZone {
  ...
  static f49(offset) {
    return this.s4o(offset, offset.toString());
  }
  z4n(instant) {
    return this.d49_1;
  }
  a4o(instant) {
    return toLocalDateTime_0(instant, this.d49_1);
  }
}
class Companion_17 {
  constructor() {
    Companion_instance_18 = this;
    this.h4n_1 = FixedOffsetTimeZone.s4o(Companion_getInstance_19().o4n_1, 'UTC');
  }
  t4o() {
    var _destruct__k2r9zo = currentSystemDefaultZone();
    var name = _destruct__k2r9zo.zk();
    var zone = _destruct__k2r9zo.al();
    return zone == null ? this.i4n(name) : zone;
  }
  i4n(zoneId) {
    if (zoneId === 'UTC') {
      return this.h4n_1;
    ...
    if (zoneId === 'Z' || zoneId === 'z') {
      return asTimeZone(Companion_getInstance_19().o4n_1);
    }
    if (zoneId === 'SYSTEM') {
      return this.t4o();
    }
    if (zoneId.length === 1) {
      throw IllegalTimeZoneException.r48('Invalid zone ID: ' + zoneId);
    }
    try {
      if (startsWith_0(zoneId, '+') || startsWith_0(zoneId, '-')) {
        return asTimeZone(get_lenientOffsetFormat().vr(zoneId));
      }
      switch (zoneId) {
        case 'UTC':
        case 'GMT':
        case 'UT':
          return FixedOffsetTimeZone.s4o(Companion_getInstance_19().o4n_1, zoneId);
      }
      if (startsWith_0(zoneId, 'UTC+') || startsWith_0(zoneId, 'GMT+') || startsWith_0(zoneId, 'UTC-') || startsWith_0(zoneId, 'GMT-')) {
        ...
        var offset = get_lenientOffsetFormat().vr(substring_0(zoneId, 3));
        return offset.a4g_1 === 0 ? FixedOffsetTimeZone.s4o(offset, prefix) : FixedOffsetTimeZone.s4o(offset, prefix + offset.toString());
      }
      if (startsWith_0(zoneId, 'UT+') || startsWith_0(zoneId, 'UT-')) {
        var offset_0 = get_lenientOffsetFormat().vr(substring_0(zoneId, 2));
        return offset_0.a4g_1 === 0 ? FixedOffsetTimeZone.s4o(offset_0, 'UT') : FixedOffsetTimeZone.s4o(offset_0, 'UT' + offset_0.toString());
      }
    } catch ($p) {
      if ($p instanceof DateTimeFormatException) {
        var e = $p;
        throw IllegalTimeZoneException.s48(e);
      } else {
        throw $p;
      }
    }
    ...
    try {
      ...
      if ($p instanceof Exception) {
        var e_0 = $p;
        throw IllegalTimeZoneException.t48('Invalid zone ID: ' + zoneId, e_0);
      } else {
        throw $p;
      }
    }
...
class Companion_18 {
  constructor() {
    ...
    this.o4n_1 = new UtcOffset(0);
  }
  u4o(input, format) {
    return format.vr(input);
  }
  p4n(input, format, $super) {
    format = format === VOID ? getIsoUtcOffsetFormat() : format;
    return $super === VOID ? this.u4o(input, format) : $super.u4o.call(this, input, format);
  }
  v4o(hours, minutes, seconds) {
    validate(this, hours, minutes, seconds);
    return hours === 0 && minutes === 0 && seconds === 0 ? this.o4n_1 : this.w4o((imul(hours, 3600) + imul(minutes, 60) | 0) + seconds | 0);
  }
  w4o(seconds) {
    validateTotal(this, seconds);
    var tmp;
    if ((seconds % 900 | 0) === 0) {
      var tmp0_elvis_lhs = get_utcOffsetCache().c4(seconds);
      var tmp_0;
      if (tmp0_elvis_lhs == null) {
        // Inline function 'kotlin.also' call
        var this_0 = new UtcOffset(seconds);
        // Inline function 'kotlin.collections.set' call
        get_utcOffsetCache().f4(seconds, this_0);
        tmp_0 = this_0;
      } else {
...
class UtcOffset {
  ...
  toString() {
    return format_2(this, Formats_instance_2.a49());
  }
}
class Companion_19 {
  x4o(input, format) {
  ...
  s4n(input, format, $super) {
    format = format === VOID ? Formats_instance_3.a49() : format;
...
class YearMonth {
  constructor(year, month) {
    ...
    var containsLower = Companion_getInstance_14().q4m_1.g4b_1;
    var containsUpper = Companion_getInstance_14().r4m_1.g4b_1;
    var containsArg = this.g4h_1;
    // Inline function 'kotlin.require' call
    if (!(containsLower <= containsArg ? containsArg <= containsUpper : false)) {
      var message_0 = 'Year ' + this.g4h_1 + ' is out of range: ' + Companion_getInstance_14().q4m_1.g4b_1 + '..' + Companion_getInstance_14().r4m_1.g4b_1;
      throw IllegalArgumentException.h2(toString(message_0));
    }
  }
  j4b() {
    return Month_0(this.h4h_1);
  }
  y4o(other) {
    var tmp = KProperty1;
  ...
  d(other) {
    return this.y4o(other instanceof YearMonth ? other : THROW_CCE());
  }
  toString() {
    return Formats_instance_3.a49().b49(this);
  }
  equals(other) {
    var tmp;
    var tmp_0;
    if (other instanceof YearMonth) {
      tmp_0 = this.g4h_1 === other.g4h_1;
    } else {
      tmp_0 = false;
    }
    if (tmp_0) {
      tmp = this.j4b().equals(other.j4b());
    } else {
      tmp = false;
    }
    return tmp;
  ...
  hashCode() {
    return imul(this.g4h_1, 31) + this.j4b().hashCode() | 0;
  }
}
...
class RegionTimeZone extends TimeZone {
  ...
  z4n(instant) {
    return this.u4n_1.z4o(instant);
  }
}
class TimeZoneRulesCommon {
  constructor(transitionEpochSeconds, offsets, recurringZoneRules) {
    this.a4p_1 = transitionEpochSeconds;
    this.b4p_1 = offsets;
    this.c4p_1 = recurringZoneRules;
    // Inline function 'kotlin.require' call
    if (!(this.b4p_1.k2() === (this.a4p_1.k2() + 1 | 0))) {
    ...
    var this_0 = ArrayList.n2();
    var inductionVariable = 0;
    var last = this.a4p_1.k2() - 1 | 0;
    if (inductionVariable <= last)
      do {
        var i = inductionVariable;
        inductionVariable = inductionVariable + 1 | 0;
        var instant = Companion_getInstance().ur(this.a4p_1.j2(i));
        var ldtBefore = toLocalDateTime_0(instant, this.b4p_1.j2(i));
        var ldtAfter = toLocalDateTime_0(instant, this.b4p_1.j2(i + 1 | 0));
        if (ldtBefore.k4o(ldtAfter) < 0) {
          this_0.z1(ldtBefore);
          this_0.z1(ldtAfter);
        } else {
          this_0.z1(ldtAfter);
  ...
  z4o(instant) {
    var epochSeconds = instant.xr_1;
    var tmp;
    if (!(this.c4p_1 == null)) {
      var tmp0_safe_receiver = lastOrNull(this.a4p_1);
      var tmp_0;
      if (tmp0_safe_receiver == null) {
        tmp_0 = null;
      } else {
    ...
    if (tmp) {
      return this.c4p_1.f4p(instant, last(this.b4p_1));
    }
    // Inline function 'kotlin.let' call
    // Inline function 'kotlin.math.absoluteValue' call
    var this_0 = binarySearch(this.a4p_1, epochSeconds) + 1 | 0;
    var index = abs(this_0);
    return this.b4p_1.j2(index);
  }
  toString() {
    // Inline function 'kotlin.text.buildString' call
    // Inline function 'kotlin.apply' call
    var this_0 = StringBuilder.h1();
    var inductionVariable = 0;
    var last_0 = this.a4p_1.k2() - 1 | 0;
    if (inductionVariable <= last_0)
      do {
        var i = inductionVariable;
        inductionVariable = inductionVariable + 1 | 0;
        this_0.o1(this.b4p_1.j2(i));
        this_0.i1(' until ');
        this_0.o1(Companion_getInstance().ur(this.a4p_1.j2(i)));
        this_0.i1(', ');
      }
       while (inductionVariable <= last_0);
    this_0.i1('then ');
    this_0.o1(last(this.b4p_1));
    if (!(this.c4p_1 == null)) {
      this_0.i1(', after that ');
      this_0.o1(this.c4p_1);
    }
    return this_0.toString();
  }
}
class Rule {
  constructor(transitionDateTime, offsetBefore, offsetAfter) {
    this.g4p_1 = transitionDateTime;
    this.h4p_1 = offsetBefore;
    this.i4p_1 = offsetAfter;
  }
  toString() {
    return 'transitioning from ' + this.h4p_1.toString() + ' to ' + this.i4p_1.toString() + ' on ' + toString_1(this.g4p_1);
  }
}
class sam$kotlin_Comparator$0_0 {
  constructor(function_0) {
    this.j4p_1 = function_0;
  }
  pi(a, b) {
    return this.j4p_1(a, b);
  }
  compare(a, b) {
    return this.pi(a, b);
  }
...
function DayOfWeek_0(isoDayNumber) {
  ...
  return get_entries().j2(isoDayNumber - 1 | 0);
}
...
function Month_0(number) {
  ...
  return get_entries_0().j2(number - 1 | 0);
}
...
function asTimeZone(_this__u8e3s4) {
  return FixedOffsetTimeZone.f49(_this__u8e3s4);
}
...
function char(_this__u8e3s4, value) {
  return _this__u8e3s4.u49(toString_0(value));
}
function optional(_this__u8e3s4, ifZero, format) {
  ...
  if (isInterface(_this__u8e3s4, AbstractDateTimeFormatBuilder)) {
    _this__u8e3s4.m4a(ifZero, typeof format === 'function' ? format : THROW_CCE());
    tmp = Unit_instance;
  } else {
...
function alternativeParsing(_this__u8e3s4, alternativeFormats, primaryFormat) {
  ...
  if (isInterface(_this__u8e3s4, AbstractDateTimeFormatBuilder)) {
    ...
    _this__u8e3s4.n4a(tmp_0, typeof primaryFormat === 'function' ? primaryFormat : THROW_CCE());
    tmp = Unit_instance;
  } else {
    throw IllegalStateException.o('impossible');
  }
...
function secondFractionInternal(_this__u8e3s4, minLength, maxLength, grouping) {
  if (isInterface(_this__u8e3s4, AbstractWithTimeBuilder)) {
    _this__u8e3s4.t4a(new BasicFormatStructure(new FractionalSecondDirective(minLength, maxLength, grouping)));
  }
}
...
function ISO_DATE$delegate$lambda() {
  ...
  return tmp.r4b(ISO_DATE$delegate$lambda$lambda);
}
...
function ISO_DATE_BASIC$delegate$lambda() {
  _init_properties_LocalDateFormat_kt__k1uk9u();
  var tmp = Companion_instance_6;
  return tmp.r4b(ISO_DATE_BASIC$delegate$lambda$lambda);
}
...
function ISO_DATETIME$delegate$lambda() {
  ...
  return tmp.l4c(ISO_DATETIME$delegate$lambda$lambda);
}
function ISO_DATETIME$delegate$lambda$lambda($this$build) {
  _init_properties_LocalDateTimeFormat_kt__aloigl();
  $this$build.x49(get_ISO_DATE());
...
function ISO_TIME$delegate$lambda() {
  ...
  return tmp.a4e(ISO_TIME$delegate$lambda$lambda);
}
...
function isoOffset(_this__u8e3s4, zOnZero, useSeparator, outputMinute, outputSecond) {
  _init_properties_UtcOffsetFormat_kt__9r9ddw();
  // Inline function 'kotlin.require' call
  if (!(outputMinute.r4(outputSecond) >= 0)) {
...
function ISO_OFFSET$delegate$lambda() {
  ...
  return tmp.k4g(ISO_OFFSET$delegate$lambda$lambda);
}
...
function ISO_OFFSET_BASIC$delegate$lambda() {
  _init_properties_UtcOffsetFormat_kt__9r9ddw();
  var tmp = Companion_instance_10;
  return tmp.k4g(ISO_OFFSET_BASIC$delegate$lambda$lambda);
}
...
function FOUR_DIGIT_OFFSET$delegate$lambda() {
  _init_properties_UtcOffsetFormat_kt__9r9ddw();
  var tmp = Companion_instance_10;
  return tmp.k4g(FOUR_DIGIT_OFFSET$delegate$lambda$lambda);
}
...
function requireParsedField(field, name) {
  _init_properties_YearMonthFormat_kt__i0mmu0();
  if (field == null) {
    throw DateTimeFormatException.k48('Can not create a ' + name + ' from the given input: the field ' + name + ' is missing');
  }
  return field;
}
...
function ISO_YEAR_MONTH$delegate$lambda() {
  ...
  return tmp.i4h(ISO_YEAR_MONTH$delegate$lambda$lambda);
}
...
function Accessor$getterNotNull$ref(p0) {
  var l = (_this__u8e3s4) => p0.g4i(_this__u8e3s4);
...
function SignedFormatStructure$parser$lambda(this$0) {
  return (value, isNegative) => {
    var _iterator__ex2g4s = this$0.e4j_1.l1();
    while (_iterator__ex2g4s.m1()) {
      var field = _iterator__ex2g4s.n1();
      var wasNegative = field.r4g().z4i(value) === true;
      field.r4g().y4i(value, !(isNegative === wasNegative));
    }
    return Unit_instance;
  };
}
function formatter$checkIfAllNegative(this$0, value) {
  ...
  $l$loop: while (_iterator__ex2g4s.m1()) {
    var check = _iterator__ex2g4s.n1();
    if (check.r4g().z4i(value) === true)
      seenNonZero = true;
    else if (check.t4g(value))
      continue $l$loop;
    else
      return false;
  }
...
function basicFormats$rec($this_buildList, format) {
  if (format instanceof BasicFormatStructure)
    $this_buildList.z1(format.a4j_1);
  else {
    if (format instanceof ConcatenatedFormatStructure) {
      // Inline function 'kotlin.collections.forEach' call
      var _iterator__ex2g4s = format.s4a_1.l1();
      ...
      if (!(format instanceof ConstantFormatStructure)) {
        if (format instanceof SignedFormatStructure) {
          basicFormats$rec($this_buildList, format.c4j_1);
        } else {
          if (format instanceof AlternativesParsingFormatStructure) {
            basicFormats$rec($this_buildList, format.n4j_1);
            // Inline function 'kotlin.collections.forEach' call
            var _iterator__ex2g4s_0 = format.o4j_1.l1();
            while (_iterator__ex2g4s_0.m1()) {
              var element_0 = _iterator__ex2g4s_0.n1();
            ...
            if (format instanceof OptionalFormatStructure) {
              basicFormats$rec($this_buildList, format.j4j_1);
            } else {
              noWhenBranchMatchedException();
            }
          }
...
function conjunctionPredicate(predicates) {
  return predicates.j1() ? Truth_instance : predicates.k2() === 1 ? single(predicates) : new ConjunctionPredicate(predicates);
}
var Truth_instance;
...
function setWithoutReassigning(_this__u8e3s4, receiver, value) {
  var tmp0_elvis_lhs = _this__u8e3s4.y4i(receiver, value);
  var tmp;
  if (tmp0_elvis_lhs == null) {
    return null;
  } else {
...
function Parser__match_impl_nzt83d($this, input, initialContainer, startIndex) {
  ...
  iterate_over_alternatives: while (true) {
    ...
    var state = tmp;
    var output = state.k4l_1.o4b();
    var inputPosition = state.m4l_1;
    var parserStructure = state.l4l_1;
    // Inline function 'kotlin.run' call
    $l$block: {
      var inductionVariable = 0;
      var last = parserStructure.o4l_1.k2() - 1 | 0;
      if (inductionVariable <= last)
        do {
          var ix = inductionVariable;
          inductionVariable = inductionVariable + 1 | 0;
          // Inline function 'kotlinx.datetime.internal.format.parser.ParseResult.match' call
          var this_0 = parserStructure.o4l_1.j2(ix).q4l(output, input, inputPosition);
      ...
      if (parserStructure.p4l_1.j1()) {
        ...
        var inductionVariable_0 = parserStructure.p4l_1.k2() - 1 | 0;
        if (0 <= inductionVariable_0)
          do {
            var ix_0 = inductionVariable_0;
            inductionVariable_0 = inductionVariable_0 + -1 | 0;
            parseOptions.z1(new ParserState(output, parserStructure.p4l_1.j2(ix_0), inputPosition));
          }
  ...
  throw ParseException.t4l(errors);
}
function Parser__match$default_impl_x2xlti($this, input, initialContainer, startIndex, $super) {
  ...
  if ($super === VOID) {
    ...
    var tmp_0 = $super;
    tmp = (tmp_0 == null ? null : new Parser(tmp_0)).u4l.call(new Parser($this), input, initialContainer, startIndex);
  }
  return tmp;
}
...
function Parser__equals_impl_djxokv($this, other) {
  if (!(other instanceof Parser))
    return false;
  var tmp0_other_with_cast = other instanceof Parser ? other.n4l_1 : THROW_CCE();
...
function concat(_this__u8e3s4) {
  ...
  if (!_this__u8e3s4.j1()) {
    var iterator = _this__u8e3s4.p2(_this__u8e3s4.k2());
    while (iterator.o7()) {
      var tmp0 = iterator.q7();
      var acc = accumulator;
...
function formatError(errors) {
  if (errors.k2() === 1) {
    return 'Position ' + errors.j2(0).g4l_1 + ': ' + errors.j2(0).h4l_1();
  }
  var averageMessageLength = 33;
  var tmp0_buffer = StringBuilder.dc(imul(averageMessageLength, errors.k2()));
...
function concat$append(_this__u8e3s4, other) {
  var tmp;
  if (_this__u8e3s4.p4l_1.j1()) {
    tmp = new ParserStructure(plus(_this__u8e3s4.o4l_1, other.o4l_1), other.p4l_1);
  } else {
    // Inline function 'kotlin.collections.map' call
    var this_0 = _this__u8e3s4.p4l_1;
    // Inline function 'kotlin.collections.mapTo' call
    var destination = ArrayList.y1(collectionSizeOrDefault(this_0, 10));
    var _iterator__ex2g4s = this_0.l1();
    while (_iterator__ex2g4s.m1()) {
      var item = _iterator__ex2g4s.n1();
      var tmp$ret$2 = concat$append(item, other);
      destination.z1(tmp$ret$2);
    }
    tmp = new ParserStructure(_this__u8e3s4.o4l_1, destination);
  }
  return tmp;
}
function concat$simplify(_this__u8e3s4, unconditionalModifications) {
  // Inline function 'kotlin.collections.mutableListOf' call
  var newOperations = ArrayList.n2();
  var currentNumberSpan = null;
  var unconditionalModificationsForTails = toMutableList(unconditionalModifications);
  var _iterator__ex2g4s = _this__u8e3s4.o4l_1.l1();
  while (_iterator__ex2g4s.m1()) {
    var op = _iterator__ex2g4s.n1();
    if (op instanceof NumberSpanParserOperation) {
      if (!(currentNumberSpan == null)) {
        currentNumberSpan.m2(op.w4l_1);
      } else {
        currentNumberSpan = toMutableList(op.w4l_1);
      }
    } else {
      if (op instanceof UnconditionalModification) {
        unconditionalModificationsForTails.z1(op);
      } else {
        if (!(currentNumberSpan == null)) {
          newOperations.z1(new NumberSpanParserOperation(currentNumberSpan));
  ...
  while (_iterator__ex2g4s_0.m1()) {
    ...
    var tmp;
    if (simplified.o4l_1.j1()) {
      // Inline function 'kotlin.collections.ifEmpty' call
      var this_0 = simplified.p4l_1;
      var tmp_0;
      if (this_0.j1()) {
  ...
  if (currentNumberSpan == null) {
    ...
    $l$block_0: {
      ...
      var _iterator__ex2g4s_1 = mergedTails.l1();
      while (_iterator__ex2g4s_1.m1()) {
        var element_0 = _iterator__ex2g4s_1.n1();
        var tmp0_safe_receiver = firstOrNull(element_0.o4l_1);
        var tmp_4;
        if (tmp0_safe_receiver == null) {
          tmp_4 = null;
        } else {
    ...
    if (tmp$ret$8) {
      ...
      // Inline function 'kotlin.collections.map' call
      // Inline function 'kotlin.collections.mapTo' call
      var destination_0 = ArrayList.y1(collectionSizeOrDefault(mergedTails, 10));
      var _iterator__ex2g4s_2 = mergedTails.l1();
      while (_iterator__ex2g4s_2.m1()) {
        var item = _iterator__ex2g4s_2.n1();
        var firstOperation = firstOrNull(item.o4l_1);
        var tmp_5;
        if (firstOperation instanceof NumberSpanParserOperation) {
          tmp_5 = new ParserStructure(plus(listOf_0(new NumberSpanParserOperation(plus(currentNumberSpan, firstOperation.w4l_1))), drop(item.o4l_1, 1)), item.p4l_1);
        } else {
          if (firstOperation == null) {
            tmp_5 = new ParserStructure(listOf_0(new NumberSpanParserOperation(currentNumberSpan)), item.p4l_1);
          } else {
            tmp_5 = new ParserStructure(plus(listOf_0(new NumberSpanParserOperation(currentNumberSpan)), item.o4l_1), item.p4l_1);
          }
        }
        var tmp$ret$14 = tmp_5;
        destination_0.z1(tmp$ret$14);
      }
...
function formatError$lambda(it) {
  return 'position ' + it.g4l_1 + ": '" + it.h4l_1() + "'";
}
...
function _get_whatThisExpects__4pg11j($this) {
  ...
  while (_iterator__ex2g4s.m1()) {
    var item = _iterator__ex2g4s.n1();
    var length = item.a();
    var tmp$ret$2 = (length == null ? 'at least one digit' : '' + length + ' digits') + (' for ' + item.q4k_1);
    destination.z1(tmp$ret$2);
  }
  var consumerLengths = destination;
  var tmp;
  if ($this.y4l_1) {
    tmp = 'a number with at least ' + $this.x4l_1 + ' digits: ' + toString(consumerLengths);
  } else {
    tmp = 'a number with exactly ' + $this.x4l_1 + ' digits: ' + toString(consumerLengths);
  }
  return tmp;
}
...
function NumberSpanParserOperation$consume$lambda_1($numberString, this$0, $i, $error) {
  return () => "Can not interpret the string '" + $numberString + "' as " + this$0.w4l_1.j2($i).q4k_1 + ': ' + $error.v4k();
}
function SignedIntParser(minDigits, maxDigits, spacePadding, setter, name, plusOnExceedsWidth) {
  ...
  if (!(plusOnExceedsWidth == null)) {
    parsers.z1(spaceAndZeroPaddedUnsignedInt(minDigits, plusOnExceedsWidth, spacePadding, setter, name));
    parsers.z1(new ParserStructure(listOf([new PlainStringParserOperation('+'), new NumberSpanParserOperation(listOf_0(new UnsignedIntConsumer(plusOnExceedsWidth + 1 | 0, maxDigits, setter, name, false)))]), emptyList()));
  } else {
    parsers.z1(spaceAndZeroPaddedUnsignedInt(minDigits, maxDigits, spacePadding, setter, name));
  }
  return new ParserStructure(emptyList(), parsers);
}
function PlainStringParserOperation$consume$lambda(this$0) {
  return () => "Unexpected end of input: yet to parse '" + this$0.z4l_1 + "'";
}
function PlainStringParserOperation$consume$lambda_0(this$0, $input, $startIndex, $i) {
  return () => {
    ...
    return 'Expected ' + this$0.z4l_1 + ' but got ' + tmp$ret$0;
  };
}
function SignParser$consume$lambda(this$0, $char) {
  return () => 'Expected ' + this$0.c4m_1 + ' but got ' + toString_0($char);
}
function spaceAndZeroPaddedUnsignedInt$numberOfRequiredLengths($withMinus, $setter, $name, minNumberLength, maxNumberLength) {
  ...
  var this_0 = ArrayList.n2();
  if ($withMinus) {
    this_0.z1(new PlainStringParserOperation('-'));
  }
  this_0.z1(new NumberSpanParserOperation(listOf_0(new UnsignedIntConsumer(minNumberLength - ($withMinus ? 1 : 0) | 0, maxNumberLength - ($withMinus ? 1 : 0) | 0, $setter, $name, $withMinus))));
  var tmp$ret$1 = this_0.e5();
...
function TimeBasedDateTimeUnitSerializer$descriptor$delegate$lambda$lambda($this$buildClassSerialDescriptor) {
  ...
  var this_0 = serializer(createKType(PrimitiveClasses_getInstance().cg(), arrayOf([]), false));
  var descriptor = (isInterface(this_0, KSerializer) ? this_0 : THROW_CCE()).hv();
  $this$buildClassSerialDescriptor.ny(elementName, descriptor, annotations, false);
  return Unit_instance;
}
...
function DayBasedDateTimeUnitSerializer$descriptor$delegate$lambda$lambda($this$buildClassSerialDescriptor) {
  ...
  // Inline function 'kotlinx.serialization.serializer' call
  // Inline function 'kotlinx.serialization.internal.cast' call
  var this_0 = serializer(createKType(PrimitiveClasses_getInstance().bg(), arrayOf([]), false));
  var descriptor = (isInterface(this_0, KSerializer) ? this_0 : THROW_CCE()).hv();
  $this$buildClassSerialDescriptor.ny('days', descriptor, annotations, false);
  return Unit_instance;
}
...
function MonthBasedDateTimeUnitSerializer$descriptor$delegate$lambda$lambda($this$buildClassSerialDescriptor) {
  ...
  var this_0 = serializer(createKType(PrimitiveClasses_getInstance().bg(), arrayOf([]), false));
  var descriptor = (isInterface(this_0, KSerializer) ? this_0 : THROW_CCE()).hv();
  $this$buildClassSerialDescriptor.ny('months', descriptor, annotations, false);
  return Unit_instance;
}
...
function throwUnknownIndexException(index) {
  throw SerializationException.xw('An unknown field for index ' + index);
}
...
function timeZoneById(zoneId) {
  ...
  if (tmp1_safe_receiver == null)
    ...
    // Inline function 'kotlin.let' call
    return RegionTimeZone.w4n(tmp1_safe_receiver, id);
  }
  throw IllegalTimeZoneException.r48('js-joda timezone database is not available');
}
...
function rulesForId(zoneId) {
  ...
  var tmp0_safe_receiver = _Result___get_value__impl__bjfvqg(this_0);
  return tmp0_safe_receiver == null ? null : tmp0_safe_receiver.b4o(zoneId);
}
function tzdb$charCodeToInt(char) {
  ...
  if (_Char___init__impl__6a9atx(48) <= char ? char <= _Char___init__impl__6a9atx(57) : false) {
    ...
    throw IllegalArgumentException.h2('Invalid character: ' + toString_0(char));
  }
  return tmp;
}
function tzdb$base60MinutesInSeconds(string) {
  ...
  var whole = parts.j2(0);
  // Inline function 'kotlin.collections.map' call
  var this_0 = numberRangeToNumber(minuteNumberStart, get_lastIndex(whole));
  // Inline function 'kotlin.collections.mapTo' call
  var destination = ArrayList.y1(collectionSizeOrDefault(this_0, 10));
  var inductionVariable = this_0.z2_1;
  var last = this_0.a3_1;
  if (inductionVariable <= last)
    do {
  ...
  if (!properties_initialized_Platform_kt_qdcgvf) {
    ...
    try {
      ...
      $l$block: {
        ...
        var zonesPacked = _destruct__k2r9zo.zk();
        var linksPacked = _destruct__k2r9zo.al();
        var _iterator__ex2g4s = zonesPacked.l1();
        while (_iterator__ex2g4s.m1()) {
          var zone = _iterator__ex2g4s.n1();
          var components = split(zone, charArrayOf([_Char___init__impl__6a9atx(124)]));
          // Inline function 'kotlin.collections.map' call
          var this_0 = split(components.j2(2), charArrayOf([_Char___init__impl__6a9atx(32)]));
          // Inline function 'kotlin.collections.mapTo' call
          var destination = ArrayList.y1(collectionSizeOrDefault(this_0, 10));
          ...
          var this_1 = components.j2(3);
          // Inline function 'kotlin.text.mapTo' call
          var destination_0 = ArrayList.y1(charSequenceLength(this_1));
          var inductionVariable = 0;
          ...
          // Inline function 'kotlin.collections.map' call
          var this_2 = split(components.j2(4), charArrayOf([_Char___init__impl__6a9atx(32)]));
          // Inline function 'kotlin.collections.mapTo' call
          var destination_1 = ArrayList.y1(collectionSizeOrDefault(this_2, 10));
          ...
          var tmp2 = components.j2(0);
          var tmp$ret$12;
          $l$block_0: {
            // Inline function 'kotlin.collections.runningReduce' call
            var iterator = lengthsOfPeriodsWithOffsets.l1();
            if (!iterator.m1()) {
              tmp$ret$12 = emptyList();
              break $l$block_0;
            }
            var accumulator = iterator.n1();
            // Inline function 'kotlin.apply' call
            var this_3 = ArrayList.y1(collectionSizeOrDefault(lengthsOfPeriodsWithOffsets, 10));
            this_3.z1(accumulator);
            var result = this_3;
            while (iterator.m1()) {
              var tmp0 = accumulator;
              var p1 = iterator.n1();
              accumulator = add(tmp0, p1);
              result.z1(accumulator);
            }
            tmp$ret$12 = result;
          }
          // Inline function 'kotlin.let' call
          var it = tmp$ret$12;
          var tmp_1 = it.k2() === (indices.k2() - 1 | 0) ? it : take(it, indices.k2() - 1 | 0);
          // Inline function 'kotlin.collections.map' call
          // Inline function 'kotlin.collections.mapTo' call
          var destination_2 = ArrayList.y1(collectionSizeOrDefault(indices, 10));
          var _iterator__ex2g4s_2 = indices.l1();
          while (_iterator__ex2g4s_2.m1()) {
            var item_2 = _iterator__ex2g4s_2.n1();
            var tmp$ret$20 = offsets.j2(item_2);
            destination_2.z1(tmp$ret$20);
          }
          // Inline function 'kotlin.collections.set' call
          var value = new TimeZoneRulesCommon(tmp_1, destination_2, null);
          zones.f4(tmp2, value);
        }
        var _iterator__ex2g4s_3 = linksPacked.l1();
        while (_iterator__ex2g4s_3.m1()) {
          var link = _iterator__ex2g4s_3.n1();
          var components_0 = split(link, charArrayOf([_Char___init__impl__6a9atx(124)]));
          var tmp1_safe_receiver = zones.c4(components_0.j2(0));
          if (tmp1_safe_receiver == null)
            null;
          else {
            // Inline function 'kotlin.let' call
            // Inline function 'kotlin.collections.set' call
            var key = components_0.j2(1);
            zones.f4(key, tmp1_safe_receiver);
          }
        }
...
function plus_1(_this__u8e3s4, value, unit) {
  ...
  try {
    ...
    if (unit instanceof DayBased) {
      tmp_0 = _this__u8e3s4.i4o(safeMultiply(value, fromInt(unit.q47_1)));
    } else {
      if (unit instanceof MonthBased) {
        tmp_0 = _this__u8e3s4.h4o(safeMultiply(value, fromInt(unit.r47_1)));
      } else {
        noWhenBranchMatchedException();
      }
    }
    ...
    if ($p instanceof ArithmeticException) {
      var e = $p;
      throw DateTimeArithmeticException.y48('Arithmetic overflow when adding a value to a date', e);
    } else {
      if ($p instanceof IllegalArgumentException) {
        var e_0 = $p;
        throw DateTimeArithmeticException.y48('Boundaries of LocalDate exceeded when adding a value', e_0);
      } else {
        throw $p;
      }
    }
...
function plusSeconds(_this__u8e3s4, seconds) {
  ...
  var currentNanoOfDay = _this__u8e3s4.d4d_1.o4o();
  ...
  var newTime = newNanoOfDay === currentNanoOfDay ? _this__u8e3s4.d4d_1 : Companion_getInstance_16().p4o(newNanoOfDay);
  return new LocalDateTime(_this__u8e3s4.c4d_1.i4o(totalDays), newTime);
}
function ISO_DATETIME_OPTIONAL_SECONDS_TRAILING_ZEROS$delegate$lambda() {
  _init_properties_LocalDateTime_kt__bewbbg();
  var tmp = Companion_instance_7;
  return tmp.l4c(ISO_DATETIME_OPTIONAL_SECONDS_TRAILING_ZEROS$delegate$lambda$lambda);
}
function ISO_DATETIME_OPTIONAL_SECONDS_TRAILING_ZEROS$delegate$lambda$lambda($this$build) {
  ...
  $this$build.f4a(get_ISO_TIME_OPTIONAL_SECONDS_TRAILING_ZEROS());
  return Unit_instance;
}
...
function ISO_TIME_OPTIONAL_SECONDS_TRAILING_ZEROS$delegate$lambda() {
  _init_properties_LocalTime_kt__nmhi56();
  var tmp = Companion_instance_8;
  return tmp.a4e(ISO_TIME_OPTIONAL_SECONDS_TRAILING_ZEROS$delegate$lambda$lambda);
}
...
function ISO_TIME_OPTIONAL_SECONDS_TRAILING_ZEROS$delegate$lambda$lambda$lambda$lambda($this$optional) {
  _init_properties_LocalTime_kt__nmhi56();
  char($this$optional, _Char___init__impl__6a9atx(46));
  secondFractionInternal($this$optional, 1, 9, Companion_getInstance_9().b4f_1);
  return Unit_instance;
}
...
function toLocalDateTime(_this__u8e3s4, timeZone) {
  _init_properties_TimeZone_kt__dwyks9();
  return timeZone.a4o(_this__u8e3s4);
}
function toInstant(_this__u8e3s4, offset, youShallNotPass) {
  youShallNotPass = youShallNotPass === VOID ? Companion_getInstance_5().e48_1 : youShallNotPass;
  _init_properties_TimeZone_kt__dwyks9();
  return Companion_getInstance().sr(_this__u8e3s4.m4o(offset), _this__u8e3s4.k4d());
}
function toLocalDateTime_0(_this__u8e3s4, offset) {
  ...
  try {
    ...
    if ($p instanceof IllegalArgumentException) {
      var e = $p;
      throw DateTimeArithmeticException.y48('Instant ' + _this__u8e3s4.toString() + ' is not representable as LocalDateTime', e);
    } else {
      throw $p;
    }
  }
...
function toLocalDateTimeImpl(_this__u8e3s4, offset) {
  _init_properties_TimeZone_kt__dwyks9();
  var tmp0 = _this__u8e3s4.xr_1;
  // Inline function 'kotlin.Long.plus' call
  var other = offset.a4g_1;
  ...
  var date = Companion_getInstance_14().e4o(localEpochDay);
  var time = Companion_getInstance_16().r4o(secsOfDay, _this__u8e3s4.yr_1);
...
function lenientOffsetFormat$lambda$lambda($this$alternativeParsing) {
  _init_properties_TimeZone_kt__dwyks9();
  $this$alternativeParsing.g4a(Padding_NONE_getInstance());
  return Unit_instance;
}
...
function _init_properties_TimeZone_kt__dwyks9() {
  if (!properties_initialized_TimeZone_kt_fgsidh) {
    ...
    var tmp = Companion_instance_10;
    lenientOffsetFormat = tmp.k4g(lenientOffsetFormat$lambda);
  }
}
...
function validateTotal($this, totalSeconds) {
  if (!(-64800 <= totalSeconds ? totalSeconds <= 64800 : false)) {
    throw IllegalArgumentException.h2('Total seconds value is out of range: ' + totalSeconds);
  }
}
function validate($this, hours, minutes, seconds) {
  if (hours < -18 || hours > 18) {
    throw IllegalArgumentException.h2('Zone offset hours not in valid range: value ' + hours + ' is not in the range -18 to 18');
  }
  if (hours > 0) {
    if (minutes < 0 || seconds < 0) {
      throw IllegalArgumentException.h2('Zone offset minutes and seconds must be positive because hours is positive');
    }
  } else if (hours < 0) {
    if (minutes > 0 || seconds > 0) {
      throw IllegalArgumentException.h2('Zone offset minutes and seconds must be negative because hours is negative');
    }
  } else if (minutes > 0 && seconds < 0 || (minutes < 0 && seconds > 0)) {
    throw IllegalArgumentException.h2('Zone offset minutes and seconds must have the same sign');
  }
  if (abs(minutes) > 59) {
    throw IllegalArgumentException.h2('Zone offset minutes not in valid range: abs(value) ' + abs(minutes) + ' is not in the range 0 to 59');
  }
  if (abs(seconds) > 59) {
    throw IllegalArgumentException.h2('Zone offset seconds not in valid range: abs(value) ' + abs(seconds) + ' is not in the range 0 to 59');
  }
  if (abs(hours) === 18 && (abs(minutes) > 0 || abs(seconds) > 0)) {
    throw IllegalArgumentException.h2('Utc offset not in valid range: -18:00 to +18:00');
  }
}
...
function UtcOffset_0(hours, minutes, seconds) {
  ...
  if (!(hours == null)) {
    ...
    tmp = tmp_0.v4o(hours, tmp_1, seconds == null ? 0 : seconds);
  } else if (!(minutes == null)) {
    var tmp_2 = Companion_getInstance_19();
    var tmp_3 = minutes / 60 | 0;
    var tmp_4 = minutes % 60 | 0;
    tmp = tmp_2.v4o(tmp_3, tmp_4, seconds == null ? 0 : seconds);
  } else {
    var tmp_5 = Companion_getInstance_19();
    tmp = tmp_5.w4o(seconds == null ? 0 : seconds);
  }
  return tmp;
}
...
function _init_properties_UtcOffset_kt__93zod7() {
  if (!properties_initialized_UtcOffset_kt_4gxffr) {
    ...
    // Inline function 'kotlin.collections.mutableMapOf' call
    utcOffsetCache = LinkedHashMap.l5();
  }
}
...
function RecurringZoneRules$rulesForYear$lambda(a, b) {
  // Inline function 'kotlin.comparisons.compareValuesBy' call
  var tmp = a.g4p_1;
  var tmp$ret$2 = b.g4p_1;
  return compareValues(tmp, tmp$ret$2);
}
function safeAdd(a, b) {
  var sum = add(a, b);
  if ((a ^ sum) < 0n && (a ^ b) >= 0n) {
    throw ArithmeticException.te('Addition overflows a long: ' + a.toString() + ' + ' + b.toString());
  }
  return sum;
}
function safeMultiply(a, b) {
  ...
  if (!(divide(total, b) === a) || (a === -9223372036854775808n && b === -1n) || (b === -9223372036854775808n && a === -1n)) {
    throw ArithmeticException.te('Multiplication overflows a long: ' + a.toString() + ' * ' + b.toString());
  }
  return total;
}
function safeMultiply_0(a, b) {
  ...
  if (total < -2147483648n || total > 2147483647n) {
    throw ArithmeticException.te('Multiplication overflows an int: ' + a + ' * ' + b);
  }
...
initMetadataForClass(DateTimeFormatException, 'DateTimeFormatException', DateTimeFormatException.j48);
initMetadataForClass(IllegalTimeZoneException, 'IllegalTimeZoneException', IllegalTimeZoneException.q48);
initMetadataForClass(DateTimeArithmeticException, 'DateTimeArithmeticException', DateTimeArithmeticException.x48);
...
protoOf(Builder).n4a = appendAlternativeParsingImpl;
protoOf(Builder).m4a = appendOptionalImpl;
protoOf(Builder).u49 = chars;
protoOf(Builder).x2k = build;
protoOf(Builder).u4b = addFormatStructureForYearMonth;
protoOf(Builder).v49 = day;
protoOf(Builder).w49 = day$default;
protoOf(Builder).x49 = date;
protoOf(Builder).q49 = year;
protoOf(Builder).r49 = year$default;
protoOf(Builder).s49 = monthNumber;
protoOf(Builder).t49 = monthNumber$default;
...
protoOf(Builder_0).n4a = appendAlternativeParsingImpl;
protoOf(Builder_0).m4a = appendOptionalImpl;
protoOf(Builder_0).u49 = chars;
protoOf(Builder_0).x2k = build;
protoOf(Builder_0).t4b = addFormatStructureForDate;
protoOf(Builder_0).t4a = addFormatStructureForTime;
protoOf(Builder_0).u4b = addFormatStructureForYearMonth;
protoOf(Builder_0).v49 = day;
protoOf(Builder_0).w49 = day$default;
protoOf(Builder_0).x49 = date;
protoOf(Builder_0).q49 = year;
protoOf(Builder_0).r49 = year$default;
protoOf(Builder_0).s49 = monthNumber;
protoOf(Builder_0).t49 = monthNumber$default;
protoOf(Builder_0).y49 = hour;
protoOf(Builder_0).z49 = hour$default;
protoOf(Builder_0).a4a = minute;
protoOf(Builder_0).b4a = minute$default;
protoOf(Builder_0).c4a = second;
protoOf(Builder_0).d4a = second$default;
protoOf(Builder_0).e4a = secondFraction;
protoOf(Builder_0).f4a = time;
...
protoOf(IncompleteLocalTime).r4d = set_fractionOfSecond;
protoOf(IncompleteLocalTime).s4d = get_fractionOfSecond;
...
protoOf(Builder_1).n4a = appendAlternativeParsingImpl;
protoOf(Builder_1).m4a = appendOptionalImpl;
protoOf(Builder_1).u49 = chars;
protoOf(Builder_1).x2k = build;
protoOf(Builder_1).y49 = hour;
protoOf(Builder_1).z49 = hour$default;
protoOf(Builder_1).a4a = minute;
protoOf(Builder_1).b4a = minute$default;
protoOf(Builder_1).c4a = second;
protoOf(Builder_1).d4a = second$default;
protoOf(Builder_1).e4a = secondFraction;
protoOf(Builder_1).f4a = time;
...
protoOf(Builder_2).n4a = appendAlternativeParsingImpl;
protoOf(Builder_2).m4a = appendOptionalImpl;
protoOf(Builder_2).u49 = chars;
protoOf(Builder_2).x2k = build;
protoOf(Builder_2).g4a = offsetHours;
protoOf(Builder_2).h4a = offsetHours$default;
protoOf(Builder_2).i4a = offsetMinutesOfHour;
protoOf(Builder_2).j4a = offsetMinutesOfHour$default;
protoOf(Builder_2).k4a = offsetSecondsOfMinute;
protoOf(Builder_2).l4a = offsetSecondsOfMinute$default;
...
protoOf(Builder_3).n4a = appendAlternativeParsingImpl;
protoOf(Builder_3).m4a = appendOptionalImpl;
protoOf(Builder_3).u49 = chars;
protoOf(Builder_3).x2k = build;
protoOf(Builder_3).q49 = year;
protoOf(Builder_3).r49 = year$default;
protoOf(Builder_3).s49 = monthNumber;
protoOf(Builder_3).t49 = monthNumber$default;
...
protoOf(PropertyAccessor).g4i = getterNotNull;
...
export {
  Companion_getInstance_18 as Companion_getInstance3fr80ko02pro7,
